...
void sub_001EE330_0x1ee330(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1EE390u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EE390u, 0x1EE33Cu, 0x1EE344u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EE344u;
label_1ee344:
...
label_1ee380:
    ...
    ctx->pc = 0x1EE388u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EE388u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
