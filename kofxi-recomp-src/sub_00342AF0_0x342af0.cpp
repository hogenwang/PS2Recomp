...
void sub_00342AF0_0x342af0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x342B08u;
    {
        ...
        ctx->pc = 0x342B0Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x342B08u;
    ...
    ctx->pc = 0x342B10u;
    {
        ...
        if (branch_taken_0x342b10) {
            ctx->pc = 0x342B14u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x342B10u;
...
label_342b20:
    ...
    ctx->pc = 0x342B20u;
    {
        ...
        ctx->pc = 0x342B24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x342B20u;
...
label_342b28:
    ...
    ctx->pc = 0x342B2Cu;
    {
        ...
        if (branch_taken_0x342b2c) {
            ctx->pc = 0x342B30u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x342B2Cu;
    ...
    ctx->pc = 0x342B3Cu;
    {
        ...
        if (branch_taken_0x342b3c) {
            ctx->pc = 0x342B40u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x342B3Cu;
...
label_342b50:
    ...
    ctx->pc = 0x342B54u;
    {
        ...
        if (branch_taken_0x342b54) {
            ctx->pc = 0x342B58u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x342B54u;
    ...
    ctx->pc = 0x342B64u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x342B60u;
    ...
    if (runtime->hasFunction(0x14E3F0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x342B68u; }
        if (ctx->pc != 0x342B68u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_342b6c:
    ...
    ctx->pc = 0x342B74u;
    {
        ...
        ctx->pc = 0x342B78u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x342B74u;
