...
void sub_001F5C10_0x1f5c10(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F5C40u;
    // 0x1f5c44: 0x8e040040  lw          $a0, 0x40($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 64)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CCA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CCA0u, 0x1F5C40u, 0x1F5C48u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F5C48u;
label_1f5c48:
...
label_1f5cd8:
    ...
    ctx->pc = 0x1f5cfcu;
    // NOP
    if (ctx->pc == 0x1f5cfcu) { ctx->pc = 0x1f5d00u; }
}
