...
label_29ab48:
    ...
    ctx->pc = 0x29AB44u;
    {
        ...
        ctx->pc = 0x29AB48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AB44u;
            // 0x29ab48: 0xffb00000  sd          $s0, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 16));
...
label_29ab58:
    ...
    ctx->pc = 0x29AB54u;
    {
        ...
        ctx->pc = 0x29AB58u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AB54u;
            // 0x29ab58: 0x220102d  daddu       $v0, $s1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_29ab9c:
    ...
    ctx->pc = 0x29AB98u;
    {
        ...
        ctx->pc = 0x29AB9Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AB98u;
            // 0x29ab9c: 0x200902d  daddu       $s2, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_29abb0:
    ...
    ctx->pc = 0x29ABACu;
    {
        ...
        ctx->pc = 0x29ABB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29ABACu;
            // 0x29abb0: 0x2721821  addu        $v1, $s3, $s2 (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 19), GPR_U32(ctx, 18)));
        ctx->in_delay_slot = false;
...
label_29ac3c:
    ...
    ctx->pc = 0x29AC3Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29AC38u;
            // 0x29ac3c: 0x24060200  addiu       $a2, $zero, 0x200 (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 512));
        ctx->in_delay_slot = false;
    ctx->pc = 0x285438u;
    if (runtime->hasFunction(0x285438u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29AC40u; }
        if (ctx->pc != 0x29AC40u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29ac44:
    ...
    ctx->pc = 0x29AC40u;
    {
        ...
        ctx->pc = 0x29AC44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AC40u;
            // 0x29ac44: 0x5d1021  addu        $v0, $v0, $sp (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 29)));
        ctx->in_delay_slot = false;
...
label_29ac60:
    ...
    ctx->pc = 0x29AC5Cu;
    {
        ...
        ctx->pc = 0x29AC60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AC5Cu;
            // 0x29ac60: 0x93a70000  lbu         $a3, 0x0($sp) (Delay Slot)
        SET_GPR_U32(ctx, 7, (uint8_t)READ8(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
...
label_29aca4:
    ...
    ctx->pc = 0x29ACA0u;
    {
        ...
        if (branch_taken_0x29aca0) {
            ctx->pc = 0x29ACA4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x29ACA0u;
            // 0x29aca4: 0x24a50001  addiu       $a1, $a1, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 1));
        ctx->in_delay_slot = false;
            ctx->pc = 0x29AC84u;
...
label_29accc:
    ...
    ctx->pc = 0x29ACC8u;
    {
        ...
        ctx->pc = 0x29ACCCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29ACC8u;
            // 0x29accc: 0x90a70000  lbu         $a3, 0x0($a1) (Delay Slot)
        SET_GPR_U32(ctx, 7, (uint8_t)READ8(ADD32(GPR_U32(ctx, 5), 0)));
        ctx->in_delay_slot = false;
...
label_29ad04:
    ...
    ctx->pc = 0x29AD00u;
    {
        ...
        ctx->pc = 0x29AD04u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AD00u;
            // 0x29ad04: 0x521821  addu        $v1, $v0, $s2 (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 18)));
        ctx->in_delay_slot = false;
...
label_29ad14:
    ...
    ctx->pc = 0x29AD10u;
    {
        ...
        ctx->pc = 0x29AD14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AD10u;
            // 0x29ad14: 0xa0802d  daddu       $s0, $a1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_29ad28:
    ...
    ctx->pc = 0x29AD24u;
    {
        ...
        ctx->pc = 0x29AD28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AD24u;
            // 0x29ad28: 0x92060000  lbu         $a2, 0x0($s0) (Delay Slot)
        SET_GPR_U32(ctx, 6, (uint8_t)READ8(ADD32(GPR_U32(ctx, 16), 0)));
        ctx->in_delay_slot = false;
...
label_29ad50:
    ...
    ctx->pc = 0x29AD4Cu;
    {
        ...
        if (branch_taken_0x29ad4c) {
            ctx->pc = 0x29AD50u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x29AD4Cu;
            // 0x29ad50: 0x802d  daddu       $s0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
            ctx->pc = 0x29ADACu;
...
label_29ad70:
    ...
    ctx->pc = 0x29AD6Cu;
    {
        ...
        ctx->pc = 0x29AD70u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AD6Cu;
            // 0x29ad70: 0x92060000  lbu         $a2, 0x0($s0) (Delay Slot)
        SET_GPR_U32(ctx, 6, (uint8_t)READ8(ADD32(GPR_U32(ctx, 16), 0)));
        ctx->in_delay_slot = false;
...
label_29ad9c:
    ...
    ctx->pc = 0x29AD98u;
    {
        ...
        ctx->pc = 0x29AD9Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29AD98u;
            // 0x29ad9c: 0x6800a  movz        $s0, $zero, $a2 (Delay Slot)
        if (GPR_U64(ctx, 6) == 0) SET_GPR_VEC(ctx, 16, GPR_VEC(ctx, 0));
        ctx->in_delay_slot = false;
...
label_29ada4:
    ...
    ctx->pc = 0x29ADA0u;
    {
        ...
        ctx->pc = 0x29ADA4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29ADA0u;
            // 0x29ada4: 0x802d  daddu       $s0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_29adc4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29ADC0u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x29AE08u;
    if (runtime->hasFunction(0x29AE08u)) {
        auto targetFn = runtime->lookupFunction(0x29AE08u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0029AE08_0x29ae08(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29ADC8u; }
        if (ctx->pc != 0x29ADC8u) { return; }
    }
    ctx->pc = 0x29ADC8u;
...
label_29ae00:
    ...
    ctx->pc = 0x29ADFCu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x29AE00u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29ADFCu;
            // 0x29ae00: 0x27bd0280  addiu       $sp, $sp, 0x280 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 640));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
