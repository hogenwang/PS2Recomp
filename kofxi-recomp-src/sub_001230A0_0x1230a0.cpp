...
void sub_001230A0_0x1230a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x12312cu: goto label_12312c;
        default: break;
    }
    ...
    ctx->pc = 0x1230B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1230B0u;
    ...
    if (runtime->hasFunction(0x122660u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1230B8u; }
        if (ctx->pc != 0x1230B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1230b8:
    ...
    ctx->pc = 0x1230C4u;
    {
        ...
        ctx->pc = 0x1230C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1230C4u;
    ...
    ctx->pc = 0x1230D8u;
    {
        ...
        ctx->pc = 0x1230DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1230D8u;
    ...
    ctx->pc = 0x1230F0u;
    {
        ...
        ctx->pc = 0x1230F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1230F0u;
