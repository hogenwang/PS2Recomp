...
void sub_001277D8_0x1277d8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x12781cu: goto label_12781c;
        default: break;
    }
    ...
    ctx->pc = 0x1277E0u;
    {
        ...
        ctx->pc = 0x1277E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1277E0u;
    ...
    ctx->pc = 0x1277E8u;
    {
        ...
        ctx->pc = 0x1277ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1277E8u;
    ...
    ctx->pc = 0x1277F4u;
    {
        ...
        ctx->pc = 0x1277F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1277F4u;
...
label_127804:
    ...
    ctx->pc = 0x127804u;
    {
        ...
        ctx->pc = 0x127808u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127804u;
...
label_12780c:
    ...
    ctx->pc = 0x12780Cu;
    {
        ...
        ctx->pc = 0x127810u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12780Cu;
...
label_12781c:
    ...
    ctx->pc = 0x127820u;
    {
        ...
        ctx->pc = 0x127824u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127820u;
...
label_127848:
    ...
    ctx->pc = 0x127848u;
    {
        ...
        ctx->pc = 0x12784Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127848u;
...
label_12785c:
    ...
    ctx->pc = 0x12785Cu;
    {
        ...
        ctx->pc = 0x127860u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12785Cu;
