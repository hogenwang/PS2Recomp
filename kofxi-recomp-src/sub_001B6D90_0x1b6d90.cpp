...
void sub_001B6D90_0x1b6d90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B6DA0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6D9Cu;
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6DA4u; }
        if (ctx->pc != 0x1B6DA4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b6da4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6DA4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B6DC8u;
    if (runtime->hasFunction(0x1B6DC8u)) {
        auto targetFn = runtime->lookupFunction(0x1B6DC8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001B6DC8_0x1b6dc8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6DACu; }
        if (ctx->pc != 0x1B6DACu) { return; }
    }
    ctx->pc = 0x1B6DACu;
label_1b6dac:
    ...
    ctx->pc = 0x1B6DB0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6DACu;
    ...
    if (runtime->hasFunction(0x1B8168u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6DB4u; }
        if (ctx->pc != 0x1B6DB4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b6db4:
    ...
    ctx->pc = 0x1B6DC0u;
    {
        ...
        ctx->pc = 0x1B6DC4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6DC0u;
