...
void sub_002E3988_0x2e3988(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2E3A2Cu;
    // 0x2e3a30: 0x8c660004  lw          $a2, 0x4($v1) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2E3A2Cu, 0x2E3A34u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3A34u;
label_2e3a34:
    ...
    ctx->pc = 0x2e3a5cu;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2E3A5C raw=0xCB188A50");
...
label_2e3a68:
    ...
    ctx->pc = 0x2e3a74u;
    throw std::runtime_error("Unhandled opcode: 0x1D at 0x2E3A74 raw=0x76D01D4C");
    ...
    ctx->pc = 0x2e3a9cu;
    throw std::runtime_error("Unhandled FPU instruction: format 0xC, function 0x3F at 0x2E3A9C raw=0x4594EFBF");
    // 0x2e3aa0: 0x4a901548  vmaddx.y    $vf21, $vf2, $vf16x
    ctx->pc = 0x2e3aa0u;
    { __m128 mul_res = PS2_VMUL(ctx->vu0_vf[2], _mm_shuffle_ps(ctx->vu0_vf[16], ctx->vu0_vf[16], _MM_SHUFFLE(0,0,0,0))); __m128 res = PS2_VADD(ctx->vu0_acc, mul_res); __m128i mask = _mm_set_epi32(0, 0, -1, 0); ctx->vu0_vf[21] = _mm_blendv_ps(ctx->vu0_vf[21], res, _mm_castsi128_ps(mask)); ctx->vu0_acc = res; }
    ...
    ctx->pc = 0x2E3AA4u;
    {
        ...
        if (branch_taken_0x2e3aa4) {
            ...
            throw std::runtime_error("Unhandled COP0 CO-OP: 0xF at 0x2E3AA8 raw=0x421F2D4F");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2C9918u;
            return;
        }
    ...
    ctx->pc = 0x2e3aacu;
    { __m128 mul_res = PS2_VMUL(ctx->vu0_vf[18], _mm_shuffle_ps(ctx->vu0_vf[17], ctx->vu0_vf[17], _MM_SHUFFLE(0,0,0,0))); __m128 res = PS2_VADD(ctx->vu0_acc, mul_res); __m128i mask = _mm_set_epi32(0, 0, -1, 0); ctx->vu0_vf[21] = _mm_blendv_ps(ctx->vu0_vf[21], res, _mm_castsi128_ps(mask)); ctx->vu0_acc = res; }
    ...
    ctx->pc = 0x2e3ab8u;
    { __m128 mul_res = PS2_VMUL(ctx->vu0_vf[2], _mm_shuffle_ps(ctx->vu0_vf[17], ctx->vu0_vf[17], _MM_SHUFFLE(0,0,0,0))); __m128 res = PS2_VADD(ctx->vu0_acc, mul_res); __m128i mask = _mm_set_epi32(0, 0, -1, 0); ctx->vu0_vf[21] = _mm_blendv_ps(ctx->vu0_vf[21], res, _mm_castsi128_ps(mask)); ctx->vu0_acc = res; }
...
label_fallthrough_0x2e3acc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xAEC71A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xAEC71A0u, 0x2E3AECu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3AF4u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x3686070u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3686070u, 0x2E3B10u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3B18u;
    ...
    ctx->pc = 0x2e3b2cu;
    throw std::runtime_error("Unhandled MMI instruction: function 0xC at 0x2E3B2C raw=0x72DA1D4C");
    ...
    ctx->pc = 0x2e3b34u;
    throw std::runtime_error("Unhandled FPU instruction: format 0xC, function 0x3F at 0x2E3B34 raw=0x4594EFBF");
    ...
    ctx->pc = 0x2e3b40u;
    throw std::runtime_error("Unhandled COP0 CO-OP: 0xF at 0x2E3B40 raw=0x421F2D4F");
    ...
    ctx->pc = 0x2e3b54u;
    { __m128 mul_res = PS2_VMUL(ctx->vu0_vf[3], _mm_shuffle_ps(ctx->vu0_vf[27], ctx->vu0_vf[27], _MM_SHUFFLE(2,2,2,2))); __m128 res = PS2_VSUB(ctx->vu0_acc, mul_res); __m128i mask = _mm_set_epi32(-1, 0, -1, 0); ctx->vu0_vf[27] = _mm_blendv_ps(ctx->vu0_vf[27], res, _mm_castsi128_ps(mask)); ctx->vu0_acc = res; }
    // 0x2e3b58: 0xc0b7c76  jal         func_2DF1D8
    ctx->pc = 0x2E3B58u;
    SET_GPR_U32(ctx, 31, 0x2E3B60u);
    ctx->pc = 0x2E3B5Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3B58u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2E3B58u, 0x2E3B60u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3B60u;
label_2e3b60:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xAEC71A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xAEC71A0u, 0x2E3B7Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3B84u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x8AC4610u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x8AC4610u, 0x2E3BB0u, 0x2E3BB8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3BB8u;
label_2e3bb8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E3958u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E3958u, 0x2E3BB8u, 0x2E3BC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3BC0u;
label_2e3bc0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x3644570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3644570u, 0x2E3BD4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3BDCu;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xA6C5D78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xA6C5D78u, 0x2E3BDCu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3BE4u;
    ...
    ctx->pc = 0x2E3C00u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3BFCu;
    // 0x2e3c00: 0x2a9b1d0e  slti        $k1, $s4, 0x1D0E (Delay Slot)
    SET_GPR_U64(ctx, 27, ((int64_t)GPR_S64(ctx, 20) < (int64_t)(int32_t)7438) ? 1 : 0);
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E0410u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E0410u, 0x2E3BFCu, 0x2E3C04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3C04u;
label_2e3c04:
    ...
    ctx->pc = 0x2E3C10u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3C0Cu;
    // 0x2e3c10: 0xfa3b1344  sqc2        $vf27, 0x1344($s1) (Delay Slot)
    WRITE128(ADD32(GPR_U32(ctx, 17), 4932), _mm_castps_si128(ctx->vu0_vf[27]));
    ctx->in_delay_slot = false;
    ctx->pc = 0xEAC4738u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xEAC4738u, 0x2E3C0Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3C14u;
    ...
    ctx->pc = 0x2e3c20u;
    throw std::runtime_error("Unhandled opcode: 0x3D at 0x2E3C20 raw=0xF584E9CE");
    ...
    ctx->pc = 0x2E3C24u;
    {
        ...
        if (branch_taken_0x2e3c24) {
            ctx->pc = 0x2E3C28u;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2E3C24u;
            // 0x2e3c28: 0xf6de1d6c  sdc1        $f30, 0x1D6C($s6) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x3D at 0x2E3C28 raw=0xF6DE1D6C");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2EB298u;
            return;
        }
...
label_fallthrough_0x2e3c34:
    ...
    ctx->pc = 0x2E3C48u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3C44u;
    // 0x2e3c48: 0x8da1b5c  j           func_3686D70 (Delay Slot)
    // J 0x3686D70 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x3E45570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3E45570u, 0x2E3C44u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3C4Cu;
    ...
    ctx->pc = 0x2E3C50u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3C4Cu;
    // 0x2e3c50: 0x6adb1945  ldl         $k1, 0x1945($s6) (Delay Slot)
    { uint32_t addr = ADD32(GPR_U32(ctx, 22), 6469); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint64_t mem = READ64(aligned_addr); uint32_t shift = (7u - offset) << 3; uint64_t keepMask = (shift == 0) ? 0ull : ((1ull << shift) - 1ull); SET_GPR_U64(ctx, 27, (GPR_U64(ctx, 27) & keepMask) | (mem << shift)); }
    ctx->in_delay_slot = false;
    ctx->pc = 0xA6C5D78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xA6C5D78u, 0x2E3C4Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3C54u;
    ...
    ctx->pc = 0x2e3c68u;
    { __m128 mul_res = PS2_VMUL(ctx->vu0_vf[2], _mm_shuffle_ps(ctx->vu0_vf[27], ctx->vu0_vf[27], _MM_SHUFFLE(2,2,2,2))); __m128 res = PS2_VSUB(ctx->vu0_acc, mul_res); __m128i mask = _mm_set_epi32(-1, 0, -1, 0); ctx->vu0_vf[19] = _mm_blendv_ps(ctx->vu0_vf[19], res, _mm_castsi128_ps(mask)); ctx->vu0_acc = res; }
    ...
    ctx->pc = 0x2E3C7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3C78u;
    // 0x2e3c7c: 0x8f91f5c  j           func_3E47D70 (Delay Slot)
    // J 0x3E47D70 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x3684D70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3684D70u, 0x2E3C78u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3C80u;
    ...
    ctx->pc = 0x2E3C88u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3C84u;
    // 0x2e3c88: 0x38da17fc  xori        $k0, $a2, 0x17FC (Delay Slot)
    SET_GPR_U64(ctx, 26, GPR_U64(ctx, 6) ^ (uint64_t)(uint16_t)6140);
    ctx->in_delay_slot = false;
    ctx->pc = 0xA6C5D78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xA6C5D78u, 0x2E3C84u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3C8Cu;
    ...
    ctx->pc = 0x2E3CA4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3CA0u;
    // 0x2e3ca4: 0x8d9115c  j           func_3644570 (Delay Slot)
    // J 0x3644570 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x3E87570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3E87570u, 0x2E3CA0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3CA8u;
    ...
    ctx->pc = 0x2E3CB0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3CACu;
    // 0x2e3cb0: 0x7a5b17ce  lq          $k1, 0x17CE($s2) (Delay Slot)
    SET_GPR_VEC(ctx, 27, READ128(ADD32(GPR_U32(ctx, 18), 6094)));
    ctx->in_delay_slot = false;
    ctx->pc = 0xA6C5D78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xA6C5D78u, 0x2E3CACu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3CB4u;
    ...
    ctx->pc = 0x2e3cbcu;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2E3CBC raw=0xCA3B1344");
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E08C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E08C0u, 0x2E3CD8u, 0x2E3CE0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3CE0u;
label_2e3ce0:
    ...
    ctx->pc = 0x2e3ce8u;
    throw std::runtime_error("Unhandled REGIMM instruction: 0x14 at 0x2E3CE8 raw=0x0594ECBE");
    ...
    ctx->pc = 0x2E3D14u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3D10u;
    // 0x2e3d14: 0x594ecbe  .word       0x0594ECBE                   # INVALID     $t4, $s4, -0x1342 # 00000000 <InstrIdType: CPU_REGIMM> (Delay Slot)
    throw std::runtime_error("Unhandled REGIMM instruction: 0x14 at 0x2E3D14 raw=0x0594ECBE");
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E0410u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E0410u, 0x2E3D10u, 0x2E3D18u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3D18u;
label_2e3d18:
    ...
    ctx->pc = 0x2e3d2cu;
    throw std::runtime_error("Unhandled opcode: 0x3D at 0x2E3D2C raw=0xF584E9CE");
    ...
    ctx->pc = 0x2e3d34u;
    throw std::runtime_error("Unhandled opcode: 0x3D at 0x2E3D34 raw=0xF6DE1D6C");
    ...
    ctx->pc = 0x2e3d40u;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2E3D40 raw=0xC9AB11CE");
label_2e3d44:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x8AC4510u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x8AC4510u, 0x2E3D4Cu, 0x2E3D54u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3D54u;
label_2e3d54:
    ...
    ctx->pc = 0x2e3d5cu;
    throw std::runtime_error("Unhandled FPU instruction: format 0xC, function 0x3F at 0x2E3D5C raw=0x4594EFBF");
    ...
    ctx->pc = 0x2e3d68u;
    throw std::runtime_error("Unhandled COP0 CO-OP: 0xF at 0x2E3D68 raw=0x421F2D4F");
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2E3D78u, 0x2E3D80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3D80u;
label_2e3d80:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x8AC4510u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x8AC4510u, 0x2E3D8Cu, 0x2E3D94u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3D94u;
label_2e3d94:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xAEC71A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xAEC71A0u, 0x2E3DA8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3DB0u;
    ...
    ctx->pc = 0x2e3ddcu;
    throw std::runtime_error("Unhandled FPU instruction: format 0xC, function 0x3F at 0x2E3DDC raw=0x4594EFBF");
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2E3E00u, 0x2E3E08u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3E08u;
label_2e3e08:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xAEC71A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xAEC71A0u, 0x2E3E24u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3E2Cu;
    ...
    ctx->pc = 0x2e3e58u;
    throw std::runtime_error("Unhandled FPU instruction: format 0xC, function 0x3F at 0x2E3E58 raw=0x4594EFBF");
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2E3E78u, 0x2E3E80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3E80u;
label_2e3e80:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xAEC71A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xAEC71A0u, 0x2E3E9Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2E3EA4u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F7296Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F7296Cu, 0x2E3EE4u, 0x2E3EECu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3EECu;
label_2e3eec:
    ...
    ctx->pc = 0x2e3ef0u;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2E3EF0 raw=0xCB188A51");
...
label_2e3efc:
    ...
    ctx->pc = 0x2E3F18u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3F14u;
    // 0x2e3f18: 0x8c460000  lw          $a2, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2E3F14u, 0x2E3F1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3F1Cu;
label_2e3f1c:
    ...
    ctx->pc = 0x2E3F5Cu;
    {
        ...
        ctx->pc = 0x2E3F60u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2E3F5Cu;
        // 0x2e3f60: 0x27bd00f0  addiu       $sp, $sp, 0xF0 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 240));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2E3F5Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2e3f68:
    ...
    ctx->pc = 0x2E3F80u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E3F7Cu;
    // 0x2e3f80: 0x882d  daddu       $s1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x27B090u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x27B090u, 0x2E3F7Cu, 0x2E3F84u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3F84u;
label_2e3f84:
    ...
    ctx->pc = 0x2E4870u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E4870u, 0x2E3F8Cu, 0x2E3F94u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3F94u;
label_2e3f94:
    ...
    ctx->pc = 0x116518u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116518u, 0x2E3FA0u, 0x2E3FA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3FA8u;
label_2e3fa8:
...
label_2e3fac:
    ...
    ctx->pc = 0x27B370u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x27B370u, 0x2E3FACu, 0x2E3FB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E3FB4u;
label_2e3fb4:
    ...
    ctx->pc = 0x2E3FC4u;
    {
        ...
        ctx->pc = 0x2E3FC8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2E3FC4u;
        // 0x2e3fc8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2E3FC4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2e3fccu;
    // NOP
    if (ctx->pc == 0x2e3fccu) { ctx->pc = 0x2e3fd0u; }
}
