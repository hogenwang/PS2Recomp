...
void sub_00287BE8_0x287be8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x287C04u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x287C00u;
    ...
    if (runtime->hasFunction(0x286A20u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x287C08u; }
        if (ctx->pc != 0x287C08u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_287c08:
    ...
    if (runtime->hasFunction(0x286A20u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x287C10u; }
        if (ctx->pc != 0x287C10u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00286A20_0x286a20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x287C10u; }
...
label_287c18:
    ...
    ctx->pc = 0x287C24u;
    {
        ...
        ctx->pc = 0x287C28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x287C24u;
