...
void sub_00108C90_0x108c90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x108CBCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108CB8u;
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CC0u; }
        if (ctx->pc != 0x108CC0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_108cc0:
    ...
    ctx->pc = 0x108CC8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108CC4u;
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CCCu; }
        if (ctx->pc != 0x108CCCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CCCu; }
...
label_108ccc:
    ...
    ctx->pc = 0x108CD4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108CD0u;
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CD8u; }
        if (ctx->pc != 0x108CD8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CD8u; }
...
label_108cd8:
    ...
    ctx->pc = 0x108CE0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108CDCu;
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CE4u; }
        if (ctx->pc != 0x108CE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CE4u; }
...
label_108ce4:
    ...
    ctx->pc = 0x108CECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108CE8u;
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CF0u; }
        if (ctx->pc != 0x108CF0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CF0u; }
...
label_108cf0:
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CFCu; }
        if (ctx->pc != 0x108CFCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108CFCu; }
...
label_108cfc:
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108D08u; }
        if (ctx->pc != 0x108D08u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108D08u; }
...
label_108d08:
    ...
    ctx->pc = 0x108D14u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108D10u;
    ...
    if (runtime->hasFunction(0x107158u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108D18u; }
        if (ctx->pc != 0x108D18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00107158_0x107158(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x108D18u; }
...
label_108d18:
    ...
    ctx->pc = 0x108D28u;
    ctx->pc = 0x108D2Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x108D28u;
