...
label_191b30:
    ...
    ctx->pc = 0x191B34u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x191B30u;
    // 0x191b34: 0x24060002  addiu       $a2, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x323890u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x323890u, 0x191B30u, 0x191B38u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x191B38u;
label_191b38:
...
label_191b40:
    ...
    ctx->pc = 0x191B48u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x191B44u;
    // 0x191b48: 0x24060002  addiu       $a2, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x323890u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x323890u, 0x191B44u, 0x191B4Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x191B4Cu;
label_191b4c:
...
label_191b50:
    ...
    ctx->pc = 0x191B50u;
    {
        ...
        ctx->pc = 0x191B54u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x191B50u;
        // 0x191b54: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x191B50u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x191b5cu;
    // NOP
    if (ctx->pc == 0x191b5cu) { ctx->pc = 0x191b60u; }
}
