...
void sub_00168420_0x168420(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x168434u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x168430u;
    ...
    if (runtime->hasFunction(0x171B30u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x168438u; }
        if (ctx->pc != 0x168438u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_168438:
    ...
    ctx->pc = 0x16844Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x168448u;
    ...
    if (runtime->hasFunction(0x171B30u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x168450u; }
        if (ctx->pc != 0x168450u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00171B30_0x171b30(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x168450u; }
