...
void sub_001F7930_0x1f7930(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F793Cu;
    // 0x1f7940: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F7960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F7960u, 0x1F793Cu, 0x1F7944u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F7944u;
label_1f7944:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F79F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F79F8u, 0x1F7944u, 0x1F794Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F794Cu;
label_1f794c:
    ...
    ctx->pc = 0x1F795Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F7958u;
    // 0x1f795c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F7A78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F7A78u, 0x1F7958u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1F7960u;
}
