...
void sub_00154800_0x154800(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1548B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1548B4u;
    ...
    if (runtime->hasFunction(0x19FDD0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1548BCu; }
        if (ctx->pc != 0x1548BCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1548bc:
    ...
    if (runtime->hasFunction(0x1A0430u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1548C4u; }
        if (ctx->pc != 0x1548C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1548c4:
    ...
    ctx->pc = 0x1548C8u;
    {
        ...
        ctx->pc = 0x1548CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1548C8u;
