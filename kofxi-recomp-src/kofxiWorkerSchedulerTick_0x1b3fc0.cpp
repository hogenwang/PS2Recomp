...
void kofxiWorkerSchedulerTick_0x1b3fc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B3FD4u;
    // 0x1b3fd8: 0x8e040000  lw          $a0, 0x0($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B3198u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3198u, 0x1B3FD4u, 0x1B3FDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3FDCu;
label_1b3fdc:
    ...
    ctx->pc = 0x1B3FECu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B3FE8u;
    // 0x1b3fec: 0x8e040000  lw          $a0, 0x0($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B3130u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3130u, 0x1B3FE8u, 0x1B3FF0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3FF0u;
label_1b3ff0:
    ...
    ctx->pc = 0x1B3638u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3638u, 0x1B3FF0u, 0x1B3FF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3FF8u;
label_1b3ff8:
    ...
    ctx->pc = 0x1B3198u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3198u, 0x1B400Cu, 0x1B4014u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B4014u;
label_1b4014:
...
label_1b403c:
    ...
    ctx->pc = 0x1B4040u;
    {
        ...
        ctx->pc = 0x1B4044u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B4040u;
        // 0x1b4044: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B4040u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
