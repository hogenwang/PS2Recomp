...
void sub_001BBE20_0x1bbe20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1BBE3Cu;
    // 0x1bbe40: 0xc0902d  daddu       $s2, $a2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BBE3Cu, 0x1BBE44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BBE44u;
label_1bbe44:
    ...
    ctx->pc = 0x1BBE50u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BBE4Cu;
    // 0x1bbe50: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BBE70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BBE70u, 0x1BBE4Cu, 0x1BBE54u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BBE54u;
label_1bbe54:
    ...
    ctx->pc = 0x1bbe6cu;
    // NOP
    if (ctx->pc == 0x1bbe6cu) { ctx->pc = 0x1bbe70u; }
}
