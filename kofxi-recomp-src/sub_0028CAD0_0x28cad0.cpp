...
void sub_0028CAD0_0x28cad0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x28CADCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28CAD8u;
    ...
    if (runtime->hasFunction(0x2A2FD8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x28CAE0u; }
        if (ctx->pc != 0x28CAE0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_28cae0:
    ...
    ctx->pc = 0x28CAE4u;
    {
        ...
        if (branch_taken_0x28cae4) {
            ctx->pc = 0x28CAE8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x28CAE4u;
    ...
    ctx->pc = 0x28CB00u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28CAFCu;
    ...
    if (runtime->hasFunction(0x295920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x28CB04u; }
        if (ctx->pc != 0x28CB04u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
