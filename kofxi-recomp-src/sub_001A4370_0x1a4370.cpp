...
void sub_001A4370_0x1a4370(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1297C8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A4394u; }
        if (ctx->pc != 0x1A4394u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a43a0:
    ...
    ctx->pc = 0x1A43A8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A43A4u;
    ...
    if (runtime->hasFunction(0x129E28u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A43ACu; }
        if (ctx->pc != 0x1A43ACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a43ac:
    ...
    ctx->pc = 0x1A43ACu;
    {
        ...
        if (branch_taken_0x1a43ac) {
            ctx->pc = 0x1A43B0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1A43ACu;
    ...
    ctx->pc = 0x1A43C0u;
    {
        ...
        ctx->pc = 0x1A43C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A43C0u;
...
label_1a43c8:
    ...
    ctx->pc = 0x1A43CCu;
    {
        ...
        ctx->pc = 0x1A43D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A43CCu;
...
label_1a43d8:
    ...
    ctx->pc = 0x1A43E4u;
    {
        ...
        ctx->pc = 0x1A43E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A43E4u;
