...
void sub_002FC4B0_0x2fc4b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2FC4C4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC4C0u;
            // 0x2fc4c4: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x25F5D8u;
    if (runtime->hasFunction(0x25F5D8u)) {
        auto targetFn = runtime->lookupFunction(0x25F5D8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FC4C8u; }
        if (ctx->pc != 0x2FC4C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0025F5D8_0x25f5d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FC4C8u; }
        if (ctx->pc != 0x2FC4C8u) { return; }
    }
    ctx->pc = 0x2FC4C8u;
label_2fc4c8:
    ...
    ctx->pc = 0x2FC4CCu;
    {
        ...
        ctx->pc = 0x2FC4D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC4CCu;
    ...
    if (runtime->hasFunction(0x25F2E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0025F2E0_0x25f2e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FC4DCu; }
        if (ctx->pc != 0x2FC4DCu) { return; }
    }
    ctx->pc = 0x2FC4DCu;
...
label_2fc4e0:
    ...
    ctx->pc = 0x2FC4ECu;
    {
        ...
        ctx->pc = 0x2FC4F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC4ECu;
