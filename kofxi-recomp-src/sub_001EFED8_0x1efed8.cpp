...
label_1eff20:
    ...
    ctx->pc = 0x1EFF30u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1EFF2Cu;
    // 0x1eff30: 0x260202d  daddu       $a0, $s3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 19) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1DC300u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DC300u, 0x1EFF2Cu, 0x1EFF34u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EFF34u;
label_1eff34:
...
label_1eff44:
    ...
    ctx->pc = 0x1EFF58u;
    {
        ...
        ctx->pc = 0x1EFF5Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1EFF58u;
        // 0x1eff5c: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EFF58u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
