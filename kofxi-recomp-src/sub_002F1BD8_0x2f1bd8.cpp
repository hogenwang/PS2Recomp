...
label_2f1c30:
    ...
    ctx->pc = 0x2F1C60u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F1C5Cu;
    // 0x2f1c60: 0xadae000c  sw          $t6, 0xC($t5) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 13), 12), GPR_U32(ctx, 14));
    ctx->in_delay_slot = false;
    ctx->pc = 0x225F58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x225F58u, 0x2F1C5Cu, 0x2F1C64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F1C64u;
label_2f1c64:
...
label_2f1c68:
    ...
    ctx->pc = 0x2F1C70u;
    {
        ...
        ctx->pc = 0x2F1C74u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F1C70u;
        // 0x2f1c74: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F1C70u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
