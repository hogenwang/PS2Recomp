...
void sub_002E8B88_0x2e8b88(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2E8BE0u;
    // 0x2e8be4: 0xae06000c  sw          $a2, 0xC($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 12), GPR_U32(ctx, 6));
    ctx->in_delay_slot = false;
    ctx->pc = 0x231A98u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x231A98u, 0x2E8BE0u, 0x2E8BE8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8BE8u;
label_2e8be8:
    ...
    ctx->pc = 0x2E8BF4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E8BF0u;
    // 0x2e8bf4: 0xae110014  sw          $s1, 0x14($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 20), GPR_U32(ctx, 17));
    ctx->in_delay_slot = false;
    ctx->pc = 0x231A98u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x231A98u, 0x2E8BF0u, 0x2E8BF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8BF8u;
label_2e8bf8:
    ...
    ctx->pc = 0x2E8C04u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E8C00u;
    // 0x2e8c04: 0xae12001c  sw          $s2, 0x1C($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 28), GPR_U32(ctx, 18));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2625A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2625A8u, 0x2E8C00u, 0x2E8C08u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8C08u;
label_2e8c08:
...
label_2e8c20:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x262DB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x262DB0u, 0x2E8C20u, 0x2E8C28u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8C28u;
label_2e8c28:
...
label_2e8c40:
    ...
    ctx->pc = 0x22D6B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22D6B0u, 0x2E8C40u, 0x2E8C48u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8C48u;
label_2e8c48:
...
label_2e8c4c:
    ...
    ctx->pc = 0x2E8C5Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2E8C5Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2E8C78u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E8C74u;
    // 0x2e8c78: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x262E28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x262E28u, 0x2E8C74u, 0x2E8C7Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8C7Cu;
label_2e8c7c:
...
label_2e8c98:
    ...
    ctx->pc = 0x2E8C9Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2E8C98u;
    // 0x2e8c9c: 0x2484fda8  addiu       $a0, $a0, -0x258 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294966696));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2625D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2625D0u, 0x2E8C98u, 0x2E8CA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8CA0u;
label_2e8ca0:
...
label_2e8cb8:
    ...
    ctx->pc = 0x22D6B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22D6B0u, 0x2E8CB8u, 0x2E8CC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2E8CC0u;
label_2e8cc0:
...
label_2e8cc4:
    ...
    ctx->pc = 0x2E8CCCu;
    {
        ...
        ctx->pc = 0x2E8CD0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2E8CCCu;
        // 0x2e8cd0: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2E8CCCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2e8cd4u;
    // NOP
    if (ctx->pc == 0x2e8cd4u) { ctx->pc = 0x2e8cd8u; }
}
