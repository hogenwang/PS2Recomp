...
void sub_002C2824_0x2c2824(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2C2838u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C2834u;
    ...
    if (runtime->hasFunction(0x280ED8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C283Cu; }
        if (ctx->pc != 0x2C283Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c283c:
    ...
    ctx->pc = 0x2C2840u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C283Cu;
    ...
    if (runtime->hasFunction(0x283050u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C2844u; }
        if (ctx->pc != 0x2C2844u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c2858:
    ...
    ctx->pc = 0x2C2860u;
    {
        ...
        ctx->pc = 0x2C2864u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C2860u;
