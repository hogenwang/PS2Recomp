...
void sub_002E6428_0x2e6428(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2E6434u;
    {
        ...
        ctx->pc = 0x2E6438u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6434u;
...
label_2e6444:
    ...
    ctx->pc = 0x2E644Cu;
    {
        ...
        if (branch_taken_0x2e644c) {
            ctx->pc = 0x2E6450u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2E644Cu;
    ...
    ctx->pc = 0x2E645Cu;
    {
        ...
        ctx->pc = 0x2E6460u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E645Cu;
    ...
    ctx->pc = 0x2E6464u;
    {
        ...
        ctx->pc = 0x2E6468u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6464u;
...
label_2e646c:
    ...
    ctx->pc = 0x2E646Cu;
    {
        ...
        ctx->pc = 0x2E6470u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E646Cu;
...
label_2e6474:
    ...
    ctx->pc = 0x2E6474u;
    {
        ...
        ctx->pc = 0x2E6478u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6474u;
