...
void sub_001FCAA0_0x1fcaa0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FCAC0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCABCu;
    ...
    if (runtime->hasFunction(0x1ED920u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FCAC4u; }
        if (ctx->pc != 0x1FCAC4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1fcac4:
    ...
    ctx->pc = 0x1FCAC8u;
    {
        ...
        ctx->pc = 0x1FCACCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCAC8u;
...
label_1fcae8:
    ...
    ctx->pc = 0x1FCAECu;
    {
        ...
        ctx->pc = 0x1FCAF0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCAECu;
...
label_1fcb18:
    ...
    ctx->pc = 0x1FCB38u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCB34u;
    ...
    if (runtime->hasFunction(0x1ED920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FCB3Cu; }
        if (ctx->pc != 0x1FCB3Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001ED920_0x1ed920(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FCB3Cu; }
...
label_1fcb3c:
    ...
    ctx->pc = 0x1FCB40u;
    {
        ...
        ctx->pc = 0x1FCB44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCB40u;
    ...
    ctx->pc = 0x1FCB58u;
    ctx->pc = 0x1FCB5Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCB58u;
...
label_1fcb60:
    ...
    ctx->pc = 0x1FCB64u;
    {
        ...
        ctx->pc = 0x1FCB68u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCB64u;
    ...
    ctx->pc = 0x1FCB84u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCB80u;
...
label_1fcb90:
    ...
    ctx->pc = 0x1FCB9Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1FCBA0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FCB9Cu;
