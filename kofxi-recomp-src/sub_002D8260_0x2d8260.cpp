...
void sub_002D8260_0x2d8260(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D8264u;
    {
        ...
        ctx->pc = 0x2D8268u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8264u;
    ...
    ctx->pc = 0x2D8270u;
    ctx->pc = 0x2D8274u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8270u;
            // 0x2d8274: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2D84C8u;
    {
        auto targetFn = runtime->lookupFunction(0x2D84C8u);
...
label_2d8278:
    ...
    ctx->pc = 0x2D827Cu;
    {
        ...
        ctx->pc = 0x2D8280u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D827Cu;
