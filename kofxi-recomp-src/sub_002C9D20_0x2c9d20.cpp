...
label_2c9d9c:
    ...
    ctx->pc = 0x2C9DA4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C9DA4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2c9dacu;
    // NOP
    if (ctx->pc == 0x2c9dacu) { ctx->pc = 0x2c9db0u; }
}
