...
label_154688:
    ...
    ctx->pc = 0x128EF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x128EF8u, 0x15469Cu, 0x1546A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1546A4u;
label_1546a4:
...
label_1546b8:
    ...
    ctx->pc = 0x128EF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x128EF8u, 0x1546B8u, 0x1546C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1546C0u;
label_1546c0:
...
label_1546cc:
    ...
    ctx->pc = 0x1543F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1543F0u, 0x1546DCu, 0x1546E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1546E4u;
label_1546e4:
    ...
    ctx->branch_pc = 0x1546E8u;
    // 0x1546ec: 0x8044f340  lb          $a0, -0xCC0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int8_t)READ8(ADD32(GPR_U32(ctx, 2), 4294964032)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x14B510u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x14B510u, 0x1546E8u, 0x1546F0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1546F0u;
label_1546f0:
    ...
    ctx->pc = 0x1546F4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1546F4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1546fcu;
    // NOP
    if (ctx->pc == 0x1546fcu) { ctx->pc = 0x154700u; }
}
