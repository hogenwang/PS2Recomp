...
void sub_0022C3C8_0x22c3c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x22C198u;
    if (runtime->hasFunction(0x22C198u)) {
        auto targetFn = runtime->lookupFunction(0x22C198u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x22C41Cu; }
        if (ctx->pc != 0x22C41Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0022C198_0x22c198(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x22C41Cu; }
        if (ctx->pc != 0x22C41Cu) { return; }
    }
    ctx->pc = 0x22C41Cu;
label_22c41c:
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x22D3A8u; }
        if (ctx->pc != 0x22D3A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_22d3a8:
    ...
    ctx->pc = 0x22D3D0u;
    {
        ...
        ctx->pc = 0x22D3D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x22D3D0u;
