...
void sub_002BBD30_0x2bbd30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2BBD40u;
    // 0x2bbd44: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B1898u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B1898u, 0x2BBD40u, 0x2BBD48u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBD48u;
label_2bbd48:
    ...
    ctx->pc = 0x2BBD54u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2BBD50u;
    // 0x2bbd54: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x29CA30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29CA30u, 0x2BBD50u, 0x2BBD58u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBD58u;
label_2bbd58:
...
label_2bbd64:
    ...
    ctx->pc = 0x2BBD68u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BBD68u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2BBD8Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2BBD88u;
    // 0x2bbd8c: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B1898u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B1898u, 0x2BBD88u, 0x2BBD90u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBD90u;
label_2bbd90:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x29CA78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29CA78u, 0x2BBD98u, 0x2BBDA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBDA0u;
label_2bbda0:
...
label_2bbdb0:
    ...
    ctx->pc = 0x2BBDB8u;
    {
        ...
        ctx->pc = 0x2BBDBCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2BBDB8u;
        // 0x2bbdbc: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BBDB8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x29CB20u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29CB20u, 0x2BBDC8u, 0x2BBDD0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBDD0u;
label_2bbdd0:
    ...
    ctx->pc = 0x2BBDD4u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BBDD4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2BBDE0u;
    ctx->pc = 0x29CB80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29CB80u, 0x2BBDE0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2BBDE8u;
    ...
    ctx->pc = 0x29CBA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29CBA0u, 0x2BBDF0u, 0x2BBDF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBDF8u;
label_2bbdf8:
    ...
    ctx->pc = 0x2BBDFCu;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BBDFCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2bbe04u;
    // NOP
    if (ctx->pc == 0x2bbe04u) { ctx->pc = 0x2bbe08u; }
}
