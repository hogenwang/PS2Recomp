...
void sub_002FC110_0x2fc110(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2FC118u;
    {
        ...
        ctx->pc = 0x2FC11Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC118u;
    ...
    ctx->pc = 0x2FC120u;
    {
        ...
        ctx->pc = 0x2FC124u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC120u;
...
label_2fc130:
    ...
    ctx->pc = 0x2FC14Cu;
    {
        ...
        ctx->pc = 0x2FC150u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC14Cu;
...
label_2fc158:
    ...
    ctx->pc = 0x2FC160u;
    {
        ...
        ctx->pc = 0x2FC164u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC160u;
