...
label_1b4618:
    ...
    ctx->pc = 0x1B4614u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B4614u, 0x1B461Cu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B461Cu;
...
label_1b4624:
    ...
    ctx->pc = 0x1B4620u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B4620u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1b4648:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B46F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B46F8u, 0x1B4644u, 0x1B464Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B464Cu;
label_1b464c:
...
label_1b4650:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B2718u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B2718u, 0x1B464Cu, 0x1B4654u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B4654u;
label_1b4654:
...
label_1b4678:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B3670u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3670u, 0x1B4674u, 0x1B467Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B467Cu;
label_1b467c:
...
label_1b46a0:
    ...
    ctx->pc = 0x1B469Cu;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B469Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1b46d8:
    ...
    ctx->pc = 0x1B3850u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3850u, 0x1B46D4u, 0x1B46DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B46DCu;
label_1b46dc:
...
label_1b46e0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B2718u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B2718u, 0x1B46DCu, 0x1B46E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B46E4u;
label_1b46e4:
...
label_1b46f4:
    ...
    ctx->pc = 0x1B46F0u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B46F0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
