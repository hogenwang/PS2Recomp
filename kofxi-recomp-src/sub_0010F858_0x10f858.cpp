...
void sub_0010F858_0x10f858(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10F880u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x10F87Cu;
    ...
    if (runtime->hasFunction(0x10EA48u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x10F884u; }
        if (ctx->pc != 0x10F884u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_10f884:
    ...
    ctx->pc = 0x10F888u;
    {
        ...
        ctx->pc = 0x10F88Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10F888u;
