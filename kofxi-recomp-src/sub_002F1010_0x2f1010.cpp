...
label_2f101c:
    ...
    ctx->pc = 0x2F1048u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F1044u;
    // 0x2f1048: 0x34e763bd  ori         $a3, $a3, 0x63BD (Delay Slot)
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) | (uint64_t)(uint16_t)25533);
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1CF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1CF8u, 0x2F1044u, 0x2F104Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F104Cu;
label_2f104c:
...
label_2f1054:
    ...
    ctx->pc = 0x2F1058u;
    {
        ...
        ctx->pc = 0x2F105Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F1058u;
        // 0x2f105c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F1058u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2f1070:
    ...
    ctx->pc = 0x2F1078u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F1074u;
    // 0x2f1078: 0x24060004  addiu       $a2, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F0678u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F0678u, 0x2F1074u, 0x2F107Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F107Cu;
label_2f107c:
