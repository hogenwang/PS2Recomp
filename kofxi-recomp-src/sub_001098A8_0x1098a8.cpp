...
void sub_001098A8_0x1098a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1098D4u;
    {
        ...
        ctx->pc = 0x1098D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1098D4u;
...
label_10991c:
    ...
    ctx->pc = 0x10991Cu;
    {
        ...
        ctx->pc = 0x109920u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10991Cu;
    ...
    ctx->pc = 0x109960u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x109964u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x109960u;
...
label_109968:
    ...
    ctx->pc = 0x10996Cu;
    ctx->pc = 0x109970u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x10996Cu;
