...
void sub_001B9B48_0x1b9b48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B9B58u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9B54u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9B5Cu; }
        if (ctx->pc != 0x1B9B5Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b9b5c:
    ...
    if (runtime->hasFunction(0x1B9B80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9B64u; }
        if (ctx->pc != 0x1B9B64u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b9b64:
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9B6Cu; }
        if (ctx->pc != 0x1B9B6Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
