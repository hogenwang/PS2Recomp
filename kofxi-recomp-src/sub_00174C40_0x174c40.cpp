...
void sub_00174C40_0x174c40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x174C48u;
    // 0x174c4c: 0x27a40040  addiu       $a0, $sp, 0x40 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F6F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F6F0u, 0x174C48u, 0x174C50u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x174C50u;
label_174c50:
    ...
    ctx->pc = 0x174C54u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x174C50u;
    // 0x174c54: 0x27a40010  addiu       $a0, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F700u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F700u, 0x174C50u, 0x174C58u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x174C58u;
label_174c58:
    ...
    ctx->pc = 0x174C60u;
    {
        ...
        ctx->pc = 0x174C64u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x174C60u;
        // 0x174c64: 0x27bd0060  addiu       $sp, $sp, 0x60 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 96));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x174C60u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x174c6cu;
    // NOP
    if (ctx->pc == 0x174c6cu) { ctx->pc = 0x174c70u; }
}
