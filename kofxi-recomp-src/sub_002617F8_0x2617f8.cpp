...
void sub_002617F8_0x2617f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x26180Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x261808u;
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x261810u; }
        if (ctx->pc != 0x261810u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_261810:
    ...
    ctx->pc = 0x261814u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x261810u;
    ...
    if (runtime->hasFunction(0x261548u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x261818u; }
        if (ctx->pc != 0x261818u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_261818:
    ...
    ctx->pc = 0x26181Cu;
    {
        ...
        ctx->pc = 0x261820u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26181Cu;
    ...
    ctx->pc = 0x261828u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x261824u;
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x26182Cu; }
        if (ctx->pc != 0x26182Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0012A0F8_0x12a0f8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x26182Cu; }
...
label_26182c:
    ...
    ctx->pc = 0x261838u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x261834u;
    ...
    if (runtime->hasFunction(0x12A598u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x26183Cu; }
        if (ctx->pc != 0x26183Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
