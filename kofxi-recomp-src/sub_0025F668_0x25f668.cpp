...
void sub_0025F668_0x25f668(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x231A08u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F68Cu; }
        if (ctx->pc != 0x25F68Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f698:
    ...
    ctx->pc = 0x25F6A8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F6A4u;
    ...
    if (runtime->hasFunction(0x12A3E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F6ACu; }
        if (ctx->pc != 0x25F6ACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f6ac:
    ...
    ctx->pc = 0x25F6ACu;
    {
        ...
        if (branch_taken_0x25f6ac) {
            ctx->pc = 0x25F6B0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x25F6ACu;
...
label_25f6b8:
    ...
    ctx->pc = 0x25F6BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F6B8u;
    ...
    if (runtime->hasFunction(0x231A60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F6C0u; }
        if (ctx->pc != 0x25F6C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f6c0:
    ...
    ctx->pc = 0x25F6D8u;
    {
        ...
        ctx->pc = 0x25F6DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25F6D8u;
