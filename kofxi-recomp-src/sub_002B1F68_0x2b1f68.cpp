...
label_2b1f94:
    ...
    ctx->pc = 0x2AF918u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2AF918u, 0x2B1FA0u, 0x2B1FA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2B1FA8u;
label_2b1fa8:
...
label_2b1fbc:
    ...
    ctx->pc = 0x2B1FC4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2B1FC0u;
    // 0x2b1fc4: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x295920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x295920u, 0x2B1FC0u, 0x2B1FC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2B1FC8u;
label_2b1fc8:
...
label_2b1fd4:
    ...
    ctx->pc = 0x2B1FD8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2B1FD4u;
    // 0x2b1fd8: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B1968u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B1968u, 0x2B1FD4u, 0x2B1FDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2B1FDCu;
label_2b1fdc:
    ...
    ctx->pc = 0x2B1FE8u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2B1FE8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
