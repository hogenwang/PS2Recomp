...
void sub_001C61B0_0x1c61b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C61C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C61BCu;
    ...
    if (runtime->hasFunction(0x1C6AB8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C61C4u; }
        if (ctx->pc != 0x1C61C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c61c4:
    ...
    ctx->pc = 0x1C61C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C61C4u;
            // 0x1c61c8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C61E0u;
    if (runtime->hasFunction(0x1C61E0u)) {
        auto targetFn = runtime->lookupFunction(0x1C61E0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C61CCu; }
        if (ctx->pc != 0x1C61CCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C61E0_0x1c61e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C61CCu; }
        if (ctx->pc != 0x1C61CCu) { return; }
    }
    ctx->pc = 0x1C61CCu;
label_1c61cc:
    ...
    ctx->pc = 0x1C61D4u;
    ctx->pc = 0x1C61D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C61D4u;
