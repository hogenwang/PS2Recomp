...
label_200504:
    ...
    ctx->pc = 0x200504u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x200504u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x20050cu;
    // NOP
    if (ctx->pc == 0x20050cu) { ctx->pc = 0x200510u; }
}
