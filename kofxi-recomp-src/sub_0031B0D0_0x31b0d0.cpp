...
label_31b300:
    ...
    ctx->pc = 0x31B300u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x31B300u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x31b30cu;
    // NOP
    if (ctx->pc == 0x31b30cu) { ctx->pc = 0x31b310u; }
}
