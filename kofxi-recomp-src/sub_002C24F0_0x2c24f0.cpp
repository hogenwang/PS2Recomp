...
label_2c251c:
    ...
    ctx->pc = 0x2C2524u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C2520u;
    // 0x2c2524: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2805A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2805A8u, 0x2C2520u, 0x2C2528u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C2528u;
label_2c2528:
    ...
    ctx->pc = 0x2C2538u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C2534u;
    // 0x2c2538: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x282A80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x282A80u, 0x2C2534u, 0x2C253Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C253Cu;
label_2c253c:
...
label_2c2540:
    ...
    ctx->pc = 0x2C254Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C2548u;
    // 0x2c254c: 0x24060010  addiu       $a2, $zero, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2818E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2818E8u, 0x2C2548u, 0x2C2550u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C2550u;
label_2c2550:
    ...
    ctx->pc = 0x2C2574u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C2570u;
    // 0x2c2574: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x281740u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x281740u, 0x2C2570u, 0x2C2578u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C2578u;
label_2c2578:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2805A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2805A8u, 0x2C257Cu, 0x2C2584u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C2584u;
label_2c2584:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x282A80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x282A80u, 0x2C2590u, 0x2C2598u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C2598u;
label_2c2598:
...
label_2c25a4:
    ...
    ctx->pc = 0x2C25B8u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C25B8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
