...
void sub_002B7320_0x2b7320(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2B7334u;
    {
        ...
        ctx->pc = 0x2B7338u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B7334u;
    ...
    ctx->pc = 0x2B733Cu;
    {
        ...
        ctx->pc = 0x2B7340u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B733Cu;
...
label_2b7344:
    ...
    ctx->pc = 0x2B737Cu;
    {
        ...
        if (branch_taken_0x2b737c) {
            ctx->pc = 0x2B7380u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2B737Cu;
...
label_2b7384:
    ...
    ctx->pc = 0x2B7438u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2B743Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B7438u;
