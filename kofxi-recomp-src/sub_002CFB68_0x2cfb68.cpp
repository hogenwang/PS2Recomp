...
void sub_002CFB68_0x2cfb68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2CFB68u;
    {
        ...
        if (branch_taken_0x2cfb68) {
            ctx->pc = 0x2CFB6Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFB68u;
    ...
    ctx->pc = 0x2CFB70u;
    {
        ...
        ctx->pc = 0x2CFB74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFB70u;
...
label_2cfb78:
    ...
    ctx->pc = 0x2CFB78u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2CFB7Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFB78u;
...
label_2cfb80:
    ...
    ctx->pc = 0x2CFB88u;
    {
        ...
        ctx->pc = 0x2CFB8Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFB88u;
...
label_2cfb90:
    ...
    ctx->pc = 0x2CFBA4u;
    {
        ...
        ctx->pc = 0x2CFBA8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFBA4u;
...
label_2cfbac:
    ...
    ctx->pc = 0x2CFBACu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2CFBB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFBACu;
