...
label_205174:
    ...
    ctx->pc = 0x205174u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x205174u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x20517cu;
    // NOP
    if (ctx->pc == 0x20517cu) { ctx->pc = 0x205180u; }
}
