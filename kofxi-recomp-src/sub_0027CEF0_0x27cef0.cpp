...
label_27cef0:
    ...
    ctx->pc = 0x27CF14u;
    {
        ...
        ctx->pc = 0x27CF18u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27CF14u;
...
label_27cf24:
    ...
    ctx->pc = 0x27CF24u;
    {
        ...
        ctx->pc = 0x27CF28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27CF24u;
    ...
    ctx->pc = 0x27CF3Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x27CF38u;
    ...
    if (runtime->hasFunction(0x2FC840u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x27CF40u; }
        if (ctx->pc != 0x27CF40u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_27cf40:
    ...
    if (runtime->hasFunction(0x2FC3F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x27CF58u; }
        if (ctx->pc != 0x27CF58u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_27cf60:
    ...
    ctx->pc = 0x27CF60u;
    {
        ...
        ctx->pc = 0x27CF64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27CF60u;
...
label_27cf78:
    ...
    ctx->pc = 0x27CF88u;
    {
        ...
        ctx->pc = 0x27CF8Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27CF88u;
...
label_27cf90:
    ...
    ctx->pc = 0x27CFACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x27CFA8u;
    ...
    if (runtime->hasFunction(0x27BDB0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x27CFB0u; }
        if (ctx->pc != 0x27CFB0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_27cfb0:
    ...
    ctx->pc = 0x27CFD0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x27CFCCu;
            // 0x27cfd0: 0x8c443558  lw          $a0, 0x3558($v0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 13656)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x27CE38u;
    if (runtime->hasFunction(0x27CE38u)) {
        auto targetFn = runtime->lookupFunction(0x27CE38u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x27CFD4u; }
        if (ctx->pc != 0x27CFD4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0027CE38_0x27ce38(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x27CFD4u; }
        if (ctx->pc != 0x27CFD4u) { return; }
    }
    ctx->pc = 0x27CFD4u;
label_27cfd4:
    ...
    ctx->pc = 0x27CFD4u;
    {
        ...
        ctx->pc = 0x27CFD8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27CFD4u;
...
label_27cfe0:
    ...
    ctx->pc = 0x27CFF0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x27CFECu;
...
label_27cff8:
    ...
    ctx->pc = 0x27CFF8u;
    {
        ...
        ctx->pc = 0x27CFFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27CFF8u;
...
label_27d00c:
    ...
    ctx->pc = 0x27D01Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x27D020u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27D01Cu;
