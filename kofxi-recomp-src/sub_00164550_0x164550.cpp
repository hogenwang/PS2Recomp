...
label_1645cc:
    ...
    ctx->pc = 0x1645CCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1645CCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1645dcu;
    // NOP
    if (ctx->pc == 0x1645dcu) { ctx->pc = 0x1645e0u; }
}
