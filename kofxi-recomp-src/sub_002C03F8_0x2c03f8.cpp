...
void sub_002C03F8_0x2c03f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2C0418u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C0414u;
    ...
    if (runtime->hasFunction(0x27FCA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C041Cu; }
        if (ctx->pc != 0x2C041Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c041c:
    ...
    ctx->pc = 0x2C0420u;
    {
        ...
        ctx->pc = 0x2C0424u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C0420u;
