...
void sub_003059E0_0x3059e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x3059E4u;
    {
        ...
        ctx->branch_pc = 0x3059E4u;
        // 0x3059e8: 0xac641d40  sw          $a0, 0x1D40($v1) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 3), 7488), GPR_U32(ctx, 4));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x3059E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x3059ecu;
    // NOP
    if (ctx->pc == 0x3059ecu) { ctx->pc = 0x3059f0u; }
}
