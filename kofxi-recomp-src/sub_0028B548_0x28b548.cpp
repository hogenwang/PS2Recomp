...
void sub_0028B548_0x28b548(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x28B568u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28B564u;
            // 0x28b568: 0x2484a7f0  addiu       $a0, $a0, -0x5810 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294944752));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2897D8u;
    if (runtime->hasFunction(0x2897D8u)) {
        auto targetFn = runtime->lookupFunction(0x2897D8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x28B56Cu; }
        if (ctx->pc != 0x28B56Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002897D8_0x2897d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x28B56Cu; }
        if (ctx->pc != 0x28B56Cu) { return; }
    }
    ctx->pc = 0x28B56Cu;
