...
void sub_001F49C8_0x1f49c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F49D4u;
    // 0x1f49d8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1DC188u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DC188u, 0x1F49D4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1F49DCu;
    // 0x1f49dc: 0x0  nop
    ...
    ctx->pc = 0x1D9CD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D9CD0u, 0x1F49F8u, 0x1F4A00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F4A00u;
label_1f4a00:
...
label_1f4a04:
    ...
    ctx->pc = 0x1F4A08u;
    {
        ...
        ctx->pc = 0x1F4A0Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F4A08u;
        // 0x1f4a0c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F4A08u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1F4A10u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F4A10u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1F4A18u;
    {
        ...
        ctx->pc = 0x1F4A1Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F4A18u;
        // 0x1f4a1c: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F4A18u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1F4A20u;
    {
        ...
        ctx->pc = 0x1F4A24u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F4A20u;
        // 0x1f4a24: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F4A20u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F5460u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F5460u, 0x1F4A90u, 0x1F4A98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F4A98u;
label_1f4a98:
    ...
    ctx->pc = 0x1F4B28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F4B28u, 0x1F4AACu, 0x1F4AB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F4AB4u;
label_1f4ab4:
    ...
    ctx->pc = 0x1F4AD0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F4ACCu;
    // 0x1f4ad0: 0xae630280  sw          $v1, 0x280($s3) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 19), 640), GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FCBA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FCBA8u, 0x1F4ACCu, 0x1F4AD4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F4AD4u;
label_1f4ad4:
...
label_1f4ae8:
    ...
    ctx->pc = 0x1F4AF8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F4AF4u;
    // 0x1f4af8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F58F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F58F8u, 0x1F4AF4u, 0x1F4AFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F4AFCu;
label_1f4afc:
...
label_1f4b08:
    ...
    ctx->pc = 0x1F4B20u;
    {
        ...
        ctx->pc = 0x1F4B24u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F4B20u;
        // 0x1f4b24: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F4B20u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
