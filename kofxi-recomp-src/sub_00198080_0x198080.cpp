...
label_19812c:
    ...
    ctx->pc = 0x19812Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x19812Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x19813cu;
    // NOP
    if (ctx->pc == 0x19813cu) { ctx->pc = 0x198140u; }
}
