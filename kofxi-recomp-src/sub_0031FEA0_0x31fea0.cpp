...
label_31feb8:
    ...
    ctx->pc = 0x31FED0u;
    {
        ...
        ctx->pc = 0x31FED4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x31FED0u;
...
label_31fee0:
    ...
    ctx->pc = 0x31FEE4u;
    {
        ...
        if (branch_taken_0x31fee4) {
            ctx->pc = 0x31FEE8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x31FEE4u;
    ...
    ctx->pc = 0x31FEECu;
    {
        ...
        ctx->pc = 0x31FEF0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x31FEECu;
...
label_31fef4:
    ...
    ctx->pc = 0x31FEF8u;
    {
        ...
        ctx->pc = 0x31FEFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x31FEF8u;
...
label_31ff00:
    ...
    ctx->pc = 0x31FF00u;
    {
        ...
        ctx->pc = 0x31FF04u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x31FF00u;
