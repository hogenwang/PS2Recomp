...
void sub_00189760_0x189760(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x18978Cu;
    // 0x189790: 0x24050003  addiu       $a1, $zero, 0x3 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x160F80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x160F80u, 0x18978Cu, 0x189794u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x189794u;
label_189794:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x160F80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x160F80u, 0x1897A4u, 0x1897ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1897ACu;
label_1897ac:
    ...
    ctx->pc = 0x1897BCu;
    {
        ...
        ctx->pc = 0x1897C0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1897BCu;
        // 0x1897c0: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1897BCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1897ccu;
    // NOP
    if (ctx->pc == 0x1897ccu) { ctx->pc = 0x1897d0u; }
}
