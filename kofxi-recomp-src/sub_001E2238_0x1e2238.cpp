...
void sub_001E2238_0x1e2238(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1024E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1024E0u, 0x1E2244u, 0x1E224Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E224Cu;
label_1e224c:
...
label_1e2258:
    ...
    ctx->branch_pc = 0x1E225Cu;
    // 0x1e2260: 0x2406001e  addiu       $a2, $zero, 0x1E (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 30));
    ctx->in_delay_slot = false;
    ctx->pc = 0x102AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x102AB0u, 0x1E225Cu, 0x1E2264u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E2264u;
label_1e2264:
    ...
    ctx->pc = 0x1E2274u;
    {
        ...
        ctx->pc = 0x1E2278u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E2274u;
        // 0x1e2278: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E2274u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1E2290u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E228Cu;
    // 0x1e2290: 0xa0802d  daddu       $s0, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1024E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1024E0u, 0x1E228Cu, 0x1E2294u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E2294u;
label_1e2294:
    ...
    ctx->pc = 0x1E22A0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E229Cu;
    // 0x1e22a0: 0x2406001e  addiu       $a2, $zero, 0x1E (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 30));
    ctx->in_delay_slot = false;
    ctx->pc = 0x102AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x102AB0u, 0x1E229Cu, 0x1E22A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E22A4u;
label_1e22a4:
    ...
    ctx->pc = 0x1E22B0u;
    {
        ...
        ctx->pc = 0x1E22B4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E22B0u;
        // 0x1e22b4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E22B0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e22ccu;
    // NOP
    if (ctx->pc == 0x1e22ccu) { ctx->pc = 0x1e22d0u; }
}
