...
void sub_001C6900_0x1c6900(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C6908u;
    {
        ...
        ctx->pc = 0x1C690Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C6908u;
    ...
    ctx->pc = 0x1C691Cu;
    ctx->pc = 0x1C6920u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C691Cu;
...
label_1c6928:
    ...
    ctx->pc = 0x1C6938u;
    {
        ...
        ctx->pc = 0x1C693Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C6938u;
...
label_1c6958:
    ...
    ctx->pc = 0x1C695Cu;
    {
        ...
        ctx->pc = 0x1C6960u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C695Cu;
