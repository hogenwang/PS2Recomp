...
void sub_001B7AC0_0x1b7ac0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B7AD0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7ACCu;
...
label_1b7ad4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7AD4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B7AF8u;
    if (runtime->hasFunction(0x1B7AF8u)) {
        auto targetFn = runtime->lookupFunction(0x1B7AF8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001B7AF8_0x1b7af8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7ADCu; }
        if (ctx->pc != 0x1B7ADCu) { return; }
    }
    ctx->pc = 0x1B7ADCu;
label_1b7adc:
    ...
    ctx->pc = 0x1B7AE0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7ADCu;
    ...
    if (runtime->hasFunction(0x1B8168u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7AE4u; }
        if (ctx->pc != 0x1B7AE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
