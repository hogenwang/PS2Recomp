...
void sub_001AD180_0x1ad180(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1AD1A0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AD19Cu;
    // 0x1ad1a0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ACF78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ACF78u, 0x1AD19Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1AD1A4u;
    // 0x1ad1a4: 0x0  nop
...
label_1ad1a8:
    ...
    ctx->pc = 0x1AD1B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AD1B0u;
    // 0x1ad1b4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ACDE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ACDE0u, 0x1AD1B0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1AD1B8u;
label_1ad1b8:
    ...
    ctx->pc = 0x1AD1C8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AD1C4u;
    // 0x1ad1c8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ACC68u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ACC68u, 0x1AD1C4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1AD1CCu;
    // 0x1ad1cc: 0x0  nop
...
label_1ad1d0:
    ...
    ctx->pc = 0x1AD1D0u;
    {
        ...
        ctx->pc = 0x1AD1D4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1AD1D0u;
        // 0x1ad1d4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AD1D0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
