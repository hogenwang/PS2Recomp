...
void sub_00330010_0x330010(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x330054u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x330050u;
    ...
    if (runtime->hasFunction(0x155B50u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x330058u; }
        if (ctx->pc != 0x330058u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_330058:
    ...
    ctx->pc = 0x3300A4u;
    {
        ...
        ctx->pc = 0x3300A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3300A4u;
