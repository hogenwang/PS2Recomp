...
label_1bac34:
    ...
    ctx->pc = 0x1BAC38u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAC34u;
            // 0x1bac38: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BAC58u;
    if (runtime->hasFunction(0x1BAC58u)) {
        auto targetFn = runtime->lookupFunction(0x1BAC58u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAC3Cu; }
        if (ctx->pc != 0x1BAC3Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BAC58_0x1bac58(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAC3Cu; }
        if (ctx->pc != 0x1BAC3Cu) { return; }
    }
    ctx->pc = 0x1BAC3Cu;
label_1bac3c:
    ...
    ctx->pc = 0x1BAC40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAC3Cu;
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAC44u; }
        if (ctx->pc != 0x1BAC44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bac44:
    ...
    ctx->pc = 0x1BAC50u;
    {
        ...
        ctx->pc = 0x1BAC54u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAC50u;
