...
label_2c49a0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A2FD8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A2FD8u, 0x2C499Cu, 0x2C49A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C49A4u;
label_2c49a4:
...
label_2c49b4:
    ...
    ctx->pc = 0x2C49C8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C49C4u;
    // 0x2c49c8: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x295920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x295920u, 0x2C49C4u, 0x2C49CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C49CCu;
label_2c49cc:
...
label_2c49d4:
    ...
    ctx->pc = 0x2C27B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2C27B8u, 0x2C49D4u, 0x2C49DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C49DCu;
label_2c49dc:
    ...
    ctx->pc = 0x2C49E8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C49E4u;
    // 0x2c49e8: 0x24040003  addiu       $a0, $zero, 0x3 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x281BC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x281BC8u, 0x2C49E4u, 0x2C49ECu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C49ECu;
label_2c49ec:
...
label_2c4a00:
    ...
    ctx->pc = 0x2C4A04u;
    {
        ...
        ctx->pc = 0x2C4A08u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2C4A04u;
        // 0x2c4a08: 0x27bd0050  addiu       $sp, $sp, 0x50 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 80));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C4A04u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2c4a0cu;
    // NOP
    if (ctx->pc == 0x2c4a0cu) { ctx->pc = 0x2c4a10u; }
}
