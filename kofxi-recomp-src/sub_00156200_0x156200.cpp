...
label_156270:
    ...
    ctx->pc = 0x156270u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x156270u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x15627cu;
    // NOP
    if (ctx->pc == 0x15627cu) { ctx->pc = 0x156280u; }
}
