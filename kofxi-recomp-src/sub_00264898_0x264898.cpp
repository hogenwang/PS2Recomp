...
void sub_00264898_0x264898(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2648A4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2648A0u;
    ...
    if (runtime->hasFunction(0x2645A0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2648A8u; }
        if (ctx->pc != 0x2648A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2648a8:
    ...
    ctx->pc = 0x2648ACu;
    {
        ...
        ctx->pc = 0x2648B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2648ACu;
