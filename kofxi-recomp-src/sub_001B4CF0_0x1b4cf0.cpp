...
void sub_001B4CF0_0x1b4cf0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CA3B8u;
    {
        auto targetFn = runtime->lookupFunction(0x1CA3B8u);
...
label_1b4d08:
    ...
    ctx->pc = 0x1B4D14u;
    ctx->pc = 0x1B4D18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4D14u;
            // 0x1b4d18: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1CA450u;
    {
        auto targetFn = runtime->lookupFunction(0x1CA450u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4d20:
    ...
    ctx->pc = 0x1CA480u;
    {
        auto targetFn = runtime->lookupFunction(0x1CA480u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4d38:
    ...
    ctx->pc = 0x1CA4B0u;
    {
        auto targetFn = runtime->lookupFunction(0x1CA4B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4d50:
    ...
    ctx->pc = 0x1B4D5Cu;
    ctx->pc = 0x1B4D60u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4D5Cu;
            // 0x1b4d60: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1CA4E8u;
    {
        auto targetFn = runtime->lookupFunction(0x1CA4E8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4d68:
    ...
    ctx->pc = 0x1B4D74u;
    ctx->pc = 0x1B4D78u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4D74u;
            // 0x1b4d78: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1CA518u;
    {
        auto targetFn = runtime->lookupFunction(0x1CA518u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
