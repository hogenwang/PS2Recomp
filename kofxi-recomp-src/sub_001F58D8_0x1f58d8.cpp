...
label_1f58ec:
    ...
    ctx->pc = 0x1F58ECu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F58ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f58f4u;
    // NOP
    if (ctx->pc == 0x1f58f4u) { ctx->pc = 0x1f58f8u; }
}
