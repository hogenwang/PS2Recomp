...
void sub_001EB850_0x1eb850(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1EB860u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EB85Cu;
    ...
    if (runtime->hasFunction(0x1ED920u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EB864u; }
        if (ctx->pc != 0x1EB864u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1eb890:
    ...
    if (runtime->hasFunction(0x1FAE40u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EB898u; }
        if (ctx->pc != 0x1EB898u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1eb898:
    ...
    ctx->pc = 0x1EB8A4u;
    {
        ...
        ctx->pc = 0x1EB8A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1EB8A4u;
