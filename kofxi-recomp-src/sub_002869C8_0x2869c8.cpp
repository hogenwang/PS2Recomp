...
void sub_002869C8_0x2869c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2869D0u;
    {
        ...
        ctx->pc = 0x2869D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2869D0u;
    ...
    ctx->pc = 0x2869E8u;
    {
        ...
        ctx->pc = 0x2869ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2869E8u;
    ...
    ctx->pc = 0x2869F0u;
    {
        ...
        ctx->pc = 0x2869F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2869F0u;
...
label_286a00:
    ...
    ctx->pc = 0x286A00u;
    {
        ...
        ctx->pc = 0x286A04u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286A00u;
    ...
    ctx->pc = 0x286A0Cu;
    {
        ...
        ctx->pc = 0x286A10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286A0Cu;
