...
void sub_0013CF30_0x13cf30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13CF44u;
    {
        ...
        if (branch_taken_0x13cf44) {
            ctx->pc = 0x13CF48u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF44u;
    ...
    ctx->pc = 0x13CF50u;
    {
        ...
        if (branch_taken_0x13cf50) {
            ctx->pc = 0x13CF54u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF50u;
    ...
    ctx->pc = 0x13CF58u;
    {
        ...
        if (branch_taken_0x13cf58) {
            ctx->pc = 0x13CF5Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF58u;
    ...
    ctx->pc = 0x13CF60u;
    {
        ...
        ctx->pc = 0x13CF64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF60u;
...
label_13cf68:
    ...
    ctx->pc = 0x13CF6Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF68u;
    ...
    if (runtime->hasFunction(0x140740u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x13CF70u; }
        if (ctx->pc != 0x13CF70u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13cf78:
    ...
    ctx->pc = 0x13CF7Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF78u;
    ...
    if (runtime->hasFunction(0x140740u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13CF80u; }
        if (ctx->pc != 0x13CF80u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00140740_0x140740(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13CF80u; }
...
label_13cf88:
    ...
    ctx->pc = 0x13CF90u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF8Cu;
    ...
    if (runtime->hasFunction(0x140740u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13CF94u; }
        if (ctx->pc != 0x13CF94u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00140740_0x140740(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13CF94u; }
...
label_13cf98:
    ...
    ctx->pc = 0x13CF98u;
    {
        ...
        ctx->pc = 0x13CF9Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13CF98u;
