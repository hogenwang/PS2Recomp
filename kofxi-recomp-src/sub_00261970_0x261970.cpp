...
void sub_00261970_0x261970(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x261970u;
    {
        ...
        ctx->pc = 0x261974u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261970u;
...
label_261980:
    ...
    ctx->pc = 0x261980u;
    {
        ...
        ctx->pc = 0x261984u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261980u;
...
label_261990:
    ...
    ctx->pc = 0x26199Cu;
    {
        ...
        if (branch_taken_0x26199c) {
            ctx->pc = 0x2619A0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x26199Cu;
    ...
    ctx->pc = 0x2619A4u;
    {
        ...
        ctx->pc = 0x2619A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2619A4u;
...
label_2619ac:
    ...
    ctx->pc = 0x2619B0u;
    {
        ...
        ctx->pc = 0x2619B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2619B0u;
...
label_2619b8:
    ...
    ctx->pc = 0x2619B8u;
    {
        ...
        ctx->pc = 0x2619BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2619B8u;
...
label_2619c4:
    ...
    ctx->pc = 0x2619C4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2619C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2619C4u;
