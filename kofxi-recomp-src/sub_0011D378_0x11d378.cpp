...
void sub_0011D378_0x11d378(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11D3ACu;
    {
        ...
        ctx->pc = 0x11D3B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11D3ACu;
    ...
    ctx->pc = 0x11D3B4u;
    {
        ...
        ctx->pc = 0x11D3B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11D3B4u;
...
label_11d3bc:
    ...
    ctx->pc = 0x11D3C4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11D3C0u;
    ...
    if (runtime->hasFunction(0x11D1C8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x11D3C8u; }
        if (ctx->pc != 0x11D3C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_11d3c8:
    ...
    ctx->pc = 0x11D3D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11D3D0u;
    ...
    if (runtime->hasFunction(0x127120u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x11D3D8u; }
        if (ctx->pc != 0x11D3D8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
