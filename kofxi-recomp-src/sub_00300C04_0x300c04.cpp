...
void sub_00300C04_0x300c04(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x300C24u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300C20u;
    // 0x300c24: 0x24040010  addiu       $a0, $zero, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2FE0D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FE0D0u, 0x300C20u, 0x300C28u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300C28u;
label_300c28:
...
label_300c58:
    ...
    ctx->pc = 0x300C7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300C78u;
    // 0x300c7c: 0x24040024  addiu       $a0, $zero, 0x24 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 36));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2FE1B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FE1B0u, 0x300C78u, 0x300C80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300C80u;
label_300c80:
...
label_300c90:
    ...
    ctx->pc = 0x300CB8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300CB4u;
    // 0x300cb8: 0x24a5da70  addiu       $a1, $a1, -0x2590 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294957680));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3008E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3008E0u, 0x300CB4u, 0x300CBCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300CBCu;
label_300cbc:
...
label_300cc4:
    ...
    ctx->pc = 0x300CCCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300CC8u;
    // 0x300ccc: 0x24840d40  addiu       $a0, $a0, 0xD40 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 3392));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2099D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2099D0u, 0x300CC8u, 0x300CD0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300CD0u;
label_300cd0:
...
label_300cd8:
    ...
    ctx->pc = 0x300CFCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300CF8u;
    // 0x300cfc: 0x24040024  addiu       $a0, $zero, 0x24 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 36));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2FE1B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FE1B0u, 0x300CF8u, 0x300D00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300D00u;
label_300d00:
...
label_300d20:
    ...
    ctx->pc = 0x300D28u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300D24u;
    // 0x300d28: 0x24a5da70  addiu       $a1, $a1, -0x2590 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294957680));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3008E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3008E0u, 0x300D24u, 0x300D2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300D2Cu;
label_300d2c:
...
label_300d30:
    ...
    ctx->pc = 0x300D34u;
    {
        ...
        ctx->pc = 0x300D38u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x300D34u;
        // 0x300d38: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x300D34u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x11F028u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11F028u, 0x300D60u, 0x300D68u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300D68u;
label_300d68:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x11ED18u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11ED18u, 0x300D70u, 0x300D78u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300D78u;
label_300d78:
    ...
    ctx->pc = 0x300D94u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300D90u;
    // 0x300d94: 0x24a5da70  addiu       $a1, $a1, -0x2590 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294957680));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3008E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3008E0u, 0x300D90u, 0x300D98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300D98u;
label_300d98:
...
label_300da0:
    ...
    ctx->pc = 0x300DB4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300DB0u;
    // 0x300db4: 0x24a5da70  addiu       $a1, $a1, -0x2590 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294957680));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3008E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3008E0u, 0x300DB0u, 0x300DB8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300DB8u;
label_300db8:
...
label_300dc0:
    ...
    ctx->pc = 0x300DCCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300DC8u;
    // 0x300dcc: 0x24a50de0  addiu       $a1, $a1, 0xDE0 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 3552));
    ctx->in_delay_slot = false;
    ctx->pc = 0x300960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x300960u, 0x300DC8u, 0x300DD0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300DD0u;
label_300dd0:
...
label_300dd4:
    ...
    ctx->pc = 0x300DD4u;
    {
        ...
        ctx->pc = 0x300DD8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x300DD4u;
        // 0x300dd8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x300DD4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x300DFCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300DF8u;
    // 0x300dfc: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x11EE38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11EE38u, 0x300DF8u, 0x300E00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E00u;
label_300e00:
    ...
    ctx->pc = 0x300E0Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300E08u;
    // 0x300e0c: 0x27a6001c  addiu       $a2, $sp, 0x1C (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 28));
    ctx->in_delay_slot = false;
    ctx->pc = 0x11ED18u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11ED18u, 0x300E08u, 0x300E10u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E10u;
label_300e10:
    ...
    ctx->pc = 0x300A60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x300A60u, 0x300E10u, 0x300E18u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E18u;
label_300e18:
    ...
    ctx->pc = 0x300E28u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300E24u;
    // 0x300e28: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3009E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3009E0u, 0x300E24u, 0x300E2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E2Cu;
label_300e2c:
...
label_300e34:
    ...
    ctx->pc = 0x300E40u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300E3Cu;
    // 0x300e40: 0x24a5da70  addiu       $a1, $a1, -0x2590 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294957680));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3008E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3008E0u, 0x300E3Cu, 0x300E44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E44u;
label_300e44:
...
label_300e48:
    ...
    ctx->pc = 0x300E48u;
    {
        ...
        ctx->pc = 0x300E4Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x300E48u;
        // 0x300e4c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x300E48u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x300E5Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300E58u;
    // 0x300e5c: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1A4610u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A4610u, 0x300E58u, 0x300E60u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E60u;
label_300e60:
    ...
    ctx->pc = 0x300E7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300E78u;
    // 0x300e7c: 0x24a5fba0  addiu       $a1, $a1, -0x460 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294966176));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2FE150u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FE150u, 0x300E78u, 0x300E80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E80u;
label_300e80:
...
label_300e88:
    ...
    ctx->pc = 0x300E98u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300E94u;
    // 0x300e98: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2FE270u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FE270u, 0x300E94u, 0x300E9Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300E9Cu;
label_300e9c:
...
label_300ea0:
    ...
    ctx->pc = 0x300EA0u;
    {
        ...
        ctx->pc = 0x300EA4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x300EA0u;
        // 0x300ea4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x300EA0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x300F30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x300F30u, 0x300EB8u, 0x300EC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300EC0u;
label_300ec0:
    ...
    ctx->pc = 0x300EC8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300EC4u;
    // 0x300ec8: 0xa0409738  sb          $zero, -0x68C8($v0) (Delay Slot)
    WRITE8(ADD32(GPR_U32(ctx, 2), 4294940472), (uint8_t)GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x155A10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x155A10u, 0x300EC4u, 0x300ECCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300ECCu;
label_300ecc:
    ...
    ctx->pc = 0x300EF0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300EECu;
    // 0x300ef0: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x31E7F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x31E7F0u, 0x300EECu, 0x300EF4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300EF4u;
label_300ef4:
    ...
    ctx->pc = 0x300EF8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300EF4u;
    // 0x300ef8: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1A4610u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A4610u, 0x300EF4u, 0x300EFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300EFCu;
label_300efc:
    ...
    ctx->pc = 0x300F08u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300F04u;
    // 0x300f08: 0x248433f0  addiu       $a0, $a0, 0x33F0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 13296));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2099E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2099E0u, 0x300F04u, 0x300F0Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300F0Cu;
label_300f0c:
    ...
    ctx->pc = 0x300F1Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x300F18u;
    // 0x300f1c: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2FE3D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FE3D0u, 0x300F18u, 0x300F20u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x300F20u;
label_300f20:
    ...
    ctx->pc = 0x300F24u;
    {
        ...
        ctx->pc = 0x300F28u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x300F24u;
        // 0x300f28: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x300F24u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
