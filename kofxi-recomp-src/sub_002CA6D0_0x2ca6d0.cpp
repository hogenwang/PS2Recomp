...
void sub_002CA6D0_0x2ca6d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2CA6E8u;
    {
        ...
        ctx->pc = 0x2CA6ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA6E8u;
    ...
    ctx->pc = 0x2CA6F4u;
    {
        ...
        ctx->pc = 0x2CA6F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA6F4u;
...
label_2ca744:
    ...
    if (runtime->hasFunction(0x2D8370u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CA74Cu; }
        if (ctx->pc != 0x2CA74Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2ca74c:
    ...
    ctx->pc = 0x2CA74Cu;
    {
        ...
        ctx->pc = 0x2CA750u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA74Cu;
...
label_2ca758:
    ...
    ctx->pc = 0x2CA75Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA758u;
    ...
    if (runtime->hasFunction(0x2D8398u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CA760u; }
        if (ctx->pc != 0x2CA760u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2ca760:
    ...
    ctx->pc = 0x2CA770u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA76Cu;
    ...
    if (runtime->hasFunction(0x2D8288u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CA774u; }
        if (ctx->pc != 0x2CA774u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2ca7b8:
    ...
    ctx->pc = 0x2CA7B8u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2CA7BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA7B8u;
...
label_2ca7c8:
    ...
    ctx->pc = 0x2CA7C8u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2CA7CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CA7C8u;
