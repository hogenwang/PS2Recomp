...
label_2bdc20:
    ...
    ctx->pc = 0x2BDC28u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BDC24u;
    ...
    if (runtime->hasFunction(0x2A3980u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BDC2Cu; }
        if (ctx->pc != 0x2BDC2Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bdc2c:
    ...
    ctx->pc = 0x2BDC34u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BDC30u;
    ...
    if (runtime->hasFunction(0x2A39D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BDC38u; }
        if (ctx->pc != 0x2BDC38u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bdc38:
    ...
    ctx->pc = 0x2BDC40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BDC3Cu;
    ...
    if (runtime->hasFunction(0x2A3A30u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BDC44u; }
        if (ctx->pc != 0x2BDC44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
