...
label_1fc284:
    ...
    ctx->pc = 0x1FC2A4u;
    ctx->pc = 0x1FC2A8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FC2A4u;
...
label_1fc2b0:
    ...
    ctx->pc = 0x1FC2B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FC2B4u;
    ...
    if (runtime->hasFunction(0x1FC508u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FC2BCu; }
        if (ctx->pc != 0x1FC2BCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1fc2bc:
    ...
    if (runtime->hasFunction(0x1FAE40u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FC2D4u; }
        if (ctx->pc != 0x1FC2D4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1fc2d4:
    ...
    ctx->pc = 0x1FC2E4u;
    {
        ...
        ctx->pc = 0x1FC2E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FC2E4u;
