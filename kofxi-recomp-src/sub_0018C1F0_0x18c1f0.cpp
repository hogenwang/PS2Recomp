...
label_18c278:
    ...
    ctx->pc = 0x18C280u;
    {
        ...
        ctx->pc = 0x18C284u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C280u;
...
label_18c28c:
    ...
    ctx->pc = 0x18C2A0u;
    {
        ...
        ctx->pc = 0x18C2A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C2A0u;
...
label_18c2a8:
    ...
    ctx->pc = 0x18C2ACu;
    {
        ...
        ctx->pc = 0x18C2B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C2ACu;
...
label_18c2bc:
    ...
    ctx->pc = 0x18C2C0u;
    {
        ...
        ctx->pc = 0x18C2C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C2C0u;
