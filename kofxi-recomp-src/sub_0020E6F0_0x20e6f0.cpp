...
void sub_0020E6F0_0x20e6f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20E72Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20E728u;
    ...
    if (runtime->hasFunction(0x20A510u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E730u; }
        if (ctx->pc != 0x20E730u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_20e730:
    ...
    ctx->pc = 0x20E734u;
    {
        ...
        if (branch_taken_0x20e734) {
            ctx->pc = 0x20E738u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x20E734u;
    ...
    ctx->pc = 0x20E770u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20E76Cu;
            // 0x20e770: 0x2224821  addu        $t1, $s1, $v0 (Delay Slot)
        SET_GPR_S32(ctx, 9, (int32_t)ADD32(GPR_U32(ctx, 17), GPR_U32(ctx, 2)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x20BB80u;
    if (runtime->hasFunction(0x20BB80u)) {
        auto targetFn = runtime->lookupFunction(0x20BB80u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E774u; }
        if (ctx->pc != 0x20E774u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0020BB80_0x20bb80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E774u; }
        if (ctx->pc != 0x20E774u) { return; }
    }
    ctx->pc = 0x20E774u;
...
label_20e778:
    ...
    ctx->pc = 0x20E784u;
    {
        ...
        ctx->pc = 0x20E788u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E784u;
