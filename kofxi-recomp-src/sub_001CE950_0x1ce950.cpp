...
label_1ce958:
    ...
    ctx->pc = 0x1CE95Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1CE960u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE95Cu;
...
label_1ce968:
    ...
    ctx->pc = 0x1CE96Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1CE970u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE96Cu;
...
label_1ce998:
    ...
    ctx->pc = 0x1CE9C0u;
    if (runtime->hasFunction(0x1CE9C0u)) {
        auto targetFn = runtime->lookupFunction(0x1CE9C0u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001CE9C0_0x1ce9c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CE9A8u; }
        if (ctx->pc != 0x1CE9A8u) { return; }
    }
    ctx->pc = 0x1CE9A8u;
label_1ce9a8:
    ...
    ctx->pc = 0x1CE9B4u;
    ctx->pc = 0x1CE9B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE9B4u;
