...
label_1b1908:
    ...
    ctx->pc = 0x1B1918u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1914u;
    ...
    if (runtime->hasFunction(0x1B1AB0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B191Cu; }
        if (ctx->pc != 0x1B191Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b191c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B191Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B1940u;
    if (runtime->hasFunction(0x1B1940u)) {
        auto targetFn = runtime->lookupFunction(0x1B1940u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1924u; }
        if (ctx->pc != 0x1B1924u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B1940_0x1b1940(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1924u; }
        if (ctx->pc != 0x1B1924u) { return; }
    }
    ctx->pc = 0x1B1924u;
label_1b1924:
    ...
    ctx->pc = 0x1B1928u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1924u;
