...
label_3007a4:
    ...
    ctx->pc = 0x3007C4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3007C0u;
            // 0x3007c4: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x3013A0u;
    if (runtime->hasFunction(0x3013A0u)) {
        auto targetFn = runtime->lookupFunction(0x3013A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3007C8u; }
        if (ctx->pc != 0x3007C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_003013A0_0x3013a0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3007C8u; }
        if (ctx->pc != 0x3007C8u) { return; }
    }
    ctx->pc = 0x3007C8u;
...
label_300800:
    ...
    ctx->pc = 0x300814u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x300810u;
    ...
    if (runtime->hasFunction(0x2FDFA0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x300818u; }
        if (ctx->pc != 0x300818u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_300818:
    ...
    ctx->pc = 0x30081Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x300820u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x30081Cu;
...
label_300860:
    ...
    ctx->pc = 0x300870u;
    {
        ...
        if (branch_taken_0x300870) {
            ctx->pc = 0x300874u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x300870u;
...
label_300880:
    ...
    ctx->pc = 0x300890u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x30088Cu;
            // 0x300890: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2FE330u;
    if (runtime->hasFunction(0x2FE330u)) {
        auto targetFn = runtime->lookupFunction(0x2FE330u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x300894u; }
        if (ctx->pc != 0x300894u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002FE330_0x2fe330(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x300894u; }
        if (ctx->pc != 0x300894u) { return; }
    }
    ctx->pc = 0x300894u;
...
label_3008a0:
    ...
    ctx->pc = 0x3008B0u;
    {
        ...
        if (branch_taken_0x3008b0) {
            ctx->pc = 0x3008B4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x3008B0u;
    ...
    if (runtime->hasFunction(0x1A1450u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3008C0u; }
        if (ctx->pc != 0x3008C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001A1450_0x1a1450(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3008C0u; }
        if (ctx->pc != 0x3008C0u) { return; }
    }
    ctx->pc = 0x3008C0u;
label_3008c0:
    ...
    ctx->pc = 0x3008C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3008C4u;
    ...
    if (runtime->hasFunction(0x2099D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3008CCu; }
        if (ctx->pc != 0x3008CCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_3008d0:
    ...
    ctx->pc = 0x3008D0u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x3008D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3008D0u;
