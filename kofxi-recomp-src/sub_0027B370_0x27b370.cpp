...
void sub_0027B370_0x27b370(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x27B388u;
    {
        ...
        ctx->pc = 0x27B38Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27B388u;
    ...
    ctx->pc = 0x27B39Cu;
    ctx->pc = 0x27B3A0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x27B39Cu;
...
label_27b3a8:
    ...
    ctx->pc = 0x27B3ACu;
    {
        ...
        ctx->pc = 0x27B3B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27B3ACu;
...
label_27b3b8:
    ...
    ctx->pc = 0x27B3BCu;
    {
        ...
        ctx->pc = 0x27B3C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x27B3BCu;
