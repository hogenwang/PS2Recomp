...
void sub_001B9F98_0x1b9f98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B9FB0u;
    ctx->pc = 0x1B9FB4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9FB0u;
...
label_1b9fb8:
    ...
    ctx->pc = 0x1B9FBCu;
    {
        ...
        ctx->pc = 0x1B9FC0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9FBCu;
    ...
    ctx->pc = 0x1B9FC8u;
    {
        ...
        ctx->pc = 0x1B9FCCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9FC8u;
...
label_1b9fe0:
    ...
    ctx->pc = 0x1B9FE8u;
    {
        ...
        if (branch_taken_0x1b9fe8) {
            ctx->pc = 0x1B9FECu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9FE8u;
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9FF4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B4CD8u;
    if (runtime->hasFunction(0x1B4CD8u)) {
        auto targetFn = runtime->lookupFunction(0x1B4CD8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9FFCu; }
        if (ctx->pc != 0x1B9FFCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B4CD8_0x1b4cd8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9FFCu; }
        if (ctx->pc != 0x1B9FFCu) { return; }
    }
    ctx->pc = 0x1B9FFCu;
...
label_1ba014:
    ...
    ctx->pc = 0x1BA014u;
    {
        ...
        ctx->pc = 0x1BA018u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA014u;
...
label_1ba020:
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA034u; }
        if (ctx->pc != 0x1BA034u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba034:
    ...
    ctx->pc = 0x1BA038u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA034u;
    ...
    if (runtime->hasFunction(0x1BA058u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA03Cu; }
        if (ctx->pc != 0x1BA03Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba03c:
    ...
    ctx->pc = 0x1BA040u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA03Cu;
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA044u; }
        if (ctx->pc != 0x1BA044u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba044:
    ...
    ctx->pc = 0x1BA050u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1BA054u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA050u;
