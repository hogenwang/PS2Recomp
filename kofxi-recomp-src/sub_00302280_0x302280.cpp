...
void sub_00302280_0x302280(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x302290u;
    // 0x302294: 0x202d  daddu       $a0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CEE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CEE0u, 0x302290u, 0x302298u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x302298u;
label_302298:
    ...
    ctx->pc = 0x3022A4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3022A0u;
    // 0x3022a4: 0x2484e910  addiu       $a0, $a0, -0x16F0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294961424));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1017F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1017F0u, 0x3022A0u, 0x3022A8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3022A8u;
label_3022a8:
    ...
    ctx->pc = 0x3022B0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3022ACu;
    // 0x3022b0: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x101150u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x101150u, 0x3022ACu, 0x3022B4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3022B4u;
label_3022b4:
    ...
    ctx->pc = 0x3022C8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3022C4u;
    // 0x3022c8: 0xae050040  sw          $a1, 0x40($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 64), GPR_U32(ctx, 5));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1017F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1017F0u, 0x3022C4u, 0x3022CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3022CCu;
label_3022cc:
    ...
    ctx->pc = 0x3022D4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3022D0u;
    // 0x3022d4: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x101150u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x101150u, 0x3022D0u, 0x3022D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3022D8u;
label_3022d8:
    ...
    ctx->pc = 0x302308u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x302304u;
    // 0x302308: 0xac4325c0  sw          $v1, 0x25C0($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 9664), GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CEE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CEE0u, 0x302304u, 0x30230Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x30230Cu;
label_30230c:
    ...
    ctx->pc = 0x30231Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x302318u;
    // 0x30231c: 0x24a52490  addiu       $a1, $a1, 0x2490 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 9360));
    ctx->in_delay_slot = false;
    ctx->pc = 0x102810u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x102810u, 0x302318u, 0x302320u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x302320u;
label_302320:
    ...
    ctx->pc = 0x302328u;
    {
        ...
        ctx->pc = 0x30232Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x302328u;
        // 0x30232c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x302328u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
