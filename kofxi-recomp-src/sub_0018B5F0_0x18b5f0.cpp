...
label_18b7b4:
    ...
    ctx->pc = 0x18B7B4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x18B7B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x18b7bcu;
    // NOP
    if (ctx->pc == 0x18b7bcu) { ctx->pc = 0x18b7c0u; }
}
