...
label_13d8ac:
    ...
    ctx->pc = 0x13D8ACu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x13D8ACu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x13d8bcu;
    // NOP
    if (ctx->pc == 0x13d8bcu) { ctx->pc = 0x13d8c0u; }
}
