...
void sub_00163C50_0x163c50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x163C80u;
    if (runtime->hasFunction(0x163C80u)) {
        auto targetFn = runtime->lookupFunction(0x163C80u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x163C60u; }
        if (ctx->pc != 0x163C60u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00163C80_0x163c80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x163C60u; }
        if (ctx->pc != 0x163C60u) { return; }
    }
    ctx->pc = 0x163C60u;
label_163c60:
    ...
    ctx->pc = 0x163CE0u;
    if (runtime->hasFunction(0x163CE0u)) {
        auto targetFn = runtime->lookupFunction(0x163CE0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00163CE0_0x163ce0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x163C68u; }
        if (ctx->pc != 0x163C68u) { return; }
    }
    ctx->pc = 0x163C68u;
label_163c68:
    ...
    ctx->pc = 0x163C6Cu;
    {
        ...
        ctx->pc = 0x163C70u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x163C6Cu;
