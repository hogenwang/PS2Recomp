...
void sub_002076C0_0x2076c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x204120u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x204120u, 0x2076C8u, 0x2076D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2076D0u;
label_2076d0:
    ...
    ctx->branch_pc = 0x2076D8u;
    // 0x2076dc: 0x24440824  addiu       $a0, $v0, 0x824 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 2084));
    ctx->in_delay_slot = false;
    ctx->pc = 0x206DF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x206DF0u, 0x2076D8u, 0x2076E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2076E0u;
label_2076e0:
    ...
    ctx->pc = 0x2076E4u;
    {
        ...
        ctx->pc = 0x2076E8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2076E4u;
        // 0x2076e8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2076E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2076ecu;
    // NOP
    if (ctx->pc == 0x2076ecu) { ctx->pc = 0x2076f0u; }
}
