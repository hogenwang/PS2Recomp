...
label_205e94:
    ...
    ctx->pc = 0x205E94u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x205E94u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x205e9cu;
    // NOP
    if (ctx->pc == 0x205e9cu) { ctx->pc = 0x205ea0u; }
}
