...
label_261ce8:
    ...
    ctx->pc = 0x261CECu;
    {
        ...
        ctx->pc = 0x261CF0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261CECu;
    ...
    ctx->pc = 0x261CF8u;
    {
        ...
        ctx->pc = 0x261CFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261CF8u;
...
label_261d08:
    ...
    ctx->pc = 0x261D08u;
    {
        ...
        if (branch_taken_0x261d08) {
            ctx->pc = 0x261D0Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x261D08u;
...
label_261d24:
    ...
    ctx->pc = 0x261D24u;
    {
        ...
        if (branch_taken_0x261d24) {
            ctx->pc = 0x261D28u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x261D24u;
    ...
    ctx->pc = 0x261D2Cu;
    {
        ...
        ctx->pc = 0x261D30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261D2Cu;
...
label_261d34:
    ...
    ctx->pc = 0x261D3Cu;
    {
        ...
        if (branch_taken_0x261d3c) {
            ctx->pc = 0x261D40u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x261D3Cu;
...
label_261d78:
    ...
    ctx->pc = 0x261D78u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x261D7Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261D78u;
