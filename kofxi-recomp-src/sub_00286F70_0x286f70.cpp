...
void sub_00286F70_0x286f70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x286F88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x286F84u;
    ...
    if (runtime->hasFunction(0x286808u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x286F8Cu; }
        if (ctx->pc != 0x286F8Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_286f8c:
    ...
    ctx->pc = 0x286FA4u;
    {
        ...
        ctx->pc = 0x286FA8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286FA4u;
...
label_286fb0:
    ...
    ctx->pc = 0x286FF0u;
    {
        ...
        ctx->pc = 0x286FF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286FF0u;
...
label_286ff8:
    ...
    ctx->pc = 0x287008u;
    {
        ...
        ctx->pc = 0x28700Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x287008u;
