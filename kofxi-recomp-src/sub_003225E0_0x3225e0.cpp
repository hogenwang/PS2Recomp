...
void sub_003225E0_0x3225e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x322618u;
    {
        ...
        ctx->pc = 0x32261Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322618u;
    ...
    ctx->pc = 0x322630u;
    {
        ...
        ctx->pc = 0x322634u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322630u;
...
label_322648:
    ...
    ctx->pc = 0x3226A4u;
    {
        ...
        ctx->pc = 0x3226A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3226A4u;
    ...
    ctx->pc = 0x3226CCu;
    {
        ...
        ctx->pc = 0x3226D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3226CCu;
...
label_3227c0:
    ...
    ctx->pc = 0x3229A8u;
    {
        ...
        ctx->pc = 0x3229ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3229A8u;
...
label_3229ec:
    ...
    ctx->pc = 0x322A30u;
    {
        ...
        ctx->pc = 0x322A34u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322A30u;
...
label_322a38:
    ...
    ctx->pc = 0x322A5Cu;
    {
        ...
        ctx->pc = 0x322A60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322A5Cu;
