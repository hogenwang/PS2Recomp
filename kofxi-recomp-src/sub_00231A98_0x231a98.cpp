...
label_231ab4:
    ...
    ctx->pc = 0x231AB4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x231AB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x231abcu;
    // NOP
    if (ctx->pc == 0x231abcu) { ctx->pc = 0x231ac0u; }
}
