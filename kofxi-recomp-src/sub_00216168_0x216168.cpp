...
label_216168:
    ...
    ctx->pc = 0x21617Cu;
    ctx->pc = 0x216180u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x21617Cu;
...
label_216188:
    ...
    ctx->pc = 0x21619Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x216198u;
...
label_2161a0:
    ...
    ctx->pc = 0x2161A8u;
    {
        ...
        ctx->pc = 0x2161ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2161A8u;
...
label_2161b0:
    ...
    ctx->pc = 0x2161D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2161D0u;
