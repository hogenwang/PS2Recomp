...
void sub_001B63C0_0x1b63c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B63D0u;
    // 0x1b63d4: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ABA58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ABA58u, 0x1B63D0u, 0x1B63D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B63D8u;
label_1b63d8:
    ...
    ctx->pc = 0x1B63F8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B63F4u;
    // 0x1b63f8: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ABA60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ABA60u, 0x1B63F4u, 0x1B63FCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B63FCu;
label_1b63fc:
...
label_1b640c:
    ...
    ctx->pc = 0x1B6410u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B6410u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
