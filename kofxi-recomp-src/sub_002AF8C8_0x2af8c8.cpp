...
void sub_002AF8C8_0x2af8c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2AF8FCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2AF8F8u;
    // 0x2af8fc: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x28F018u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x28F018u, 0x2AF8F8u, 0x2AF900u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2AF900u;
label_2af900:
...
label_2af908:
    ...
    ctx->pc = 0x2AF90Cu;
    {
        ...
        ctx->pc = 0x2AF910u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2AF90Cu;
        // 0x2af910: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2AF90Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2af914u;
    // NOP
    if (ctx->pc == 0x2af914u) { ctx->pc = 0x2af918u; }
}
