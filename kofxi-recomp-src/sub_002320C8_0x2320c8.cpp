...
void sub_002320C8_0x2320c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2320D4u;
    {
        ...
        ctx->pc = 0x2320D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2320D4u;
    ...
    ctx->pc = 0x2320DCu;
    {
        ...
        ctx->pc = 0x2320E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2320DCu;
...
label_2320e4:
    ...
    ctx->pc = 0x2320ECu;
    {
        ...
        if (branch_taken_0x2320ec) {
            ctx->pc = 0x2320F0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2320ECu;
    ...
    ctx->pc = 0x2320F4u;
    {
        ...
        ctx->pc = 0x2320F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2320F4u;
...
label_2320fc:
    ...
    if (runtime->hasFunction(0x22D3E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x232118u; }
        if (ctx->pc != 0x232118u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_23211c:
    ...
    ctx->pc = 0x232120u;
    {
        ...
        ctx->pc = 0x232124u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x232120u;
