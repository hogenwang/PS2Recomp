...
void kofxiIopHeapFree_0x115210(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11522Cu;
    {
        ...
        ctx->pc = 0x115230u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11522Cu;
...
label_115234:
    ...
    ctx->pc = 0x115268u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x115264u;
    ...
    if (runtime->hasFunction(0x110D30u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x11526Cu; }
        if (ctx->pc != 0x11526Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_11526c:
    ...
    ctx->pc = 0x11526Cu;
    {
        ...
        ctx->pc = 0x115270u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11526Cu;
...
label_115278:
    ...
    ctx->pc = 0x115280u;
    {
        ...
        ctx->pc = 0x115284u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x115280u;
