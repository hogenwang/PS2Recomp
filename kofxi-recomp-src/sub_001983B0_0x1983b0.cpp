...
label_1983c0:
    ...
    ctx->pc = 0x1983BCu;
    {
        ...
        ctx->pc = 0x1983C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1983BCu;
            // 0x1983c0: 0x7fb00000  sq          $s0, 0x0($sp) (Delay Slot)
        WRITE128(ADD32(GPR_U32(ctx, 29), 0), GPR_VEC(ctx, 16));
...
label_1983d8:
    ...
    ctx->pc = 0x1983D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1983D4u;
            // 0x1983d8: 0x622024  and         $a0, $v1, $v0 (Delay Slot)
        SET_GPR_U64(ctx, 4, GPR_U64(ctx, 3) & GPR_U64(ctx, 2));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1A4B80u;
    if (runtime->hasFunction(0x1A4B80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1983DCu; }
        if (ctx->pc != 0x1983DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1985c4:
    ...
    ctx->pc = 0x1985C0u;
    {
        ...
        ctx->pc = 0x1985C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1985C0u;
            // 0x1985c4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
