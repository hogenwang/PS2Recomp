...
void sub_001E47B8_0x1e47b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E4800u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E4800u, 0x1E47D4u, 0x1E47DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E47DCu;
label_1e47dc:
    ...
    ctx->pc = 0x1E47ECu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E47E8u;
    // 0x1e47ec: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E49B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E49B0u, 0x1E47E8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E47F0u;
label_1e47f0:
    ...
    ctx->pc = 0x1E47F4u;
    {
        ...
        ctx->pc = 0x1E47F8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E47F4u;
        // 0x1e47f8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E47F4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e47fcu;
    // NOP
    if (ctx->pc == 0x1e47fcu) { ctx->pc = 0x1e4800u; }
}
