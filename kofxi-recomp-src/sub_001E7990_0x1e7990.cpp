...
void sub_001E7990_0x1e7990(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E799Cu;
    // 0x1e79a0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E22D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E22D0u, 0x1E799Cu, 0x1E79A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E79A4u;
label_1e79a4:
    ...
    ctx->pc = 0x1E79ACu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E79A8u;
    // 0x1e79ac: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E7900u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E7900u, 0x1E79A8u, 0x1E79B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E79B0u;
label_1e79b0:
    ...
    ctx->pc = 0x1E6C80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6C80u, 0x1E79B0u, 0x1E79B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E79B8u;
label_1e79b8:
    ...
    ctx->pc = 0x1E79C0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E79BCu;
    // 0x1e79c0: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E7900u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E7900u, 0x1E79BCu, 0x1E79C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E79C4u;
label_1e79c4:
    ...
    ctx->pc = 0x1E22E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E22E8u, 0x1E79C4u, 0x1E79CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E79CCu;
label_1e79cc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E6CF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6CF0u, 0x1E79D8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E79E0u;
}
