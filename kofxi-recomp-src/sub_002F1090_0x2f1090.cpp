...
void sub_002F1090_0x2f1090(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2F10ACu;
    // 0x2f10b0: 0x24050004  addiu       $a1, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1010u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1010u, 0x2F10ACu, 0x2F10B4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F10B4u;
label_2f10b4:
...
label_2f10d4:
    ...
    ctx->pc = 0x2F10E4u;
    {
        ...
        ctx->pc = 0x2F10E8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F10E4u;
        // 0x2f10e8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F10E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2f10ecu;
    // NOP
    if (ctx->pc == 0x2f10ecu) { ctx->pc = 0x2f10f0u; }
}
