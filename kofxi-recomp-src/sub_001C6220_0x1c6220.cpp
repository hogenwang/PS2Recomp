...
void sub_001C6220_0x1c6220(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C6230u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C622Cu;
    ...
    if (runtime->hasFunction(0x1C6AB8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C6234u; }
        if (ctx->pc != 0x1C6234u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c6234:
    ...
    ctx->pc = 0x1C6238u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C6234u;
            // 0x1c6238: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C6250u;
    if (runtime->hasFunction(0x1C6250u)) {
        auto targetFn = runtime->lookupFunction(0x1C6250u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C623Cu; }
        if (ctx->pc != 0x1C623Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C6250_0x1c6250(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C623Cu; }
        if (ctx->pc != 0x1C623Cu) { return; }
    }
    ctx->pc = 0x1C623Cu;
