...
void sub_001A6B08_0x1a6b08(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x116EA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A6B18u; }
        if (ctx->pc != 0x1A6B18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a6b18:
    ...
    ctx->pc = 0x1A6B34u;
    {
        ...
        ctx->pc = 0x1A6B38u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A6B34u;
...
label_1a6b88:
    ...
    ctx->pc = 0x1A6B88u;
    {
        ...
        ctx->pc = 0x1A6B8Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A6B88u;
