...
void sub_001CE030_0x1ce030(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CE038u;
    {
        ...
        ctx->pc = 0x1CE03Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE038u;
    ...
    ctx->pc = 0x1CE044u;
    {
        ...
        ctx->pc = 0x1CE048u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE044u;
...
label_1ce058:
    ...
    ctx->pc = 0x1CE080u;
    {
        ...
        ctx->pc = 0x1CE084u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE080u;
...
label_1ce0b4:
    ...
    ctx->pc = 0x1CE0B8u;
    {
        ...
        ctx->pc = 0x1CE0BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE0B8u;
...
label_1ce0c4:
    ...
    ctx->pc = 0x1CE0C8u;
    {
        ...
        if (branch_taken_0x1ce0c8) {
            ctx->pc = 0x1CE0CCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE0C8u;
...
label_1ce0e4:
    ...
    ctx->pc = 0x1CE0E8u;
    {
        ...
        ctx->pc = 0x1CE0ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE0E8u;
