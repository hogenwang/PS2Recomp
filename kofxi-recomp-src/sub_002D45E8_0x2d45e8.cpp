...
void sub_002D45E8_0x2d45e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D4600u;
    {
        ...
        ctx->pc = 0x2D4604u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D4600u;
    ...
    ctx->pc = 0x2D4610u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D460Cu;
    ...
    if (runtime->hasFunction(0x2D8288u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D4614u; }
        if (ctx->pc != 0x2D4614u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d4614:
    ...
    ctx->pc = 0x2D4614u;
    {
        ...
        ctx->pc = 0x2D4618u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D4614u;
...
label_2d4634:
    ...
    ctx->pc = 0x2D4638u;
    {
        ...
        ctx->pc = 0x2D463Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D4638u;
