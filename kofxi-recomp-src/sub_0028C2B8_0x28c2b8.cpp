...
void sub_0028C2B8_0x28c2b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x28C2C8u;
    {
        ...
        ctx->pc = 0x28C2CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28C2C8u;
    ...
    ctx->pc = 0x28C2D4u;
    {
        ...
        ctx->pc = 0x28C2D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28C2D4u;
    ...
    ctx->pc = 0x28C2E0u;
    {
        ...
        ctx->pc = 0x28C2E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28C2E0u;
    ...
    ctx->pc = 0x28C2ECu;
    {
        ...
        ctx->pc = 0x28C2F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28C2ECu;
    ...
    if (runtime->hasFunction(0x28CB28u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x28C2FCu; }
        if (ctx->pc != 0x28C2FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_28c308:
    ...
    ctx->pc = 0x28C30Cu;
    {
        ...
        ctx->pc = 0x28C310u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28C30Cu;
