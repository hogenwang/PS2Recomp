...
void sub_002EE858_0x2ee858(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x224270u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x224270u, 0x2EE884u, 0x2EE88Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EE88Cu;
label_2ee88c:
    ...
    ctx->pc = 0x2EDD70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2EDD70u, 0x2EE898u, 0x2EE8A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EE8A0u;
label_2ee8a0:
...
label_2ee8a8:
    ...
    ctx->pc = 0x2EE8B0u;
    {
        ...
        ctx->pc = 0x2EE8B4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2EE8B0u;
        // 0x2ee8b4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2EE8B0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2ee8b8:
    ...
    ctx->pc = 0x2ee8d4u;
    // NOP
    if (ctx->pc == 0x2ee8d4u) { ctx->pc = 0x2ee8d8u; }
}
