...
label_1785b0:
    ...
    ctx->pc = 0x1785B0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1785B0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1785bcu;
    // NOP
    if (ctx->pc == 0x1785bcu) { ctx->pc = 0x1785c0u; }
}
