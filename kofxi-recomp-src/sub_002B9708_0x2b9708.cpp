...
void sub_002B9708_0x2b9708(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1247C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1247C8u, 0x2B971Cu, 0x2B9724u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2B9724u;
label_2b9724:
    ...
    ctx->pc = 0x2B9728u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2B9724u;
    // 0x2b9728: 0x8c440000  lw          $a0, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B9748u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B9748u, 0x2B9724u, 0x2B972Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2B972Cu;
label_2b972c:
...
label_2b973c:
    ...
    ctx->pc = 0x2B973Cu;
    {
        ...
        ctx->pc = 0x2B9740u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2B973Cu;
        // 0x2b9740: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2B973Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2b9744u;
    // NOP
    if (ctx->pc == 0x2b9744u) { ctx->pc = 0x2b9748u; }
}
