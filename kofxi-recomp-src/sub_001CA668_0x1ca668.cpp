...
label_1ca690:
    ...
    ctx->pc = 0x1CA698u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1CA694u;
    // 0x1ca698: 0x2484b810  addiu       $a0, $a0, -0x47F0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294948880));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B4848u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B4848u, 0x1CA694u, 0x1CA69Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1CA69Cu;
label_1ca69c:
...
label_1ca6a0:
    ...
    ctx->pc = 0x1CA6A4u;
    {
        ...
        ctx->pc = 0x1CA6A8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1CA6A4u;
        // 0x1ca6a8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1CA6A4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1ca6acu;
    // NOP
    if (ctx->pc == 0x1ca6acu) { ctx->pc = 0x1ca6b0u; }
}
