...
void sub_0010E7E0_0x10e7e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10E7F4u;
    {
        ...
        ctx->pc = 0x10E7F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E7F4u;
...
label_10e804:
    ...
    ctx->pc = 0x10E804u;
    {
        ...
        ctx->pc = 0x10E808u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E804u;
    ...
    ctx->pc = 0x10E80Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x10E810u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E80Cu;
...
label_10e814:
    ...
    ctx->pc = 0x10E844u;
    {
        ...
        if (branch_taken_0x10e844) {
            ctx->pc = 0x10E848u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x10E844u;
    ...
    ctx->pc = 0x10E850u;
    {
        ...
        ctx->pc = 0x10E854u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E850u;
