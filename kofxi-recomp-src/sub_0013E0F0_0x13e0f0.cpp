...
void sub_0013E0F0_0x13e0f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x13E100u;
    // 0x13e104: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x13E750u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x13E750u, 0x13E100u, 0x13E108u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x13E108u;
label_13e108:
    ...
    ctx->pc = 0x13E118u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x13E114u;
    // 0x13e118: 0x24050002  addiu       $a1, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x13D510u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x13D510u, 0x13E114u, 0x13E11Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x13E11Cu;
label_13e11c:
...
label_13e158:
    ...
    ctx->pc = 0x13E160u;
    {
        ...
        ctx->pc = 0x13E164u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x13E160u;
        // 0x13e164: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x13E160u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x13e16cu;
    // NOP
    if (ctx->pc == 0x13e16cu) { ctx->pc = 0x13e170u; }
}
