...
label_2ea34c:
    ...
    ctx->branch_pc = 0x2EA36Cu;
    // 0x2ea370: 0x502d  daddu       $t2, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 10, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x262AD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x262AD0u, 0x2EA36Cu, 0x2EA374u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EA374u;
label_2ea374:
    ...
    ctx->pc = 0x2EA37Cu;
    {
        ...
        ctx->pc = 0x2EA380u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2EA37Cu;
        // 0x2ea380: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2EA37Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2ea384u;
    // NOP
    if (ctx->pc == 0x2ea384u) { ctx->pc = 0x2ea388u; }
}
