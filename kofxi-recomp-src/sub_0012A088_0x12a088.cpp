...
void sub_0012A088_0x12a088(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x12A08Cu;
    {
        ...
        ctx->pc = 0x12A090u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A08Cu;
...
label_12a094:
    ...
    ctx->pc = 0x12A09Cu;
    {
        ...
        ctx->pc = 0x12A0A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A09Cu;
...
label_12a0ac:
    ...
    ctx->pc = 0x12A0B4u;
    {
        ...
        ctx->pc = 0x12A0B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A0B4u;
...
label_12a0d0:
    ...
    ctx->pc = 0x12A0E4u;
    {
        ...
        ctx->pc = 0x12A0E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A0E4u;
