...
void sub_002267B0_0x2267b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2267C8u;
    {
        ...
        ctx->pc = 0x2267CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2267C8u;
    ...
    ctx->pc = 0x2267E8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2267E4u;
...
label_2267f0:
    ...
    ctx->pc = 0x2267FCu;
    {
        ...
        ctx->pc = 0x226800u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2267FCu;
...
label_226804:
    ...
    ctx->pc = 0x2F9D28u;
    if (runtime->hasFunction(0x2F9D28u)) {
        auto targetFn = runtime->lookupFunction(0x2F9D28u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_002F9D28_0x2f9d28(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x22680Cu; }
        if (ctx->pc != 0x22680Cu) { return; }
    }
    ctx->pc = 0x22680Cu;
label_22680c:
    ...
    ctx->pc = 0x226824u;
    {
        ...
        ctx->pc = 0x226828u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226824u;
    ...
    if (runtime->hasFunction(0x225F58u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226834u; }
        if (ctx->pc != 0x226834u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00225F58_0x225f58(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226834u; }
...
label_226834:
    ...
    ctx->pc = 0x226834u;
    {
        ...
        ctx->pc = 0x226838u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226834u;
...
label_22683c:
    ...
    ctx->pc = 0x226860u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x22685Cu;
    ...
    if (runtime->hasFunction(0x225F58u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226864u; }
        if (ctx->pc != 0x226864u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00225F58_0x225f58(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226864u; }
...
label_226864:
    ...
    ctx->pc = 0x226864u;
    {
        ...
        ctx->pc = 0x226868u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226864u;
