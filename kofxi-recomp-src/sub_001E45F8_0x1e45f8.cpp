...
label_1e4614:
    ...
    ctx->pc = 0x1E4614u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E4614u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e461cu;
    // NOP
    if (ctx->pc == 0x1e461cu) { ctx->pc = 0x1e4620u; }
}
