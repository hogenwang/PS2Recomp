...
void sub_002F6510_0x2f6510(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F652Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F6528u;
    // 0x2f652c: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x12A0F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x12A0F8u, 0x2F6528u, 0x2F6530u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F6530u;
label_2f6530:
    ...
    ctx->pc = 0x2F6534u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F6530u;
    // 0x2f6534: 0x24440001  addiu       $a0, $v0, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F9140u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F9140u, 0x2F6530u, 0x2F6538u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F6538u;
label_2f6538:
...
label_2f654c:
    ...
    ctx->pc = 0x2F6550u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F654Cu;
    // 0x2f6550: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x129F70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x129F70u, 0x2F654Cu, 0x2F6554u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F6554u;
label_2f6554:
...
label_2f6558:
    ...
    ctx->pc = 0x2F6564u;
    {
        ...
        ctx->pc = 0x2F6568u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F6564u;
        // 0x2f6568: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F6564u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2f656cu;
    // NOP
    if (ctx->pc == 0x2f656cu) { ctx->pc = 0x2f6570u; }
}
