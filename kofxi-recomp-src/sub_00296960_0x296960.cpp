...
void sub_00296960_0x296960(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x296964u;
    {
        ...
        ctx->pc = 0x296968u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x296964u;
...
label_29697c:
    ...
    ctx->pc = 0x291670u;
    if (runtime->hasFunction(0x291670u)) {
        auto targetFn = runtime->lookupFunction(0x291670u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296984u; }
        if (ctx->pc != 0x296984u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00291670_0x291670(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296984u; }
        if (ctx->pc != 0x296984u) { return; }
    }
    ctx->pc = 0x296984u;
label_296984:
    ...
    ctx->pc = 0x296988u;
    {
        ...
        ctx->pc = 0x29698Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x296988u;
