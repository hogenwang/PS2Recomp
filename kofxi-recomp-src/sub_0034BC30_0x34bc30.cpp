...
void sub_0034BC30_0x34bc30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x34BC68u;
    // 0x34bc6c: 0x502021  addu        $a0, $v0, $s0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 16)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x127120u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x127120u, 0x34BC68u, 0x34BC70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BC70u;
label_34bc70:
    ...
    ctx->pc = 0x34BC88u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BC84u;
    // 0x34bc88: 0x24440020  addiu       $a0, $v0, 0x20 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 32));
    ctx->in_delay_slot = false;
    ctx->pc = 0x127120u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x127120u, 0x34BC84u, 0x34BC8Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BC8Cu;
label_34bc8c:
    ...
    ctx->pc = 0x34BCA4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BCA0u;
    // 0x34bca4: 0x24440020  addiu       $a0, $v0, 0x20 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 32));
    ctx->in_delay_slot = false;
    ctx->pc = 0x129E28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x129E28u, 0x34BCA0u, 0x34BCA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BCA8u;
label_34bca8:
...
label_34bcd8:
    ...
    ctx->pc = 0x34BCF8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BCF4u;
    // 0x34bcf8: 0xafa3003c  sw          $v1, 0x3C($sp) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 29), 60), GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x34BAA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x34BAA0u, 0x34BCF4u, 0x34BCFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BCFCu;
label_34bcfc:
    ...
    ctx->pc = 0x34BD00u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BCFCu;
    // 0x34bd00: 0x27a4003c  addiu       $a0, $sp, 0x3C (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 29), 60));
    ctx->in_delay_slot = false;
    ctx->pc = 0x34BAA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x34BAA0u, 0x34BCFCu, 0x34BD04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BD04u;
label_34bd04:
    ...
    ctx->pc = 0x34BD18u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BD14u;
    // 0x34bd18: 0xac620044  sw          $v0, 0x44($v1) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 3), 68), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x34BAA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x34BAA0u, 0x34BD14u, 0x34BD1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BD1Cu;
label_34bd1c:
    ...
    ctx->pc = 0x34BD30u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BD2Cu;
    // 0x34bd30: 0xac620054  sw          $v0, 0x54($v1) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 3), 84), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x34BAA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x34BAA0u, 0x34BD2Cu, 0x34BD34u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BD34u;
label_34bd34:
    ...
    ctx->pc = 0x34BD50u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BD4Cu;
    // 0x34bd50: 0xaca20054  sw          $v0, 0x54($a1) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 5), 84), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x34BAA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x34BAA0u, 0x34BD4Cu, 0x34BD54u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BD54u;
label_34bd54:
    ...
    ctx->pc = 0x34BD80u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BD7Cu;
    // 0x34bd80: 0x24450020  addiu       $a1, $v0, 0x20 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 2), 32));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20D6C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20D6C0u, 0x34BD7Cu, 0x34BD84u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BD84u;
label_34bd84:
    ...
    ctx->pc = 0x34BD98u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BD94u;
    // 0x34bd98: 0x24440078  addiu       $a0, $v0, 0x78 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 120));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20D850u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20D850u, 0x34BD94u, 0x34BD9Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BD9Cu;
label_34bd9c:
    ...
    ctx->pc = 0x34BDB0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BDACu;
    // 0x34bdb0: 0x24440098  addiu       $a0, $v0, 0x98 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 152));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20D850u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20D850u, 0x34BDACu, 0x34BDB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BDB4u;
label_34bdb4:
    ...
    ctx->pc = 0x34BDC8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x34BDC4u;
    // 0x34bdc8: 0x244400f8  addiu       $a0, $v0, 0xF8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 248));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20D850u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20D850u, 0x34BDC4u, 0x34BDCCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x34BDCCu;
label_34bdcc:
    ...
    ctx->pc = 0x34BDD8u;
    {
        ...
        ctx->pc = 0x34BDDCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x34BDD8u;
        // 0x34bddc: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x34BDD8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
