...
void sub_00230AA0_0x230aa0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x230AB0u;
    {
        ...
        ctx->pc = 0x230AB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x230AB0u;
...
label_230aec:
    ...
    ctx->pc = 0x230B04u;
    {
        ...
        ctx->pc = 0x230B08u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x230B04u;
...
label_230b14:
    ...
    ctx->pc = 0x230B28u;
    if (runtime->hasFunction(0x230B28u)) {
        auto targetFn = runtime->lookupFunction(0x230B28u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x230B1Cu; }
        if (ctx->pc != 0x230B1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00230B28_0x230b28(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x230B1Cu; }
        if (ctx->pc != 0x230B1Cu) { return; }
    }
    ctx->pc = 0x230B1Cu;
label_230b1c:
    ...
    ctx->pc = 0x230B20u;
    {
        ...
        ctx->pc = 0x230B24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x230B20u;
