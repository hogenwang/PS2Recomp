...
label_1ea6ac:
    ...
    ctx->pc = 0x1EA6ACu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EA6ACu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1ea708:
    ...
    ctx->pc = 0x1EA714u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1EA710u;
    // 0x1ea714: 0x7382b  sltu        $a3, $zero, $a3 (Delay Slot)
    SET_GPR_U64(ctx, 7, ((uint64_t)GPR_U64(ctx, 0) < (uint64_t)GPR_U64(ctx, 7)) ? 1 : 0);
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EA728u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EA728u, 0x1EA710u, 0x1EA718u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EA718u;
label_1ea718:
    ...
    ctx->pc = 0x1EA720u;
    {
        ...
        ctx->pc = 0x1EA724u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1EA720u;
        // 0x1ea724: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EA720u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
