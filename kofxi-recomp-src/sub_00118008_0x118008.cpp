...
label_118034:
    ...
    ctx->pc = 0x11804Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x11804Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x118054u;
    // NOP
    if (ctx->pc == 0x118054u) { ctx->pc = 0x118058u; }
}
