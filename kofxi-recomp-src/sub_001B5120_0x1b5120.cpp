...
void sub_001B5120_0x1b5120(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A99A0u;
    if (runtime->hasFunction(0x1A99A0u)) {
        auto targetFn = runtime->lookupFunction(0x1A99A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B5144u; }
        if (ctx->pc != 0x1B5144u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001A99A0_0x1a99a0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B5144u; }
        if (ctx->pc != 0x1B5144u) { return; }
    }
    ctx->pc = 0x1B5144u;
label_1b5144:
    ...
    ctx->pc = 0x1B5158u;
    ctx->pc = 0x1B515Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B5158u;
            // 0x1b515c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1A97B8u;
    {
        auto targetFn = runtime->lookupFunction(0x1A97B8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
