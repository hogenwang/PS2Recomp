...
void sub_001C7CC0_0x1c7cc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1C7CCCu;
    // 0x1c7cd0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C7A08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C7A08u, 0x1C7CCCu, 0x1C7CD4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C7CD4u;
label_1c7cd4:
    ...
    ctx->pc = 0x1C7CD8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C7CD4u;
    // 0x1c7cd8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C7CF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C7CF0u, 0x1C7CD4u, 0x1C7CDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C7CDCu;
label_1c7cdc:
    ...
    ctx->pc = 0x1c7cecu;
    // NOP
    if (ctx->pc == 0x1c7cecu) { ctx->pc = 0x1c7cf0u; }
}
