...
void sub_001DC470_0x1dc470(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1DC478u;
    {
        ...
        ctx->pc = 0x1DC47Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC478u;
...
label_1dc484:
    ...
    ctx->pc = 0x1DC48Cu;
    ctx->pc = 0x1DC490u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC48Cu;
            // 0x1dc490: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1D0118u;
    {
        auto targetFn = runtime->lookupFunction(0x1D0118u);
...
label_1dc498:
    ...
    ctx->pc = 0x1DC4A8u;
    ctx->pc = 0x1DC4ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC4A8u;
            // 0x1dc4ac: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1D0140u;
    {
        auto targetFn = runtime->lookupFunction(0x1D0140u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
