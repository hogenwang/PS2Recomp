...
void sub_00152B10_0x152b10(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x152B24u;
    {
        ...
        if (branch_taken_0x152b24) {
            ctx->pc = 0x152B28u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x152B24u;
    ...
    if (runtime->hasFunction(0x152AE0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x152B34u; }
        if (ctx->pc != 0x152B34u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_152b34:
    ...
    ctx->pc = 0x152B48u;
    {
        ...
        ctx->pc = 0x152B4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x152B48u;
...
label_152b9c:
    ...
    ctx->pc = 0x152C4Cu;
    {
        ...
        ctx->pc = 0x152C50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x152C4Cu;
