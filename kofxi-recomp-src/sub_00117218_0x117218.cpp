...
void sub_00117218_0x117218(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x117224u;
    // 0x117228: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD10u, 0x117224u, 0x11722Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x11722Cu;
label_11722c:
    ...
    ctx->pc = 0x11724Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x117248u;
    // 0x11724c: 0xafa30004  sw          $v1, 0x4($sp) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 29), 4), GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD00u, 0x117248u, 0x117250u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117250u;
label_117250:
    ...
    ctx->pc = 0x117254u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x117250u;
    // 0x117254: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD10u, 0x117250u, 0x117258u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117258u;
label_117258:
    ...
    ctx->pc = 0x11725Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x117258u;
    // 0x11725c: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD00u, 0x117258u, 0x117260u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117260u;
label_117260:
    ...
    ctx->pc = 0x117278u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x117278u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
