...
label_2192c0:
    ...
    ctx->pc = 0x2192D4u;
    ctx->pc = 0x2192D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2192D4u;
...
label_2192e0:
    ...
    ctx->pc = 0x2192F4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2192F0u;
...
label_219308:
    ...
    ctx->pc = 0x21932Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x219328u;
...
label_219330:
    ...
    ctx->pc = 0x219344u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x219348u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x219344u;
