...
void sub_001F0838_0x1f0838(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F084Cu;
    // 0x1f0850: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F5280u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F5280u, 0x1F084Cu, 0x1F0854u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F0854u;
label_1f0854:
...
label_1f0894:
    ...
    ctx->pc = 0x1f08a4u;
    // NOP
    if (ctx->pc == 0x1f08a4u) { ctx->pc = 0x1f08a8u; }
}
