...
void sub_001CE0F0_0x1ce0f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CE108u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE104u;
    ...
    if (runtime->hasFunction(0x1CDB48u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CE10Cu; }
        if (ctx->pc != 0x1CE10Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ce10c:
    ...
    ctx->pc = 0x1CE114u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE110u;
    ...
    if (runtime->hasFunction(0x1CE130u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001CE130_0x1ce130(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CE118u; }
        if (ctx->pc != 0x1CE118u) { return; }
    }
    ctx->pc = 0x1CE118u;
label_1ce118:
    ...
    ctx->pc = 0x1CE124u;
    ctx->pc = 0x1CE128u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE124u;
