...
void sub_00225FD8_0x225fd8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x225FF0u;
    {
        ...
        ctx->pc = 0x225FF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x225FF0u;
...
label_226024:
    ...
    ctx->pc = 0x226028u;
    {
        ...
        ctx->pc = 0x22602Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226028u;
...
label_226030:
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226050u; }
        if (ctx->pc != 0x226050u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001272D8_0x1272d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226050u; }
...
label_226050:
    ...
    ctx->pc = 0x22605Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x226060u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x22605Cu;
