...
void sub_001E2060_0x1e2060(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E20D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E20D8u, 0x1E2074u, 0x1E207Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E207Cu;
label_1e207c:
...
label_1e2088:
    ...
    ctx->pc = 0x1E20A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E20A0u, 0x1E2088u, 0x1E2090u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E2090u;
label_1e2090:
...
label_1e2094:
    ...
    ctx->pc = 0x1E2094u;
    {
        ...
        ctx->pc = 0x1E2098u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E2094u;
        // 0x1e2098: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E2094u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e209cu;
    // NOP
    if (ctx->pc == 0x1e209cu) { ctx->pc = 0x1e20a0u; }
}
