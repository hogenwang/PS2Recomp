...
void sub_002C0360_0x2c0360(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2831A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2831A8u, 0x2C0380u, 0x2C0388u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C0388u;
label_2c0388:
    ...
    ctx->pc = 0x2C038Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C038Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2c0394u;
    // NOP
    if (ctx->pc == 0x2c0394u) { ctx->pc = 0x2c0398u; }
}
