...
void sub_002262C0_0x2262c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2262F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2262ECu;
            // 0x2262f0: 0xffab0048  sd          $t3, 0x48($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 72), GPR_U64(ctx, 11));
        ctx->in_delay_slot = false;
    ctx->pc = 0x12E548u;
    if (runtime->hasFunction(0x12E548u)) {
        auto targetFn = runtime->lookupFunction(0x12E548u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0012E548_0x12e548(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2262F4u; }
        if (ctx->pc != 0x2262F4u) { return; }
    }
    ctx->pc = 0x2262F4u;
label_2262f4:
    ...
    ctx->pc = 0x2262F4u;
    {
        ...
        ctx->pc = 0x2262F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2262F4u;
    ...
    ctx->pc = 0x226304u;
    {
        ...
        ctx->pc = 0x226308u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226304u;
...
label_226310:
    ...
    ctx->pc = 0x226310u;
    {
        ...
        ctx->pc = 0x226314u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226310u;
    ...
    ctx->pc = 0x22631Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x226318u;
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x226320u; }
        if (ctx->pc != 0x226320u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_226320:
    ...
    ctx->pc = 0x22632Cu;
    {
        ...
        ctx->pc = 0x226330u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x22632Cu;
...
label_22633c:
    ...
    ctx->pc = 0x226344u;
    {
        ...
        ctx->pc = 0x226348u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226344u;
...
label_22634c:
    ...
    ctx->pc = 0x226350u;
    {
        ...
        ctx->pc = 0x226354u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x226350u;
