...
label_2b028c:
    ...
    ctx->pc = 0x2B0288u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2B0288u, 0x2B0290u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x2B0290u;
...
label_2b0298:
    ...
    ctx->pc = 0x2B0294u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2B0294u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2b029c:
    ...
    ctx->pc = 0x2b029cu;
    // NOP
    if (ctx->pc == 0x2b029cu) { ctx->pc = 0x2b02a0u; }
}
