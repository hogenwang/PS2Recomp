...
label_18b1a4:
    ...
    ctx->pc = 0x18B1A0u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x18B1A0u, 0x18B1A8u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x18B1A8u;
...
label_18b1e8:
    ...
    ctx->pc = 0x18B1E4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x18B1E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_18b1ec:
    ...
    ctx->pc = 0x18b1ecu;
    // NOP
    if (ctx->pc == 0x18b1ecu) { ctx->pc = 0x18b1f0u; }
}
