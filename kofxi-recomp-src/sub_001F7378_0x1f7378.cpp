...
void sub_001F7378_0x1f7378(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F7390u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F738Cu;
    ...
    if (runtime->hasFunction(0x1ED920u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7394u; }
        if (ctx->pc != 0x1F7394u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f7394:
    ...
    ctx->pc = 0x1F73A0u;
    {
        ...
        ctx->pc = 0x1F73A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F73A0u;
    ...
    ctx->pc = 0x1F73B4u;
    ctx->pc = 0x1F73B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F73B4u;
...
label_1f73c0:
    ...
    ctx->pc = 0x1F73C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F73C4u;
    ...
    if (runtime->hasFunction(0x1FAD00u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F73CCu; }
        if (ctx->pc != 0x1F73CCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f73cc:
    ...
    ctx->pc = 0x1F73DCu;
    {
        ...
        ctx->pc = 0x1F73E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F73DCu;
