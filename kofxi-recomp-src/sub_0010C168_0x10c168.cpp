...
void sub_0010C168_0x10c168(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10C188u;
    {
        ...
        ctx->pc = 0x10C18Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10C188u;
    ...
    ctx->pc = 0x10C19Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x10C198u;
    ...
    if (runtime->hasFunction(0x10A810u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x10C1A0u; }
        if (ctx->pc != 0x10C1A0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_10c1a0:
    ...
    ctx->pc = 0x10C1A0u;
    {
        ...
        ctx->pc = 0x10C1A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10C1A0u;
...
label_10c1a8:
    ...
    ctx->pc = 0x10C1ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x10C1A8u;
    ...
    if (runtime->hasFunction(0x10BFF0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0010BFF0_0x10bff0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x10C1B0u; }
        if (ctx->pc != 0x10C1B0u) { return; }
    }
    ctx->pc = 0x10C1B0u;
