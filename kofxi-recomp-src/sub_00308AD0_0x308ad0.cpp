...
label_308af0:
    ...
    ctx->pc = 0x308B08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x308B04u;
            // 0x308b08: 0x248447a0  addiu       $a0, $a0, 0x47A0 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 18336));
        ctx->in_delay_slot = false;
    ctx->pc = 0x308800u;
    if (runtime->hasFunction(0x308800u)) {
        auto targetFn = runtime->lookupFunction(0x308800u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x308B0Cu; }
        if (ctx->pc != 0x308B0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00308800_0x308800(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x308B0Cu; }
        if (ctx->pc != 0x308B0Cu) { return; }
    }
    ctx->pc = 0x308B0Cu;
label_308b0c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x308B18u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x308860u;
    if (runtime->hasFunction(0x308860u)) {
        auto targetFn = runtime->lookupFunction(0x308860u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00308860_0x308860(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x308B20u; }
        if (ctx->pc != 0x308B20u) { return; }
    }
    ctx->pc = 0x308B20u;
label_308b20:
    ...
    ctx->pc = 0x308B24u;
    {
        ...
        ctx->pc = 0x308B28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x308B24u;
...
label_308b30:
    ...
    if (runtime->hasFunction(0x3087C0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x308B3Cu; }
        if (ctx->pc != 0x308B3Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_308b58:
    ...
    ctx->pc = 0x308B60u;
    {
        ...
        ctx->pc = 0x308B64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x308B60u;
