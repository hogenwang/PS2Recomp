...
void sub_00294DA8_0x294da8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x294DACu;
    {
        ...
        ctx->pc = 0x294DB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x294DACu;
...
label_294dd0:
    ...
    ctx->pc = 0x294DE0u;
    {
        ...
        ctx->pc = 0x294DE4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x294DE0u;
    ...
    ctx->pc = 0x294DE8u;
    ctx->pc = 0x294DECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x294DE8u;
