...
void sub_001735D0_0x1735d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1735D0u;
    {
        ...
        if (branch_taken_0x1735d0) {
            ctx->pc = 0x1735D4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1735D0u;
...
label_1735f8:
    ...
    ctx->pc = 0x1735F8u;
    {
        ...
        if (branch_taken_0x1735f8) {
            ctx->pc = 0x1735FCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1735F8u;
    ...
    ctx->pc = 0x173608u;
    {
        ...
        if (branch_taken_0x173608) {
            ctx->pc = 0x17360Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x173608u;
...
label_173618:
    ...
    ctx->pc = 0x173624u;
    {
        ...
        ctx->pc = 0x173628u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x173624u;
