...
label_1eb5cc:
    ...
    ctx->pc = 0x1EB5CCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EB5CCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1eb5d4u;
    // NOP
    if (ctx->pc == 0x1eb5d4u) { ctx->pc = 0x1eb5d8u; }
}
