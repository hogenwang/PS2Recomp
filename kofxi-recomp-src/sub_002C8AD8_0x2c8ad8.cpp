...
label_2c8af8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2C8BB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2C8BB0u, 0x2C8AF4u, 0x2C8AFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C8AFCu;
label_2c8afc:
...
label_2c8b08:
    ...
    ctx->pc = 0x2C8B04u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C8B04u, 0x2C8B0Cu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x2C8B0Cu;
...
label_2c8b28:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2CF288u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2CF288u, 0x2C8B24u, 0x2C8B2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C8B2Cu;
label_2c8b2c:
...
label_2c8b6c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2C8BB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2C8BB0u, 0x2C8B68u, 0x2C8B70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C8B70u;
label_2c8b70:
...
label_2c8b7c:
    ...
    ctx->pc = 0x2C8B78u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C8B78u, 0x2C8B80u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x2C8B80u;
...
label_2c8b94:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2CF358u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2CF358u, 0x2C8B90u, 0x2C8B98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C8B98u;
label_2c8b98:
...
label_2c8bac:
    ...
    ctx->pc = 0x2C8BA8u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C8BA8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
