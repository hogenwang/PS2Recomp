...
label_1e00a8:
    ...
    ctx->pc = 0x1E00D4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E00D4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e00dcu;
    // NOP
    if (ctx->pc == 0x1e00dcu) { ctx->pc = 0x1e00e0u; }
}
