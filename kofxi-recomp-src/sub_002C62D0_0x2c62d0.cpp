...
void sub_002C62D0_0x2c62d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2C62F8u;
    {
        ...
        ctx->pc = 0x2C62FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C62F8u;
    ...
    if (runtime->hasFunction(0x2D82E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C6308u; }
        if (ctx->pc != 0x2C6308u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c6314:
    ...
    if (runtime->hasFunction(0x2D7CA0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C6324u; }
        if (ctx->pc != 0x2C6324u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c6340:
    ...
    ctx->pc = 0x2C6350u;
    {
        ...
        ctx->pc = 0x2C6354u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C6350u;
