...
label_261ca8:
    ...
    ctx->pc = 0x261CB4u;
    {
        ...
        if (branch_taken_0x261cb4) {
            ctx->pc = 0x261CB8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x261CB4u;
    ...
    ctx->pc = 0x261CBCu;
    {
        ...
        if (branch_taken_0x261cbc) {
            ctx->pc = 0x261CC0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x261CBCu;
...
label_261cc4:
    ...
    ctx->pc = 0x261CC4u;
    {
        ...
        ctx->pc = 0x261CC8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261CC4u;
...
label_261ccc:
    ...
    ctx->pc = 0x261CCCu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x261CD0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x261CCCu;
