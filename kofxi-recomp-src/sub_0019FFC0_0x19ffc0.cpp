...
label_1a0084:
    ...
    ctx->pc = 0x1A00F0u;
    {
        ...
        ctx->pc = 0x1A00F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A00F0u;
...
label_1a0130:
    ...
    ctx->pc = 0x1A0178u;
    {
        ...
        ctx->pc = 0x1A017Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A0178u;
    ...
    ctx->pc = 0x1A0194u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A0190u;
    ...
    if (runtime->hasFunction(0x19FE60u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A0198u; }
        if (ctx->pc != 0x1A0198u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a0198:
    ...
    ctx->pc = 0x1A019Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A0198u;
    ...
    if (runtime->hasFunction(0x19FF00u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A01A0u; }
        if (ctx->pc != 0x1A01A0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a01a0:
    ...
    ctx->pc = 0x1A01B0u;
    {
        ...
        ctx->pc = 0x1A01B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A01B0u;
