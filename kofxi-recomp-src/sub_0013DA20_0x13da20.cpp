...
void sub_0013DA20_0x13da20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13DA40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13DA3Cu;
    ...
    if (runtime->hasFunction(0x18A010u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DA44u; }
        if (ctx->pc != 0x13DA44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13da44:
    ...
    ctx->pc = 0x13DA48u;
    {
        ...
        if (branch_taken_0x13da48) {
            ctx->pc = 0x13DA4Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13DA48u;
...
label_13da58:
    ...
    ctx->pc = 0x13DA64u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13DA60u;
    ...
    if (runtime->hasFunction(0x18DC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DA68u; }
        if (ctx->pc != 0x13DA68u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13da68:
    ...
    ctx->pc = 0x13DA68u;
    {
        ...
        if (branch_taken_0x13da68) {
            ctx->pc = 0x13DA6Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13DA68u;
    ...
    ctx->pc = 0x13DA70u;
    {
        ...
        ctx->pc = 0x13DA74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13DA70u;
...
label_13da78:
    ...
    ctx->pc = 0x13DAA0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13DA9Cu;
            // 0x13daa0: 0x23840  sll         $a3, $v0, 1 (Delay Slot)
        SET_GPR_S32(ctx, 7, (int32_t)SLL32(GPR_U32(ctx, 2), 1));
        ctx->in_delay_slot = false;
    ctx->pc = 0x13E8B0u;
    if (runtime->hasFunction(0x13E8B0u)) {
        auto targetFn = runtime->lookupFunction(0x13E8B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DAA4u; }
        if (ctx->pc != 0x13DAA4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0013E8B0_0x13e8b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DAA4u; }
        if (ctx->pc != 0x13DAA4u) { return; }
    }
    ctx->pc = 0x13DAA4u;
label_13daa4:
    ...
    ctx->pc = 0x13DAB0u;
    {
        ...
        ctx->pc = 0x13DAB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13DAB0u;
...
label_13dab8:
    ...
    ctx->pc = 0x13DAC8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13DAC4u;
    ...
    if (runtime->hasFunction(0x12EFB0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DACCu; }
        if (ctx->pc != 0x13DACCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13dacc:
    ...
    if (runtime->hasFunction(0x13DC70u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DADCu; }
        if (ctx->pc != 0x13DADCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13dadc:
    ...
    ctx->pc = 0x13DAF0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13DAECu;
    ...
    if (runtime->hasFunction(0x18DC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DAF4u; }
        if (ctx->pc != 0x13DAF4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0018DC80_0x18dc80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13DAF4u; }
...
label_13daf4:
    ...
    ctx->pc = 0x13DAF4u;
    {
        ...
        if (branch_taken_0x13daf4) {
            ctx->pc = 0x13DAF8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13DAF4u;
    ...
    ctx->pc = 0x13DAFCu;
    {
        ...
        ctx->pc = 0x13DB00u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13DAFCu;
...
label_13db28:
    ...
    ctx->pc = 0x13DB44u;
    {
        ...
        ctx->pc = 0x13DB48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13DB44u;
...
label_13db54:
    ...
    ctx->pc = 0x13DB68u;
    {
        ...
        ctx->pc = 0x13DB6Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13DB68u;
