...
void sub_002DCE38_0x2dce38(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x2dced8u: goto label_2dced8;
        case 0x2dcee8u: goto label_2dcee8;
        case 0x2dcef8u: goto label_2dcef8;
        case 0x2dcf0cu: goto label_2dcf0c;
        case 0x2dcf24u: goto label_2dcf24;
        case 0x2dcf44u: goto label_2dcf44;
    ...
    ctx->pc = 0x2DCE78u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCE74u;
    ...
    if (runtime->hasFunction(0x2D8FC0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCE7Cu; }
        if (ctx->pc != 0x2DCE7Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dce7c:
    ...
    ctx->pc = 0x2DCE8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCE88u;
            // 0x2dce8c: 0xdd54c2d7  ld          $s4, -0x3D29($t2) (Delay Slot)
        SET_GPR_U64(ctx, 20, READ64(ADD32(GPR_U32(ctx, 10), 4294951639)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x33AEEB0u;
    {
        auto targetFn = runtime->lookupFunction(0x33AEEB0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCE90u; }
        if (ctx->pc != 0x2DCE90u) { return; }
    }
    ctx->pc = 0x2DCE90u;
label_2dce90:
...
label_2dceb0:
    ...
    ctx->pc = 0x2DCEB4u;
    {
        ...
        if (branch_taken_0x2dceb4) {
            ctx->pc = 0x2DCEB8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCEB4u;
    ...
    ctx->pc = 0x2DCEC0u;
    {
        ...
        if (branch_taken_0x2dcec0) {
            ctx->pc = 0x2DCEC4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCEC0u;
...
label_2dced8:
    ...
    ctx->pc = 0x2DCEE0u;
    ctx->pc = 0x2DCEE4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCEE0u;
...
label_2dcee8:
    ...
    ctx->pc = 0x2DCEF0u;
    ctx->pc = 0x2DCEF4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCEF0u;
...
label_2dcef8:
    ...
    ctx->pc = 0x2DCEF8u;
    {
        ...
        if (branch_taken_0x2dcef8) {
            ctx->pc = 0x2DCEFCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCEF8u;
...
label_2dcf24:
    ...
    ctx->pc = 0x2DCF28u;
    {
        ...
        if (branch_taken_0x2dcf28) {
            ctx->pc = 0x2DCF2Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCF28u;
    ...
    ctx->pc = 0x2DCF34u;
    {
        ...
        if (branch_taken_0x2dcf34) {
            ctx->pc = 0x2DCF38u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCF34u;
...
label_2dcf6c:
    ...
    ctx->pc = 0x2DCF88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCF84u;
    ...
    if (runtime->hasFunction(0x2D8FC0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCF8Cu; }
        if (ctx->pc != 0x2DCF8Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002D8FC0_0x2d8fc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCF8Cu; }
