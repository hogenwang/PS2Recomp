...
void sub_001A5130_0x1a5130(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A5150u;
    {
        ...
        ctx->pc = 0x1A5154u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A5150u;
...
label_1a516c:
    ...
    ctx->pc = 0x1A5170u;
    {
        ...
        if (branch_taken_0x1a5170) {
            ctx->pc = 0x1A5174u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1A5170u;
...
label_1a51a4:
    ...
    ctx->pc = 0x1A51BCu;
    {
        ...
        ctx->pc = 0x1A51C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A51BCu;
...
label_1a51d0:
    ...
    ctx->pc = 0x1A51E0u;
    {
        ...
        ctx->pc = 0x1A51E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A51E0u;
