...
label_1e97ec:
    ...
    ctx->pc = 0x1E97F8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E97F4u;
    // 0x1e97f8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E9850u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E9850u, 0x1E97F4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E97FCu;
    // 0x1e97fc: 0x0  nop
...
label_1e9800:
    ...
    ctx->pc = 0x1E9800u;
    {
        ...
        ctx->pc = 0x1E9804u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E9800u;
        // 0x1e9804: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E9800u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
