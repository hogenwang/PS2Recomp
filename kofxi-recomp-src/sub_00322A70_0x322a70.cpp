...
label_322a8c:
    ...
    ctx->pc = 0x322A9Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x322A98u;
    ...
    if (runtime->hasFunction(0x18F420u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x322AA0u; }
        if (ctx->pc != 0x322AA0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_322ab0:
    ...
    ctx->pc = 0x322AB8u;
    {
        ...
        ctx->pc = 0x322ABCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322AB8u;
    ...
    ctx->pc = 0x322ACCu;
    {
        ...
        ctx->pc = 0x322AD0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322ACCu;
