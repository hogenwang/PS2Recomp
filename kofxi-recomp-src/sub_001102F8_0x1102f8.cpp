...
void sub_001102F8_0x1102f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x1103a4u: goto label_1103a4;
        default: break;
    }
    ...
    ctx->pc = 0x110300u;
    {
        ...
        ctx->pc = 0x110304u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x110300u;
    ...
    ctx->pc = 0x110324u;
    {
        ...
        ctx->pc = 0x110328u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x110324u;
...
// In recompiled code, we don't need explicit memory barriers
    ...
    ctx->pc = 0x110394u;
    {
        ...
        ctx->pc = 0x110398u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x110394u;
