...
label_1eb7f4:
    ...
    ctx->pc = 0x1EB7F0u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EB7F0u, 0x1EB7F8u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1EB7F8u;
...
label_1eb810:
    ...
    ctx->pc = 0x1EB80Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EB80Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1eb814:
    ...
    ctx->pc = 0x1eb814u;
    // NOP
    if (ctx->pc == 0x1eb814u) { ctx->pc = 0x1eb818u; }
}
