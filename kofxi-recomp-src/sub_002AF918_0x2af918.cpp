...
void sub_002AF918_0x2af918(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2AF928u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2AF924u;
    ...
    if (runtime->hasFunction(0x2A2FD8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2AF92Cu; }
        if (ctx->pc != 0x2AF92Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2af92c:
    ...
    ctx->pc = 0x2AF94Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2AF948u;
    ...
    if (runtime->hasFunction(0x295920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2AF950u; }
        if (ctx->pc != 0x2AF950u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2af978:
    ...
    ctx->pc = 0x2AF980u;
    {
        ...
        ctx->pc = 0x2AF984u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2AF980u;
