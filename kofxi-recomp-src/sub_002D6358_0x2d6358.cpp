...
void sub_002D6358_0x2d6358(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D635Cu;
    {
        ...
        ctx->pc = 0x2D6360u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D635Cu;
...
label_2d6378:
    ...
    ctx->pc = 0x2D637Cu;
    {
        ...
        ctx->pc = 0x2D6380u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D637Cu;
    ...
    ctx->pc = 0x2D6394u;
    {
        ...
        if (branch_taken_0x2d6394) {
            ctx->pc = 0x2D6398u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2D6394u;
...
label_2d639c:
    ...
    ctx->pc = 0x2D63B8u;
    {
        ...
        ctx->pc = 0x2D63BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D63B8u;
...
label_2d63c0:
    ...
    ctx->pc = 0x2D63D4u;
    {
        ...
        ctx->pc = 0x2D63D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D63D4u;
