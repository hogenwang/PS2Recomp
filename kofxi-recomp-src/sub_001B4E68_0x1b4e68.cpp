...
void sub_001B4E68_0x1b4e68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B4E7Cu;
    {
        ...
        ctx->pc = 0x1B4E80u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4E7Cu;
    ...
    ctx->pc = 0x1AB190u;
    if (runtime->hasFunction(0x1AB190u)) {
        auto targetFn = runtime->lookupFunction(0x1AB190u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B4E8Cu; }
        if (ctx->pc != 0x1B4E8Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001AB190_0x1ab190(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B4E8Cu; }
        if (ctx->pc != 0x1B4E8Cu) { return; }
    }
    ctx->pc = 0x1B4E8Cu;
label_1b4e8c:
    ...
    ctx->pc = 0x1B4E9Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4E98u;
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B4EA0u; }
        if (ctx->pc != 0x1B4EA0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b4ea0:
    ...
    ctx->pc = 0x1B4EB4u;
    {
        ...
        ctx->pc = 0x1B4EB8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4EB4u;
