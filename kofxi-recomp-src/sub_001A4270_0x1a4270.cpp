...
label_1a42bc:
    ...
    ctx->pc = 0x1A42C4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A42C0u;
    ...
    if (runtime->hasFunction(0x129E28u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A42C8u; }
        if (ctx->pc != 0x1A42C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a42c8:
    ...
    ctx->pc = 0x1A42E8u;
    {
        ...
        ctx->pc = 0x1A42ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A42E8u;
...
label_1a42f0:
    ...
    ctx->pc = 0x1A42F4u;
    {
        ...
        ctx->pc = 0x1A42F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A42F4u;
