...
void sub_0025CEE8_0x25cee8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x25CF14u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF10u;
    ...
    if (runtime->hasFunction(0x25CA38u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CF18u; }
        if (ctx->pc != 0x25CF18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25cf18:
    ...
    ctx->pc = 0x25CF1Cu;
    {
        ...
        ctx->pc = 0x25CF20u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF1Cu;
    ...
    if (runtime->hasFunction(0x231A08u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CF2Cu; }
        if (ctx->pc != 0x25CF2Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25cf2c:
    ...
    ctx->pc = 0x25CF30u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF2Cu;
    ...
    if (runtime->hasFunction(0x2302D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CF34u; }
        if (ctx->pc != 0x25CF34u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25cf34:
    ...
    ctx->pc = 0x25CF38u;
    {
        ...
        ctx->pc = 0x25CF3Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF38u;
...
label_25cf48:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF50u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x22DDB8u;
    if (runtime->hasFunction(0x22DDB8u)) {
        auto targetFn = runtime->lookupFunction(0x22DDB8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0022DDB8_0x22ddb8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CF58u; }
        if (ctx->pc != 0x25CF58u) { return; }
    }
    ctx->pc = 0x25CF58u;
label_25cf58:
    ...
    ctx->pc = 0x25CF5Cu;
    {
        ...
        ctx->pc = 0x25CF60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF5Cu;
...
label_25cf68:
    ...
    ctx->pc = 0x25CF6Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF68u;
    ...
    if (runtime->hasFunction(0x231A60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CF70u; }
        if (ctx->pc != 0x25CF70u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25cf70:
    ...
    ctx->pc = 0x25CF78u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF74u;
    ...
    if (runtime->hasFunction(0x25CB68u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CF7Cu; }
        if (ctx->pc != 0x25CF7Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25cf7c:
    ...
    ctx->pc = 0x25CF7Cu;
    {
        ...
        ctx->pc = 0x25CF80u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF7Cu;
    ...
    ctx->pc = 0x25CF84u;
    {
        ...
        ctx->pc = 0x25CF88u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CF84u;
...
label_25cf90:
    ...
    ctx->pc = 0x25CFACu;
    {
        ...
        ctx->pc = 0x25CFB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CFACu;
