...
void sub_001A6158_0x1a6158(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A616Cu;
    {
        ...
        ctx->pc = 0x1A6170u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A616Cu;
...
label_1a6174:
    ...
    ctx->pc = 0x1A6178u;
    {
        ...
        ctx->pc = 0x1A617Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A6178u;
...
label_1a6180:
    ...
    ctx->pc = 0x1A6188u;
    {
        ...
        if (branch_taken_0x1a6188) {
            ctx->pc = 0x1A618Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1A6188u;
...
label_1a619c:
    ...
    ctx->pc = 0x1A61A0u;
    {
        ...
        ctx->pc = 0x1A61A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A61A0u;
...
label_1a61d4:
    ...
    ctx->pc = 0x1A6220u;
    {
        ...
        ctx->pc = 0x1A6224u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A6220u;
...
label_1a62d8:
    ...
    ctx->pc = 0x1A62DCu;
    {
        ...
        ctx->pc = 0x1A62E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A62DCu;
    ...
    ctx->pc = 0x1A6304u;
    {
        ...
        ctx->pc = 0x1A6308u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A6304u;
