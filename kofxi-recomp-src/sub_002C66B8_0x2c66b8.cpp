...
label_2c66d0:
    ...
    ctx->pc = 0x2C66CCu;
    {
        ...
        ctx->pc = 0x2C66D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C66CCu;
            // 0x2c66d0: 0x8c840020  lw          $a0, 0x20($a0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 32)));
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x2C66D4u; }
            if (ctx->pc != 0x2C66D4u) { return; }
        }
        }
    }
    ctx->pc = 0x2C66D4u;
...
label_2c66f8:
    ...
    ctx->pc = 0x2C66F4u;
    {
        ...
        ctx->pc = 0x2C66F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C66F4u;
            // 0x2c66f8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
