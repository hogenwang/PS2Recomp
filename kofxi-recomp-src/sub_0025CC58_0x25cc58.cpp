...
void sub_0025CC58_0x25cc58(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x25CC74u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CC70u;
...
label_25cc78:
    ...
    ctx->pc = 0x25CC80u;
    {
        ...
        ctx->pc = 0x25CC84u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25CC80u;
...
label_25cc90:
    ...
    ctx->pc = 0x25CCA4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CCA0u;
    ...
    if (runtime->hasFunction(0x10CC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25CCA8u; }
        if (ctx->pc != 0x25CCA8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25cca8:
    ...
    ctx->pc = 0x25CCACu;
    {
        ...
        if (branch_taken_0x25ccac) {
            ctx->pc = 0x25CCB0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x25CCACu;
...
label_25ccb4:
    ...
    ctx->pc = 0x25CCC8u;
    ctx->pc = 0x25CCCCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25CCC8u;
