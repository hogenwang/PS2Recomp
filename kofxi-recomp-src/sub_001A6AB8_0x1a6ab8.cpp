...
label_1a6ae4:
    ...
    ctx->pc = 0x1A6AFCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A6AFCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a6b04u;
    // NOP
    if (ctx->pc == 0x1a6b04u) { ctx->pc = 0x1a6b08u; }
}
