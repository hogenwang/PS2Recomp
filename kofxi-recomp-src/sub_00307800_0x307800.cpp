...
label_307860:
    ...
    ctx->pc = 0x307860u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x307860u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x30786cu;
    // NOP
    if (ctx->pc == 0x30786cu) { ctx->pc = 0x307870u; }
}
