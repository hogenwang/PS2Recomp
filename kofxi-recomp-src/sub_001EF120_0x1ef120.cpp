...
void sub_001EF120_0x1ef120(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1EF138u;
    // 0x1ef13c: 0x24120001  addiu       $s2, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 18, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EF1A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EF1A8u, 0x1EF138u, 0x1EF140u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EF140u;
label_1ef140:
    ...
    ctx->pc = 0x1EF150u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1EF14Cu;
    // 0x1ef150: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EB570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EB570u, 0x1EF14Cu, 0x1EF154u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EF154u;
label_1ef154:
    ...
    ctx->pc = 0x1EF2D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EF2D8u, 0x1EF160u, 0x1EF168u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EF168u;
label_1ef168:
    ...
    ctx->pc = 0x1EF188u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1EF184u;
    // 0x1ef188: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EF238u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EF238u, 0x1EF184u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1EF18Cu;
    // 0x1ef18c: 0x0  nop
...
label_1ef190:
    ...
    ctx->pc = 0x1EF1A0u;
    {
        ...
        ctx->pc = 0x1EF1A4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1EF1A0u;
        // 0x1ef1a4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EF1A0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
