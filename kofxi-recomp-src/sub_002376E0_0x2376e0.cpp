...
void sub_002376E0_0x2376e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2376E0u;
    {
        ...
        ctx->pc = 0x2376E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2376E0u;
    ...
    ctx->pc = 0x2376E8u;
    {
        ...
        ctx->pc = 0x2376ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2376E8u;
...
label_2376f0:
    ...
    ctx->pc = 0x2376F8u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2376FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2376F8u;
...
label_237700:
    ...
    ctx->pc = 0x237704u;
    {
        ...
        ctx->pc = 0x237708u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x237704u;
...
label_237710:
    ...
    ctx->pc = 0x237710u;
    {
        ...
        if (branch_taken_0x237710) {
            ctx->pc = 0x237714u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x237710u;
...
label_237728:
    ...
    ctx->pc = 0x237728u;
    {
        ...
        if (branch_taken_0x237728) {
            ctx->pc = 0x23772Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x237728u;
...
label_237730:
    ...
    ctx->pc = 0x237730u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x237734u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x237730u;
