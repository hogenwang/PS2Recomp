...
void sub_002F2178_0x2f2178(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2F21A8u;
    // 0x2f21ac: 0x8e2400bc  lw          $a0, 0xBC($s1) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 17), 188)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F21A8u, 0x2F21B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F21B0u;
label_2f21b0:
...
label_2f21d0:
    ...
    ctx->pc = 0x2F21DCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F21D8u;
    // 0x2f21dc: 0x8c46000c  lw          $a2, 0xC($v0) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 12)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F21D8u, 0x2F21E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F21E0u;
label_2f21e0:
...
label_2f2208:
    ...
    ctx->pc = 0x2F2220u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F221Cu;
    // 0x2f2220: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F221Cu, 0x2F2224u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2224u;
label_2f2224:
    ...
    ctx->pc = 0x2F223Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2238u;
    // 0x2f223c: 0x24c61be8  addiu       $a2, $a2, 0x1BE8 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 7144));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F2238u, 0x2F2240u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2240u;
label_2f2240:
...
label_2f2268:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F227Cu, 0x2F2284u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2284u;
label_2f2284:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F2298u, 0x2F22A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F22A0u;
label_2f22a0:
...
label_2f22c8:
    ...
    ctx->pc = 0x2F22E0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F22DCu;
    // 0x2f22e0: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F22DCu, 0x2F22E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F22E4u;
label_2f22e4:
    ...
    ctx->pc = 0x2F22FCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F22F8u;
    // 0x2f22fc: 0x24c61c20  addiu       $a2, $a2, 0x1C20 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 7200));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F22F8u, 0x2F2300u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2300u;
label_2f2300:
...
label_2f2328:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F2340u, 0x2F2348u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2348u;
label_2f2348:
...
label_2f2360:
    ...
    ctx->pc = 0x2F2370u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F236Cu;
    // 0x2f2370: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F236Cu, 0x2F2374u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2374u;
label_2f2374:
...
label_2f2398:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F23B0u, 0x2F23B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F23B8u;
label_2f23b8:
    ...
    ctx->pc = 0x2F1EC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1EC8u, 0x2F23CCu, 0x2F23D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F23D4u;
label_2f23d4:
    ...
    ctx->pc = 0x2F6510u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F6510u, 0x2F23E4u, 0x2F23ECu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F23ECu;
label_2f23ec:
...
label_2f2400:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F66C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F66C0u, 0x2F2418u, 0x2F2420u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2420u;
label_2f2420:
...
label_2f2440:
    ...
    ctx->pc = 0x2F2448u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2444u;
    // 0x2f2448: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F2444u, 0x2F244Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F244Cu;
label_2f244c:
    ...
    ctx->pc = 0x2F2454u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2450u;
    // 0x2f2454: 0x240202d  daddu       $a0, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F9178u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F9178u, 0x2F2450u, 0x2F2458u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2458u;
label_2f2458:
...
label_2f24b0:
    ...
    ctx->pc = 0x2F24BCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F24B8u;
    // 0x2f24bc: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F24B8u, 0x2F24C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F24C0u;
label_2f24c0:
    ...
    ctx->pc = 0x2F24E4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F24E0u;
    // 0x2f24e4: 0x24c61ca0  addiu       $a2, $a2, 0x1CA0 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 7328));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F24E0u, 0x2F24E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F24E8u;
label_2f24e8:
...
label_2f2510:
    ...
    ctx->pc = 0x2F251Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2518u;
    // 0x2f251c: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F2518u, 0x2F2520u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2520u;
label_2f2520:
    ...
    ctx->pc = 0x2F2534u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2530u;
    // 0x2f2534: 0x24060010  addiu       $a2, $zero, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1272D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1272D8u, 0x2F2530u, 0x2F2538u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2538u;
label_2f2538:
    ...
    ctx->pc = 0x2F254Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2548u;
    // 0x2f254c: 0x24050010  addiu       $a1, $zero, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F890u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F890u, 0x2F2548u, 0x2F2550u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2550u;
label_2f2550:
    ...
    ctx->pc = 0x2F255Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2558u;
    // 0x2f255c: 0x3a0302d  daddu       $a2, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5570u, 0x2F2558u, 0x2F2560u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F2560u;
label_2f2560:
...
label_2f2588:
    ...
    ctx->pc = 0x2F25A8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F25A4u;
    // 0x2f25a8: 0x24a51ce0  addiu       $a1, $a1, 0x1CE0 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 7392));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F1F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F1F08u, 0x2F25A4u, 0x2F25ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F25ACu;
label_2f25ac:
    ...
    ctx->pc = 0x2F25C0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F25BCu;
    // 0x2f25c0: 0x24a51cf0  addiu       $a1, $a1, 0x1CF0 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 7408));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F6790u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F6790u, 0x2F25BCu, 0x2F25C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F25C4u;
label_2f25c4:
...
label_2f2600:
    ...
    ctx->pc = 0x2F2608u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F2604u;
    // 0x2f2608: 0xae000000  sw          $zero, 0x0($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 0), GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F5650u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F5650u, 0x2F2604u, 0x2F260Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F260Cu;
label_2f260c:
...
label_2f2610:
    ...
    ctx->pc = 0x2F2624u;
    {
        ...
        ctx->pc = 0x2F2628u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F2624u;
        // 0x2f2628: 0x27bd0060  addiu       $sp, $sp, 0x60 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 96));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F2624u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2f262cu;
    // NOP
    if (ctx->pc == 0x2f262cu) { ctx->pc = 0x2f2630u; }
}
