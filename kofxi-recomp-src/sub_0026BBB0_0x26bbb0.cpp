...
void sub_0026BBB0_0x26bbb0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x26BBC0u;
    {
        ...
        ctx->pc = 0x26BBC4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26BBC0u;
    ...
    ctx->pc = 0x26BBC8u;
    {
        ...
        ctx->pc = 0x26BBCCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26BBC8u;
...
label_26bbf0:
    ...
    if (runtime->hasFunction(0x228950u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x26BBF8u; }
        if (ctx->pc != 0x26BBF8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_26bbf8:
    ...
    ctx->pc = 0x26BBFCu;
    {
        ...
        ctx->pc = 0x26BC00u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26BBFCu;
