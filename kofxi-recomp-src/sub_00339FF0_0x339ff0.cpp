...
void sub_00339FF0_0x339ff0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x33A028u;
    {
        ...
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x33A028u, 0x0u, PS2Runtime::GuestBranchKind::IndirectJump, "JR")) {
            return;
        }
    }
    ctx->pc = 0x33A030u;
...
label_33a20c:
    ...
    ctx->pc = 0x33A20Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x33A20Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x33a21cu;
    // NOP
    if (ctx->pc == 0x33a21cu) { ctx->pc = 0x33a220u; }
}
