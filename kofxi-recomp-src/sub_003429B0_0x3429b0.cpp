...
void sub_003429B0_0x3429b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x3429C8u;
    // 0x3429cc: 0xa0802d  daddu       $s0, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20A360u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20A360u, 0x3429C8u, 0x3429D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3429D0u;
label_3429d0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x20A360u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20A360u, 0x3429D4u, 0x3429DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3429DCu;
label_3429dc:
...
label_342a24:
    ...
    ctx->pc = 0x342A34u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x342A34u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x342a3cu;
    // NOP
    if (ctx->pc == 0x342a3cu) { ctx->pc = 0x342a40u; }
}
