...
label_281be0:
    ...
    ctx->pc = 0x281C00u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x281BFCu;
    ...
    if (runtime->hasFunction(0x295920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x281C04u; }
        if (ctx->pc != 0x281C04u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_281c1c:
    ...
    ctx->pc = 0x281C24u;
    {
        ...
        ctx->pc = 0x281C28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x281C24u;
