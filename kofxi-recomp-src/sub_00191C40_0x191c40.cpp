...
void sub_00191C40_0x191c40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x191C50u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x191C4Cu;
    ...
    if (runtime->hasFunction(0x323980u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x191C54u; }
        if (ctx->pc != 0x191C54u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_191c54:
    ...
    if (runtime->hasFunction(0x323890u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x191C64u; }
        if (ctx->pc != 0x191C64u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_191c64:
    ...
    ctx->pc = 0x191C68u;
    {
        ...
        ctx->pc = 0x191C6Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x191C68u;
