...
// Function: sub_001CE440
// Address: 0x1ce440 - 0x1ce5b8
void sub_001CE440_0x1ce440(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_001CE440_0x1ce440");
#endif
...
label_1ce450:
    ...
    ctx->pc = 0x1CE44Cu;
    {
        ...
        ctx->pc = 0x1CE450u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE44Cu;
            // 0x1ce450: 0xac440000  sw          $a0, 0x0($v0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 2), 0), GPR_U32(ctx, 4));
...
label_1ce4c4:
    ...
    ctx->pc = 0x1CE4C0u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x1CE4C8u; }
            if (ctx->pc != 0x1CE4C8u) { return; }
        }
        }
    }
    ctx->pc = 0x1CE4C8u;
...
label_1ce518:
    ...
    ctx->pc = 0x1CE514u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1CE518u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE514u;
            // 0x1ce518: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_1ce534:
    ...
    ctx->pc = 0x1CE530u;
    {
        ...
        ctx->pc = 0x1CE534u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE530u;
            // 0x1ce534: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_1ce54c:
    ...
    ctx->pc = 0x1CE548u;
    {
        ...
        if (branch_taken_0x1ce548) {
            ctx->pc = 0x1CE54Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE548u;
            // 0x1ce54c: 0x410c0  sll         $v0, $a0, 3 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)SLL32(GPR_U32(ctx, 4), 3));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1CE568u;
...
label_1ce55c:
    ...
    if (runtime->hasFunction(0x1CDD20u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CE560u; }
        if (ctx->pc != 0x1CE560u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ce594:
    ...
    ctx->pc = 0x1CE590u;
    {
        ...
        if (branch_taken_0x1ce590) {
            ctx->pc = 0x1CE594u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE590u;
            // 0x1ce594: 0xc0102d  daddu       $v0, $a2, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1CE5A8u;
...
label_1ce5b0:
    ...
    ctx->pc = 0x1CE5ACu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1CE5B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CE5ACu;
            // 0x1ce5b0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
