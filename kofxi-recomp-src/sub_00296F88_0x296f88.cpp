...
void sub_00296F88_0x296f88(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x296FA4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296FA0u;
            // 0x296fa4: 0xffb10010  sd          $s1, 0x10($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 16), GPR_U64(ctx, 17));
        ctx->in_delay_slot = false;
    ctx->pc = 0x296BC8u;
    if (runtime->hasFunction(0x296BC8u)) {
        auto targetFn = runtime->lookupFunction(0x296BC8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FA8u; }
        if (ctx->pc != 0x296FA8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00296BC8_0x296bc8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FA8u; }
        if (ctx->pc != 0x296FA8u) { return; }
    }
    ctx->pc = 0x296FA8u;
label_296fa8:
    ...
    ctx->pc = 0x296FB0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296FACu;
    ...
    if (runtime->hasFunction(0x29A7C0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FB4u; }
        if (ctx->pc != 0x296FB4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_296fb4:
    ...
    ctx->pc = 0x296FC4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296FC0u;
    ...
    if (runtime->hasFunction(0x299FC0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FC8u; }
        if (ctx->pc != 0x296FC8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_296fc8:
    ...
    ctx->pc = 0x296FD4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296FD0u;
            // 0x296fd4: 0x240202d  daddu       $a0, $s2, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x29A878u;
    if (runtime->hasFunction(0x29A878u)) {
        auto targetFn = runtime->lookupFunction(0x29A878u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FD8u; }
        if (ctx->pc != 0x296FD8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0029A878_0x29a878(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FD8u; }
        if (ctx->pc != 0x296FD8u) { return; }
    }
    ctx->pc = 0x296FD8u;
label_296fd8:
    ...
    ctx->pc = 0x296FE4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296FE0u;
    ...
    if (runtime->hasFunction(0x299FC0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FE8u; }
        if (ctx->pc != 0x296FE8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00299FC0_0x299fc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FE8u; }
...
label_296fe8:
    ...
    ctx->pc = 0x296FECu;
    {
        ...
        ctx->pc = 0x296FF0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x296FECu;
    ...
    ctx->pc = 0x296FF8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296FF4u;
            // 0x296ff8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x296BD0u;
    if (runtime->hasFunction(0x296BD0u)) {
        auto targetFn = runtime->lookupFunction(0x296BD0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FFCu; }
        if (ctx->pc != 0x296FFCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00296BD0_0x296bd0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x296FFCu; }
        if (ctx->pc != 0x296FFCu) { return; }
    }
    ctx->pc = 0x296FFCu;
label_296ffc:
    ...
    ctx->pc = 0x297000u;
    {
        ...
        ctx->pc = 0x297004u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x297000u;
    ...
    ctx->pc = 0x297008u;
    {
        ...
        ctx->pc = 0x29700Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x297008u;
    ...
    ctx->pc = 0x297014u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x297010u;
    ...
    if (runtime->hasFunction(0x29A7C0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297018u; }
        if (ctx->pc != 0x297018u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0029A7C0_0x29a7c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297018u; }
...
label_297018:
    ...
    ctx->pc = 0x297024u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x297020u;
    ...
    if (runtime->hasFunction(0x299FC0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297028u; }
        if (ctx->pc != 0x297028u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00299FC0_0x299fc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297028u; }
...
label_297028:
    ...
    ctx->pc = 0x297028u;
    {
        ...
        ctx->pc = 0x29702Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x297028u;
    ...
    ctx->pc = 0x297034u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x297030u;
    ...
    if (runtime->hasFunction(0x29A878u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297038u; }
        if (ctx->pc != 0x297038u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0029A878_0x29a878(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297038u; }
...
label_297038:
    ...
    ctx->pc = 0x297044u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x297040u;
    ...
    if (runtime->hasFunction(0x299FC0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297048u; }
        if (ctx->pc != 0x297048u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00299FC0_0x299fc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297048u; }
...
label_297054:
    ...
    ctx->pc = 0x297064u;
    {
        ...
        ctx->pc = 0x297068u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x297064u;
