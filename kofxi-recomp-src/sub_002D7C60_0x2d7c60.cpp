...
void sub_002D7C60_0x2d7c60(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D7C74u;
    {
        ...
        ctx->pc = 0x2D7C78u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7C74u;
    ...
    ctx->pc = 0x2D7C84u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7C80u;
    ...
    if (runtime->hasFunction(0x2D82B0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D7C88u; }
        if (ctx->pc != 0x2D7C88u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d7c8c:
    ...
    ctx->pc = 0x2D7C94u;
    {
        ...
        ctx->pc = 0x2D7C98u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7C94u;
