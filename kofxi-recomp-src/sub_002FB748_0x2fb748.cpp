...
label_2fb79c:
    ...
    ctx->pc = 0x2FB7B0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2FB7ACu;
    // 0x2fb7b0: 0x2406000c  addiu       $a2, $zero, 0xC (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 12));
    ctx->in_delay_slot = false;
    ctx->pc = 0x12A598u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x12A598u, 0x2FB7ACu, 0x2FB7B4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FB7B4u;
label_2fb7b4:
...
label_2fb7d4:
    ...
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x2FB7D4u, 0x2FB7DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FB7DCu;
label_2fb7dc:
...
label_2fb7e4:
    ...
    ctx->pc = 0x2FB7F0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2FB7ECu;
    // 0x2fb7f0: 0x2406000e  addiu       $a2, $zero, 0xE (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 14));
    ctx->in_delay_slot = false;
    ctx->pc = 0x12A598u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x12A598u, 0x2FB7ECu, 0x2FB7F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FB7F4u;
label_2fb7f4:
...
label_2fb7fc:
    ...
    ctx->pc = 0x2FB804u;
    {
        ...
        ctx->pc = 0x2FB808u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2FB804u;
        // 0x2fb808: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2FB804u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2fb80cu;
    // NOP
    if (ctx->pc == 0x2fb80cu) { ctx->pc = 0x2fb810u; }
}
