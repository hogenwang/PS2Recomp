...
label_2b0350:
    ...
    ctx->pc = 0x2B034Cu;
    {
        ...
        ctx->pc = 0x2B0350u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B034Cu;
            // 0x2b0350: 0xffbf0010  sd          $ra, 0x10($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 16), GPR_U64(ctx, 31));
...
label_2b0358:
    ...
    if (runtime->hasFunction(0x2B1810u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2B035Cu; }
        if (ctx->pc != 0x2B035Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2b0364:
    ...
    ctx->pc = 0x2B0360u;
    {
        ...
        ctx->pc = 0x2B0364u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B0360u;
            // 0x2b0364: 0x3c030004  lui         $v1, 0x4 (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)((uint32_t)4 << 16));
        ctx->in_delay_slot = false;
...
label_2b0384:
    ...
    ctx->pc = 0x2B0380u;
    {
        ...
        ctx->pc = 0x2B0384u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B0380u;
            // 0x2b0384: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x2B0388u; }
            if (ctx->pc != 0x2B0388u) { return; }
        }
        }
    }
    ctx->pc = 0x2B0388u;
...
label_2b038c:
    ...
    ctx->pc = 0x2B0388u;
    {
        ...
        ctx->pc = 0x2B038Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B0388u;
            // 0x2b038c: 0xdfbf0010  ld          $ra, 0x10($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 16)));
        ctx->in_delay_slot = false;
...
label_2b03a0:
    ...
    ctx->pc = 0x2B039Cu;
    {
        ...
        ctx->pc = 0x2B03A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B039Cu;
            // 0x2b03a0: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
