...
label_2bf0ac:
    ...
    ctx->pc = 0x2B70D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B70D0u, 0x2BF0ACu, 0x2BF0B4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BF0B4u;
label_2bf0b4:
...
label_2bf0dc:
    ...
    ctx->pc = 0x2BF0ECu;
    {
        ...
        ctx->pc = 0x2BF0F0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2BF0ECu;
        // 0x2bf0f0: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BF0ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2bf0f4u;
    // NOP
    if (ctx->pc == 0x2bf0f4u) { ctx->pc = 0x2bf0f8u; }
}
