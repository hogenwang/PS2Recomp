...
void sub_001FEB90_0x1feb90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1FEBA8u;
    // 0x1febac: 0x24110001  addiu       $s1, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 17, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FD9F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FD9F0u, 0x1FEBA8u, 0x1FEBB0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FEBB0u;
label_1febb0:
    ...
    ctx->pc = 0x1FEBBCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1FEBB8u;
    // 0x1febbc: 0x8e052130  lw          $a1, 0x2130($s0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 8496)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EB570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EB570u, 0x1FEBB8u, 0x1FEBC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FEBC0u;
label_1febc0:
    ...
    ctx->pc = 0x1FEC10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FEC10u, 0x1FEBC8u, 0x1FEBD0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FEBD0u;
label_1febd0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FD9D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FD9D8u, 0x1FEBECu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1FEBF4u;
    // 0x1febf4: 0x0  nop
...
label_1febf8:
    ...
    ctx->pc = 0x1FEC04u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1FEC04u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1fec0cu;
    // NOP
    if (ctx->pc == 0x1fec0cu) { ctx->pc = 0x1fec10u; }
}
