...
void sub_001530C0_0x1530c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1530DCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1530D8u;
    ...
    if (runtime->hasFunction(0x152AE0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1530E0u; }
        if (ctx->pc != 0x1530E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1530e0:
    ...
    ctx->pc = 0x1530ECu;
    {
        ...
        if (branch_taken_0x1530ec) {
            ctx->pc = 0x1530F0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1530ECu;
...
label_153138:
    ...
    ctx->pc = 0x153144u;
    {
        ...
        ctx->pc = 0x153148u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x153144u;
