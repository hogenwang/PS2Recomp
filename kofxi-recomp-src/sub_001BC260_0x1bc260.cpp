...
void sub_001BC260_0x1bc260(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1BC27Cu;
    // 0x1bc280: 0xc0902d  daddu       $s2, $a2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BC27Cu, 0x1BC284u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC284u;
label_1bc284:
    ...
    ctx->pc = 0x1BC290u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BC28Cu;
    // 0x1bc290: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BC2B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BC2B0u, 0x1BC28Cu, 0x1BC294u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC294u;
label_1bc294:
    ...
    ctx->pc = 0x1bc2acu;
    // NOP
    if (ctx->pc == 0x1bc2acu) { ctx->pc = 0x1bc2b0u; }
}
