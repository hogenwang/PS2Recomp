...
void sub_001F9F48_0x1f9f48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1D63E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D63E8u, 0x1F9F5Cu, 0x1F9F64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F9F64u;
label_1f9f64:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F9FB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F9FB8u, 0x1F9F64u, 0x1F9F6Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F9F6Cu;
label_1f9f6c:
    ...
    ctx->pc = 0x1F9FB0u;
    {
        ...
        ctx->pc = 0x1F9FB4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F9FB0u;
        // 0x1f9fb4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F9FB0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
