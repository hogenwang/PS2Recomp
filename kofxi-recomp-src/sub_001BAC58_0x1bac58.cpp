...
label_1bac70:
    ...
    ctx->pc = 0x1BAC70u;
    {
        ...
        ctx->pc = 0x1BAC74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAC70u;
...
label_1bac7c:
    ...
    ctx->pc = 0x1BAC80u;
    {
        ...
        ctx->pc = 0x1BAC84u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAC80u;
...
label_1bac9c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAC9Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BACB8u;
    if (runtime->hasFunction(0x1BACB8u)) {
        auto targetFn = runtime->lookupFunction(0x1BACB8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BACA4u; }
        if (ctx->pc != 0x1BACA4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BACB8_0x1bacb8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BACA4u; }
        if (ctx->pc != 0x1BACA4u) { return; }
    }
    ctx->pc = 0x1BACA4u;
