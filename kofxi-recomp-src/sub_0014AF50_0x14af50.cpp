...
void sub_0014AF50_0x14af50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B04A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B04A0u, 0x14AF68u, 0x14AF70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x14AF70u;
label_14af70:
...
label_14af78:
    ...
    ctx->branch_pc = 0x14AFF0u;
    // 0x14aff4: 0xfc435d78  sd          $v1, 0x5D78($v0) (Delay Slot)
    WRITE64(ADD32(GPR_U32(ctx, 2), 23928), GPR_U64(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x14B010u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x14B010u, 0x14AFF0u, 0x14AFF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x14AFF8u;
label_14aff8:
    ...
    ctx->pc = 0x14AFFCu;
    {
        ...
        ctx->pc = 0x14B000u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x14AFFCu;
        // 0x14b000: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x14AFFCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x14b00cu;
    // NOP
    if (ctx->pc == 0x14b00cu) { ctx->pc = 0x14b010u; }
}
