...
label_242848:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x261548u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x261548u, 0x242850u, 0x242858u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x242858u;
label_242858:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x22D780u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22D780u, 0x242864u, 0x24286Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x24286Cu;
label_24286c:
    ...
    ctx->pc = 0x24287Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x242878u;
    // 0x24287c: 0xa22821  addu        $a1, $a1, $v0 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 2)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x123258u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x123258u, 0x242878u, 0x242880u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x242880u;
label_242880:
...
label_2428cc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x242678u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x242678u, 0x2428D0u, 0x2428D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2428D8u;
label_2428d8:
    ...
    ctx->pc = 0x2428E8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2428E4u;
    // 0x2428e8: 0x24846630  addiu       $a0, $a0, 0x6630 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 26160));
    ctx->in_delay_slot = false;
    ctx->pc = 0x22D780u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22D780u, 0x2428E4u, 0x2428ECu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2428ECu;
label_2428ec:
...
label_2428f0:
    ...
    ctx->pc = 0x2428FCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2428FCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x242904u;
    // NOP
    if (ctx->pc == 0x242904u) { ctx->pc = 0x242908u; }
}
