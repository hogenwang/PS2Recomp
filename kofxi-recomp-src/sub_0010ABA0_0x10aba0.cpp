...
label_10abf0:
    ...
    ctx->pc = 0x10ABF8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10ABF4u;
    // 0x10abf8: 0x24a5a428  addiu       $a1, $a1, -0x5BD8 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294943784));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10C168u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10C168u, 0x10ABF4u, 0x10ABFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10ABFCu;
label_10abfc:
...
label_10ac00:
    ...
    ctx->pc = 0x10AC04u;
    {
        ...
        ctx->pc = 0x10AC08u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x10AC04u;
        // 0x10ac08: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10AC04u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10AC20u;
    {
        ...
        ctx->pc = 0x10AC24u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x10AC20u;
        // 0x10ac24: 0x451023  subu        $v0, $v0, $a1 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)SUB32(GPR_U32(ctx, 2), GPR_U32(ctx, 5)));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10AC20u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10AC38u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10AC34u;
    // 0x10ac38: 0x24840068  addiu       $a0, $a0, 0x68 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 104));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10C2F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10C2F0u, 0x10AC34u, 0x10AC3Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10AC3Cu;
label_10ac3c:
    ...
    ctx->pc = 0x10AC44u;
    {
        ...
        ctx->pc = 0x10AC48u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x10AC44u;
        // 0x10ac48: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10AC44u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10AC60u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10AC5Cu;
    // 0x10ac60: 0x24840068  addiu       $a0, $a0, 0x68 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 104));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10C3D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10C3D8u, 0x10AC5Cu, 0x10AC64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10AC64u;
label_10ac64:
    ...
    ctx->pc = 0x10AC6Cu;
    {
        ...
        ctx->pc = 0x10AC70u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x10AC6Cu;
        // 0x10ac70: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10AC6Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10ac74u;
    // NOP
    if (ctx->pc == 0x10ac74u) { ctx->pc = 0x10ac78u; }
}
