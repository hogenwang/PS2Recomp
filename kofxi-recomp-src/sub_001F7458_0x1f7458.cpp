...
void sub_001F7458_0x1f7458(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F7480u;
    if (runtime->hasFunction(0x1F7480u)) {
        auto targetFn = runtime->lookupFunction(0x1F7480u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7468u; }
        if (ctx->pc != 0x1F7468u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F7480_0x1f7480(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7468u; }
        if (ctx->pc != 0x1F7468u) { return; }
    }
    ctx->pc = 0x1F7468u;
