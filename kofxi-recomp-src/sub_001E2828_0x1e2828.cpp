...
void sub_001E2828_0x1e2828(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E2834u;
    {
        ...
        ctx->pc = 0x1E2838u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2834u;
    ...
    ctx->pc = 0x1E2840u;
    ctx->pc = 0x1E2844u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2840u;
            // 0x1e2844: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1FB0B8u;
    {
        auto targetFn = runtime->lookupFunction(0x1FB0B8u);
...
label_1e2848:
    ...
    ctx->pc = 0x1E284Cu;
    {
        ...
        ctx->pc = 0x1E2850u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E284Cu;
