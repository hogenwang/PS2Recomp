...
void sub_002E8470_0x2e8470(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x10CCA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E848Cu; }
        if (ctx->pc != 0x2E848Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2e848c:
    ...
    if (runtime->hasFunction(0x10CCD0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E8498u; }
        if (ctx->pc != 0x2E8498u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2e8498:
    ...
    ctx->pc = 0x2E8498u;
    {
        ...
        ctx->pc = 0x2E849Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E8498u;
    ...
    ctx->pc = 0x2E84A0u;
    {
        ...
        ctx->pc = 0x2E84A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E84A0u;
...
label_2e84c0:
    ...
    ctx->pc = 0x2E84C4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E84C0u;
...
label_2e84c8:
    ...
    ctx->pc = 0x2E84D0u;
    {
        ...
        ctx->pc = 0x2E84D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E84D0u;
...
label_2e84dc:
    ...
    ctx->pc = 0x2E84E8u;
    {
        ...
        ctx->pc = 0x2E84ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E84E8u;
