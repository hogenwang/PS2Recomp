...
void sub_001852A0_0x1852a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1852B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1852B4u;
            // 0x1852b8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x185330u;
    if (runtime->hasFunction(0x185330u)) {
        auto targetFn = runtime->lookupFunction(0x185330u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00185330_0x185330(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1852BCu; }
        if (ctx->pc != 0x1852BCu) { return; }
    }
    ctx->pc = 0x1852BCu;
label_1852bc:
    ...
    ctx->pc = 0x1852D0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1852CCu;
    ...
    if (runtime->hasFunction(0x18A520u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1852D4u; }
        if (ctx->pc != 0x1852D4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1852d4:
    ...
    ctx->pc = 0x18530Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x185308u;
            // 0x18530c: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1854F0u;
    if (runtime->hasFunction(0x1854F0u)) {
        auto targetFn = runtime->lookupFunction(0x1854F0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x185310u; }
        if (ctx->pc != 0x185310u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001854F0_0x1854f0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x185310u; }
        if (ctx->pc != 0x185310u) { return; }
    }
    ctx->pc = 0x185310u;
