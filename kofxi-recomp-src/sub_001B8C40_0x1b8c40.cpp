...
void sub_001B8C40_0x1b8c40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B8C4Cu;
    // 0x1b8c50: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1B8C4Cu, 0x1B8C54u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B8C54u;
label_1b8c54:
    ...
    ctx->pc = 0x1B8C58u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B8C54u;
    // 0x1b8c58: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8C70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8C70u, 0x1B8C54u, 0x1B8C5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B8C5Cu;
label_1b8c5c:
    ...
    ctx->pc = 0x1b8c6cu;
    // NOP
    if (ctx->pc == 0x1b8c6cu) { ctx->pc = 0x1b8c70u; }
}
