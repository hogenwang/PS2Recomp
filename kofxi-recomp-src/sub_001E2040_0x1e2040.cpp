...
void sub_001E2040_0x1e2040(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E2048u;
    // 0x1e204c: 0x24040008  addiu       $a0, $zero, 0x8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 8));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2238u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2238u, 0x1E2048u, 0x1E2050u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E2050u;
label_1e2050:
