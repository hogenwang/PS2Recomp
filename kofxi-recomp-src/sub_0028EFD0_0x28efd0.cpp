...
label_28efe0:
    ...
    ctx->pc = 0x28EFDCu;
    {
        ...
        ctx->pc = 0x28EFE0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28EFDCu;
            // 0x28efe0: 0xffbf0000  sd          $ra, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
...
label_28f000:
    ...
    ctx->pc = 0x28EFFCu;
    ctx->pc = 0x28F000u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28EFFCu;
            // 0x28f000: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x295920u;
...
label_28f008:
    ...
    ctx->pc = 0x28F004u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x28F00Cu; }
            if (ctx->pc != 0x28F00Cu) { return; }
        }
        }
    }
    ctx->pc = 0x28F00Cu;
