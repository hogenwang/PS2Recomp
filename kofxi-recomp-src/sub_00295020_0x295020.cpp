...
void sub_00295020_0x295020(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x295030u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29502Cu;
    ...
    if (runtime->hasFunction(0x2A2FD8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x295034u; }
        if (ctx->pc != 0x295034u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_295034:
    ...
    ctx->pc = 0x295054u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x295050u;
    ...
    if (runtime->hasFunction(0x295920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x295058u; }
        if (ctx->pc != 0x295058u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_295058:
    ...
    ctx->pc = 0x295058u;
    {
        ...
        ctx->pc = 0x29505Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295058u;
...
label_295070:
    ...
    ctx->pc = 0x295078u;
    {
        ...
        ctx->pc = 0x29507Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295078u;
