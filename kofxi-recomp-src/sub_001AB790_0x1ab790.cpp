...
void sub_001AB790_0x1ab790(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1AB258u;
    if (runtime->hasFunction(0x1AB258u)) {
        auto targetFn = runtime->lookupFunction(0x1AB258u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB7B4u; }
        if (ctx->pc != 0x1AB7B4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001AB258_0x1ab258(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB7B4u; }
        if (ctx->pc != 0x1AB7B4u) { return; }
    }
    ctx->pc = 0x1AB7B4u;
label_1ab7b4:
    ...
    ctx->pc = 0x1AB7CCu;
    {
        ...
        ctx->pc = 0x1AB7D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB7CCu;
    ...
    ctx->pc = 0x1AB3F8u;
    {
        auto targetFn = runtime->lookupFunction(0x1AB3F8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1ab7f8:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB7F8u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1AC910u;
    if (runtime->hasFunction(0x1AC910u)) {
        auto targetFn = runtime->lookupFunction(0x1AC910u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB800u; }
        if (ctx->pc != 0x1AB800u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001AC910_0x1ac910(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB800u; }
        if (ctx->pc != 0x1AB800u) { return; }
    }
    ctx->pc = 0x1AB800u;
label_1ab800:
    ...
    ctx->pc = 0x1AB820u;
    ctx->pc = 0x1AB824u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB820u;
            // 0x1ab824: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1AC6A0u;
    {
        auto targetFn = runtime->lookupFunction(0x1AC6A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1ab828:
    ...
    ctx->pc = 0x1AB82Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB828u;
            // 0x1ab82c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1AD118u;
    if (runtime->hasFunction(0x1AD118u)) {
        auto targetFn = runtime->lookupFunction(0x1AD118u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB830u; }
        if (ctx->pc != 0x1AB830u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001AD118_0x1ad118(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB830u; }
        if (ctx->pc != 0x1AB830u) { return; }
    }
    ctx->pc = 0x1AB830u;
label_1ab830:
    ...
    ctx->pc = 0x1AB830u;
    {
        ...
        ctx->pc = 0x1AB834u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB830u;
...
label_1ab858:
    ...
    ctx->pc = 0x1AB85Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB858u;
            // 0x1ab85c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1A9E20u;
    if (runtime->hasFunction(0x1A9E20u)) {
        auto targetFn = runtime->lookupFunction(0x1A9E20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB860u; }
        if (ctx->pc != 0x1AB860u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001A9E20_0x1a9e20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB860u; }
        if (ctx->pc != 0x1AB860u) { return; }
    }
    ctx->pc = 0x1AB860u;
label_1ab860:
    ...
    ctx->pc = 0x1AB860u;
    {
        ...
        ctx->pc = 0x1AB864u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB860u;
    ...
    ctx->pc = 0x1A9F98u;
    {
        auto targetFn = runtime->lookupFunction(0x1A9F98u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1ab888:
    ...
    ctx->pc = 0x1AB88Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB888u;
            // 0x1ab88c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1AA728u;
    if (runtime->hasFunction(0x1AA728u)) {
        auto targetFn = runtime->lookupFunction(0x1AA728u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB890u; }
        if (ctx->pc != 0x1AB890u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001AA728_0x1aa728(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB890u; }
        if (ctx->pc != 0x1AB890u) { return; }
    }
    ctx->pc = 0x1AB890u;
label_1ab890:
    ...
    ctx->pc = 0x1AB890u;
    {
        ...
        ctx->pc = 0x1AB894u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB890u;
    ...
    ctx->pc = 0x1AB8B0u;
    ctx->pc = 0x1AB8B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB8B0u;
            // 0x1ab8b4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1AA890u;
    {
        auto targetFn = runtime->lookupFunction(0x1AA890u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1ab8b8:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB8B8u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1A9918u;
    if (runtime->hasFunction(0x1A9918u)) {
        auto targetFn = runtime->lookupFunction(0x1A9918u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001A9918_0x1a9918(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AB8C0u; }
        if (ctx->pc != 0x1AB8C0u) { return; }
    }
    ctx->pc = 0x1AB8C0u;
label_1ab8c0:
    ...
    ctx->pc = 0x1AB8C0u;
    {
        ...
        ctx->pc = 0x1AB8C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB8C0u;
    ...
    ctx->pc = 0x1AB8E0u;
    ctx->pc = 0x1AB8E4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB8E0u;
            // 0x1ab8e4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1A9868u;
    {
        auto targetFn = runtime->lookupFunction(0x1A9868u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1ab8e8:
    ...
    ctx->pc = 0x1AB8FCu;
    {
        ...
        ctx->pc = 0x1AB900u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AB8FCu;
