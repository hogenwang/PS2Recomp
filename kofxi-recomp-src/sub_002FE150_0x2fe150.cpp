...
void sub_002FE150_0x2fe150(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2FE164u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2FE160u;
    ...
    if (runtime->hasFunction(0x1A4740u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FE168u; }
        if (ctx->pc != 0x2FE168u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2fe168:
    ...
    ctx->pc = 0x2FE174u;
    {
        ...
        ctx->pc = 0x2FE178u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FE174u;
...
label_2fe18c:
    ...
    if (runtime->hasFunction(0x2099D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FE198u; }
        if (ctx->pc != 0x2FE198u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2fe198:
    ...
    ctx->pc = 0x2FE1A0u;
    {
        ...
        ctx->pc = 0x2FE1A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FE1A0u;
