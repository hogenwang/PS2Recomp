...
label_1be2ec:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BE440u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BE440u, 0x1BE2E8u, 0x1BE2F0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BE2F0u;
label_1be2f0:
...
label_1be2f4:
    ...
    ctx->pc = 0x1BE2F0u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BE2F0u, 0x1BE2F8u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1BE2F8u;
...
label_1be304:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BE3A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BE3A8u, 0x1BE300u, 0x1BE308u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BE308u;
label_1be308:
...
label_1be374:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x12A0F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x12A0F8u, 0x1BE370u, 0x1BE378u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BE378u;
label_1be378:
...
label_1be384:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x127120u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x127120u, 0x1BE380u, 0x1BE388u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BE388u;
label_1be388:
...
label_1be3a0:
    ...
    ctx->pc = 0x1BE39Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BE39Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1be3a4:
    ...
    ctx->pc = 0x1be3a4u;
    // NOP
    if (ctx->pc == 0x1be3a4u) { ctx->pc = 0x1be3a8u; }
}
