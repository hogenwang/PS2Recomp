...
void sub_001B62A0_0x1b62a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B62B0u;
    // 0x1b62b4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AB9F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AB9F8u, 0x1B62B0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1B62B8u;
    ...
    ctx->pc = 0x1B62CCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B62C8u;
    // 0x1b62cc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ABA00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ABA00u, 0x1B62C8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1B62D0u;
}
