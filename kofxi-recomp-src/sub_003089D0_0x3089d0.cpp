...
label_3089f0:
    ...
    ctx->pc = 0x3089F8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3089F4u;
    ...
    if (runtime->hasFunction(0x3087C0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x3089FCu; }
        if (ctx->pc != 0x3089FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_3089fc:
    ...
    ctx->pc = 0x308A08u;
    {
        ...
        if (branch_taken_0x308a08) {
            ctx->pc = 0x308A0Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x308A08u;
...
label_308a10:
    ...
    ctx->pc = 0x308A18u;
    {
        ...
        ctx->pc = 0x308A1Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x308A18u;
