...
void sub_001B0AB8_0x1b0ab8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B0AD0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B0ACCu;
    // 0x1b0ad0: 0x24847810  addiu       $a0, $a0, 0x7810 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 30736));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1B0ACCu, 0x1B0AD4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0AD4u;
label_1b0ad4:
    ...
    ctx->pc = 0x1B0ADCu;
    {
        ...
        ctx->pc = 0x1B0AE0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B0ADCu;
        // 0x1b0ae0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B0ADCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1b0ae8:
    ...
    ctx->pc = 0x1B0B08u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B0B04u;
    // 0x1b0b08: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AB0u, 0x1B0B04u, 0x1B0B0Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0B0Cu;
label_1b0b0c:
    ...
    ctx->pc = 0x1B0B10u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B0B0Cu;
    // 0x1b0b10: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B0B30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B0B30u, 0x1B0B0Cu, 0x1B0B14u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0B14u;
label_1b0b14:
    ...
    ctx->pc = 0x1B0B18u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B0B14u;
    // 0x1b0b18: 0x40802d  daddu       $s0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AC8u, 0x1B0B14u, 0x1B0B1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0B1Cu;
label_1b0b1c:
    ...
    ctx->pc = 0x1B0B28u;
    {
        ...
        ctx->pc = 0x1B0B2Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B0B28u;
        // 0x1b0b2c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B0B28u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
