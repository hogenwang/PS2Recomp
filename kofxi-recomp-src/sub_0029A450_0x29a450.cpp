...
void sub_0029A450_0x29a450(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29A47Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x29A478u;
    // 0x29a47c: 0x24a5a370  addiu       $a1, $a1, -0x5C90 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294943600));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2985C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2985C0u, 0x29A478u, 0x29A480u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x29A480u;
label_29a480:
...
label_29a488:
    ...
    ctx->pc = 0x29A490u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x29A490u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x29A4ACu;
    {
        ...
        ctx->pc = 0x29A4B0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x29A4ACu;
        // 0x29a4b0: 0xac620014  sw          $v0, 0x14($v1) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 3), 20), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x29A4ACu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x29A4C4u;
    {
        ...
        ctx->pc = 0x29A4C8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x29A4C4u;
        // 0x29a4c8: 0xac620008  sw          $v0, 0x8($v1) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 3), 8), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x29A4C4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x29A4F8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x29A4F4u;
    // 0x29a4f8: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x280ED8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x280ED8u, 0x29A4F4u, 0x29A4FCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x29A4FCu;
label_29a4fc:
