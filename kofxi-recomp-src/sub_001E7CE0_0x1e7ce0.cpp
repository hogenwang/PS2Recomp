...
void sub_001E7CE0_0x1e7ce0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E7CE4u;
    {
        ...
        ctx->pc = 0x1E7CE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E7CE4u;
    ...
    ctx->pc = 0x1E7CF0u;
    ctx->pc = 0x1E7CF4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E7CF0u;
...
label_1e7d08:
    ...
    ctx->pc = 0x1E7D14u;
    ctx->pc = 0x1E7D18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E7D14u;
            // 0x1e7d18: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B78B8u;
    {
        auto targetFn = runtime->lookupFunction(0x1B78B8u);
