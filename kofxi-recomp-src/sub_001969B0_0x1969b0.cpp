...
void sub_001969B0_0x1969b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1969D0u;
    {
        ...
        ctx->pc = 0x1969D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1969D0u;
...
label_1969e0:
    ...
    ctx->pc = 0x196A00u;
    {
        ...
        ctx->pc = 0x196A04u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x196A00u;
...
label_196a10:
    ...
    ctx->pc = 0x196A70u;
    {
        ...
        ctx->pc = 0x196A74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x196A70u;
...
label_196abc:
    ...
    ctx->pc = 0x196ACCu;
    {
        ...
        ctx->pc = 0x196AD0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x196ACCu;
