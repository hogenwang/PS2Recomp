...
label_2fc9b0:
    ...
    ctx->pc = 0x2FC940u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FC940u, 0x2FC9CCu, 0x2FC9D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FC9D4u;
label_2fc9d4:
    ...
    ctx->pc = 0x2FC9E8u;
    {
        ...
        ctx->pc = 0x2FC9ECu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2FC9E8u;
        // 0x2fc9ec: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2FC9E8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2FC9FCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2FC9F8u;
    // 0x2fc9fc: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD10u, 0x2FC9F8u, 0x2FCA00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FCA00u;
label_2fca00:
...
label_2fca18:
    ...
    ctx->pc = 0x2FCA1Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2FCA18u;
    // 0x2fca1c: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD10u, 0x2FCA18u, 0x2FCA20u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FCA20u;
label_2fca20:
...
label_2fca44:
    ...
    ctx->pc = 0x2FCA48u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2FCA48u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2FCA64u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2FCA64u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2fca90:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD10u, 0x2FCA90u, 0x2FCA98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FCA98u;
label_2fca98:
...
label_2fcaa4:
    ...
    ctx->pc = 0x2FCAA8u;
    {
        ...
        ctx->pc = 0x2FCAACu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2FCAA8u;
        // 0x2fcaac: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2FCAA8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2fcad0:
    ...
    ctx->pc = 0x2FCAD4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2FCAD0u;
    // 0x2fcad4: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CD10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CD10u, 0x2FCAD0u, 0x2FCAD8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FCAD8u;
label_2fcad8:
...
label_2fcae0:
    ...
    ctx->pc = 0x2FCAE4u;
    {
        ...
        ctx->pc = 0x2FCAE8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2FCAE4u;
        // 0x2fcae8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2FCAE4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2fcaecu;
    // NOP
    if (ctx->pc == 0x2fcaecu) { ctx->pc = 0x2fcaf0u; }
}
