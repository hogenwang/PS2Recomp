...
void sub_00103D90_0x103d90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x116EA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116EA0u, 0x103DACu, 0x103DB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x103DB4u;
label_103db4:
...
label_103de4:
    ...
    ctx->pc = 0x103D18u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x103D18u, 0x103DF0u, 0x103DF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x103DF8u;
label_103df8:
...
label_103e6c:
    ...
    ctx->pc = 0x103E78u;
    {
        ...
        ctx->pc = 0x103E7Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x103E78u;
        // 0x103e7c: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x103E78u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
