...
void sub_00191BB0_0x191bb0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x191BB8u;
    {
        ...
        ctx->pc = 0x191BBCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x191BB8u;
    ...
    ctx->pc = 0x191BC8u;
    {
        ...
        ctx->pc = 0x191BCCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x191BC8u;
...
label_191bd0:
    ...
    if (runtime->hasFunction(0x323890u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x191BD8u; }
        if (ctx->pc != 0x191BD8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_191be0:
    ...
    ctx->pc = 0x191BE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x191BE4u;
...
label_191bf0:
    ...
    ctx->pc = 0x191BF0u;
    {
        ...
        ctx->pc = 0x191BF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x191BF0u;
