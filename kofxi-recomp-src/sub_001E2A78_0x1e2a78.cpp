...
void sub_001E2A78_0x1e2a78(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E2AE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2AE8u, 0x1E2A84u, 0x1E2A8Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E2A8Cu;
label_1e2a8c:
...
label_1e2ad8:
    ...
    ctx->pc = 0x1E2AE0u;
    {
        ...
        ctx->pc = 0x1E2AE4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E2AE0u;
        // 0x1e2ae4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E2AE0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
