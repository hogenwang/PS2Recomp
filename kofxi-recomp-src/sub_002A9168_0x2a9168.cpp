...
void sub_002A9168_0x2a9168(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2A91A0u;
    // 0x2a91a4: 0x882d  daddu       $s1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A9620u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A9620u, 0x2A91A0u, 0x2A91A8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2A91A8u;
label_2a91a8:
    ...
    ctx->pc = 0x2A91CCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2A91C8u;
    // 0x2a91cc: 0x34e7ffff  ori         $a3, $a3, 0xFFFF (Delay Slot)
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) | (uint64_t)(uint16_t)65535);
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A0490u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A0490u, 0x2A91C8u, 0x2A91D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2A91D0u;
label_2a91d0:
...
label_2a91d8:
    ...
    ctx->pc = 0x2A91F4u;
    {
        ...
        ctx->pc = 0x2A91F8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2A91F4u;
        // 0x2a91f8: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 112));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2A91F4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2a91fcu;
    // NOP
    if (ctx->pc == 0x2a91fcu) { ctx->pc = 0x2a9200u; }
}
