...
label_33a7f0:
    ...
    ctx->pc = 0x33A824u;
    {
        ...
        ctx->pc = 0x33A828u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33A824u;
...
label_33a870:
    ...
    ctx->pc = 0x33A888u;
    {
        ...
        ctx->pc = 0x33A88Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33A888u;
...
label_33a8a0:
    ...
    ctx->pc = 0x33A8A8u;
    {
        ...
        ctx->pc = 0x33A8ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33A8A8u;
    ...
    ctx->pc = 0x33A8B8u;
    {
        ...
        ctx->pc = 0x33A8BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33A8B8u;
