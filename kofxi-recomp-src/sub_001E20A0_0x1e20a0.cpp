...
void sub_001E20A0_0x1e20a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E20C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E20BCu;
    ...
    if (runtime->hasFunction(0x127120u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E20C4u; }
        if (ctx->pc != 0x1E20C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e20c4:
    ...
    ctx->pc = 0x1E20CCu;
    {
        ...
        ctx->pc = 0x1E20D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E20CCu;
