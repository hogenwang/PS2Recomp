...
void sub_001B51E0_0x1b51e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B51F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B51ECu;
    ...
    if (runtime->hasFunction(0x1B4F08u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B51F4u; }
        if (ctx->pc != 0x1B51F4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b51f4:
    ...
    ctx->pc = 0x1B5204u;
    {
        ...
        ctx->pc = 0x1B5208u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B5204u;
