...
void sub_0026D980_0x26d980(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x26D998u;
    // 0x26d99c: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x22D4E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22D4E0u, 0x26D998u, 0x26D9A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x26D9A0u;
label_26d9a0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x262EA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x262EA0u, 0x26D9A4u, 0x26D9ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x26D9ACu;
label_26d9ac:
    ...
    ctx->pc = 0x26D9B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x26D9B0u;
    // 0x26d9b4: 0x24050006  addiu       $a1, $zero, 0x6 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 6));
    ctx->in_delay_slot = false;
    ctx->pc = 0x26B858u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x26B858u, 0x26D9B0u, 0x26D9B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x26D9B8u;
label_26d9b8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x26B858u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x26B858u, 0x26D9C0u, 0x26D9C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x26D9C8u;
label_26d9c8:
    ...
    ctx->pc = 0x26D9DCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x26D9DCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x26d9e4u;
    // NOP
    if (ctx->pc == 0x26d9e4u) { ctx->pc = 0x26d9e8u; }
}
