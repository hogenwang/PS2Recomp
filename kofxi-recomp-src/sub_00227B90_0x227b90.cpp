...
void sub_00227B90_0x227b90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x227BC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x227BC0u, 0x227B98u, 0x227BA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x227BA0u;
label_227ba0:
...
label_227bac:
    ...
    ctx->pc = 0x227BB4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x227BB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x227bbcu;
    // NOP
    if (ctx->pc == 0x227bbcu) { ctx->pc = 0x227bc0u; }
}
