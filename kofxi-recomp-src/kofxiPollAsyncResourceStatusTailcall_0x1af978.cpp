...
// Function: kofxiPollAsyncResourceStatusTailcall
// Address: 0x1af978 - 0x1af9c8
void kofxiPollAsyncResourceStatusTailcall_0x1af978(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiPollAsyncResourceStatusTailcall_0x1af978");
#endif
    ...
    ctx->branch_pc = 0x1AF984u;
    // 0x1af988: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AF9C8u;
    kofxiPollAsyncResourceStatusCore_0x1af9c8(rdram, ctx, runtime); return;
    ctx->pc = 0x1AF98Cu;
    // 0x1af98c: 0x0  nop
    ctx->pc = 0x1af98cu;
    // NOP
    ...
    ctx->pc = 0x1AF9A0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF99Cu;
    // 0x1af9a0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AB0u, 0x1AF99Cu, 0x1AF9A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF9A4u;
label_1af9a4:
    ...
    ctx->pc = 0x1AF9A8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF9A4u;
    // 0x1af9a8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AF9C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AF9C8u, 0x1AF9A4u, 0x1AF9ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF9ACu;
label_1af9ac:
    ...
    ctx->pc = 0x1AF9B0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF9ACu;
    // 0x1af9b0: 0x40802d  daddu       $s0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AC8u, 0x1AF9ACu, 0x1AF9B4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF9B4u;
label_1af9b4:
    ...
    ctx->pc = 0x1AF9C0u;
    {
        ...
        ctx->pc = 0x1AF9C4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1AF9C0u;
        // 0x1af9c4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AF9C0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
