...
label_187e14:
    ...
    ctx->pc = 0x187E14u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x187E14u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x187e1cu;
    // NOP
    if (ctx->pc == 0x187e1cu) { ctx->pc = 0x187e20u; }
}
