...
void sub_0014B030_0x14b030(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x14B090u;
    if (runtime->hasFunction(0x14B090u)) {
        auto targetFn = runtime->lookupFunction(0x14B090u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x14B05Cu; }
        if (ctx->pc != 0x14B05Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0014B090_0x14b090(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x14B05Cu; }
        if (ctx->pc != 0x14B05Cu) { return; }
    }
    ctx->pc = 0x14B05Cu;
label_14b05c:
    ...
    ctx->pc = 0x14B07Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x14B078u;
    ...
    if (runtime->hasFunction(0x14B090u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x14B080u; }
        if (ctx->pc != 0x14B080u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0014B090_0x14b090(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x14B080u; }
...
label_14b080:
    ...
    ctx->pc = 0x14B084u;
    {
        ...
        ctx->pc = 0x14B088u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x14B084u;
