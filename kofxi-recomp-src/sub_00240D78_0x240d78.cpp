...
void sub_00240D78_0x240d78(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x240DA8u;
    {
        ...
        ctx->pc = 0x240DACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240DA8u;
...
label_240db8:
    ...
    ctx->pc = 0x240DC8u;
    {
        ...
        ctx->pc = 0x240DCCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240DC8u;
    ...
    ctx->pc = 0x240DD0u;
    {
        ...
        ctx->pc = 0x240DD4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240DD0u;
...
label_240de0:
    ...
    ctx->pc = 0x240DE4u;
    {
        ...
        ctx->pc = 0x240DE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240DE4u;
...
label_240dec:
    ...
    ctx->pc = 0x240DF0u;
    {
        ...
        ctx->pc = 0x240DF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240DF0u;
...
label_240df8:
    ...
    ctx->pc = 0x240DF8u;
    {
        ...
        ctx->pc = 0x240DFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240DF8u;
...
label_240e00:
    ...
    ctx->pc = 0x240E04u;
    {
        ...
        ctx->pc = 0x240E08u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240E04u;
...
label_240e24:
    ...
    ctx->pc = 0x240E2Cu;
    {
        ...
        ctx->pc = 0x240E30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240E2Cu;
