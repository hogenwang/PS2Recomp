...
void sub_00278888_0x278888(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2788A0u;
    // 0x2788a4: 0xa0902d  daddu       $s2, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DB0C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DB0C8u, 0x2788A0u, 0x2788A8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2788A8u;
label_2788a8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x274A10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x274A10u, 0x2788CCu, 0x2788D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2788D4u;
label_2788d4:
...
label_2788d8:
    ...
    ctx->pc = 0x2788DCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2788D8u;
    // 0x2788dc: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x274AF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x274AF0u, 0x2788D8u, 0x2788E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2788E0u;
label_2788e0:
...
label_2788f4:
    ...
    ctx->pc = 0x278904u;
    {
        ...
        ctx->pc = 0x278908u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x278904u;
        // 0x278908: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x278904u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x27890cu;
    // NOP
    if (ctx->pc == 0x27890cu) { ctx->pc = 0x278910u; }
}
