...
void sub_002FC560_0x2fc560(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x263678u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x263678u, 0x2FC568u, 0x2FC570u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2FC570u;
label_2fc570:
    ...
    ctx->pc = 0x2fc57cu;
    // NOP
    if (ctx->pc == 0x2fc57cu) { ctx->pc = 0x2fc580u; }
}
