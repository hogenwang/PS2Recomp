...
label_11ada0:
    ...
    ctx->pc = 0x11A6B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11A6B0u, 0x11ADA0u, 0x11ADA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x11ADA8u;
label_11ada8:
...
label_11adac:
    ...
    ctx->pc = 0x11ADACu;
    {
        ...
        ctx->pc = 0x11ADB0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x11ADACu;
        // 0x11adb0: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x11ADACu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_11adb4:
    ...
    ctx->pc = 0x11ADB8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x11ADB4u;
    // 0x11adb8: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1198C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1198C8u, 0x11ADB4u, 0x11ADBCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x11ADBCu;
label_11adbc:
...
label_11addc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x119D40u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x119D40u, 0x11ADDCu, 0x11ADE4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x11ADE4u;
label_11ade4:
...
label_11adf8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x11A6B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11A6B0u, 0x11AE04u, 0x11AE0Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x11AE0Cu;
label_11ae0c:
...
label_11ae14:
    ...
    ctx->pc = 0x11AE1Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x11AE18u;
    // 0x11ae1c: 0xc7ad0004  lwc1        $f13, 0x4($sp) (Delay Slot)
    { uint32_t bits = READ32(ADD32(GPR_U32(ctx, 29), 4)); float f; std::memcpy(&f, &bits, sizeof(f)); ctx->f[13] = f; }
    ctx->in_delay_slot = false;
    ctx->pc = 0x119D40u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x119D40u, 0x11AE18u, 0x11AE20u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x11AE20u;
label_11ae20:
