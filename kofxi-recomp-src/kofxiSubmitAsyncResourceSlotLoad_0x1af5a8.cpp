...
// Function: kofxiSubmitAsyncResourceSlotLoad
// Address: 0x1af5a8 - 0x1af858
void kofxiSubmitAsyncResourceSlotLoad_0x1af5a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiSubmitAsyncResourceSlotLoad_0x1af5a8");
#endif
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1AF610u, 0x1AF618u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF618u;
label_1af618:
...
label_1af620:
    ...
    ctx->pc = 0x1B04D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B04D0u, 0x1AF634u, 0x1AF63Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF63Cu;
label_1af63c:
...
label_1af680:
    ...
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1AF680u, 0x1AF688u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF688u;
label_1af688:
...
label_1af698:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AED68u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AED68u, 0x1AF698u, 0x1AF6A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF6A0u;
label_1af6a0:
...
label_1af6c0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1272D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1272D8u, 0x1AF6DCu, 0x1AF6E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF6E4u;
label_1af6e4:
    ...
    ctx->pc = 0x1AF704u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF700u;
    // 0x1af704: 0x3c0282d  daddu       $a1, $fp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 30) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B0390u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B0390u, 0x1AF700u, 0x1AF708u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF708u;
label_1af708:
    ...
    ctx->pc = 0x1AF72Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF728u;
    // 0x1af72c: 0x27aa000c  addiu       $t2, $sp, 0xC (Delay Slot)
    SET_GPR_S32(ctx, 10, (int32_t)ADD32(GPR_U32(ctx, 29), 12));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1540u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1540u, 0x1AF728u, 0x1AF730u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF730u;
label_1af730:
...
label_1af750:
    ...
    ctx->pc = 0x1AF760u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF75Cu;
    // 0x1af760: 0x8fa60010  lw          $a2, 0x10($sp) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 29), 16)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B01B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B01B0u, 0x1AF75Cu, 0x1AF764u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF764u;
label_1af764:
...
label_1af774:
    ...
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1AF774u, 0x1AF77Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF77Cu;
label_1af77c:
...
label_1af790:
    ...
    ctx->pc = 0x1AF79Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF798u;
    // 0x1af79c: 0x24060100  addiu       $a2, $zero, 0x100 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 256));
    ctx->in_delay_slot = false;
    ctx->pc = 0x12A598u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x12A598u, 0x1AF798u, 0x1AF7A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF7A0u;
label_1af7a0:
...
label_1af7a8:
    ...
    ctx->pc = 0x1AF7F0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF7ECu;
    // 0x1af7f0: 0xac4601d8  sw          $a2, 0x1D8($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 472), GPR_U32(ctx, 6));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B0AB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B0AB8u, 0x1AF7ECu, 0x1AF7F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF7F4u;
label_1af7f4:
    ...
    ctx->pc = 0x1AF804u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AF800u;
    // 0x1af804: 0x8e440000  lw          $a0, 0x0($s2) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 18), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B04D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B04D0u, 0x1AF800u, 0x1AF808u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AF808u;
label_1af808:
...
label_1af824:
    ...
    ctx->pc = 0x1AF84Cu;
    {
        ...
        ctx->pc = 0x1AF850u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1AF84Cu;
        // 0x1af850: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 112));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AF84Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1af854u;
    // NOP
    if (ctx->pc == 0x1af854u) { ctx->pc = 0x1af858u; }
}
