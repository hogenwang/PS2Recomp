...
void sub_001C4D48_0x1c4d48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C41D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C41D8u, 0x1C4D5Cu, 0x1C4D64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C4D64u;
label_1c4d64:
...
label_1c4d74:
    ...
    ctx->pc = 0x1C4D78u;
    {
        ...
        ctx->pc = 0x1C4D7Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C4D78u;
        // 0x1c4d7c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C4D78u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1C4D80u;
    {
        ...
        ctx->pc = 0x1C4D84u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C4D80u;
        // 0x1c4d84: 0x24020800  addiu       $v0, $zero, 0x800 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 2048));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C4D80u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1C4DA0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C4D9Cu;
    // 0x1c4da0: 0x24a5a380  addiu       $a1, $a1, -0x5C80 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 4294943616));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C41D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C41D8u, 0x1C4D9Cu, 0x1C4DA4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C4DA4u;
label_1c4da4:
...
label_1c4dc8:
    ...
    ctx->pc = 0x1C4DCCu;
    {
        ...
        ctx->pc = 0x1C4DD0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C4DCCu;
        // 0x1c4dd0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C4DCCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1c4dd4u;
    // NOP
    if (ctx->pc == 0x1c4dd4u) { ctx->pc = 0x1c4dd8u; }
}
