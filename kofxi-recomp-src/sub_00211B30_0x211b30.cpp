...
label_211b30:
    ...
    ctx->pc = 0x211B44u;
    ctx->pc = 0x211B48u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x211B44u;
...
label_211b50:
    ...
    ctx->pc = 0x211B64u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x211B60u;
...
label_211b68:
    ...
    ctx->pc = 0x211B70u;
    {
        ...
        ctx->pc = 0x211B74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211B70u;
...
label_211ba0:
    ...
    ctx->pc = 0x211BB4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x211BB8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211BB4u;
