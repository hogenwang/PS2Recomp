...
void sub_0032FCD0_0x32fcd0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x32FCE0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32FCDCu;
    ...
    if (runtime->hasFunction(0x301AE0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x32FCE4u; }
        if (ctx->pc != 0x32FCE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_32fce4:
    ...
    ctx->pc = 0x32FCECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32FCE8u;
    ...
    if (runtime->hasFunction(0x301AE0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32FCF0u; }
        if (ctx->pc != 0x32FCF0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00301AE0_0x301ae0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32FCF0u; }
...
label_32fcf0:
    ...
    ctx->pc = 0x32FCF4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32FCF0u;
    ...
    if (runtime->hasFunction(0x301600u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32FCF8u; }
        if (ctx->pc != 0x32FCF8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_32fcf8:
    ...
    if (runtime->hasFunction(0x3302F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32FD00u; }
        if (ctx->pc != 0x32FD00u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_32fd00:
    ...
    ctx->pc = 0x32FD1Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32FD18u;
    ...
    if (runtime->hasFunction(0x155B50u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32FD20u; }
        if (ctx->pc != 0x32FD20u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_32fd20:
    ...
    ctx->pc = 0x32FD38u;
    {
        ...
        ctx->pc = 0x32FD3Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x32FD38u;
