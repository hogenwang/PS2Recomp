...
void sub_002D83C8_0x2d83c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D83D4u;
    ctx->pc = 0x2D83D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D83D4u;
...
label_2d83e8:
    ...
    ctx->pc = 0x2D83FCu;
    {
        ...
        ctx->pc = 0x2D8400u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D83FCu;
    ...
    ctx->pc = 0x2D8404u;
    {
        ...
        ctx->pc = 0x2D8408u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8404u;
...
label_2d8420:
    ...
    ctx->pc = 0x2D8434u;
    {
        ...
        if (branch_taken_0x2d8434) {
            ctx->pc = 0x2D8438u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8434u;
...
label_2d843c:
    ...
    ctx->pc = 0x2D843Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2D8440u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D843Cu;
...
label_2d8448:
    ...
    ctx->pc = 0x2D8448u;
    {
        ...
        ctx->pc = 0x2D844Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8448u;
...
label_2d8458:
    ...
    ctx->pc = 0x2D846Cu;
    {
        ...
        if (branch_taken_0x2d846c) {
            ctx->pc = 0x2D8470u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2D846Cu;
...
label_2d8478:
    ...
    ctx->pc = 0x2D847Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2D8480u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D847Cu;
...
label_2d8488:
    ...
    ctx->pc = 0x2D8490u;
    {
        ...
        ctx->pc = 0x2D8494u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8490u;
...
label_2d84d8:
    ...
    ctx->pc = 0x2D84ECu;
    {
        ...
        ctx->pc = 0x2D84F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D84ECu;
...
label_2d84f4:
    ...
    ctx->pc = 0x2D84F4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2D84F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D84F4u;
...
label_2d8510:
    ...
    ctx->pc = 0x2D8520u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2D8524u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8520u;
...
label_2d8528:
    ...
    ctx->pc = 0x2D852Cu;
    {
        ...
        ctx->pc = 0x2D8530u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D852Cu;
...
label_2d8540:
    ...
    ctx->pc = 0x2D8544u;
    {
        ...
        ctx->pc = 0x2D8548u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8544u;
    ...
    ctx->pc = 0x2D8554u;
    {
        ...
        if (branch_taken_0x2d8554) {
            ctx->pc = 0x2D8558u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8554u;
    ...
    ctx->pc = 0x2D8568u;
    {
        ...
        ctx->pc = 0x2D856Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8568u;
...
label_2d8578:
    ...
    ctx->pc = 0x2D858Cu;
    {
        ...
        ctx->pc = 0x2D8590u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D858Cu;
    ...
    ctx->pc = 0x2D8594u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2D8598u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8594u;
