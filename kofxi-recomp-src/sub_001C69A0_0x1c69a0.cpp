...
void sub_001C69A0_0x1c69a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C69B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C69B0u;
    ...
    if (runtime->hasFunction(0x1C6B20u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C69B8u; }
        if (ctx->pc != 0x1C69B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c69b8:
    ...
    ctx->pc = 0x1C69B8u;
    {
        ...
        ctx->pc = 0x1C69BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C69B8u;
...
label_1c69d0:
    ...
    ctx->pc = 0x1C69D4u;
    {
        ...
        ctx->pc = 0x1C69D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C69D4u;
    ...
    ctx->pc = 0x1C69ECu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1C69F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C69ECu;
