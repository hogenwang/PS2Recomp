...
label_1be084:
    ...
    if (runtime->hasFunction(0x1BDF50u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BE088u; }
        if (ctx->pc != 0x1BE088u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BDF50_0x1bdf50(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BE088u; }
        if (ctx->pc != 0x1BE088u) { return; }
    }
    ctx->pc = 0x1BE088u;
...
label_1be090:
    ...
    ctx->pc = 0x1BE08Cu;
    {
        ...
        ctx->pc = 0x1BE090u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE08Cu;
            // 0x1be090: 0x2402fffd  addiu       $v0, $zero, -0x3 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 4294967293));
        ctx->in_delay_slot = false;
...
label_1be0cc:
    ...
    ctx->pc = 0x1BE0C8u;
    {
        ...
        ctx->pc = 0x1BE0CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE0C8u;
            // 0x1be0cc: 0x8c44c7c8  lw          $a0, -0x3838($v0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294952904)));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1BE0D0u; }
            if (ctx->pc != 0x1BE0D0u) { return; }
        }
        }
    }
    ctx->pc = 0x1BE0D0u;
...
label_1be0d8:
    ...
    ctx->pc = 0x1BE0D4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1BE0D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE0D4u;
            // 0x1be0d8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
