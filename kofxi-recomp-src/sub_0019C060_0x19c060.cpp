...
void sub_0019C060_0x19c060(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x19C090u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x19C08Cu;
    ...
    if (runtime->hasFunction(0x198080u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x19C094u; }
        if (ctx->pc != 0x19C094u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_19c094:
    ...
    ctx->pc = 0x19C0A0u;
    {
        ...
        if (branch_taken_0x19c0a0) {
            ctx->pc = 0x19C0A4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x19C0A0u;
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x19C0BCu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x19C130u;
    if (runtime->hasFunction(0x19C130u)) {
        auto targetFn = runtime->lookupFunction(0x19C130u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x19C0C4u; }
        if (ctx->pc != 0x19C0C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0019C130_0x19c130(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x19C0C4u; }
        if (ctx->pc != 0x19C0C4u) { return; }
    }
    ctx->pc = 0x19C0C4u;
