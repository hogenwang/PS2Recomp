...
void sub_001B6B30_0x1b6b30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B6B3Cu;
    // 0x1b6b40: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B69D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B69D8u, 0x1B6B3Cu, 0x1B6B44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6B44u;
label_1b6b44:
...
label_1b6b48:
    ...
    ctx->pc = 0x1B1AE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AE0u, 0x1B6B48u, 0x1B6B50u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6B50u;
label_1b6b50:
    ...
    ctx->pc = 0x1B6B60u;
    {
        ...
        ctx->pc = 0x1B6B64u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B6B60u;
        // 0x1b6b64: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B6B60u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
