...
void sub_001F2E78_0x1f2e78(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FB008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FB008u, 0x1F2EA4u, 0x1F2EACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2EACu;
label_1f2eac:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FB008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FB008u, 0x1F2EB8u, 0x1F2EC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2EC0u;
label_1f2ec0:
...
label_1f2ee0:
    ...
    ctx->pc = 0x1F2EE4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F2EE0u;
    // 0x1f2ee4: 0x8e510018  lw          $s1, 0x18($s2) (Delay Slot)
    SET_GPR_S32(ctx, 17, (int32_t)READ32(ADD32(GPR_U32(ctx, 18), 24)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F30D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F30D8u, 0x1F2EE0u, 0x1F2EE8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2EE8u;
label_1f2ee8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F3128u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F3128u, 0x1F2EF4u, 0x1F2EFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2EFCu;
label_1f2efc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F3178u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F3178u, 0x1F2F08u, 0x1F2F10u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2F10u;
label_1f2f10:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F2F70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F2F70u, 0x1F2F18u, 0x1F2F20u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2F20u;
label_1f2f20:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F3258u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F3258u, 0x1F2F2Cu, 0x1F2F34u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2F34u;
label_1f2f34:
...
label_1f2f3c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F2FD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F2FD0u, 0x1F2F40u, 0x1F2F48u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F2F48u;
label_1f2f48:
...
label_1f2f4c:
    ...
    ctx->pc = 0x1F2F64u;
    {
        ...
        ctx->pc = 0x1F2F68u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F2F64u;
        // 0x1f2f68: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F2F64u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f2f6cu;
    // NOP
    if (ctx->pc == 0x1f2f6cu) { ctx->pc = 0x1f2f70u; }
}
