...
void sub_00189EC0_0x189ec0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x189E60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x189E60u, 0x189EC8u, 0x189ED0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x189ED0u;
label_189ed0:
...
label_189edc:
    ...
    ctx->pc = 0x189EE0u;
    {
        ...
        ctx->pc = 0x189EE4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x189EE0u;
        // 0x189ee4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x189EE0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
