...
label_1c8b14:
    ...
    ctx->pc = 0x1C8B14u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C8B14u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1c8b1cu;
    // NOP
    if (ctx->pc == 0x1c8b1cu) { ctx->pc = 0x1c8b20u; }
}
