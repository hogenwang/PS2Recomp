...
void sub_001BB400_0x1bb400(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BB41Cu; }
        if (ctx->pc != 0x1BB41Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bb41c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB420u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BB448u;
    if (runtime->hasFunction(0x1BB448u)) {
        auto targetFn = runtime->lookupFunction(0x1BB448u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001BB448_0x1bb448(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BB428u; }
        if (ctx->pc != 0x1BB428u) { return; }
    }
    ctx->pc = 0x1BB428u;
label_1bb428:
    ...
    ctx->pc = 0x1BB42Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB428u;
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BB430u; }
        if (ctx->pc != 0x1BB430u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bb430:
    ...
    ctx->pc = 0x1BB440u;
    {
        ...
        ctx->pc = 0x1BB444u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB440u;
