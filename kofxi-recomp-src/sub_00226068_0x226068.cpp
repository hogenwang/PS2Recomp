...
label_22609c:
    ...
    ctx->pc = 0x22609Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x22609Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2260a4u;
    // NOP
    if (ctx->pc == 0x2260a4u) { ctx->pc = 0x2260a8u; }
}
