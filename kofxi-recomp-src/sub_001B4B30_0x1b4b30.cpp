...
void sub_001B4B30_0x1b4b30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B4B40u;
    // 0x1b4b44: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C9CF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C9CF8u, 0x1B4B40u, 0x1B4B48u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B4B48u;
label_1b4b48:
    ...
    ctx->pc = 0x1B4B50u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B4B4Cu;
    // 0x1b4b50: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C9C60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C9C60u, 0x1B4B4Cu, 0x1B4B54u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B4B54u;
label_1b4b54:
    ...
    ctx->pc = 0x1B4B64u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B4B60u;
    // 0x1b4b64: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C9AD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C9AD0u, 0x1B4B60u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1B4B68u;
    ...
    ctx->pc = 0x1B4B78u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B4B74u;
    // 0x1b4b78: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C9BB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C9BB8u, 0x1B4B74u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1B4B7Cu;
    // 0x1b4b7c: 0x0  nop
    ...
    ctx->pc = 0x1B4B90u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B4B8Cu;
    // 0x1b4b90: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C9C00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C9C00u, 0x1B4B8Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1B4B94u;
    // 0x1b4b94: 0x0  nop
    ctx->pc = 0x1b4b94u;
    // NOP
    if (ctx->pc == 0x1b4b94u) { ctx->pc = 0x1b4b98u; }
}
