...
void sub_00162FC0_0x162fc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x162F60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x162F60u, 0x162FC8u, 0x162FD0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x162FD0u;
label_162fd0:
...
label_162fdc:
    ...
    ctx->pc = 0x162FE0u;
    {
        ...
        ctx->pc = 0x162FE4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x162FE0u;
        // 0x162fe4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x162FE0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x162fecu;
    // NOP
    if (ctx->pc == 0x162fecu) { ctx->pc = 0x162ff0u; }
}
