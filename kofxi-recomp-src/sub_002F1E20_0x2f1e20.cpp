...
void sub_002F1E20_0x2f1e20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F1E2Cu;
    {
        ...
        ctx->pc = 0x2F1E30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E2Cu;
...
label_2f1e34:
    ...
    ctx->pc = 0x2F1E34u;
    {
        ...
        ctx->pc = 0x2F1E38u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E34u;
...
label_2f1e48:
    ...
    ctx->pc = 0x2F1E5Cu;
    {
        ...
        ctx->pc = 0x2F1E60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E5Cu;
    ...
    ctx->pc = 0x2F1E64u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2F1E68u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E64u;
