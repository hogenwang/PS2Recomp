...
label_1e605c:
    ...
    ctx->pc = 0x1E605Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E6058u;
            // 0x1e605c: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E67D8u;
    if (runtime->hasFunction(0x1E67D8u)) {
        auto targetFn = runtime->lookupFunction(0x1E67D8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E6060u; }
        if (ctx->pc != 0x1E6060u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E67D8_0x1e67d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E6060u; }
        if (ctx->pc != 0x1E6060u) { return; }
    }
    ctx->pc = 0x1E6060u;
...
label_1e6068:
    ...
    if (runtime->hasFunction(0x1E67F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E606Cu; }
        if (ctx->pc != 0x1E606Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e6074:
    ...
    ctx->pc = 0x1E6070u;
    {
        ...
        if (branch_taken_0x1e6070) {
            ctx->pc = 0x1E6074u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1E6070u;
            // 0x1e6074: 0xdfb00000  ld          $s0, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1E60A8u;
...
label_1e608c:
    ...
    ctx->pc = 0x1E6088u;
    {
        ...
        if (branch_taken_0x1e6088) {
            ctx->pc = 0x1E608Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1E6088u;
            // 0x1e608c: 0x24420001  addiu       $v0, $v0, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 2), 1));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1E60A0u;
...
label_1e6094:
    ...
    ctx->pc = 0x1E6090u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1E6098u; }
            if (ctx->pc != 0x1E6098u) { return; }
        }
        }
    }
    ctx->pc = 0x1E6098u;
...
label_1e60b4:
    ...
    ctx->pc = 0x1E60B0u;
    {
        ...
        ctx->pc = 0x1E60B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E60B0u;
            // 0x1e60b4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_1e60cc:
    ...
    if (runtime->hasFunction(0x1E67D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E60D0u; }
        if (ctx->pc != 0x1E60D0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E67D8_0x1e67d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E60D0u; }
...
label_1e60d8:
    ...
    ctx->pc = 0x1E60D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E60D4u;
            // 0x1e60d8: 0x40882d  daddu       $s1, $v0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E67F0u;
    if (runtime->hasFunction(0x1E67F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E60DCu; }
        if (ctx->pc != 0x1E60DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E67F0_0x1e67f0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E60DCu; }
...
label_1e60e4:
    ...
    ctx->pc = 0x1E60E0u;
    {
        ...
        if (branch_taken_0x1e60e0) {
            ctx->pc = 0x1E60E4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1E60E0u;
            // 0x1e60e4: 0xdfb00000  ld          $s0, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1E6114u;
...
label_1e60f0:
    ...
    ctx->pc = 0x1E60ECu;
    {
        ...
        ctx->pc = 0x1E60F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E60ECu;
            // 0x1e60f0: 0x2443ffff  addiu       $v1, $v0, -0x1 (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 2), 4294967295));
        ctx->in_delay_slot = false;
...
label_1e60f8:
    ...
    ctx->pc = 0x1E60F4u;
    {
        ...
        ctx->pc = 0x1E60F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E60F4u;
            // 0x1e60f8: 0xae230004  sw          $v1, 0x4($s1) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 17), 4), GPR_U32(ctx, 3));
        ctx->in_delay_slot = false;
...
label_1e610c:
    ...
    ctx->pc = 0x1E6108u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1E6110u; }
            if (ctx->pc != 0x1E6110u) { return; }
        }
        }
    }
    ctx->pc = 0x1E6110u;
...
label_1e6120:
    ...
    ctx->pc = 0x1E611Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E6120u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E611Cu;
            // 0x1e6120: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
