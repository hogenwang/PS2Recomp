...
void sub_001B91B0_0x1b91b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B91BCu;
    // 0x1b91c0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1B91BCu, 0x1B91C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B91C4u;
label_1b91c4:
    ...
    ctx->pc = 0x1B91C8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B91C4u;
    // 0x1b91c8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B91E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B91E0u, 0x1B91C4u, 0x1B91CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B91CCu;
label_1b91cc:
    ...
    ctx->pc = 0x1b91dcu;
    // NOP
    if (ctx->pc == 0x1b91dcu) { ctx->pc = 0x1b91e0u; }
}
