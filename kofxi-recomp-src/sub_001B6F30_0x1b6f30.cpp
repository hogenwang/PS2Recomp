...
void sub_001B6F30_0x1b6f30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B6F40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6F3Cu;
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6F44u; }
        if (ctx->pc != 0x1B6F44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b6f44:
    ...
    if (runtime->hasFunction(0x1B6F60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6F4Cu; }
        if (ctx->pc != 0x1B6F4Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B6F60_0x1b6f60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6F4Cu; }
        if (ctx->pc != 0x1B6F4Cu) { return; }
    }
    ctx->pc = 0x1B6F4Cu;
label_1b6f4c:
    ...
    ctx->pc = 0x1B6F54u;
    ctx->pc = 0x1B6F58u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6F54u;
