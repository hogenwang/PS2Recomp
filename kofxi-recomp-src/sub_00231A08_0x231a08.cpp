...
void sub_00231A08_0x231a08(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x231A1Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x231A18u;
    ...
    if (runtime->hasFunction(0x10CB50u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x231A20u; }
        if (ctx->pc != 0x231A20u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_231a20:
    ...
    ctx->pc = 0x231A28u;
    {
        ...
        ctx->pc = 0x231A2Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x231A28u;
    ...
    ctx->pc = 0x231A30u;
    {
        ...
        ctx->pc = 0x231A34u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x231A30u;
...
label_231a38:
    ...
    ctx->pc = 0x231A3Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x231A38u;
    ...
    if (runtime->hasFunction(0x10CCA0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x231A40u; }
        if (ctx->pc != 0x231A40u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
