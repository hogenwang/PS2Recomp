...
void sub_0021FFD8_0x21ffd8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x21FFE8u;
    {
        ...
        ctx->pc = 0x21FFECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x21FFE8u;
    ...
    ctx->pc = 0x21FFF4u;
    ctx->pc = 0x21FFF8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x21FFF4u;
...
label_21fffc:
    ...
    ctx->pc = 0x220000u;
    {
        ...
        ctx->pc = 0x220004u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x220000u;
...
label_220008:
    ...
    ctx->pc = 0x22001Cu;
    {
        ...
        ctx->pc = 0x220020u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x22001Cu;
    ...
    if (runtime->hasFunction(0x221A58u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x22002Cu; }
        if (ctx->pc != 0x22002Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_22002c:
    ...
    ctx->pc = 0x22003Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x220038u;
    ...
    if (runtime->hasFunction(0x221A58u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x220040u; }
        if (ctx->pc != 0x220040u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00221A58_0x221a58(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x220040u; }
...
label_22004c:
    ...
    ctx->pc = 0x220050u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x22004Cu;
    ...
    if (runtime->hasFunction(0x221740u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x220054u; }
        if (ctx->pc != 0x220054u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
