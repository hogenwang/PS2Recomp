...
void sub_00142040_0x142040(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x142054u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x142050u;
    ...
    if (runtime->hasFunction(0x142170u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x142058u; }
        if (ctx->pc != 0x142058u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_142058:
    ...
    if (runtime->hasFunction(0x1421F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x142064u; }
        if (ctx->pc != 0x142064u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_142064:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x14206Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1420D0u;
    if (runtime->hasFunction(0x1420D0u)) {
        auto targetFn = runtime->lookupFunction(0x1420D0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x142074u; }
        if (ctx->pc != 0x142074u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001420D0_0x1420d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x142074u; }
        if (ctx->pc != 0x142074u) { return; }
    }
    ctx->pc = 0x142074u;
label_142074:
    ...
    ctx->pc = 0x142084u;
    {
        ...
        if (branch_taken_0x142084) {
            ctx->pc = 0x142088u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x142084u;
...
label_14209c:
    ...
    ctx->pc = 0x14209Cu;
    {
        ...
        if (branch_taken_0x14209c) {
            ctx->pc = 0x1420A0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x14209Cu;
