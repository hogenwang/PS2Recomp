...
void sub_00117158_0x117158(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x116F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116F08u, 0x117160u, 0x117168u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117168u;
label_117168:
    ...
    ctx->pc = 0x117048u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x117048u, 0x117168u, 0x117170u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117170u;
label_117170:
    ...
    ctx->pc = 0x117638u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x117638u, 0x117170u, 0x117178u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117178u;
label_117178:
    ...
    ctx->branch_pc = 0x117178u;
    // 0x11717c: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1177B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1177B0u, 0x117178u, 0x117180u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117180u;
label_117180:
    ...
    ctx->pc = 0x1179F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1179F0u, 0x117180u, 0x117188u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117188u;
label_117188:
    ...
    ctx->pc = 0x10DA38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10DA38u, 0x117188u, 0x117190u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117190u;
label_117190:
    ...
    ctx->pc = 0x117280u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x117280u, 0x117190u, 0x117198u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x117198u;
label_117198:
    ...
    ctx->pc = 0x116778u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116778u, 0x117198u, 0x1171A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1171A0u;
label_1171a0:
    ...
    ctx->pc = 0x1171A8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1171A4u;
    // 0x1171a8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x118ED0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x118ED0u, 0x1171A4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1171ACu;
    // 0x1171ac: 0x0  nop
    ctx->pc = 0x1171acu;
    // NOP
    if (ctx->pc == 0x1171acu) { ctx->pc = 0x1171b0u; }
}
