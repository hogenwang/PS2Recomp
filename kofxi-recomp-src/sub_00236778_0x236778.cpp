...
void sub_00236778_0x236778(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2367BCu;
    {
        ...
        ctx->pc = 0x2367C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2367BCu;
...
label_2367d0:
    ...
    ctx->pc = 0x2367D4u;
    {
        ...
        ctx->pc = 0x2367D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2367D4u;
    ...
    ctx->pc = 0x2367E0u;
    {
        ...
        if (branch_taken_0x2367e0) {
            ctx->pc = 0x2367E4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2367E0u;
...
label_236810:
    ...
    ctx->pc = 0x236824u;
    {
        ...
        ctx->pc = 0x236828u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x236824u;
