...
void sub_001C4020_0x1c4020(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C4034u;
    {
        ...
        ctx->pc = 0x1C4038u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C4034u;
...
label_1c4048:
    ...
    ctx->pc = 0x1C4058u;
    {
        ...
        ctx->pc = 0x1C405Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C4058u;
...
label_1c4094:
    ...
    ctx->pc = 0x1C4098u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C4094u;
    ...
    if (runtime->hasFunction(0x129B68u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C409Cu; }
        if (ctx->pc != 0x1C409Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c409c:
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C40A4u; }
        if (ctx->pc != 0x1C40A4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c40a4:
    ...
    ctx->pc = 0x1C40B4u;
    {
        ...
        ctx->pc = 0x1C40B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C40B4u;
...
label_1c40c4:
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C40CCu; }
        if (ctx->pc != 0x1C40CCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0012A0F8_0x12a0f8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C40CCu; }
...
label_1c40f8:
    ...
    ctx->pc = 0x1C1488u;
    {
        auto targetFn = runtime->lookupFunction(0x1C1488u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1c4110:
    ...
    ctx->pc = 0x1C411Cu;
    ctx->pc = 0x1C4120u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C411Cu;
            // 0x1c4120: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C1360u;
    {
        auto targetFn = runtime->lookupFunction(0x1C1360u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1c4128:
    ...
    ctx->pc = 0x1C13A0u;
    {
        auto targetFn = runtime->lookupFunction(0x1C13A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1c4140:
    ...
    ctx->pc = 0x1C13B0u;
    {
        auto targetFn = runtime->lookupFunction(0x1C13B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1c4158:
    ...
    ctx->pc = 0x1C1408u;
    {
        auto targetFn = runtime->lookupFunction(0x1C1408u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1c4170:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C4184u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C5B90u;
    if (runtime->hasFunction(0x1C5B90u)) {
        auto targetFn = runtime->lookupFunction(0x1C5B90u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C418Cu; }
        if (ctx->pc != 0x1C418Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C5B90_0x1c5b90(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C418Cu; }
        if (ctx->pc != 0x1C418Cu) { return; }
    }
    ctx->pc = 0x1C418Cu;
label_1c418c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C418Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C5C20u;
    if (runtime->hasFunction(0x1C5C20u)) {
        auto targetFn = runtime->lookupFunction(0x1C5C20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001C5C20_0x1c5c20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C4194u; }
        if (ctx->pc != 0x1C4194u) { return; }
    }
    ctx->pc = 0x1C4194u;
label_1c4194:
    ...
    ctx->pc = 0x1C41A0u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1C41A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C41A0u;
