...
void sub_001E8DD8_0x1e8dd8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E8DE4u;
    // 0x1e8de8: 0x8c852064  lw          $a1, 0x2064($a0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 8292)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EA980u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EA980u, 0x1E8DE4u, 0x1E8DECu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E8DECu;
label_1e8dec:
    ...
    ctx->pc = 0x1E8DF0u;
    {
        ...
        ctx->pc = 0x1E8DF4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E8DF0u;
        // 0x1e8df4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E8DF0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
