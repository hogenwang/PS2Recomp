...
void sub_002AC400_0x2ac400(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2AC424u;
    {
        ...
        ctx->pc = 0x2AC428u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2AC424u;
...
label_2ac448:
    ...
    ctx->pc = 0x2AC44Cu;
    {
        ...
        if (branch_taken_0x2ac44c) {
            ctx->pc = 0x2AC450u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2AC44Cu;
...
label_2ac464:
    ...
    ctx->pc = 0x2AC488u;
    ctx->pc = 0x2AC48Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2AC488u;
...
label_2ac490:
    ...
    ctx->pc = 0x2AC49Cu;
    {
        ...
        ctx->pc = 0x2AC4A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2AC49Cu;
