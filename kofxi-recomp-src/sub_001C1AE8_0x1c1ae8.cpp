...
label_1c1b10:
    ...
    ctx->pc = 0x1C1B20u;
    {
        ...
        if (branch_taken_0x1c1b20) {
            ctx->pc = 0x1C1B24u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1B20u;
...
label_1c1b3c:
    ...
    ctx->pc = 0x1C1B40u;
    {
        ...
        ctx->pc = 0x1C1B44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1B40u;
...
label_1c1b58:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1B64u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C1778u;
    if (runtime->hasFunction(0x1C1778u)) {
        auto targetFn = runtime->lookupFunction(0x1C1778u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001C1778_0x1c1778(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C1B6Cu; }
        if (ctx->pc != 0x1C1B6Cu) { return; }
    }
    ctx->pc = 0x1C1B6Cu;
...
label_1c1b70:
    ...
    ctx->pc = 0x1C1B70u;
    {
        ...
        ctx->pc = 0x1C1B74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1B70u;
    ...
    ctx->pc = 0x1C1B88u;
    ctx->pc = 0x1C1B8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1B88u;
...
label_1c1b90:
    ...
    ctx->pc = 0x1C1B9Cu;
    {
        ...
        ctx->pc = 0x1C1BA0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1B9Cu;
...
label_1c1ba8:
    ...
    if (runtime->hasFunction(0x1B4848u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C1BCCu; }
        if (ctx->pc != 0x1C1BCCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c1bcc:
    ...
    ctx->pc = 0x1C1BDCu;
    {
        ...
        ctx->pc = 0x1C1BE0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1BDCu;
...
label_1c1c10:
    ...
    ctx->pc = 0x1C1C20u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1C1C24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1C20u;
