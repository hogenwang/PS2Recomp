...
void sub_001C62B8_0x1c62b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C6AB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C6AB8u, 0x1C62C4u, 0x1C62CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C62CCu;
label_1c62cc:
    ...
    ctx->pc = 0x1C62D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C62CCu;
    // 0x1c62d0: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C62E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C62E8u, 0x1C62CCu, 0x1C62D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C62D4u;
label_1c62d4:
    ...
    ctx->pc = 0x1c62e4u;
    // NOP
    if (ctx->pc == 0x1c62e4u) { ctx->pc = 0x1c62e8u; }
}
