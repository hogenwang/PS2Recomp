...
void sub_0017E980_0x17e980(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x17E9B4u;
    {
        ...
        ctx->branch_pc = 0x17E9B4u;
        // 0x17e9b8: 0xac800574  sw          $zero, 0x574($a0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 4), 1396), GPR_U32(ctx, 0));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x17E9B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x17e9bcu;
    // NOP
    if (ctx->pc == 0x17e9bcu) { ctx->pc = 0x17e9c0u; }
}
