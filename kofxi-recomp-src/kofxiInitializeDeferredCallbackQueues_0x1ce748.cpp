...
// Function: kofxiInitializeDeferredCallbackQueues
// Address: 0x1ce748 - 0x1ce788
void kofxiInitializeDeferredCallbackQueues_0x1ce748(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiInitializeDeferredCallbackQueues_0x1ce748");
#endif
    ...
    ctx->pc = 0x1CE6A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE6A0u, 0x1CE764u, 0x1CE76Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1CE76Cu;
label_1ce76c:
    ...
    ctx->pc = 0x1CE780u;
    {
        ...
        ctx->pc = 0x1CE784u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1CE780u;
        // 0x1ce784: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1CE780u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
