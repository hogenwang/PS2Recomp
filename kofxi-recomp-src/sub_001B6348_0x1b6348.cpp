...
void sub_001B6348_0x1b6348(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B6364u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B6360u;
    // 0x1b6364: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ABA30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ABA30u, 0x1B6360u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1B6368u;
label_1b6368:
    ...
    ctx->pc = 0x1B636Cu;
    {
        ...
        ctx->pc = 0x1B6370u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B636Cu;
        // 0x1b6370: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B636Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1b6374u;
    // NOP
    if (ctx->pc == 0x1b6374u) { ctx->pc = 0x1b6378u; }
}
