...
void sub_003221B0_0x3221b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x322234u;
    {
        ...
        if (branch_taken_0x322234) {
            ctx->pc = 0x322238u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x322234u;
...
label_322244:
    ...
    ctx->pc = 0x322254u;
    {
        ...
        ctx->pc = 0x322258u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322254u;
    ...
    ctx->pc = 0x32226Cu;
    {
        ...
        ctx->pc = 0x322270u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x32226Cu;
...
label_3222c4:
    ...
    ctx->pc = 0x3222DCu;
    {
        ...
        ctx->pc = 0x3222E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3222DCu;
...
label_322558:
    ...
    ctx->pc = 0x32259Cu;
    {
        ...
        ctx->pc = 0x3225A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x32259Cu;
...
label_3225a8:
    ...
    ctx->pc = 0x3225CCu;
    {
        ...
        ctx->pc = 0x3225D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3225CCu;
