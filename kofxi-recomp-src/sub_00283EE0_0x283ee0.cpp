...
void sub_00283EE0_0x283ee0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x283EE8u;
    {
        ...
        ctx->pc = 0x283EECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x283EE8u;
    ...
    ctx->pc = 0x283EF4u;
    {
        ...
        ctx->pc = 0x283EF8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x283EF4u;
...
label_283f40:
    ...
    ctx->pc = 0x283F40u;
    {
        ...
        ctx->pc = 0x283F44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x283F40u;
...
label_283f50:
    ...
    ctx->pc = 0x283F5Cu;
    {
        ...
        ctx->pc = 0x283F60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x283F5Cu;
...
label_283f64:
    ...
    ctx->pc = 0x283F6Cu;
    {
        ...
        if (branch_taken_0x283f6c) {
            ctx->pc = 0x283F70u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x283F6Cu;
