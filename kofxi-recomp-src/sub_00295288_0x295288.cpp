...
void sub_00295288_0x295288(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x295294u;
    {
        ...
        ctx->pc = 0x295298u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295294u;
...
label_2952a0:
    ...
    ctx->pc = 0x2952A4u;
    {
        ...
        if (branch_taken_0x2952a4) {
            ctx->pc = 0x2952A8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2952A4u;
    ...
    ctx->pc = 0x295334u;
    {
        ...
        ctx->pc = 0x295338u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295334u;
...
label_295354:
    ...
    ctx->pc = 0x295398u;
    {
        ...
        ctx->pc = 0x29539Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295398u;
    ...
    ctx->pc = 0x2953B4u;
    {
        ...
        ctx->pc = 0x2953B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2953B4u;
...
label_2953c8:
    ...
    ctx->pc = 0x2953D8u;
    {
        ...
        ctx->pc = 0x2953DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2953D8u;
