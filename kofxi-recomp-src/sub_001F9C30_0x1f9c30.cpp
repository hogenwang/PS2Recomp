...
void sub_001F9C30_0x1f9c30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F9C40u;
    {
        ...
        ctx->pc = 0x1F9C44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9C40u;
    ...
    ctx->pc = 0x1F9C50u;
    {
        ...
        ctx->pc = 0x1F9C54u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9C50u;
...
label_1f9c94:
    ...
    ctx->pc = 0x1F9CB0u;
    {
        ...
        ctx->pc = 0x1F9CB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9CB0u;
...
label_1f9cbc:
    ...
    ctx->pc = 0x1F9CBCu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1F9CC0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9CBCu;
