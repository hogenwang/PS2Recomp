...
label_224fb0:
    ...
    ctx->pc = 0x224FB0u;
    {
        ...
        ctx->pc = 0x224FB4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x224FB0u;
        // 0x224fb4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x224FB0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_224fb8:
    ...
    ctx->pc = 0x224FC4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x224FC0u;
    // 0x224fc4: 0x160302d  daddu       $a2, $t3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 11) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x225148u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x225148u, 0x224FC0u, 0x224FC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x224FC8u;
label_224fc8:
...
label_224fd0:
    ...
    ctx->pc = 0x2250F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2250F0u, 0x224FD0u, 0x224FD8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x224FD8u;
label_224fd8:
