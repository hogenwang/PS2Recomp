...
void sub_0022A9A0_0x22a9a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x22A9A8u;
    // 0x22a9ac: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x22A9E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22A9E0u, 0x22A9A8u, 0x22A9B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x22A9B0u;
label_22a9b0:
    ...
    ctx->pc = 0x22A9B4u;
    {
        ...
        ctx->pc = 0x22A9B8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x22A9B4u;
        // 0x22a9b8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x22A9B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x22A9CCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x22A9C8u;
    // 0x22a9cc: 0x24080001  addiu       $t0, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 8, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x22A9E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22A9E0u, 0x22A9C8u, 0x22A9D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x22A9D0u;
label_22a9d0:
    ...
    ctx->pc = 0x22A9D4u;
    {
        ...
        ctx->pc = 0x22A9D8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x22A9D4u;
        // 0x22a9d8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x22A9D4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x22a9dcu;
    // NOP
    if (ctx->pc == 0x22a9dcu) { ctx->pc = 0x22a9e0u; }
}
