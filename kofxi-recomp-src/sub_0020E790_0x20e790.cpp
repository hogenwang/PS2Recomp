...
void sub_0020E790_0x20e790(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20E7B4u;
    {
        ...
        ctx->pc = 0x20E7B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E7B4u;
...
label_20e7c0:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20E7C4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x20E6F0u;
    if (runtime->hasFunction(0x20E6F0u)) {
        auto targetFn = runtime->lookupFunction(0x20E6F0u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0020E6F0_0x20e6f0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E7CCu; }
        if (ctx->pc != 0x20E7CCu) { return; }
    }
    ctx->pc = 0x20E7CCu;
label_20e7cc:
    ...
    ctx->pc = 0x20E7D8u;
    {
        ...
        if (branch_taken_0x20e7d8) {
            ctx->pc = 0x20E7DCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x20E7D8u;
...
label_20e7e0:
    ...
    ctx->pc = 0x20E7F0u;
    {
        ...
        ctx->pc = 0x20E7F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E7F0u;
