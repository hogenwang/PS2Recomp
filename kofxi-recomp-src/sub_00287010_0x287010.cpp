...
void sub_00287010_0x287010(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x28701Cu;
    {
        ...
        if (branch_taken_0x28701c) {
            ctx->pc = 0x287020u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x28701Cu;
    ...
    ctx->pc = 0x287024u;
    {
        ...
        ctx->pc = 0x287028u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x287024u;
...
label_287030:
    ...
    ctx->pc = 0x287038u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x28703Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x287038u;
...
label_287040:
    ...
    ctx->pc = 0x287044u;
    {
        ...
        ctx->pc = 0x287048u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x287044u;
...
label_287058:
    ...
    ctx->pc = 0x28706Cu;
    {
        ...
        ctx->pc = 0x287070u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28706Cu;
