...
void sub_002940B8_0x2940b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2940DCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2940D8u;
    ...
    if (runtime->hasFunction(0x2A23F0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2940E0u; }
        if (ctx->pc != 0x2940E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2940e0:
    ...
    ctx->pc = 0x2940E4u;
    {
        ...
        ctx->pc = 0x2940E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2940E4u;
