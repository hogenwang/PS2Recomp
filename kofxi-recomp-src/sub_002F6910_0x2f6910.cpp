...
void sub_002F6910_0x2f6910(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F6918u;
    {
        ...
        ctx->pc = 0x2F691Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F6918u;
    ...
    ctx->pc = 0x2F6938u;
    {
        ...
        ctx->pc = 0x2F693Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F6938u;
...
label_2f6948:
    ...
    ctx->pc = 0x2F6978u;
    {
        ...
        ctx->pc = 0x2F697Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F6978u;
...
label_2f6980:
    ...
    ctx->pc = 0x2F6984u;
    {
        ...
        ctx->pc = 0x2F6988u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F6984u;
