...
label_2f07a8:
    ...
    ctx->pc = 0x2F07D0u;
    {
        ...
        ctx->pc = 0x2F07D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F07D0u;
    ...
    ctx->pc = 0x2F07E4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2F07E0u;
    ...
    if (runtime->hasFunction(0x127120u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F07E8u; }
        if (ctx->pc != 0x2F07E8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2f07e8:
    ...
    ctx->pc = 0x2F07F8u;
    {
        ...
        ctx->pc = 0x2F07FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F07F8u;
