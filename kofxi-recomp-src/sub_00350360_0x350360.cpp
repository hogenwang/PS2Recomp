...
label_350360:
    ...
    ctx->branch_pc = 0x350374u;
    // 0x350378: 0xa0409738  sb          $zero, -0x68C8($v0) (Delay Slot)
    WRITE8(ADD32(GPR_U32(ctx, 2), 4294940472), (uint8_t)GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x155A10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x155A10u, 0x350374u, 0x35037Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x35037Cu;
label_35037c:
    ...
    ctx->pc = 0x350394u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x350390u;
    // 0x350394: 0xac40beb8  sw          $zero, -0x4148($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 4294950584), GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x154700u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x154700u, 0x350390u, 0x350398u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x350398u;
label_350398:
    ...
    ctx->pc = 0x3503A0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x35039Cu;
    // 0x3503a0: 0xac40bdc8  sw          $zero, -0x4238($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 4294950344), GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1A4B00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A4B00u, 0x35039Cu, 0x3503A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3503A4u;
label_3503a4:
    ...
    ctx->pc = 0x32C7D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x32C7D0u, 0x3503A4u, 0x3503ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3503ACu;
label_3503ac:
    ...
    ctx->pc = 0x3503B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3503B4u;
    // 0x3503b8: 0xac40d9c0  sw          $zero, -0x2640($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 4294957504), GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x155780u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x155780u, 0x3503B4u, 0x3503BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3503BCu;
label_3503bc:
    ...
    ctx->pc = 0x3503D8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3503D4u;
    // 0x3503d8: 0xa043dae0  sb          $v1, -0x2520($v0) (Delay Slot)
    WRITE8(ADD32(GPR_U32(ctx, 2), 4294957792), (uint8_t)GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2099D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2099D0u, 0x3503D4u, 0x3503DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3503DCu;
label_3503dc:
    ...
    ctx->pc = 0x3503E4u;
    {
        ...
        ctx->pc = 0x3503E8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x3503E4u;
        // 0x3503e8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x3503E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x350444u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x350440u;
    // 0x350444: 0xa062dae0  sb          $v0, -0x2520($v1) (Delay Slot)
    WRITE8(ADD32(GPR_U32(ctx, 3), 4294957792), (uint8_t)GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x301FD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x301FD0u, 0x350440u, 0x350448u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x350448u;
label_350448:
    ...
    ctx->pc = 0x350450u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x35044Cu;
    // 0x350450: 0x24050009  addiu       $a1, $zero, 0x9 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 9));
    ctx->in_delay_slot = false;
    ctx->pc = 0x301AE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x301AE0u, 0x35044Cu, 0x350454u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x350454u;
label_350454:
    ...
    ctx->pc = 0x301890u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x301890u, 0x350454u, 0x35045Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x35045Cu;
label_35045c:
...
label_350464:
    ...
    ctx->pc = 0x350468u;
    {
        ...
        ctx->pc = 0x35046Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x350468u;
        // 0x35046c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x350468u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x350480u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x35047Cu;
    // 0x350480: 0x248452f0  addiu       $a0, $a0, 0x52F0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 21232));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x35047Cu, 0x350484u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x350484u;
label_350484:
    ...
    ctx->pc = 0x350498u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x350494u;
    // 0x350498: 0xac439478  sw          $v1, -0x6B88($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 4294939768), GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2099D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2099D0u, 0x350494u, 0x35049Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x35049Cu;
label_35049c:
    ...
    ctx->pc = 0x3504A0u;
    {
        ...
        ctx->pc = 0x3504A4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x3504A0u;
        // 0x3504a4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x3504A0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x300F30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x300F30u, 0x3504B8u, 0x3504C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3504C0u;
label_3504c0:
    ...
    ctx->pc = 0x3504D4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3504D0u;
    // 0x3504d4: 0xa443be96  sh          $v1, -0x416A($v0) (Delay Slot)
    WRITE16(ADD32(GPR_U32(ctx, 2), 4294950550), (uint16_t)GPR_U32(ctx, 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2099D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2099D0u, 0x3504D0u, 0x3504D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3504D8u;
label_3504d8:
    ...
    ctx->pc = 0x3504DCu;
    {
        ...
        ctx->pc = 0x3504E0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x3504DCu;
        // 0x3504e0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x3504DCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x350520u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x35051Cu;
    // 0x350520: 0x2404000d  addiu       $a0, $zero, 0xD (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 13));
    ctx->in_delay_slot = false;
    ctx->pc = 0x346C60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x346C60u, 0x35051Cu, 0x350524u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x350524u;
label_350524:
...
label_350528:
    ...
    ctx->pc = 0x350528u;
    {
        ...
        ctx->pc = 0x35052Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x350528u;
        // 0x35052c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x350528u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
