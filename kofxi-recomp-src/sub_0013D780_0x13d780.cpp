...
void sub_0013D780_0x13d780(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13D78Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13D788u;
    ...
    if (runtime->hasFunction(0x18A210u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x13D790u; }
        if (ctx->pc != 0x13D790u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13d790:
    ...
    ctx->pc = 0x13D79Cu;
    {
        ...
        if (branch_taken_0x13d79c) {
            ctx->pc = 0x13D7A0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13D79Cu;
    ...
    ctx->pc = 0x13D7A4u;
    {
        ...
        ctx->pc = 0x13D7A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13D7A4u;
...
label_13d7ac:
    ...
    ctx->pc = 0x13D7ACu;
    {
        ...
        if (branch_taken_0x13d7ac) {
            ctx->pc = 0x13D7B0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13D7ACu;
    ...
    ctx->pc = 0x13D7B4u;
    {
        ...
        ctx->pc = 0x13D7B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13D7B4u;
...
label_13d7bc:
    ...
    ctx->pc = 0x13D7C4u;
    {
        ...
        ctx->pc = 0x13D7C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13D7C4u;
...
label_13d7cc:
    ...
    ctx->pc = 0x13D7D0u;
    {
        ...
        ctx->pc = 0x13D7D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13D7D0u;
