...
void sub_001B1270_0x1b1270(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B127Cu;
    {
        ...
        ctx->pc = 0x1B1280u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B127Cu;
    ...
    ctx->pc = 0x1B128Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1288u;
    ...
    if (runtime->hasFunction(0x1AE828u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1290u; }
        if (ctx->pc != 0x1B1290u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b1290:
    ...
    ctx->pc = 0x1B1294u;
    {
        ...
        ctx->pc = 0x1B1298u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1294u;
...
label_1b12ac:
    ...
    ctx->pc = 0x1B12B4u;
    {
        ...
        ctx->pc = 0x1B12B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B12B4u;
