...
void sub_0022D8B0_0x22d8b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x22D8B4u;
    {
        ...
        ctx->branch_pc = 0x22D8B4u;
        // 0x22d8b8: 0xac44f9f8  sw          $a0, -0x608($v0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 2), 4294965752), GPR_U32(ctx, 4));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x22D8B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x22d8bcu;
    // NOP
    if (ctx->pc == 0x22d8bcu) { ctx->pc = 0x22d8c0u; }
}
