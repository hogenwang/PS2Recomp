...
// Function: kofxiScanActiveCallbackSlots
// Address: 0x1c6418 - 0x1c6478
void kofxiScanActiveCallbackSlots_0x1c6418(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiScanActiveCallbackSlots_0x1c6418");
#endif
...
label_1c6440:
    ...
    ctx->pc = 0x1C6450u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C644Cu;
    // 0x1c6450: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C6FF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C6FF8u, 0x1C644Cu, 0x1C6454u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C6454u;
label_1c6454:
...
label_1c6458:
    ...
    ctx->pc = 0x1C6470u;
    {
        ...
        ctx->pc = 0x1C6474u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C6470u;
        // 0x1c6474: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C6470u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
