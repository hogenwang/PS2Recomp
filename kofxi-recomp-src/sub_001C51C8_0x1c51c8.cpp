...
void sub_001C51C8_0x1c51c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C51B0u;
    if (runtime->hasFunction(0x1C51B0u)) {
        auto targetFn = runtime->lookupFunction(0x1C51B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C51ECu; }
        if (ctx->pc != 0x1C51ECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c51ec:
    ...
    ctx->pc = 0x1C51F4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C51F0u;
    ...
    if (runtime->hasFunction(0x1C51B0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C51F8u; }
        if (ctx->pc != 0x1C51F8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C51B0_0x1c51b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C51F8u; }
