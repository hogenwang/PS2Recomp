...
void sub_001E5A50_0x1e5a50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E5A6Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5A68u;
    // 0x1e5a6c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C6370u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C6370u, 0x1E5A68u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E5A70u;
label_1e5a70:
    ...
    ctx->pc = 0x1E5A74u;
    {
        ...
        ctx->pc = 0x1E5A78u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E5A74u;
        // 0x1e5a78: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E5A74u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e5a7cu;
    // NOP
    if (ctx->pc == 0x1e5a7cu) { ctx->pc = 0x1e5a80u; }
}
