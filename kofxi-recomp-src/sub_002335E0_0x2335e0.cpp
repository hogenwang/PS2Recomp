...
void sub_002335E0_0x2335e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x233600u;
    {
        ...
        ctx->pc = 0x233604u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x233600u;
...
label_233610:
    ...
    ctx->pc = 0x23362Cu;
    {
        ...
        ctx->pc = 0x233630u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x23362Cu;
...
label_23363c:
    ...
    ctx->pc = 0x23363Cu;
    {
        ...
        ctx->pc = 0x233640u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x23363Cu;
...
label_233648:
    ...
    ctx->pc = 0x233660u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x23365Cu;
    ...
    if (runtime->hasFunction(0x233D80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x233664u; }
        if (ctx->pc != 0x233664u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_233664:
    ...
    ctx->pc = 0x23367Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x233678u;
    ...
    if (runtime->hasFunction(0x2336A8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x233680u; }
        if (ctx->pc != 0x233680u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_233680:
    ...
    ctx->pc = 0x233684u;
    {
        ...
        if (branch_taken_0x233684) {
            ctx->pc = 0x233688u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x233684u;
...
label_23368c:
    ...
    ctx->pc = 0x2336A0u;
    {
        ...
        ctx->pc = 0x2336A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2336A0u;
