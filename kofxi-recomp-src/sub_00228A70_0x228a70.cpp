...
void sub_00228A70_0x228a70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x228A9Cu;
    // 0x228aa0: 0x24040007  addiu       $a0, $zero, 0x7 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 7));
    ctx->in_delay_slot = false;
    ctx->pc = 0x22D6B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22D6B0u, 0x228A9Cu, 0x228AA4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x228AA4u;
label_228aa4:
...
label_228ab0:
    ...
    ctx->pc = 0x228accu;
    // NOP
    if (ctx->pc == 0x228accu) { ctx->pc = 0x228ad0u; }
}
