...
label_1a0d54:
    ...
    ctx->branch_pc = 0x1A0D70u;
    // 0x1a0d74: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19FFC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19FFC0u, 0x1A0D70u, 0x1A0D78u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A0D78u;
label_1a0d78:
...
label_1a0d98:
    ...
    ctx->pc = 0x1A0DB4u;
    {
        ...
        ctx->pc = 0x1A0DB8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1A0DB4u;
        // 0x1a0db8: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A0DB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a0dbcu;
    // NOP
    if (ctx->pc == 0x1a0dbcu) { ctx->pc = 0x1a0dc0u; }
}
