...
void sub_002041A0_0x2041a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2041B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2041B0u;
    ...
    if (runtime->hasFunction(0x205210u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2041B8u; }
        if (ctx->pc != 0x2041B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2041b8:
    ...
    ctx->pc = 0x2041BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2041B8u;
    ...
    if (runtime->hasFunction(0x2041D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2041C0u; }
        if (ctx->pc != 0x2041C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2041c0:
    ...
    ctx->pc = 0x2041C4u;
    {
        ...
        ctx->pc = 0x2041C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2041C4u;
