...
label_30c294:
    ...
    ctx->pc = 0x30C294u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x30C294u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x30c29cu;
    // NOP
    if (ctx->pc == 0x30c29cu) { ctx->pc = 0x30c2a0u; }
}
