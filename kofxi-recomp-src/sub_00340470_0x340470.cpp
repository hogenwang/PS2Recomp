...
void sub_00340470_0x340470(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x340494u;
    {
        ...
        ctx->pc = 0x340498u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x340494u;
...
label_3404a0:
    ...
    ctx->pc = 0x3404A8u;
    {
        ...
        ctx->pc = 0x3404ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3404A8u;
...
label_3404b0:
    ...
    ctx->pc = 0x3404B4u;
    {
        ...
        ctx->pc = 0x3404B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3404B4u;
...
label_3404c8:
    ...
    ctx->pc = 0x3404C8u;
    {
        ...
        ctx->pc = 0x3404CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3404C8u;
