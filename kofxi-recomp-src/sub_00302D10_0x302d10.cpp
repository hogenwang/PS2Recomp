...
void sub_00302D10_0x302d10(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x302D50u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x302D4Cu;
    ...
    if (runtime->hasFunction(0x302EA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x302D54u; }
        if (ctx->pc != 0x302D54u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_302d54:
    ...
    ctx->pc = 0x302D58u;
    {
        ...
        ctx->pc = 0x302D5Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x302D58u;
