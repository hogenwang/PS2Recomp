...
void sub_0013CE20_0x13ce20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13CE40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CE3Cu;
    ...
    if (runtime->hasFunction(0x171AB0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x13CE44u; }
        if (ctx->pc != 0x13CE44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13ce44:
    ...
    ctx->pc = 0x13CE5Cu;
    {
        ...
        if (branch_taken_0x13ce5c) {
            ctx->pc = 0x13CE60u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13CE5Cu;
    ...
    ctx->pc = 0x13CE68u;
    {
        ...
        if (branch_taken_0x13ce68) {
            ctx->pc = 0x13CE6Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13CE68u;
    ...
    ctx->pc = 0x13CE88u;
    {
        ...
        ctx->pc = 0x13CE8Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13CE88u;
...
label_13ce94:
    ...
    ctx->pc = 0x13CEA0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CE9Cu;
...
label_13cea4:
    ...
    ctx->pc = 0x13CEA4u;
    {
        ...
        ctx->pc = 0x13CEA8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13CEA4u;
...
label_13ceac:
    ...
    ctx->pc = 0x13CEB8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CEB4u;
...
label_13cec4:
    ...
    ctx->pc = 0x13CECCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13CEC8u;
...
label_13ced4:
    ...
    ctx->pc = 0x13CED8u;
    {
        ...
        ctx->pc = 0x13CEDCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13CED8u;
