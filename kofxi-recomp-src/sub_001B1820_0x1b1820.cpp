...
void sub_001B1820_0x1b1820(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B183Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1838u;
    ...
    if (runtime->hasFunction(0x127088u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1840u; }
        if (ctx->pc != 0x1B1840u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b1840:
    ...
    ctx->pc = 0x1B1840u;
    {
        ...
        ctx->pc = 0x1B1844u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1840u;
...
label_1b1880:
    ...
    ctx->pc = 0x1B1884u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1B1888u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1884u;
...
label_1b1890:
    ...
    ctx->pc = 0x1B18A8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B18A4u;
    ...
    if (runtime->hasFunction(0x1B1AB0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B18ACu; }
        if (ctx->pc != 0x1B18ACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b18ac:
    ...
    ctx->pc = 0x1B18B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B18B0u;
            // 0x1b18b4: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B18D0u;
    if (runtime->hasFunction(0x1B18D0u)) {
        auto targetFn = runtime->lookupFunction(0x1B18D0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B18B8u; }
        if (ctx->pc != 0x1B18B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B18D0_0x1b18d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B18B8u; }
        if (ctx->pc != 0x1B18B8u) { return; }
    }
    ctx->pc = 0x1B18B8u;
label_1b18b8:
    ...
    ctx->pc = 0x1B18C4u;
    ctx->pc = 0x1B18C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B18C4u;
