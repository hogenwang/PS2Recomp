...
void sub_001944E0_0x1944e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1944E8u;
    {
        ...
        if (branch_taken_0x1944e8) {
            ctx->pc = 0x1944ECu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1944E8u;
    ...
    ctx->pc = 0x194518u;
    {
        ...
        ctx->pc = 0x19451Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x194518u;
...
label_194520:
    ...
    ctx->pc = 0x19452Cu;
    {
        ...
        ctx->pc = 0x194530u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x19452Cu;
...
label_194534:
    ...
    ctx->pc = 0x194544u;
    {
        ...
        ctx->pc = 0x194548u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x194544u;
