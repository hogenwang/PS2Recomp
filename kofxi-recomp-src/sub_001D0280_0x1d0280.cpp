...
label_1d029c:
    ...
    ctx->pc = 0x1D0298u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D0298u, 0x1D02A0u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1D02A0u;
...
label_1d02a8:
    ...
    ctx->pc = 0x1D02A4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D02A4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1d02ac:
    ...
    ctx->pc = 0x1d02acu;
    // NOP
    if (ctx->pc == 0x1d02acu) { ctx->pc = 0x1d02b0u; }
}
