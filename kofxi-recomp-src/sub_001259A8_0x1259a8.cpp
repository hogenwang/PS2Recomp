...
void sub_001259A8_0x1259a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1259CCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1259C8u;
            // 0x1259cc: 0xc0282d  daddu       $a1, $a2, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x10D418u;
    if (runtime->hasFunction(0x10D418u)) {
        auto targetFn = runtime->lookupFunction(0x10D418u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1259D0u; }
        if (ctx->pc != 0x1259D0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010D418_0x10d418(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1259D0u; }
        if (ctx->pc != 0x1259D0u) { return; }
    }
    ctx->pc = 0x1259D0u;
label_1259d0:
    ...
    ctx->pc = 0x1259D4u;
    {
        ...
        if (branch_taken_0x1259d4) {
            ctx->pc = 0x1259D8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1259D4u;
...
label_1259ec:
    ...
    ctx->pc = 0x1259F4u;
    {
        ...
        ctx->pc = 0x1259F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1259F4u;
