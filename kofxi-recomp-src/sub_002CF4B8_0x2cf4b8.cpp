...
void sub_002CF4B8_0x2cf4b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2CF4BCu;
    {
        ...
        ctx->pc = 0x2CF4C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF4BCu;
...
label_2cf4c8:
    ...
    ctx->pc = 0x2CF4DCu;
    {
        ...
        ctx->pc = 0x2CF4E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF4DCu;
...
label_2cf500:
    ...
    ctx->pc = 0x2CF510u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF50Cu;
            // 0x2cf510: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2CF750u;
    if (runtime->hasFunction(0x2CF750u)) {
        auto targetFn = runtime->lookupFunction(0x2CF750u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CF514u; }
        if (ctx->pc != 0x2CF514u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002CF750_0x2cf750(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CF514u; }
        if (ctx->pc != 0x2CF514u) { return; }
    }
    ctx->pc = 0x2CF514u;
label_2cf514:
    ...
    ctx->pc = 0x2CF528u;
    ctx->pc = 0x2CF52Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF528u;
