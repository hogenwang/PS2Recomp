...
void sub_001BA138_0x1ba138(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1BA148u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA144u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA14Cu; }
        if (ctx->pc != 0x1BA14Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba14c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA14Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BA170u;
    if (runtime->hasFunction(0x1BA170u)) {
        auto targetFn = runtime->lookupFunction(0x1BA170u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
...
label_1ba154:
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA15Cu; }
        if (ctx->pc != 0x1BA15Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba15c:
    ...
    ctx->pc = 0x1BA168u;
    {
        ...
        ctx->pc = 0x1BA16Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA168u;
