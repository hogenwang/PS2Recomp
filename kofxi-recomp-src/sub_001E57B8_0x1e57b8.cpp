...
void sub_001E57B8_0x1e57b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E57E0u;
    // 0x1e57e4: 0xe0a02d  daddu       $s4, $a3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 20, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2960u, 0x1E57E0u, 0x1E57E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E57E8u;
label_1e57e8:
...
label_1e5828:
    ...
    ctx->pc = 0x1E1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E1AC8u, 0x1E5828u, 0x1E5830u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5830u;
label_1e5830:
    ...
    ctx->pc = 0x1E5834u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5830u;
    // 0x1e5834: 0x8e040048  lw          $a0, 0x48($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 72)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C62B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C62B8u, 0x1E5830u, 0x1E5838u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5838u;
label_1e5838:
    ...
    ctx->pc = 0x1E5848u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5844u;
    // 0x1e5848: 0x240282d  daddu       $a1, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5730u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5730u, 0x1E5844u, 0x1E584Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E584Cu;
label_1e584c:
    ...
    ctx->pc = 0x1E5854u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5850u;
    // 0x1e5854: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E53A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E53A0u, 0x1E5850u, 0x1E5858u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5858u;
label_1e5858:
    ...
    ctx->pc = 0x1E585Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5858u;
    // 0x1e585c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5300u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5300u, 0x1E5858u, 0x1E5860u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5860u;
label_1e5860:
...
label_1e5880:
    ...
    ctx->pc = 0x1E5898u;
    {
        ...
        ctx->pc = 0x1E589Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E5898u;
        // 0x1e589c: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E5898u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1E58B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E58B4u;
    // 0x1e58b8: 0x80882d  daddu       $s1, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2960u, 0x1E58B4u, 0x1E58BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E58BCu;
label_1e58bc:
    ...
    ctx->pc = 0x1E58D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E58CCu;
    // 0x1e58d0: 0x2484e370  addiu       $a0, $a0, -0x1C90 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294959984));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E6BE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6BE8u, 0x1E58CCu, 0x1E58D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E58D4u;
label_1e58d4:
...
label_1e58e0:
    ...
    ctx->pc = 0x1E5590u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5590u, 0x1E58E0u, 0x1E58E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E58E8u;
label_1e58e8:
    ...
    ctx->pc = 0x1E5904u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5900u;
    // 0x1e5904: 0x2484e3a0  addiu       $a0, $a0, -0x1C60 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294960032));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E6BE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6BE8u, 0x1E5900u, 0x1E5908u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5908u;
label_1e5908:
...
label_1e5910:
    ...
    ctx->pc = 0x1E5914u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5910u;
    // 0x1e5914: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5968u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5968u, 0x1E5910u, 0x1E5918u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5918u;
label_1e5918:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5980u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5980u, 0x1E592Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E5934u;
    // 0x1e5934: 0x0  nop
...
label_1e5938:
    ...
    ctx->pc = 0x1E5944u;
    {
        ...
        ctx->pc = 0x1E5948u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E5944u;
        // 0x1e5948: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E5944u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
