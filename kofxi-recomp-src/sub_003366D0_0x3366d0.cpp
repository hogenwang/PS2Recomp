...
void sub_003366D0_0x3366d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x3366F8u;
    {
        ...
        ctx->pc = 0x3366FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3366F8u;
...
label_336710:
    ...
    ctx->pc = 0x336714u;
    {
        ...
        if (branch_taken_0x336714) {
            ctx->pc = 0x336718u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x336714u;
...
label_336730:
    ...
    ctx->pc = 0x336734u;
    {
        ...
        if (branch_taken_0x336734) {
            ctx->pc = 0x336738u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x336734u;
    ...
    ctx->pc = 0x336744u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x336740u;
    ...
    if (runtime->hasFunction(0x14E3F0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x336748u; }
        if (ctx->pc != 0x336748u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_336748:
    ...
    ctx->pc = 0x336754u;
    {
        ...
        ctx->pc = 0x336758u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x336754u;
...
label_336768:
    ...
    ctx->pc = 0x336770u;
    {
        ...
        if (branch_taken_0x336770) {
            ctx->pc = 0x336774u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x336770u;
    ...
    ctx->pc = 0x336788u;
    {
        ...
        ctx->pc = 0x33678Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x336788u;
