...
label_1b7c38:
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7C4Cu; }
        if (ctx->pc != 0x1B7C4Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7c4c:
    ...
    ctx->pc = 0x1B7C50u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7C4Cu;
            // 0x1b7c50: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B7C70u;
    if (runtime->hasFunction(0x1B7C70u)) {
        auto targetFn = runtime->lookupFunction(0x1B7C70u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7C54u; }
        if (ctx->pc != 0x1B7C54u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B7C70_0x1b7c70(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7C54u; }
        if (ctx->pc != 0x1B7C54u) { return; }
    }
    ctx->pc = 0x1B7C54u;
label_1b7c54:
    ...
    ctx->pc = 0x1B7C58u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7C54u;
    ...
    if (runtime->hasFunction(0x1B8168u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7C5Cu; }
        if (ctx->pc != 0x1B7C5Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7c5c:
    ...
    ctx->pc = 0x1B7C68u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1B7C6Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7C68u;
