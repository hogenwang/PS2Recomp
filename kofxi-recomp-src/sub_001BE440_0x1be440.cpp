...
void sub_001BE440_0x1be440(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BE454u; }
        if (ctx->pc != 0x1BE454u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1be454:
    ...
    ctx->pc = 0x1BE458u;
    {
        ...
        ctx->pc = 0x1BE45Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE458u;
...
label_1be468:
    ...
    ctx->pc = 0x1BE47Cu;
    {
        ...
        ctx->pc = 0x1BE480u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE47Cu;
...
label_1be488:
    ...
    ctx->pc = 0x1BE488u;
    {
        ...
        ctx->pc = 0x1BE48Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE488u;
...
label_1be490:
    ...
    ctx->pc = 0x1BE498u;
    {
        ...
        ctx->pc = 0x1BE49Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE498u;
...
label_1be4a0:
    ...
    ctx->pc = 0x1BE4C0u;
    {
        ...
        ctx->pc = 0x1BE4C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE4C0u;
...
label_1be508:
    ...
    ctx->pc = 0x1BE50Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE508u;
...
label_1be528:
    ...
    if (runtime->hasFunction(0x12A3E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BE540u; }
        if (ctx->pc != 0x1BE540u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1be550:
    ...
    ctx->pc = 0x1BE56Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1BE570u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE56Cu;
