...
label_188ff0:
    ...
    ctx->pc = 0x188FF0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x188FF0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x189010u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18900Cu;
    // 0x189010: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1890A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1890A0u, 0x18900Cu, 0x189014u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x189014u;
label_189014:
...
label_18902c:
    ...
    ctx->pc = 0x18B570u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18B570u, 0x18902Cu, 0x189034u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x189034u;
label_189034:
...
label_189044:
    ...
    ctx->pc = 0x18905Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x189058u;
    // 0x18905c: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x164C60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x164C60u, 0x189058u, 0x189060u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x189060u;
label_189060:
...
label_189074:
    ...
    ctx->pc = 0x18907Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x189078u;
    // 0x18907c: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x164C60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x164C60u, 0x189078u, 0x189080u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x189080u;
label_189080:
...
label_189094:
    ...
    ctx->pc = 0x189098u;
    {
        ...
        ctx->pc = 0x18909Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x189098u;
        // 0x18909c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x189098u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
