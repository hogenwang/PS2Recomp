...
void sub_002413A8_0x2413a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2413CCu;
    {
        ...
        ctx->pc = 0x2413D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2413CCu;
...
label_2413d4:
    ...
    ctx->pc = 0x2413D4u;
    {
        ...
        ctx->pc = 0x2413D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2413D4u;
...
label_2413e8:
    ...
    ctx->pc = 0x2413F8u;
    {
        ...
        ctx->pc = 0x2413FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2413F8u;
...
label_241400:
    ...
    ctx->pc = 0x241414u;
    {
        ...
        ctx->pc = 0x241418u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x241414u;
    ...
    ctx->pc = 0x241424u;
    {
        ...
        ctx->pc = 0x241428u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x241424u;
...
label_24142c:
    ...
    ctx->pc = 0x24142Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x241430u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x24142Cu;
