...
void sub_0031F0A0_0x31f0a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x31F1ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x31F1A8u;
    ...
    if (runtime->hasFunction(0x10CEE0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x31F1B0u; }
        if (ctx->pc != 0x31F1B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_31f1b0:
    ...
    if (runtime->hasFunction(0x102810u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x31F1C4u; }
        if (ctx->pc != 0x31F1C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_31f1c8:
    ...
    ctx->pc = 0x31F1E8u;
    {
        ...
        ctx->pc = 0x31F1ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x31F1E8u;
