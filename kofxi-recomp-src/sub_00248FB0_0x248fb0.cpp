...
label_248fcc:
    ...
    ctx->pc = 0x248FE0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x248FDCu;
    ...
    if (runtime->hasFunction(0x228950u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x248FE4u; }
        if (ctx->pc != 0x248FE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_248fe4:
    ...
    if (runtime->hasFunction(0x228950u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x248FF4u; }
        if (ctx->pc != 0x248FF4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00228950_0x228950(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x248FF4u; }
...
label_248ff4:
    ...
    ctx->pc = 0x248FF4u;
    {
        ...
        if (branch_taken_0x248ff4) {
            ctx->pc = 0x248FF8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x248FF4u;
    ...
    ctx->pc = 0x249018u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x249014u;
            // 0x249018: 0x24100001  addiu       $s0, $zero, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 16, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
        ctx->in_delay_slot = false;
    ctx->pc = 0x248620u;
    if (runtime->hasFunction(0x248620u)) {
        auto targetFn = runtime->lookupFunction(0x248620u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x24901Cu; }
        if (ctx->pc != 0x24901Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00248620_0x248620(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x24901Cu; }
        if (ctx->pc != 0x24901Cu) { return; }
    }
    ctx->pc = 0x24901Cu;
label_24901c:
    ...
    ctx->pc = 0x249024u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x249020u;
    ...
    if (runtime->hasFunction(0x2492B0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x249028u; }
        if (ctx->pc != 0x249028u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_249028:
    ...
    ctx->pc = 0x24902Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x249028u;
    ...
    if (runtime->hasFunction(0x22D850u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x249030u; }
        if (ctx->pc != 0x249030u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_249030:
    ...
    ctx->pc = 0x24903Cu;
    {
        ...
        if (branch_taken_0x24903c) {
            ctx->pc = 0x249040u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x24903Cu;
...
label_249054:
    ...
    ctx->pc = 0x249068u;
    ctx->pc = 0x24906Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x249068u;
