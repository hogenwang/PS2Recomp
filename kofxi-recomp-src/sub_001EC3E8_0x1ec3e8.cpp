...
void sub_001EC3E8_0x1ec3e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1EC404u;
    // 0x1ec408: 0xc0902d  daddu       $s2, $a2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EC480u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EC480u, 0x1EC404u, 0x1EC40Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EC40Cu;
label_1ec40c:
    ...
    ctx->pc = 0x1EC480u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EC480u, 0x1EC41Cu, 0x1EC424u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EC424u;
label_1ec424:
    ...
    ctx->pc = 0x1EC438u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1EC434u;
    // 0x1ec438: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EC480u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EC480u, 0x1EC434u, 0x1EC43Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EC43Cu;
label_1ec43c:
...
label_1ec458:
    ...
    ctx->pc = 0x1EC480u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EC480u, 0x1EC458u, 0x1EC460u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1EC460u;
label_1ec460:
...
label_1ec464:
    ...
    ctx->pc = 0x1EC474u;
    {
        ...
        ctx->pc = 0x1EC478u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1EC474u;
        // 0x1ec478: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1EC474u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1ec47cu;
    // NOP
    if (ctx->pc == 0x1ec47cu) { ctx->pc = 0x1ec480u; }
}
