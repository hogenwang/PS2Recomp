...
void sub_0020E310_0x20e310(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20E32Cu;
    {
        ...
        ctx->pc = 0x20E330u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E32Cu;
...
label_20e338:
    ...
    ctx->pc = 0x20E33Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20E338u;
    ...
    if (runtime->hasFunction(0x20DF80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E340u; }
        if (ctx->pc != 0x20E340u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_20e340:
    ...
    ctx->pc = 0x20E34Cu;
    {
        ...
        if (branch_taken_0x20e34c) {
            ctx->pc = 0x20E350u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x20E34Cu;
...
label_20e358:
    ...
    ctx->pc = 0x20E364u;
    {
        ...
        ctx->pc = 0x20E368u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E364u;
