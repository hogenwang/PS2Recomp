...
label_2ed790:
    ...
    ctx->pc = 0x225F58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x225F58u, 0x2ED790u, 0x2ED798u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2ED798u;
label_2ed798:
...
label_2ed79c:
    ...
    ctx->pc = 0x2ED7A0u;
    {
        ...
        ctx->pc = 0x2ED7A4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2ED7A0u;
        // 0x2ed7a4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2ED7A0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2ed7d0:
    ...
    ctx->pc = 0x2ED7E8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2ED7E4u;
    // 0x2ed7e8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F12A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F12A0u, 0x2ED7E4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2ED7ECu;
    // 0x2ed7ec: 0x0  nop
    ctx->pc = 0x2ed7ecu;
    // NOP
    if (ctx->pc == 0x2ed7ecu) { ctx->pc = 0x2ed7f0u; }
}
