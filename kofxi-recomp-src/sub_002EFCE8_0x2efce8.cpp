...
void sub_002EFCE8_0x2efce8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2EFD18u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2EFD14u;
    // 0x2efd18: 0x8e050088  lw          $a1, 0x88($s0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 136)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x224158u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x224158u, 0x2EFD14u, 0x2EFD1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EFD1Cu;
label_2efd1c:
    ...
    ctx->pc = 0x2EDD70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2EDD70u, 0x2EFD24u, 0x2EFD2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EFD2Cu;
label_2efd2c:
...
label_2efd30:
    ...
    ctx->pc = 0x2EFD3Cu;
    {
        ...
        ctx->pc = 0x2EFD40u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2EFD3Cu;
        // 0x2efd40: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2EFD3Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2efd44:
    ...
    ctx->pc = 0x2EFD64u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2EFD60u;
    // 0x2efd64: 0x24e71520  addiu       $a3, $a3, 0x1520 (Delay Slot)
    SET_GPR_S32(ctx, 7, (int32_t)ADD32(GPR_U32(ctx, 7), 5408));
    ctx->in_delay_slot = false;
    ctx->pc = 0x225F58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x225F58u, 0x2EFD60u, 0x2EFD68u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EFD68u;
label_2efd68:
...
label_2efd70:
    ...
    ctx->pc = 0x2EFD7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2EFD78u;
    // 0x2efd7c: 0xc23023  subu        $a2, $a2, $v0 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)SUB32(GPR_U32(ctx, 6), GPR_U32(ctx, 2)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1271D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1271D0u, 0x2EFD78u, 0x2EFD80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EFD80u;
label_2efd80:
