...
void sub_001E7D48_0x1e7d48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E7D54u;
    // 0x1e7d58: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6C58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6C58u, 0x1E7D54u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E7D5Cu;
    // 0x1e7d5c: 0x0  nop
    ctx->pc = 0x1e7d5cu;
    // NOP
    if (ctx->pc == 0x1e7d5cu) { ctx->pc = 0x1e7d60u; }
}
