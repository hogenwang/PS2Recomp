...
void sub_0024CB98_0x24cb98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x24CBBCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x24CBB8u;
    // 0x24cbbc: 0x202d  daddu       $a0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x228950u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x228950u, 0x24CBB8u, 0x24CBC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x24CBC0u;
label_24cbc0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x242F68u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x242F68u, 0x24CBE8u, 0x24CBF0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x24CBF0u;
label_24cbf0:
    ...
    ctx->pc = 0x24CC00u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x24CC00u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
