...
void sub_002350C8_0x2350c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2350D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2350D4u;
    ...
    if (runtime->hasFunction(0x234D80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2350DCu; }
        if (ctx->pc != 0x2350DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2350dc:
    ...
    ctx->pc = 0x2350DCu;
    {
        ...
        ctx->pc = 0x2350E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2350DCu;
    ...
    ctx->pc = 0x2350E8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2350E4u;
    ...
    if (runtime->hasFunction(0x234E70u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2350ECu; }
        if (ctx->pc != 0x2350ECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2350ec:
    ...
    ctx->pc = 0x2350F8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2350F4u;
    ...
    if (runtime->hasFunction(0x234F40u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2350FCu; }
        if (ctx->pc != 0x2350FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2350fc:
    ...
    ctx->pc = 0x2350FCu;
    {
        ...
        if (branch_taken_0x2350fc) {
            ctx->pc = 0x235100u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2350FCu;
...
label_235118:
    ...
    ctx->pc = 0x235120u;
    {
        ...
        ctx->pc = 0x235124u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x235120u;
...
label_235130:
    ...
    ctx->pc = 0x235134u;
    {
        ...
        if (branch_taken_0x235134) {
            ctx->pc = 0x235138u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x235134u;
...
label_235150:
    ...
    ctx->pc = 0x23515Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x235160u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x23515Cu;
...
label_235164:
    ...
    ctx->pc = 0x235164u;
    {
        ...
        if (branch_taken_0x235164) {
            ctx->pc = 0x235168u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x235164u;
...
label_235170:
    ...
    ctx->pc = 0x235170u;
    {
        ...
        if (branch_taken_0x235170) {
            ctx->pc = 0x235174u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x235170u;
...
label_235178:
    ...
    ctx->pc = 0x235178u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x23517Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x235178u;
