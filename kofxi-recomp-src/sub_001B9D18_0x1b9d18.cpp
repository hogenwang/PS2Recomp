...
void sub_001B9D18_0x1b9d18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B9D1Cu;
    {
        ...
        ctx->pc = 0x1B9D20u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9D1Cu;
    ...
    ctx->pc = 0x1B9D2Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9D28u;
    ...
    if (runtime->hasFunction(0x1AE828u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9D30u; }
        if (ctx->pc != 0x1B9D30u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b9d30:
    ...
    ctx->pc = 0x1B9D30u;
    {
        ...
        ctx->pc = 0x1B9D34u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9D30u;
...
label_1b9d38:
    ...
    ctx->pc = 0x1B64E0u;
    {
        auto targetFn = runtime->lookupFunction(0x1B64E0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
