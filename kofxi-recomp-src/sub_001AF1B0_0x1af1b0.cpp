...
void sub_001AF1B0_0x1af1b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1AF1D0u;
    ctx->pc = 0x1AF1D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF1D0u;
...
label_1af1d8:
    ...
    ctx->pc = 0x1AF200u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF1FCu;
    ...
    if (runtime->hasFunction(0x1B1AB0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AF204u; }
        if (ctx->pc != 0x1AF204u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1af204:
    ...
    ctx->pc = 0x1AF214u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF210u;
    ...
    if (runtime->hasFunction(0x1AF240u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AF218u; }
        if (ctx->pc != 0x1AF218u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
