...
void sub_002DEB18_0x2deb18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2DEB74u;
    // 0x2deb78: 0x8c660004  lw          $a2, 0x4($v1) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2DEB74u, 0x2DEB7Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEB7Cu;
label_2deb7c:
...
label_2debb0:
    ...
    ctx->pc = 0x2debb8u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEBB8 raw=0xD1C38D48");
    // 0x2debbc: 0x41c32b48  .word       0x41C32B48                   # INVALID     $t6, $v1, 0x2B48 # 00000000 <InstrIdType: R5900_COP0>
    ctx->pc = 0x2debbcu;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEBBC raw=0x41C32B48");
    ...
    ctx->pc = 0x2debc4u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEBC4 raw=0xD33CAD17");
    ...
    ctx->pc = 0x2debd8u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEBD8 raw=0xD1CBADE8");
    // 0x2debdc: 0xc0b9406  jal         func_2E5018
    ctx->pc = 0x2DEBDCu;
    SET_GPR_U32(ctx, 31, 0x2DEBE4u);
    ctx->pc = 0x2DEBE0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEBDCu;
    // 0x2debe0: 0x1c60939  .word       0x01C60939                   # INVALID     $t6, $a2, 0x939 # 00000000 <InstrIdType: CPU_SPECIAL> (Delay Slot)
    throw std::runtime_error("Unhandled SPECIAL instruction: 0x39 at 0x2DEBE0 raw=0x01C60939");
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E5018u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E5018u, 0x2DEBDCu, 0x2DEBE4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEBE4u;
label_2debe4:
    ...
    ctx->pc = 0x2DEBECu;
    {
        ...
        if (branch_taken_0x2debec) {
            ctx->pc = 0x2DEBF0u;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2DEBECu;
            // 0x2debf0: 0xd30e4d17  lld         $t6, 0x4D17($t8) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEBF0 raw=0xD30E4D17");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2E1890u;
            return;
        }
    ...
    ctx->pc = 0x2dec08u;
    throw std::runtime_error("Unhandled REGIMM instruction: 0x6 at 0x2DEC08 raw=0x05C6092E");
    // 0x2dec0c: 0xd1c32dc8  lld         $v1, 0x2DC8($t6)
    ctx->pc = 0x2dec0cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEC0C raw=0xD1C32DC8");
    // 0x2dec10: 0xc0b8104  jal         func_2E0410
    ctx->pc = 0x2DEC10u;
    SET_GPR_U32(ctx, 31, 0x2DEC18u);
    ctx->pc = 0x2DEC14u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEC10u;
    // 0x2dec14: 0x5c6093a  .word       0x05C6093A                   # INVALID     $t6, $a2, 0x93A # 00000000 <InstrIdType: CPU_REGIMM> (Delay Slot)
    throw std::runtime_error("Unhandled REGIMM instruction: 0x6 at 0x2DEC14 raw=0x05C6093A");
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E0410u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E0410u, 0x2DEC10u, 0x2DEC18u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEC18u;
label_2dec18:
    ...
    ctx->pc = 0x2dec20u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEC20 raw=0xD30E4D17");
    ...
    ctx->pc = 0x2dec50u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEC50 raw=0x41C3BD48");
    ...
    ctx->pc = 0x2DEC68u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEC64u;
    // 0x2dec68: 0xd0c34d28  lld         $v1, 0x4D28($a2) (Delay Slot)
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEC68 raw=0xD0C34D28");
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E0520u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E0520u, 0x2DEC64u, 0x2DEC6Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEC6Cu;
label_2dec6c:
    ...
    ctx->pc = 0x2DEC7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEC78u;
    // 0x2dec7c: 0xd1c2ade8  lld         $v0, -0x5218($t6) (Delay Slot)
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEC7C raw=0xD1C2ADE8");
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DCD00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DCD00u, 0x2DEC78u, 0x2DEC80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEC80u;
label_2dec80:
...
label_fallthrough_0x2dec98:
    ...
    ctx->pc = 0x2decb0u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DECB0 raw=0x41C3BD48");
    ...
    ctx->pc = 0x2decbcu;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DECBC raw=0x41C6092E");
...
label_2decc8:
    if (ctx->pc == 0x2DECC8u) {
        ctx->pc = 0x2DECC8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2DECC4u;
        // 0x2decc8: 0xd0c34d28  lld         $v1, 0x4D28($a2) (Delay Slot)
        throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DECC8 raw=0xD0C34D28");
        ctx->in_delay_slot = false;
        ctx->pc = 0x2DECCCu;
        goto label_2deccc;
    }
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E0920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E0920u, 0x2DECC4u, 0x2DECCCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DECCCu;
label_2deccc:
    ...
    ctx->pc = 0x2decd0u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DECD0 raw=0xD30E4D17");
    // 0x2decd4: 0xc0b6e92  jal         func_2DBA48
    ctx->pc = 0x2DECD4u;
    SET_GPR_U32(ctx, 31, 0x2DECDCu);
    ctx->pc = 0x2DECD8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DECD4u;
    // 0x2decd8: 0x25c6092c  addiu       $a2, $t6, 0x92C (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 14), 2348));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DBA48u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DBA48u, 0x2DECD4u, 0x2DECDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DECDCu;
label_2decdc:
    ...
    ctx->pc = 0x2dece4u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DECE4 raw=0xD30E4D17");
...
label_2decfc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x71824B4u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x71824B4u, 0x2DECF8u, 0x2DED00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DED00u;
label_2ded00:
...
label_2ded0c:
    ...
    ctx->pc = 0x2ded0cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED0C raw=0xD1C1ADE8");
    // 0x2ded10: 0xc0b7340  jal         func_2DCD00
    ctx->pc = 0x2DED10u;
    SET_GPR_U32(ctx, 31, 0x2DED18u);
    ctx->pc = 0x2DED14u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DED10u;
    // 0x2ded14: 0x51c60939  beql        $t6, $a2, . + 4 + (0x939 << 2) (Delay Slot)
    // Likely branch instruction at 0x2DED14 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DCD00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DCD00u, 0x2DED10u, 0x2DED18u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DED18u;
label_2ded18:
    ...
    ctx->pc = 0x2DED20u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DED1Cu;
    // 0x2ded20: 0xa5d6ad88  sh          $s6, -0x5278($t6) (Delay Slot)
    WRITE16(ADD32(GPR_U32(ctx, 14), 4294946184), (uint16_t)GPR_U32(ctx, 22));
    ctx->in_delay_slot = false;
    ctx->pc = 0x71824B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x71824B0u, 0x2DED1Cu, 0x2DED24u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DED24u;
label_2ded24:
    ...
    ctx->pc = 0x2DED28u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DED24u;
    // 0x2ded28: 0xd1c7ade8  lld         $a3, -0x5218($t6) (Delay Slot)
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED28 raw=0xD1C7ADE8");
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DCD00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DCD00u, 0x2DED24u, 0x2DED2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DED2Cu;
label_2ded2c:
    ...
    ctx->pc = 0x2ded30u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED30 raw=0xD11C4E01");
    // 0x2ded34: 0xd53c4f17  ldc1        $f28, 0x4F17($t1)
    ctx->pc = 0x2ded34u;
    throw std::runtime_error("Unhandled opcode: 0x35 at 0x2DED34 raw=0xD53C4F17");
    ...
    ctx->pc = 0x2ded40u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED40 raw=0xD1B3AE00");
...
label_2ded48:
    ...
    ctx->pc = 0x2DED48u;
    {
        ...
        if (branch_taken_0x2ded48) {
            ctx->pc = 0x2DED4Cu;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2DED48u;
            // 0x2ded4c: 0xd123ae01  lld         $v1, -0x51FF($t1) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED4C raw=0xD123AE01");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2E122Cu;
            return;
        }
    ...
    ctx->pc = 0x2ded54u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED54 raw=0xD3C3AE78");
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2DED58u, 0x2DED60u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DED60u;
label_2ded60:
...
label_2ded70:
    ...
    ctx->pc = 0x2ded88u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED88 raw=0xD1C3A169");
    // 0x2ded8c: 0xf1c30128  scd         $v1, 0x128($t6)
    ctx->pc = 0x2ded8cu;
    throw std::runtime_error("Unhandled opcode: 0x3C at 0x2DED8C raw=0xF1C30128");
    ...
    ctx->pc = 0x2ded9cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DED9C raw=0xD1C3A169");
    ...
    ctx->pc = 0x2deda8u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEDA8 raw=0x41C3BD68");
    // 0x2dedac: 0xd11c4e01  lld         $gp, 0x4E01($t0)
    ctx->pc = 0x2dedacu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEDAC raw=0xD11C4E01");
    // 0x2dedb0: 0xd53c4f17  ldc1        $f28, 0x4F17($t1)
    ctx->pc = 0x2dedb0u;
    throw std::runtime_error("Unhandled opcode: 0x35 at 0x2DEDB0 raw=0xD53C4F17");
    ...
    ctx->pc = 0x2DEDB8u;
    {
        ...
        if (branch_taken_0x2dedb8) {
            ctx->pc = 0x2DEDBCu;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2DEDB8u;
            // 0x2dedbc: 0xd1b3ae00  lld         $s3, -0x5200($t5) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEDBC raw=0xD1B3AE00");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2E129Cu;
            return;
        }
    ...
    ctx->pc = 0x2dedc4u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEDC4 raw=0xD3C3AE78");
    // 0x2dedc8: 0xd123ae01  lld         $v1, -0x51FF($t1)
    ctx->pc = 0x2dedc8u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEDC8 raw=0xD123AE01");
    ...
    ctx->pc = 0x2DEDD4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEDD0u;
    // 0x2dedd4: 0x51c3a928  beql        $t6, $v1, . + 4 + (-0x56D8 << 2) (Delay Slot)
    // Likely branch instruction at 0x2DEDD4 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2DEDD0u, 0x2DEDD8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEDD8u;
label_2dedd8:
...
label_2dede4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0xF1E24B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xF1E24B0u, 0x2DEDE0u, 0x2DEDE8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEDE8u;
label_2dede8:
    ...
    ctx->pc = 0x2dee00u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE00 raw=0xD1C3A169");
    // 0x2dee04: 0xf1c30128  scd         $v1, 0x128($t6)
    ctx->pc = 0x2dee04u;
    throw std::runtime_error("Unhandled opcode: 0x3C at 0x2DEE04 raw=0xF1C30128");
    ...
    ctx->pc = 0x2dee14u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE14 raw=0xD1C3A169");
    ...
    ctx->pc = 0x2dee20u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEE20 raw=0x41C3BD68");
    // 0x2dee24: 0xd11c4e01  lld         $gp, 0x4E01($t0)
    ctx->pc = 0x2dee24u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE24 raw=0xD11C4E01");
    // 0x2dee28: 0xd53c4f17  ldc1        $f28, 0x4F17($t1)
    ctx->pc = 0x2dee28u;
    throw std::runtime_error("Unhandled opcode: 0x35 at 0x2DEE28 raw=0xD53C4F17");
    ...
    ctx->pc = 0x2DEE30u;
    {
        ...
        if (branch_taken_0x2dee30) {
            ctx->pc = 0x2DEE34u;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2DEE30u;
            // 0x2dee34: 0xd1b3ae00  lld         $s3, -0x5200($t5) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE34 raw=0xD1B3AE00");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2E1314u;
            return;
        }
    ...
    ctx->pc = 0x2dee3cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE3C raw=0xD3C3AE78");
    // 0x2dee40: 0xd123ae01  lld         $v1, -0x51FF($t1)
    ctx->pc = 0x2dee40u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE40 raw=0xD123AE01");
    ...
    ctx->pc = 0x2DEE4Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEE48u;
    // 0x2dee4c: 0x51c3a928  beql        $t6, $v1, . + 4 + (-0x56D8 << 2) (Delay Slot)
    // Likely branch instruction at 0x2DEE4C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2DEE48u, 0x2DEE50u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEE50u;
label_2dee50:
    ...
    ctx->pc = 0x2dee78u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE78 raw=0xD1C3A169");
    // 0x2dee7c: 0xf1c30128  scd         $v1, 0x128($t6)
    ctx->pc = 0x2dee7cu;
    throw std::runtime_error("Unhandled opcode: 0x3C at 0x2DEE7C raw=0xF1C30128");
    ...
    ctx->pc = 0x2dee8cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE8C raw=0xD1C3A169");
    ...
    ctx->pc = 0x2dee98u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEE98 raw=0x41C3BD68");
    // 0x2dee9c: 0xd11c4e01  lld         $gp, 0x4E01($t0)
    ctx->pc = 0x2dee9cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEE9C raw=0xD11C4E01");
    // 0x2deea0: 0xd53c4f17  ldc1        $f28, 0x4F17($t1)
    ctx->pc = 0x2deea0u;
    throw std::runtime_error("Unhandled opcode: 0x35 at 0x2DEEA0 raw=0xD53C4F17");
    ...
    ctx->pc = 0x2DEEA8u;
    {
        ...
        if (branch_taken_0x2deea8) {
            ctx->pc = 0x2DEEACu;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2DEEA8u;
            // 0x2deeac: 0xd1b3ae00  lld         $s3, -0x5200($t5) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEEAC raw=0xD1B3AE00");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2E138Cu;
            return;
        }
    ...
    ctx->pc = 0x2deeb4u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEEB4 raw=0xD3C3AE78");
    // 0x2deeb8: 0xd123ae01  lld         $v1, -0x51FF($t1)
    ctx->pc = 0x2deeb8u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEEB8 raw=0xD123AE01");
    ...
    ctx->pc = 0x2DEEC4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEEC0u;
    // 0x2deec4: 0x51c3a928  beql        $t6, $v1, . + 4 + (-0x56D8 << 2) (Delay Slot)
    // Likely branch instruction at 0x2DEEC4 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2DEEC0u, 0x2DEEC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEEC8u;
label_2deec8:
    ...
    ctx->pc = 0x2deed0u;
    throw std::runtime_error("Unhandled REGIMM instruction: 0x7 at 0x2DEED0 raw=0x07C7892C");
    ...
    ctx->pc = 0x2deef0u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEEF0 raw=0xD1C3A169");
    // 0x2deef4: 0xf1c30128  scd         $v1, 0x128($t6)
    ctx->pc = 0x2deef4u;
    throw std::runtime_error("Unhandled opcode: 0x3C at 0x2DEEF4 raw=0xF1C30128");
    ...
    ctx->pc = 0x2def04u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF04 raw=0xD1C3A169");
    ...
    ctx->pc = 0x2def10u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEF10 raw=0x41C3BD68");
    // 0x2def14: 0xd11c4e01  lld         $gp, 0x4E01($t0)
    ctx->pc = 0x2def14u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF14 raw=0xD11C4E01");
    // 0x2def18: 0xd53c4f17  ldc1        $f28, 0x4F17($t1)
    ctx->pc = 0x2def18u;
    throw std::runtime_error("Unhandled opcode: 0x35 at 0x2DEF18 raw=0xD53C4F17");
    ...
    ctx->pc = 0x2DEF20u;
    {
        ...
        if (branch_taken_0x2def20) {
            ctx->pc = 0x2DEF24u;
            ctx->in_delay_slot = true;
            ctx->branch_pc = 0x2DEF20u;
            // 0x2def24: 0xd1b3ae00  lld         $s3, -0x5200($t5) (Delay Slot)
            throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF24 raw=0xD1B3AE00");
            ctx->in_delay_slot = false;
            ctx->pc = 0x2E1404u;
            return;
        }
    ...
    ctx->pc = 0x2def2cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF2C raw=0xD3C3AE78");
    // 0x2def30: 0xd123ae01  lld         $v1, -0x51FF($t1)
    ctx->pc = 0x2def30u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF30 raw=0xD123AE01");
    ...
    ctx->pc = 0x2DEF3Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEF38u;
    // 0x2def3c: 0x51c3a928  beql        $t6, $v1, . + 4 + (-0x56D8 << 2) (Delay Slot)
    // Likely branch instruction at 0x2DEF3C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x2DF1D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2DF1D8u, 0x2DEF38u, 0x2DEF40u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEF40u;
label_2def40:
    ...
    ctx->pc = 0x2DEF4Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEF48u;
    // 0x2def4c: 0x93c38d28  lbu         $v1, -0x72D8($fp) (Delay Slot)
    SET_GPR_U32(ctx, 3, (uint8_t)READ8(ADD32(GPR_U32(ctx, 30), 4294937896)));
    ctx->in_delay_slot = false;
    ctx->pc = 0xF1E24B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0xF1E24B0u, 0x2DEF48u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DEF50u;
    ...
    ctx->pc = 0x2def68u;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF68 raw=0xD1C3A169");
    // 0x2def6c: 0xf1c30128  scd         $v1, 0x128($t6)
    ctx->pc = 0x2def6cu;
    throw std::runtime_error("Unhandled opcode: 0x3C at 0x2DEF6C raw=0xF1C30128");
    ...
    ctx->pc = 0x2def7cu;
    throw std::runtime_error("Unhandled opcode: 0x34 at 0x2DEF7C raw=0xD1C3A169");
    ...
    ctx->pc = 0x2def88u;
    throw std::runtime_error("Unhandled COP0 instruction format: 0xE at 0x2DEF88 raw=0x41C3BD68");
...
label_2defbc:
    ...
    ctx->pc = 0x2DEFD8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DEFD4u;
    // 0x2defd8: 0x8c460000  lw          $a2, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2DEFD4u, 0x2DEFDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DEFDCu;
label_2defdc:
    ...
    ctx->pc = 0x2DF010u;
    {
        ...
        ctx->pc = 0x2DF014u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2DF010u;
        // 0x2df014: 0x27bd0130  addiu       $sp, $sp, 0x130 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 304));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2DF010u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2df054:
    ...
    ctx->pc = 0x2DF060u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF05Cu;
    // 0x2df060: 0x8c660004  lw          $a2, 0x4($v1) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2DF05Cu, 0x2DF064u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DF064u;
label_2df064:
    ...
    ctx->pc = 0x1AAC0ECu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AAC0ECu, 0x2DF080u, 0x2DF088u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DF088u;
label_2df088:
    ...
    ctx->pc = 0x2df088u;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2DF088 raw=0xC92DA347");
    ...
    ctx->pc = 0x2df090u;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2DF090 raw=0xC92DA3F7");
    // 0x2df094: 0x0  nop
    ctx->pc = 0x2df094u;
    // NOP
label_2df098:
    ...
    ctx->pc = 0x2df0a4u;
    throw std::runtime_error("Unhandled COP2 format: 0xA at 0x2DF0A4 raw=0x4954FF17");
    ...
    ctx->pc = 0x2df0acu;
    throw std::runtime_error("Unhandled opcode: 0x3C at 0x2DF0AC raw=0xF21DDD0B");
    // 0x2df0b0: 0xd61f1d8b  ldc1        $f31, 0x1D8B($s0)
    ctx->pc = 0x2df0b0u;
    throw std::runtime_error("Unhandled opcode: 0x35 at 0x2DF0B0 raw=0xD61F1D8B");
    // 0x2df0b4: 0x9fe3f16  j           func_7F8FC58
    ctx->pc = 0x2DF0B4u;
    ctx->pc = 0x2DF0B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF0B4u;
    // 0x2df0b8: 0x95aa383  j           func_56A8E0C (Delay Slot)
    // J 0x56A8E0C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x7F8FC58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7F8FC58u, 0x2DF0B4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF0BCu;
    ...
    ctx->pc = 0x2DF0C4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF0C0u;
    // 0x2df0c4: 0x95aed03  j           func_56BB40C (Delay Slot)
    // J 0x56BB40C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x7F97C58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7F97C58u, 0x2DF0C0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF0C8u;
    // 0x2df0c8: 0xf5fddd17  sdc1        $f29, -0x22E9($t7)
    ctx->pc = 0x2df0c8u;
    throw std::runtime_error("Unhandled opcode: 0x3D at 0x2DF0C8 raw=0xF5FDDD17");
    // 0x2df0cc: 0x9fe7f16  j           func_7F9FC58
    ctx->pc = 0x2DF0CCu;
    ctx->pc = 0x2DF0D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF0CCu;
    // 0x2df0d0: 0xe9fefd57  swc2        $30, -0x2A9($t7) (Delay Slot)
    throw std::runtime_error("Unhandled opcode: 0x3A at 0x2DF0D0 raw=0xE9FEFD57");
    ctx->in_delay_slot = false;
    ctx->pc = 0x7F9FC58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7F9FC58u, 0x2DF0CCu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF0D4u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7E3B45Cu, 0x2DF0D4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF0DCu;
...
label_2df0e0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7E3B45Cu, 0x2DF0DCu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
label_fallthrough_0x2df0dc:
    ctx->pc = 0x2DF0E4u;
    // 0x2df0e4: 0x978f716  j           func_5E3DC58
    ctx->pc = 0x2DF0E4u;
    ctx->pc = 0x2DF0E8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF0E4u;
    // 0x2df0e8: 0x9786453  j           func_5E1914C (Delay Slot)
    // J 0x5E1914C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x5E3DC58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x5E3DC58u, 0x2DF0E4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF0ECu;
    ...
    ctx->pc = 0x2DF0F4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF0F0u;
    // 0x2df0f4: 0x9f8ed17  j           func_7E3B45C (Delay Slot)
    // J 0x7E3B45C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7E3B45Cu, 0x2DF0F0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF0F8u;
    ...
    ctx->pc = 0x2DF0FCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF0F8u;
    // 0x2df0fc: 0x9ecf55e  j           func_7B3D578 (Delay Slot)
    // J 0x7B3D578 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x783D568u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x783D568u, 0x2DF0F8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF100u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x4E9D438u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x4E9D438u, 0x2DF100u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF108u;
    ...
    ctx->pc = 0x2DF10Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF108u;
    // 0x2df10c: 0x9f8f902  j           func_7E3E408 (Delay Slot)
    // J 0x7E3E408 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x7C37458u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7C37458u, 0x2DF108u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF110u;
    ...
    ctx->pc = 0x2DF118u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF114u;
    // 0x2df118: 0x878f506  j           func_1E3D418 (Delay Slot)
    // J 0x1E3D418 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x7A3D548u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7A3D548u, 0x2DF114u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF11Cu;
    ...
    ctx->pc = 0x2DF120u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF11Cu;
    // 0x2df120: 0x97cac43  j           func_5F2B10C (Delay Slot)
    // J 0x5F2B10C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x7C37458u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x7C37458u, 0x2DF11Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF124u;
    ...
    ctx->pc = 0x2DF130u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF12Cu;
    // 0x2df130: 0x9584383  j           func_5610E0C (Delay Slot)
    // J 0x5610E0C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x561B40Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x561B40Cu, 0x2DF12Cu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF134u;
    ...
    ctx->pc = 0x2DF13Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF138u;
    // 0x2df13c: 0x95aed03  j           func_56BB40C (Delay Slot)
    // J 0x56BB40C - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E4FA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E4FA8u, 0x2DF138u, 0x2DF140u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DF140u;
label_2df140:
    ...
    ctx->pc = 0x2DF148u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF144u;
    // 0x2df148: 0x1000000b  b           . + 4 + (0xB << 2) (Delay Slot)
    // Likely branch instruction at 0x2DF148 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x74BB26Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x74BB26Cu, 0x2DF144u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DF14Cu;
    // 0x2df14c: 0x0  nop
    ...
    ctx->pc = 0x2DF15Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF158u;
    // 0x2df15c: 0x8ff6f6cd  lw          $s6, -0x933($ra) (Delay Slot)
    SET_GPR_S32(ctx, 22, (int32_t)READ32(ADD32(GPR_U32(ctx, 31), 4294964941)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x11C6AF4u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11C6AF4u, 0x2DF158u, 0x2DF160u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DF160u;
label_2df160:
    ...
    ctx->pc = 0x2df168u;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2DF168 raw=0xC92D743A");
    ...
    ctx->pc = 0x2df170u;
    throw std::runtime_error("Unhandled opcode: 0x32 at 0x2DF170 raw=0xC92D748A");
    // 0x2df174: 0x0  nop
    ctx->pc = 0x2df174u;
    // NOP
label_2df178:
    ...
    ctx->pc = 0x2DF194u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DF190u;
    // 0x2df194: 0x8c460000  lw          $a2, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2DF190u, 0x2DF198u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DF198u;
label_2df198:
    ...
    ctx->pc = 0x2DF1B8u;
    {
        ...
        ctx->pc = 0x2DF1BCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2DF1B8u;
        // 0x2df1bc: 0x27bd0080  addiu       $sp, $sp, 0x80 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 128));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2DF1B8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
