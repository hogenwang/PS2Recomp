...
void sub_001F83A0_0x1f83a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F83F0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F83ECu;
    // 0x1f83f0: 0x27a60004  addiu       $a2, $sp, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FBD18u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FBD18u, 0x1F83ECu, 0x1F83F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F83F4u;
label_1f83f4:
...
label_1f8408:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FB008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FB008u, 0x1F8410u, 0x1F8418u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8418u;
label_1f8418:
    ...
    ctx->pc = 0x1F843Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F8438u;
    // 0x1f843c: 0x8e5001b8  lw          $s0, 0x1B8($s2) (Delay Slot)
    SET_GPR_S32(ctx, 16, (int32_t)READ32(ADD32(GPR_U32(ctx, 18), 440)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FB008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FB008u, 0x1F8438u, 0x1F8440u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8440u;
label_1f8440:
...
label_1f8454:
    ...
    ctx->pc = 0x1F8484u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F8480u;
    // 0x1f8484: 0x200302d  daddu       $a2, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FAE40u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FAE40u, 0x1F8480u, 0x1F8488u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8488u;
label_1f8488:
...
label_1f848c:
    ...
    ctx->pc = 0x1F8498u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F8494u;
    // 0x1f8498: 0x240503e8  addiu       $a1, $zero, 0x3E8 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1000));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CFFB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CFFB8u, 0x1F8494u, 0x1F849Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F849Cu;
label_1f849c:
...
label_1f84a0:
    ...
    ctx->pc = 0x1F84B4u;
    {
        ...
        ctx->pc = 0x1F84B8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F84B4u;
        // 0x1f84b8: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F84B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1f84c0:
    ...
    ctx->pc = 0x1F84D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F84CCu;
    // 0x1f84d0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F8DB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F8DB0u, 0x1F84CCu, 0x1F84D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F84D4u;
label_1f84d4:
    ...
    ctx->pc = 0x1F84E4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F84E0u;
    // 0x1f84e4: 0xae02004c  sw          $v0, 0x4C($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 76), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F9618u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F9618u, 0x1F84E0u, 0x1F84E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F84E8u;
label_1f84e8:
...
label_1f84ec:
    ...
    ctx->pc = 0x1F84F4u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F84F4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1f8500:
    ...
    ctx->pc = 0x1F8510u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F850Cu;
    // 0x1f8510: 0x27a40010  addiu       $a0, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ED9C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ED9C0u, 0x1F850Cu, 0x1F8514u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8514u;
label_1f8514:
...
label_1f8598:
    ...
    ctx->pc = 0x1F85A4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F85A0u;
    // 0x1f85a4: 0xac5016d8  sw          $s0, 0x16D8($v0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 2), 5848), GPR_U32(ctx, 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ED9D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ED9D8u, 0x1F85A0u, 0x1F85A8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F85A8u;
label_1f85a8:
    ...
    ctx->pc = 0x1F85B4u;
    {
        ...
        ctx->pc = 0x1F85B8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F85B4u;
        // 0x1f85b8: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F85B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f85bcu;
    // NOP
    if (ctx->pc == 0x1f85bcu) { ctx->pc = 0x1f85c0u; }
}
