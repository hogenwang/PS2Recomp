...
void sub_001EA2A0_0x1ea2a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1EA2E0u;
    if (runtime->hasFunction(0x1EA2E0u)) {
        auto targetFn = runtime->lookupFunction(0x1EA2E0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EA2B8u; }
        if (ctx->pc != 0x1EA2B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001EA2E0_0x1ea2e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EA2B8u; }
        if (ctx->pc != 0x1EA2B8u) { return; }
    }
    ctx->pc = 0x1EA2B8u;
label_1ea2b8:
    ...
    ctx->pc = 0x1EA2C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EA2BCu;
    ...
    if (runtime->hasFunction(0x1EA2E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EA2C4u; }
        if (ctx->pc != 0x1EA2C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001EA2E0_0x1ea2e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EA2C4u; }
...
label_1ea2c4:
    ...
    ctx->pc = 0x1EA2D4u;
    ctx->pc = 0x1EA2D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EA2D4u;
