...
label_1aae64:
    ...
    ctx->pc = 0x1AAE60u;
    {
        ...
        ctx->pc = 0x1AAE64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AAE60u;
            // 0x1aae64: 0x24020001  addiu       $v0, $zero, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
...
label_1aae70:
    ...
    ctx->pc = 0x1AAE6Cu;
    ctx->pc = 0x1AAE70u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AAE6Cu;
            // 0x1aae70: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1AACA8u;
    {
        auto targetFn = runtime->lookupFunction(0x1AACA8u);
...
label_1aae7c:
    ...
    ctx->pc = 0x1AAE78u;
    {
        ...
        ctx->pc = 0x1AAE7Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AAE78u;
            // 0x1aae7c: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
...
label_1aae84:
    ...
    ctx->pc = 0x1AAB28u;
    {
        auto targetFn = runtime->lookupFunction(0x1AAB28u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1aae8c:
    ...
    ctx->pc = 0x1AA990u;
    {
        auto targetFn = runtime->lookupFunction(0x1AA990u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1aae94:
    ...
    ctx->pc = 0x1AAE90u;
    {
        ...
        ctx->pc = 0x1AAE94u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AAE90u;
            // 0x1aae94: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_1aaed0:
    ...
    ctx->pc = 0x1AAECCu;
    {
        ...
        ctx->pc = 0x1AAED0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AAECCu;
            // 0x1aaed0: 0x8c44e68c  lw          $a0, -0x1974($v0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294960780)));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1AAED4u; }
            if (ctx->pc != 0x1AAED4u) { return; }
        }
        }
    }
    ctx->pc = 0x1AAED4u;
