...
void sub_0029B798_0x29b798(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29B7B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29B7B0u;
            // 0x29b7b4: 0x8e110008  lw          $s1, 0x8($s0) (Delay Slot)
        SET_GPR_S32(ctx, 17, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 8)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x283F80u;
    if (runtime->hasFunction(0x283F80u)) {
        auto targetFn = runtime->lookupFunction(0x283F80u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29B7B8u; }
        if (ctx->pc != 0x29B7B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00283F80_0x283f80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29B7B8u; }
        if (ctx->pc != 0x29B7B8u) { return; }
    }
    ctx->pc = 0x29B7B8u;
...
label_29b7d4:
    ...
    ctx->pc = 0x29B7E0u;
    {
        ...
        ctx->pc = 0x29B7E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29B7E0u;
