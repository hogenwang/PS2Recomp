...
void sub_0022DBD0_0x22dbd0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x22DBF0u;
    // 0x22dbf4: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CCA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CCA0u, 0x22DBF0u, 0x22DBF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x22DBF8u;
label_22dbf8:
...
label_22dc54:
    ...
    ctx->pc = 0x22dc6cu;
    // NOP
    if (ctx->pc == 0x22dc6cu) { ctx->pc = 0x22dc70u; }
}
