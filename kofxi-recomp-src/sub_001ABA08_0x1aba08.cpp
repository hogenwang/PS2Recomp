...
label_1aba10:
    ...
    ctx->pc = 0x1ABA10u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1ABA14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1ABA10u;
...
label_1aba18:
    ...
    ctx->pc = 0x1ABA18u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1ABA1Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1ABA18u;
...
label_1aba20:
    ...
    ctx->pc = 0x1ABA20u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1ABA24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1ABA20u;
...
label_1aba48:
    ...
    ctx->pc = 0x1ABA48u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1ABA4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1ABA48u;
