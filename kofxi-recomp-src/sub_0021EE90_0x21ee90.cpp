...
void sub_0021EE90_0x21ee90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x21EFA8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEA0u; }
        if (ctx->pc != 0x21EEA0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_21eea0:
    ...
    ctx->pc = 0x21EEA0u;
    {
        ...
        ctx->pc = 0x21EEA4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x21EEA0u;
    ...
    ctx->pc = 0x227DA0u;
    if (runtime->hasFunction(0x227DA0u)) {
        auto targetFn = runtime->lookupFunction(0x227DA0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEB0u; }
        if (ctx->pc != 0x21EEB0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00227DA0_0x227da0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEB0u; }
        if (ctx->pc != 0x21EEB0u) { return; }
    }
    ctx->pc = 0x21EEB0u;
label_21eeb0:
    ...
    ctx->pc = 0x21EEB0u;
    {
        ...
        ctx->pc = 0x21EEB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x21EEB0u;
    ...
    ctx->pc = 0x227D78u;
    if (runtime->hasFunction(0x227D78u)) {
        auto targetFn = runtime->lookupFunction(0x227D78u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00227D78_0x227d78(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEC0u; }
        if (ctx->pc != 0x21EEC0u) { return; }
    }
    ctx->pc = 0x21EEC0u;
label_21eec0:
    ...
    ctx->pc = 0x21EEC0u;
    {
        ...
        ctx->pc = 0x21EEC4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x21EEC0u;
...
label_21eec8:
    ...
    ctx->pc = 0x21EECCu;
    ctx->pc = 0x21EED0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x21EECCu;
...
label_21eed4:
    ...
    ctx->pc = 0x227DD8u;
    if (runtime->hasFunction(0x227DD8u)) {
        auto targetFn = runtime->lookupFunction(0x227DD8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEDCu; }
        if (ctx->pc != 0x21EEDCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00227DD8_0x227dd8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEDCu; }
        if (ctx->pc != 0x21EEDCu) { return; }
    }
    ctx->pc = 0x21EEDCu;
label_21eedc:
    ...
    ctx->pc = 0x21EEE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x21EEE4u;
    ...
    if (runtime->hasFunction(0x225EF8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEECu; }
        if (ctx->pc != 0x21EEECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_21eeec:
    ...
    ctx->pc = 0x227E50u;
    if (runtime->hasFunction(0x227E50u)) {
        auto targetFn = runtime->lookupFunction(0x227E50u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEF8u; }
        if (ctx->pc != 0x21EEF8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00227E50_0x227e50(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EEF8u; }
        if (ctx->pc != 0x21EEF8u) { return; }
    }
    ctx->pc = 0x21EEF8u;
label_21eef8:
    ...
    ctx->pc = 0x226758u;
    if (runtime->hasFunction(0x226758u)) {
        auto targetFn = runtime->lookupFunction(0x226758u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EF00u; }
        if (ctx->pc != 0x21EF00u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00226758_0x226758(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EF00u; }
        if (ctx->pc != 0x21EF00u) { return; }
    }
    ctx->pc = 0x21EF00u;
label_21ef00:
    ...
    ctx->pc = 0x21EF00u;
    {
        ...
        ctx->pc = 0x21EF04u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x21EF00u;
    ...
    ctx->pc = 0x21EF0Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x21EF08u;
    ...
    if (runtime->hasFunction(0x225EF8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EF10u; }
        if (ctx->pc != 0x21EF10u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00225EF8_0x225ef8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EF10u; }
...
label_21ef10:
    ...
    ctx->pc = 0x227C00u;
    if (runtime->hasFunction(0x227C00u)) {
        auto targetFn = runtime->lookupFunction(0x227C00u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EF18u; }
        if (ctx->pc != 0x21EF18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00227C00_0x227c00(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x21EF18u; }
        if (ctx->pc != 0x21EF18u) { return; }
    }
    ctx->pc = 0x21EF18u;
label_21ef18:
    ...
    ctx->pc = 0x21EF1Cu;
    ctx->pc = 0x21EF20u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x21EF1Cu;
...
label_21ef24:
    ...
    ctx->pc = 0x21EF24u;
    {
        ...
        ctx->pc = 0x21EF28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x21EF24u;
