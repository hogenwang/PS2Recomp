...
void sub_00341C70_0x341c70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x341910u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x341910u, 0x341CA8u, 0x341CB0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x341CB0u;
label_341cb0:
...
label_341cb4:
    ...
    ctx->pc = 0x341cbcu;
    // NOP
    if (ctx->pc == 0x341cbcu) { ctx->pc = 0x341cc0u; }
}
