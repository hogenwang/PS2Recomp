...
void sub_002A9298_0x2a9298(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2A92D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2A92D0u;
    ...
    if (runtime->hasFunction(0x2A9620u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2A92D8u; }
        if (ctx->pc != 0x2A92D8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2a92d8:
    ...
    ctx->pc = 0x2A92D8u;
    {
        ...
        ctx->pc = 0x2A92DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2A92D8u;
    ...
    ctx->pc = 0x2A92FCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2A92F8u;
    ...
    if (runtime->hasFunction(0x2A03F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2A9300u; }
        if (ctx->pc != 0x2A9300u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
