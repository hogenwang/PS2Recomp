...
void sub_002CFCF8_0x2cfcf8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2CFD28u;
    {
        ...
        if (branch_taken_0x2cfd28) {
            ctx->pc = 0x2CFD2Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFD28u;
    ...
    ctx->pc = 0x2CFD3Cu;
    {
        ...
        ctx->pc = 0x2CFD40u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFD3Cu;
...
label_2cfd54:
    ...
    ctx->pc = 0x2CFD5Cu;
    {
        ...
        if (branch_taken_0x2cfd5c) {
            ctx->pc = 0x2CFD60u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFD5Cu;
...
label_2cfd70:
    ...
    ctx->pc = 0x2CFD70u;
    {
        ...
        if (branch_taken_0x2cfd70) {
            ctx->pc = 0x2CFD74u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFD70u;
...
label_2cfd7c:
    ...
    ctx->pc = 0x2CFD80u;
    {
        ...
        ctx->pc = 0x2CFD84u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFD80u;
...
label_2cfd90:
    ...
    ctx->pc = 0x2CFDB8u;
    {
        ...
        ctx->pc = 0x2CFDBCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFDB8u;
    ...
    ctx->pc = 0x2CFDC0u;
    {
        ...
        if (branch_taken_0x2cfdc0) {
            ctx->pc = 0x2CFDC4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFDC0u;
...
label_2cfdd0:
    ...
    ctx->pc = 0x2CFDD0u;
    {
        ...
        if (branch_taken_0x2cfdd0) {
            ctx->pc = 0x2CFDD4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFDD0u;
...
label_2cfddc:
    ...
    ctx->pc = 0x2CFDE0u;
    {
        ...
        if (branch_taken_0x2cfde0) {
            ctx->pc = 0x2CFDE4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFDE0u;
...
label_2cfe04:
    ...
    ctx->pc = 0x2CFE0Cu;
    {
        ...
        ctx->pc = 0x2CFE10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFE0Cu;
...
label_2cfe40:
    ...
    ctx->pc = 0x2CFE40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFE3Cu;
            // 0x2cfe40: 0x260282d  daddu       $a1, $s3, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 19) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2D18B0u;
    if (runtime->hasFunction(0x2D18B0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CFE44u; }
        if (ctx->pc != 0x2CFE44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2cfe44:
    ...
    ctx->pc = 0x2CFE44u;
    {
        ...
        ctx->pc = 0x2CFE48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFE44u;
...
label_2cfe7c:
    ...
    ctx->pc = 0x2CFE84u;
    {
        ...
        ctx->pc = 0x2CFE88u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CFE84u;
