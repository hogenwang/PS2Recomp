...
void sub_00271130_0x271130(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x271154u;
    // 0x271158: 0xe0202d  daddu       $a0, $a3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x270E38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x270E38u, 0x271154u, 0x27115Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x27115Cu;
label_27115c:
    ...
    ctx->pc = 0x271164u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x271160u;
    // 0x271164: 0x260202d  daddu       $a0, $s3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 19) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x270E38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x270E38u, 0x271160u, 0x271168u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x271168u;
label_271168:
    ...
    ctx->pc = 0x271220u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x271220u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
