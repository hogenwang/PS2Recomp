...
void sub_001A39A0_0x1a39a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A39C0u; }
        if (ctx->pc != 0x1A39C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a39c0:
    ...
    ctx->pc = 0x1A39C8u;
    {
        ...
        ctx->pc = 0x1A39CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A39C8u;
...
label_1a39d4:
    ...
    ctx->pc = 0x1A39F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A39ECu;
    ...
    if (runtime->hasFunction(0x115C50u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A39F4u; }
        if (ctx->pc != 0x1A39F4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a39f4:
    ...
    ctx->pc = 0x1A3A14u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3A10u;
...
label_1a3a18:
    ...
    ctx->pc = 0x1A3A18u;
    {
        ...
        ctx->pc = 0x1A3A1Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3A18u;
...
label_1a3a20:
    ...
    ctx->pc = 0x1A3A30u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3A2Cu;
            // 0x1a3a30: 0x27a7004c  addiu       $a3, $sp, 0x4C (Delay Slot)
        SET_GPR_S32(ctx, 7, (int32_t)ADD32(GPR_U32(ctx, 29), 76));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1159B8u;
    if (runtime->hasFunction(0x1159B8u)) {
        auto targetFn = runtime->lookupFunction(0x1159B8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A34u; }
        if (ctx->pc != 0x1A3A34u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001159B8_0x1159b8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A34u; }
        if (ctx->pc != 0x1A3A34u) { return; }
    }
    ctx->pc = 0x1A3A34u;
label_1a3a34:
    ...
    ctx->pc = 0x1A3A58u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3A54u;
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A5Cu; }
        if (ctx->pc != 0x1A3A5Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010F948_0x10f948(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A5Cu; }
...
label_1a3a68:
    ...
    ctx->pc = 0x1A3A6Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3A68u;
            // 0x1a3a6c: 0x240202d  daddu       $a0, $s2, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x115BC0u;
    if (runtime->hasFunction(0x115BC0u)) {
        auto targetFn = runtime->lookupFunction(0x115BC0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A70u; }
        if (ctx->pc != 0x1A3A70u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00115BC0_0x115bc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A70u; }
        if (ctx->pc != 0x1A3A70u) { return; }
    }
    ctx->pc = 0x1A3A70u;
label_1a3a70:
    ...
    ctx->pc = 0x1A3A94u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3A90u;
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A98u; }
        if (ctx->pc != 0x1A3A98u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010F948_0x10f948(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3A98u; }
...
label_1a3aa0:
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3AB8u; }
        if (ctx->pc != 0x1A3AB8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010F948_0x10f948(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3AB8u; }
...
label_1a3af0:
    ...
    ctx->pc = 0x1A3AF8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3AF4u;
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3AFCu; }
        if (ctx->pc != 0x1A3AFCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010F948_0x10f948(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3AFCu; }
...
label_1a3b18:
    ...
    ctx->pc = 0x1A3B34u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3B30u;
    ...
    if (runtime->hasFunction(0x115FE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3B38u; }
        if (ctx->pc != 0x1A3B38u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3b38:
    ...
    if (runtime->hasFunction(0x1A3D10u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3B48u; }
        if (ctx->pc != 0x1A3B48u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3b98:
    ...
    if (runtime->hasFunction(0x115FE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3BACu; }
        if (ctx->pc != 0x1A3BACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00115FE8_0x115fe8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3BACu; }
...
label_1a3bc0:
    ...
    ctx->pc = 0x1A3BCCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3BC8u;
    ...
    if (runtime->hasFunction(0x115FE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3BD0u; }
        if (ctx->pc != 0x1A3BD0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00115FE8_0x115fe8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3BD0u; }
...
label_1a3bf0:
    ...
    if (runtime->hasFunction(0x1A7F60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3BF8u; }
        if (ctx->pc != 0x1A3BF8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3bf8:
    ...
    ctx->pc = 0x1A3C18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3C14u;
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3C1Cu; }
        if (ctx->pc != 0x1A3C1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010F948_0x10f948(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3C1Cu; }
...
label_1a3c50:
    ...
    ctx->pc = 0x1A3C54u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3C50u;
    ...
    if (runtime->hasFunction(0x10CCA0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3C58u; }
        if (ctx->pc != 0x1A3C58u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3c58:
    ...
    if (runtime->hasFunction(0x2ECCB0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3C80u; }
        if (ctx->pc != 0x1A3C80u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3c80:
    ...
    if (runtime->hasFunction(0x21EDA0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3C88u; }
        if (ctx->pc != 0x1A3C88u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3c98:
    ...
    ctx->pc = 0x1A3CB4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3CB0u;
...
label_1a3cb8:
    ...
    if (runtime->hasFunction(0x10FEC8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3CC8u; }
        if (ctx->pc != 0x1A3CC8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a3cc8:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A3CC8u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x11C860u;
    if (runtime->hasFunction(0x11C860u)) {
        auto targetFn = runtime->lookupFunction(0x11C860u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3CD0u; }
        if (ctx->pc != 0x1A3CD0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0011C860_0x11c860(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A3CD0u; }
        if (ctx->pc != 0x1A3CD0u) { return; }
    }
    ctx->pc = 0x1A3CD0u;
