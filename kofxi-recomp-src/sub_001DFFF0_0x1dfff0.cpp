...
void sub_001DFFF0_0x1dfff0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1DFFFCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1DFFF8u;
            // 0x1dfffc: 0x3a0282d  daddu       $a1, $sp, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1FF878u;
    if (runtime->hasFunction(0x1FF878u)) {
        auto targetFn = runtime->lookupFunction(0x1FF878u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E0000u; }
        if (ctx->pc != 0x1E0000u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001FF878_0x1ff878(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E0000u; }
        if (ctx->pc != 0x1E0000u) { return; }
    }
    ctx->pc = 0x1E0000u;
label_1e0000:
    ...
    ctx->pc = 0x1E0018u;
    {
        ...
        ctx->pc = 0x1E001Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E0018u;
