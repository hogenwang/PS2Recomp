...
void sub_002962E0_0x2962e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2962ECu;
    // 0x2962f0: 0x24040090  addiu       $a0, $zero, 0x90 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 144));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A2FD8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A2FD8u, 0x2962ECu, 0x2962F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2962F4u;
label_2962f4:
    ...
    ctx->pc = 0x296318u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x296314u;
    // 0x296318: 0xfe000088  sd          $zero, 0x88($s0) (Delay Slot)
    WRITE64(ADD32(GPR_U32(ctx, 16), 136), GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2961E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2961E8u, 0x296314u, 0x29631Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x29631Cu;
label_29631c:
    ...
    ctx->pc = 0x296330u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x29632Cu;
    // 0x296330: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A3028u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A3028u, 0x29632Cu, 0x296334u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x296334u;
label_296334:
...
label_296338:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x295920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x295920u, 0x296344u, 0x29634Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x29634Cu;
label_29634c:
...
label_296350:
    ...
    ctx->pc = 0x296358u;
    {
        ...
        ctx->pc = 0x29635Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x296358u;
        // 0x29635c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x296358u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
