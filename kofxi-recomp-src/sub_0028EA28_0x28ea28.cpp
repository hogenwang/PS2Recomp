...
label_28ea50:
    ...
    ctx->pc = 0x28EA50u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28EA4Cu;
            // 0x28ea50: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x295920u;
    if (runtime->hasFunction(0x295920u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x28EA54u; }
        if (ctx->pc != 0x28EA54u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_28ea58:
    ...
    ctx->pc = 0x28EA54u;
    {
        ...
        ctx->pc = 0x28EA58u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28EA54u;
            // 0x28ea58: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
