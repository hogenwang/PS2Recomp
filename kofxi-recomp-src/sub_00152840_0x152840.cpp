...
label_152918:
    ...
    ctx->pc = 0x152924u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x152924u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x15292cu;
    // NOP
    if (ctx->pc == 0x15292cu) { ctx->pc = 0x152930u; }
}
