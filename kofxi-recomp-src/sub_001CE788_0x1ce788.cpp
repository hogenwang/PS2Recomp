...
void sub_001CE788_0x1ce788(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CE6A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE6A0u, 0x1CE7B0u, 0x1CE7B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1CE7B8u;
label_1ce7b8:
...
label_1ce7d8:
    ...
    ctx->pc = 0x1CE7D8u;
    {
        ...
        ctx->pc = 0x1CE7DCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1CE7D8u;
        // 0x1ce7dc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1CE7D8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
