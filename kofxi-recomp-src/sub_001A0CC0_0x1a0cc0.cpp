...
void sub_001A0CC0_0x1a0cc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A0CE4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A0CE4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a0cecu;
    // NOP
    if (ctx->pc == 0x1a0cecu) { ctx->pc = 0x1a0cf0u; }
}
