...
void sub_001B6950_0x1b6950(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B6960u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B695Cu;
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6964u; }
        if (ctx->pc != 0x1B6964u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b6964:
    ...
    ctx->pc = 0x1B6968u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6964u;
            // 0x1b6968: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B6980u;
    if (runtime->hasFunction(0x1B6980u)) {
        auto targetFn = runtime->lookupFunction(0x1B6980u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B696Cu; }
        if (ctx->pc != 0x1B696Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B6980_0x1b6980(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B696Cu; }
        if (ctx->pc != 0x1B696Cu) { return; }
    }
    ctx->pc = 0x1B696Cu;
