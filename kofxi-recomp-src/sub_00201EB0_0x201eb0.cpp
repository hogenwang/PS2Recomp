...
void sub_00201EB0_0x201eb0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x201F08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x201F08u, 0x201EBCu, 0x201EC4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x201EC4u;
label_201ec4:
    ...
    ctx->pc = 0x201F58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x201F58u, 0x201ED0u, 0x201ED8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x201ED8u;
label_201ed8:
...
label_201ef8:
    ...
    ctx->pc = 0x201F00u;
    {
        ...
        ctx->pc = 0x201F04u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x201F00u;
        // 0x201f04: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x201F00u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
