...
label_233dc8:
    ...
    ctx->pc = 0x233DECu;
    {
        ...
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x233DECu, 0x0u, PS2Runtime::GuestBranchKind::IndirectJump, "JR")) {
            return;
        }
    }
    ctx->pc = 0x233DF4u;
...
label_233e04:
    ...
    ctx->pc = 0x233E28u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x233E24u;
    // 0x233e28: 0x27a60040  addiu       $a2, $sp, 0x40 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
    ctx->in_delay_slot = false;
    ctx->pc = 0x233BD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x233BD0u, 0x233E24u, 0x233E2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x233E2Cu;
label_233e2c:
...
label_233e40:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x233CF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x233CF8u, 0x233E60u, 0x233E68u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x233E68u;
label_233e68:
...
label_233ed0:
    ...
    ctx->pc = 0x233EF8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x233EF4u;
    // 0x233ef8: 0x27a60048  addiu       $a2, $sp, 0x48 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 72));
    ctx->in_delay_slot = false;
    ctx->pc = 0x233BD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x233BD0u, 0x233EF4u, 0x233EFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x233EFCu;
label_233efc:
...
label_233f30:
    ...
    ctx->pc = 0x233F58u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x233F54u;
    // 0x233f58: 0x27a6004c  addiu       $a2, $sp, 0x4C (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 76));
    ctx->in_delay_slot = false;
    ctx->pc = 0x233CF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x233CF8u, 0x233F54u, 0x233F5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x233F5Cu;
label_233f5c:
...
label_234250:
    ...
    ctx->pc = 0x234268u;
    {
        ...
        ctx->pc = 0x23426Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x234268u;
        // 0x23426c: 0x27bd00b0  addiu       $sp, $sp, 0xB0 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 176));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x234268u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
