...
void sub_00122C28_0x122c28(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x122C44u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x122C40u;
    ...
    if (runtime->hasFunction(0x122660u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x122C48u; }
        if (ctx->pc != 0x122C48u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_122c48:
    ...
    ctx->pc = 0x122C54u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x122C50u;
    ...
    if (runtime->hasFunction(0x122660u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x122C58u; }
        if (ctx->pc != 0x122C58u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00122660_0x122660(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x122C58u; }
...
label_122c58:
    ...
    ctx->pc = 0x122C60u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x122C5Cu;
            // 0x122c60: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x122C80u;
    if (runtime->hasFunction(0x122C80u)) {
        auto targetFn = runtime->lookupFunction(0x122C80u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x122C64u; }
        if (ctx->pc != 0x122C64u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00122C80_0x122c80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x122C64u; }
        if (ctx->pc != 0x122C64u) { return; }
    }
    ctx->pc = 0x122C64u;
label_122c64:
    ...
    ctx->pc = 0x122C68u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x122C64u;
    ...
    if (runtime->hasFunction(0x122598u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x122C6Cu; }
        if (ctx->pc != 0x122C6Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_122c6c:
    ...
    ctx->pc = 0x122C74u;
    {
        ...
        ctx->pc = 0x122C78u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x122C74u;
