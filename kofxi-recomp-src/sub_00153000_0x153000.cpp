...
void sub_00153000_0x153000(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x15301Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x153018u;
    ...
    if (runtime->hasFunction(0x152AE0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x153020u; }
        if (ctx->pc != 0x153020u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1530ac:
    ...
    ctx->pc = 0x1530B8u;
    {
        ...
        ctx->pc = 0x1530BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1530B8u;
