...
label_2dcaf8:
    ...
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2DCB00u, 0x2DCB08u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCB08u;
label_2dcb08:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x17AE9Cu;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x17AE9Cu, 0x2DCB14u, 0x2DCB1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCB1Cu;
label_2dcb1c:
    ...
    ctx->pc = 0x2dcb2cu;
    throw std::runtime_error("Unhandled MMI instruction: function 0x1D at 0x2DCB2C raw=0x72ACEEDD");
label_2dcb30:
    ...
    ctx->pc = 0x2dcb34u;
    throw std::runtime_error("Unhandled MMI instruction: function 0xD at 0x2DCB34 raw=0x72ACEFCD");
    // 0x2dcb38: 0x0  nop
    ctx->pc = 0x2dcb38u;
    // NOP
label_2dcb3c:
...
label_fallthrough_0x2dcb44:
    ...
    ctx->pc = 0x2dcb50u;
    throw std::runtime_error("Unhandled REGIMM instruction: 0x1A at 0x2DCB50 raw=0x07BA47FB");
    ...
    ctx->pc = 0x2DCB54u;
    {
        ...
        ctx->pc = 0x2DCB58u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2DCB54u;
        // 0x2dcb58: 0x46ba55a0  .word       0x46BA55A0                   # INVALID     $s5, $k0, 0x55A0 # 00000000 <InstrIdType: R5900_COP1> (Delay Slot)
        throw std::runtime_error("Unhandled FPU instruction: format 0x15, function 0x20 at 0x2DCB58 raw=0x46BA55A0");
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x2dcb5cu;
    throw std::runtime_error("Unhandled FPU instruction: format 0xD, function 0x22 at 0x2DCB5C raw=0x45BA55A2");
    ...
    ctx->pc = 0x2dcb64u;
    throw std::runtime_error("Unhandled FPU instruction: format 0x1D, function 0xA at 0x2DCB64 raw=0x47B857CA");
...
label_fallthrough_0x2dcba0:
    ...
    ctx->pc = 0x2dcba8u;
    throw std::runtime_error("Unhandled FPU instruction: format 0x1D, function 0x0 at 0x2DCBA8 raw=0x47BAC7C0");
    // 0x2dcbac: 0x77bc47fa  .word       0x77BC47FA                   # INVALID     $sp, $gp, 0x47FA # 00000000 <InstrIdType: CPU_NORMAL>
    ctx->pc = 0x2dcbacu;
    throw std::runtime_error("Unhandled opcode: 0x1D at 0x2DCBAC raw=0x77BC47FA");
label_2dcbb0:
...
label_2dcbb8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2E3988u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2E3988u, 0x2DCBBCu, 0x2DCBC4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCBC4u;
label_2dcbc4:
...
label_2dcbd0:
    ...
    ctx->pc = 0x2DCBD4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DCBD0u;
    // 0x2dcbd4: 0xcb841c8  jal         func_2E10720 (Delay Slot)
    // JAL 0x2E10720 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x11EDB08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11EDB08u, 0x2DCBD0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2DCBD8u;
...
label_2dcbe0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x4E10720u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x4E10720u, 0x2DCBE0u, 0x2DCBE8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCBE8u;
label_2dcbe8:
    ...
    ctx->pc = 0x2DCBF0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DCBECu;
    // 0x2dcbf0: 0xfb84641  jal         func_EE11904 (Delay Slot)
    // JAL 0xEE11904 - Handled by branch logic
    ctx->in_delay_slot = false;
    ctx->pc = 0x6E10720u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x6E10720u, 0x2DCBECu, 0x2DCBF4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCBF4u;
label_2dcbf4:
...
label_fallthrough_0x2dcbfc:
    ...
    ctx->pc = 0x2dcc1cu;
    throw std::runtime_error("Unhandled FPU instruction: format 0x1D, function 0x21 at 0x2DCC1C raw=0x47B861E1");
...
label_2dcc34:
    ...
    ctx->pc = 0x2dcc40u;
    throw std::runtime_error("Unhandled REGIMM instruction: 0x1A at 0x2DCC40 raw=0x06BA1585");
    ...
    ctx->pc = 0x2DCC6Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DCC68u;
    // 0x2dcc6c: 0x7ddeeca2  sq          $fp, -0x135E($t6) (Delay Slot)
    WRITE128(ADD32(GPR_U32(ctx, 14), 4294962338), GPR_VEC(ctx, 30));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2C1DAD4u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2C1DAD4u, 0x2DCC68u, 0x2DCC70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCC70u;
label_2dcc70:
...
label_2dcc7c:
    ...
    ctx->pc = 0x2DCC98u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2DCC94u;
    // 0x2dcc98: 0x8c460000  lw          $a2, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8FC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8FC0u, 0x2DCC94u, 0x2DCC9Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2DCC9Cu;
label_2dcc9c:
...
label_2dccac:
    ...
    ctx->pc = 0x2DCCC0u;
    {
        ...
        ctx->pc = 0x2DCCC4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2DCCC0u;
        // 0x2dccc4: 0x27bd0090  addiu       $sp, $sp, 0x90 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 144));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2DCCC0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
