...
void sub_00231970_0x231970(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x231990u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x23198Cu;
    ...
    if (runtime->hasFunction(0x2616E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x231994u; }
        if (ctx->pc != 0x231994u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_231994:
    ...
    ctx->pc = 0x231998u;
    {
        ...
        ctx->pc = 0x23199Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x231998u;
    ...
    ctx->pc = 0x2319A0u;
    {
        ...
        ctx->pc = 0x2319A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2319A0u;
