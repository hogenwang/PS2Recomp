...
void sub_00201D70_0x201d70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x201D90u;
    {
        ...
        ctx->branch_pc = 0x201D90u;
        // 0x201d94: 0xac830000  sw          $v1, 0x0($a0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 4), 0), GPR_U32(ctx, 3));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x201D90u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_201d98:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE9D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE9D0u, 0x201DB4u, 0x201DBCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x201DBCu;
label_201dbc:
    ...
    ctx->pc = 0x201DC4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x201DC0u;
    // 0x201dc4: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x201A38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x201A38u, 0x201DC0u, 0x201DC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x201DC8u;
label_201dc8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x201BB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x201BB0u, 0x201DE4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x201DECu;
    // 0x201dec: 0x0  nop
...
label_201df0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE9F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE9F8u, 0x201DFCu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x201E04u;
    // 0x201e04: 0x0  nop
...
label_201e08:
    ...
    ctx->pc = 0x201E18u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x201E14u;
    // 0x201e18: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE978u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE978u, 0x201E14u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x201E1Cu;
    // 0x201e1c: 0x0  nop
    ctx->pc = 0x201e1cu;
    // NOP
    if (ctx->pc == 0x201e1cu) { ctx->pc = 0x201e20u; }
}
