...
label_187024:
    ...
    ctx->pc = 0x187024u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x187024u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x18702cu;
    // NOP
    if (ctx->pc == 0x18702cu) { ctx->pc = 0x187030u; }
}
