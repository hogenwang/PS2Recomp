...
void sub_0010E7A8_0x10e7a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10E7BCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10E7B8u;
    // 0x10e7bc: 0x2404000d  addiu       $a0, $zero, 0xD (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 13));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10E6C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10E6C0u, 0x10E7B8u, 0x10E7C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10E7C0u;
label_10e7c0:
...
label_10e7d0:
    ...
    ctx->pc = 0x10e7dcu;
    // NOP
    if (ctx->pc == 0x10e7dcu) { ctx->pc = 0x10e7e0u; }
}
