...
void sub_001BB6C8_0x1bb6c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1BB6C8u;
    {
        ...
        ctx->pc = 0x1BB6CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB6C8u;
...
label_1bb6d0:
    ...
    ctx->pc = 0x1BB6F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB6ECu;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BB6F4u; }
        if (ctx->pc != 0x1BB6F4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bb6f4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB6FCu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BB720u;
    if (runtime->hasFunction(0x1BB720u)) {
        auto targetFn = runtime->lookupFunction(0x1BB720u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001BB720_0x1bb720(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BB704u; }
        if (ctx->pc != 0x1BB704u) { return; }
    }
    ctx->pc = 0x1BB704u;
label_1bb704:
    ...
    ctx->pc = 0x1BB714u;
    ctx->pc = 0x1BB718u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BB714u;
