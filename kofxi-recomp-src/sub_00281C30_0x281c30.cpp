...
void sub_00281C30_0x281c30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x281C48u;
    {
        ...
        if (branch_taken_0x281c48) {
            ctx->pc = 0x281C4Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x281C48u;
    ...
    if (runtime->hasFunction(0x2A3028u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x281C58u; }
        if (ctx->pc != 0x281C58u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_281c5c:
    ...
    ctx->pc = 0x281C64u;
    ctx->pc = 0x281C68u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x281C64u;
...
label_281c6c:
    ...
    ctx->pc = 0x281C74u;
    {
        ...
        ctx->pc = 0x281C78u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x281C74u;
