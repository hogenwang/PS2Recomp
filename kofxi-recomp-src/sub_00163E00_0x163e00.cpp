...
void sub_00163E00_0x163e00(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x163D80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x163D80u, 0x163E0Cu, 0x163E14u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x163E14u;
label_163e14:
    ...
    ctx->pc = 0x163E2Cu;
    {
        ...
        ctx->pc = 0x163E30u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x163E2Cu;
        // 0x163e30: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x163E2Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x163e3cu;
    // NOP
    if (ctx->pc == 0x163e3cu) { ctx->pc = 0x163e40u; }
}
