...
void sub_00111460_0x111460(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x111478u;
    {
        ...
        ctx->pc = 0x11147Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x111478u;
    ...
    ctx->pc = 0x11149Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x111498u;
...
label_1114a0:
    ...
    ctx->pc = 0x1114B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1114B0u;
    ...
    if (runtime->hasFunction(0x10CC60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1114B8u; }
        if (ctx->pc != 0x1114B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        kofxiSyscallCreateSemaWrapper_0x10cc60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1114B8u; }
...
label_1114c4:
    ...
    ctx->pc = 0x1114C8u;
    {
        ...
        ctx->pc = 0x1114CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1114C8u;
