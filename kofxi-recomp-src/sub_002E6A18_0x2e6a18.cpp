...
void sub_002E6A18_0x2e6a18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2E6A1Cu;
    {
        ...
        ctx->pc = 0x2E6A20u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6A1Cu;
...
label_2e6a5c:
    ...
    ctx->pc = 0x2E6A64u;
    ctx->pc = 0x2E6A68u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6A64u;
...
label_2e6a6c:
    ...
    ctx->pc = 0x2E6A74u;
    ctx->pc = 0x2E6A78u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6A74u;
...
label_2e6a7c:
    ...
    ctx->pc = 0x2E6A84u;
    ctx->pc = 0x2E6A88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6A84u;
...
label_2e6a9c:
    ...
    ctx->pc = 0x2E6AA4u;
    ctx->pc = 0x2E6AA8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6AA4u;
...
label_2e6aac:
    ...
    ctx->pc = 0x2E6AB4u;
    ctx->pc = 0x2E6AB8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6AB4u;
