...
label_2f1f20:
    ...
    ctx->pc = 0x2F1F20u;
    {
        ...
        ctx->pc = 0x2F1F24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1F20u;
    ...
    ctx->pc = 0x2F1F30u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1F2Cu;
    ...
    if (runtime->hasFunction(0x2F6790u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F1F34u; }
        if (ctx->pc != 0x2F1F34u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2f1f34:
    ...
    ctx->pc = 0x2F1F34u;
    {
        ...
        if (branch_taken_0x2f1f34) {
            ctx->pc = 0x2F1F38u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1F34u;
...
label_2f1f40:
    ...
    ctx->pc = 0x2F1F4Cu;
    {
        ...
        ctx->pc = 0x2F1F50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1F4Cu;
