...
void sub_002CF248_0x2cf248(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2CF254u;
    // 0x2cf258: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2CF220u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2CF220u, 0x2CF254u, 0x2CF25Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2CF25Cu;
label_2cf25c:
...
label_2cf278:
    ...
    ctx->pc = 0x2CF27Cu;
    {
        ...
        ctx->pc = 0x2CF280u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2CF27Cu;
        // 0x2cf280: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2CF27Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2cf284u;
    // NOP
    if (ctx->pc == 0x2cf284u) { ctx->pc = 0x2cf288u; }
}
