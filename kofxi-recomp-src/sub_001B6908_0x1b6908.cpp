...
void sub_001B6908_0x1b6908(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B6920u;
    {
        ...
        ctx->pc = 0x1B6924u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6920u;
    ...
    ctx->pc = 0x1B692Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6928u;
            // 0x1b692c: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B6718u;
    if (runtime->hasFunction(0x1B6718u)) {
        auto targetFn = runtime->lookupFunction(0x1B6718u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6930u; }
        if (ctx->pc != 0x1B6930u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B6718_0x1b6718(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6930u; }
        if (ctx->pc != 0x1B6930u) { return; }
    }
    ctx->pc = 0x1B6930u;
label_1b6930:
    ...
    ctx->pc = 0x1B6930u;
    {
        ...
        ctx->pc = 0x1B6934u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6930u;
...
label_1b6938:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6938u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B67F0u;
    if (runtime->hasFunction(0x1B67F0u)) {
        auto targetFn = runtime->lookupFunction(0x1B67F0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6940u; }
        if (ctx->pc != 0x1B6940u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b6944:
    ...
    ctx->pc = 0x1B6944u;
    {
        ...
        ctx->pc = 0x1B6948u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6944u;
