...
label_200408:
    ...
    ctx->pc = 0x200408u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x20040Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200408u;
...
label_200418:
    ...
    ctx->pc = 0x200418u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x20041Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200418u;
...
label_200420:
    ...
    ctx->pc = 0x200420u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x200424u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200420u;
...
label_200428:
    ...
    ctx->pc = 0x200428u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x20042Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200428u;
...
label_200430:
    ...
    ctx->pc = 0x200430u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x200434u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200430u;
...
label_200438:
    ...
    ctx->pc = 0x200438u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x20043Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200438u;
...
label_200440:
    ...
    ctx->pc = 0x200440u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x200444u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200440u;
