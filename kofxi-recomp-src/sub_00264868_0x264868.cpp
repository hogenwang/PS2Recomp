...
void sub_00264868_0x264868(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x264878u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x264874u;
    ...
    if (runtime->hasFunction(0x2645A0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x26487Cu; }
        if (ctx->pc != 0x26487Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_26487c:
    ...
    ctx->pc = 0x26487Cu;
    {
        ...
        ctx->pc = 0x264880u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26487Cu;
...
label_26488c:
    ...
    ctx->pc = 0x264890u;
    {
        ...
        ctx->pc = 0x264894u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x264890u;
