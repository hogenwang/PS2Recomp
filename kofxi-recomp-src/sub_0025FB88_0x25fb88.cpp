...
label_25fba4:
    ...
    ctx->pc = 0x25FBD0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25FBCCu;
    ...
    if (runtime->hasFunction(0x2616E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x25FBD4u; }
        if (ctx->pc != 0x25FBD4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25fbd4:
    ...
    ctx->pc = 0x25FBF0u;
    {
        ...
        ctx->pc = 0x25FBF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25FBF0u;
