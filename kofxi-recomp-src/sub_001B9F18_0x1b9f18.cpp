...
void sub_001B9F18_0x1b9f18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B9F30u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9F2Cu;
    ...
    if (runtime->hasFunction(0x1AE828u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9F34u; }
        if (ctx->pc != 0x1B9F34u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b9f34:
    ...
    ctx->pc = 0x1B9F34u;
    {
        ...
        ctx->pc = 0x1B9F38u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9F34u;
...
label_1b9f48:
    ...
    ctx->pc = 0x1B9F4Cu;
    {
        ...
        ctx->pc = 0x1B9F50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9F4Cu;
...
label_1b9f74:
    ...
    if (runtime->hasFunction(0x1B9F98u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9F80u; }
        if (ctx->pc != 0x1B9F80u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
