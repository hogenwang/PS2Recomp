...
void sub_001F0430_0x1f0430(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F0440u;
    // 0x1f0444: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FB008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FB008u, 0x1F0440u, 0x1F0448u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F0448u;
label_1f0448:
    ...
    ctx->pc = 0x1ED4A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ED4A8u, 0x1F0450u, 0x1F0458u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F0458u;
label_1f0458:
...
label_1f0480:
    ...
    ctx->pc = 0x1F048Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F0488u;
    // 0x1f048c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EFE20u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EFE20u, 0x1F0488u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1F0490u;
label_1f0490:
...
label_1f0494:
    ...
    ctx->pc = 0x1F0498u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F0498u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
