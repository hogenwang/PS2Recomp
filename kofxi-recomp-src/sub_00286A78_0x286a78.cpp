...
void sub_00286A78_0x286a78(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x286A84u;
    // 0x286a88: 0x24040110  addiu       $a0, $zero, 0x110 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 272));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A2FD8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A2FD8u, 0x286A84u, 0x286A8Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286A8Cu;
label_286a8c:
    ...
    ctx->pc = 0x286A9Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x286A98u;
    // 0x286a9c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x286AC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286AC0u, 0x286A98u, 0x286AA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286AA0u;
label_286aa0:
...
label_286aac:
    ...
    ctx->pc = 0x286AB4u;
    {
        ...
        ctx->pc = 0x286AB8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x286AB4u;
        // 0x286ab8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x286AB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x286abcu;
    // NOP
    if (ctx->pc == 0x286abcu) { ctx->pc = 0x286ac0u; }
}
