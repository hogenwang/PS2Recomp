...
void sub_001E0960_0x1e0960(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E0980u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E097Cu;
            // 0x1e0980: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6950u;
    if (runtime->hasFunction(0x1E6950u)) {
        auto targetFn = runtime->lookupFunction(0x1E6950u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E0984u; }
        if (ctx->pc != 0x1E0984u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6950_0x1e6950(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E0984u; }
        if (ctx->pc != 0x1E0984u) { return; }
    }
    ctx->pc = 0x1E0984u;
label_1e0984:
    ...
    ctx->pc = 0x1E0998u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E0994u;
            // 0x1e0998: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6A10u;
    if (runtime->hasFunction(0x1E6A10u)) {
        auto targetFn = runtime->lookupFunction(0x1E6A10u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E099Cu; }
        if (ctx->pc != 0x1E099Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6A10_0x1e6a10(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E099Cu; }
        if (ctx->pc != 0x1E099Cu) { return; }
    }
    ctx->pc = 0x1E099Cu;
label_1e099c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E09ACu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E69B8u;
    if (runtime->hasFunction(0x1E69B8u)) {
        auto targetFn = runtime->lookupFunction(0x1E69B8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001E69B8_0x1e69b8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E09B4u; }
        if (ctx->pc != 0x1E09B4u) { return; }
    }
    ctx->pc = 0x1E09B4u;
label_1e09b4:
    ...
    ctx->pc = 0x1E09B8u;
    ctx->pc = 0x1E09BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E09B8u;
            // 0x1e09bc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6A68u;
    {
        auto targetFn = runtime->lookupFunction(0x1E6A68u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
