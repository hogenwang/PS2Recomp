...
void sub_001432F0_0x1432f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x143320u;
    {
        ...
        if (branch_taken_0x143320) {
            ctx->pc = 0x143324u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x143320u;
...
label_143330:
    ...
    ctx->pc = 0x143350u;
    {
        ...
        ctx->pc = 0x143354u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x143350u;
...
label_143358:
    ...
    ctx->pc = 0x143380u;
    {
        ...
        ctx->pc = 0x143384u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x143380u;
...
label_143388:
    ...
    ctx->pc = 0x1433A8u;
    {
        ...
        ctx->pc = 0x1433ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1433A8u;
