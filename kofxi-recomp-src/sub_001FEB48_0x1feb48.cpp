...
void sub_001FEB48_0x1feb48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FB008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FB008u, 0x1FEB58u, 0x1FEB60u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FEB60u;
label_1feb60:
...
label_1feb70:
    ...
    ctx->pc = 0x1FD070u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FD070u, 0x1FEB70u, 0x1FEB78u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FEB78u;
label_1feb78:
...
label_1feb7c:
    ...
    ctx->pc = 0x1FEB84u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1FEB84u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1feb8cu;
    // NOP
    if (ctx->pc == 0x1feb8cu) { ctx->pc = 0x1feb90u; }
}
