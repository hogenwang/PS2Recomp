...
void sub_001762F0_0x1762f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x176304u;
    // 0x176308: 0x24060050  addiu       $a2, $zero, 0x50 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 80));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F5B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F5B0u, 0x176304u, 0x17630Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17630Cu;
label_17630c:
    ...
    ctx->pc = 0x176320u;
    {
        ...
        ctx->pc = 0x176324u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x176320u;
        // 0x176324: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x176320u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x17632cu;
    // NOP
    if (ctx->pc == 0x17632cu) { ctx->pc = 0x176330u; }
}
