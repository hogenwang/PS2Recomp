...
void sub_00296E70_0x296e70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x296E98u; }
        if (ctx->pc != 0x296E98u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_296e98:
    ...
    ctx->pc = 0x296E9Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296E98u;
...
label_296ea4:
    ...
    ctx->pc = 0x296EACu;
    ctx->pc = 0x296EB0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296EACu;
