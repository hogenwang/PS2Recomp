...
void sub_002B7028_0x2b7028(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2B7048u;
    // 0x2b704c: 0xc33021  addu        $a2, $a2, $v1 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), GPR_U32(ctx, 3)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B6068u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B6068u, 0x2B7048u, 0x2B7050u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2B7050u;
label_2b7050:
...
label_2b708c:
    ...
    ctx->pc = 0x2B7094u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2B7094u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2b709cu;
    // NOP
    if (ctx->pc == 0x2b709cu) { ctx->pc = 0x2b70a0u; }
}
