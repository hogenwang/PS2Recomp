...
void sub_00276F78_0x276f78(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x275508u;
    if (runtime->hasFunction(0x275508u)) {
        auto targetFn = runtime->lookupFunction(0x275508u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x276F88u; }
        if (ctx->pc != 0x276F88u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00275508_0x275508(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x276F88u; }
        if (ctx->pc != 0x276F88u) { return; }
    }
    ctx->pc = 0x276F88u;
label_276f88:
    ...
    ctx->pc = 0x276F8Cu;
    {
        ...
        ctx->pc = 0x276F90u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x276F8Cu;
