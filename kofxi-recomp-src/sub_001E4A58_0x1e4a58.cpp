...
void sub_001E4A58_0x1e4a58(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E4A68u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4A64u;
            // 0x1e4a68: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E45E8u;
    if (runtime->hasFunction(0x1E45E8u)) {
        auto targetFn = runtime->lookupFunction(0x1E45E8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E4A6Cu; }
        if (ctx->pc != 0x1E4A6Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E45E8_0x1e45e8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E4A6Cu; }
        if (ctx->pc != 0x1E4A6Cu) { return; }
    }
    ctx->pc = 0x1E4A6Cu;
...
label_1e4a80:
    ...
    ctx->pc = 0x1E4A98u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4A94u;
            // 0x1e4a98: 0x382d  daddu       $a3, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1FE648u;
    if (runtime->hasFunction(0x1FE648u)) {
        auto targetFn = runtime->lookupFunction(0x1FE648u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E4A9Cu; }
        if (ctx->pc != 0x1E4A9Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001FE648_0x1fe648(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E4A9Cu; }
        if (ctx->pc != 0x1E4A9Cu) { return; }
    }
    ctx->pc = 0x1E4A9Cu;
...
label_1e4aa8:
    ...
    ctx->pc = 0x1E4AB0u;
    {
        ...
        ctx->pc = 0x1E4AB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4AB0u;
...
label_1e4ab8:
    ...
    ctx->pc = 0x201B30u;
    {
        auto targetFn = runtime->lookupFunction(0x201B30u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1e4ad0:
    ...
    ctx->pc = 0x1E4AE0u;
    ctx->pc = 0x1E4AE4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4AE0u;
            // 0x1e4ae4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x201B48u;
    {
        auto targetFn = runtime->lookupFunction(0x201B48u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1e4ae8:
    ...
    ctx->pc = 0x1E4AF8u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E4AFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4AF8u;
...
label_1e4b00:
    ...
    ctx->pc = 0x1E4B24u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4B20u;
            // 0x1e4b24: 0x8c8400a8  lw          $a0, 0xA8($a0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 168)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x201AE0u;
    if (runtime->hasFunction(0x201AE0u)) {
        auto targetFn = runtime->lookupFunction(0x201AE0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00201AE0_0x201ae0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E4B28u; }
        if (ctx->pc != 0x1E4B28u) { return; }
    }
    ctx->pc = 0x1E4B28u;
label_1e4b28:
    ...
    ctx->pc = 0x1E4B44u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E4B48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E4B44u;
