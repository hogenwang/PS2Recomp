...
void sub_001ED7B0_0x1ed7b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1ED7DCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1ED7D8u;
            // 0x1ed7dc: 0x248416dc  addiu       $a0, $a0, 0x16DC (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 5852));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1ED848u;
    if (runtime->hasFunction(0x1ED848u)) {
        auto targetFn = runtime->lookupFunction(0x1ED848u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1ED7E0u; }
        if (ctx->pc != 0x1ED7E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001ED848_0x1ed848(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1ED7E0u; }
        if (ctx->pc != 0x1ED7E0u) { return; }
    }
    ctx->pc = 0x1ED7E0u;
label_1ed7e0:
    ...
    ctx->pc = 0x1ED7E0u;
    {
        ...
        ctx->pc = 0x1ED7E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1ED7E0u;
...
label_1ed7e8:
    ...
    if (runtime->hasFunction(0x1ED920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1ED7F0u; }
        if (ctx->pc != 0x1ED7F0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ed7f0:
    ...
    ctx->pc = 0x1ED810u;
    ctx->pc = 0x1ED814u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1ED810u;
...
label_1ed818:
    ...
    ctx->pc = 0x1ED824u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1ED820u;
    ...
    if (runtime->hasFunction(0x1ED848u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1ED828u; }
        if (ctx->pc != 0x1ED828u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001ED848_0x1ed848(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1ED828u; }
