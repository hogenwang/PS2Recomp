...
void sub_001E7A18_0x1e7a18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E28A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E28A8u, 0x1E7A20u, 0x1E7A28u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E7A28u;
label_1e7a28:
    ...
    ctx->branch_pc = 0x1E7A28u;
    // 0x1e7a2c: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E7D48u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E7D48u, 0x1E7A28u, 0x1E7A30u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E7A30u;
label_1e7a30:
    ...
    ctx->pc = 0x1E7A3Cu;
    {
        ...
        ctx->pc = 0x1E7A40u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E7A3Cu;
        // 0x1e7a40: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E7A3Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e7a44u;
    // NOP
    if (ctx->pc == 0x1e7a44u) { ctx->pc = 0x1e7a48u; }
}
