...
void sub_001E2E90_0x1e2e90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1E2960u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E2EC8u; }
        if (ctx->pc != 0x1E2EC8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e2ec8:
    ...
    ctx->pc = 0x1E2EF0u;
    ctx->pc = 0x1E2EF4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2EF0u;
...
label_1e2ef8:
    ...
    ctx->pc = 0x1E2F08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2F04u;
            // 0x1e2f08: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
        SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1FBCA0u;
    if (runtime->hasFunction(0x1FBCA0u)) {
        auto targetFn = runtime->lookupFunction(0x1FBCA0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E2F0Cu; }
        if (ctx->pc != 0x1E2F0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001FBCA0_0x1fbca0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E2F0Cu; }
        if (ctx->pc != 0x1E2F0Cu) { return; }
    }
    ctx->pc = 0x1E2F0Cu;
label_1e2f0c:
    ...
    ctx->pc = 0x1E2F0Cu;
    {
        ...
        ctx->pc = 0x1E2F10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2F0Cu;
...
label_1e2f1c:
    ...
    ctx->pc = 0x1E2F24u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2F20u;
    ...
    if (runtime->hasFunction(0x1E6BE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E2F28u; }
        if (ctx->pc != 0x1E2F28u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e2f28:
    ...
    ctx->pc = 0x1E2F2Cu;
    {
        ...
        ctx->pc = 0x1E2F30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2F2Cu;
...
label_1e2f40:
    ...
    ctx->pc = 0x1E2F54u;
    {
        ...
        ctx->pc = 0x1E2F58u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2F54u;
...
label_1e2f7c:
    ...
    ctx->pc = 0x1E2F84u;
    ctx->pc = 0x1E2F88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2F84u;
...
label_1e2fc0:
    ...
    ctx->pc = 0x1E2FD8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2FD4u;
    ...
    if (runtime->hasFunction(0x1E2960u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E2FDCu; }
        if (ctx->pc != 0x1E2FDCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E2960_0x1e2960(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E2FDCu; }
...
label_1e2fdc:
    ...
    ctx->pc = 0x1E2FE4u;
    {
        ...
        ctx->pc = 0x1E2FE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E2FE4u;
    ...
    ctx->pc = 0x1E3000u;
    ctx->pc = 0x1E3004u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3000u;
...
label_1e3008:
    ...
    ctx->pc = 0x1E1DF0u;
    if (runtime->hasFunction(0x1E1DF0u)) {
        auto targetFn = runtime->lookupFunction(0x1E1DF0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3010u; }
        if (ctx->pc != 0x1E3010u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E1DF0_0x1e1df0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3010u; }
        if (ctx->pc != 0x1E3010u) { return; }
    }
    ctx->pc = 0x1E3010u;
label_1e3010:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3014u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6408u;
    if (runtime->hasFunction(0x1E6408u)) {
        auto targetFn = runtime->lookupFunction(0x1E6408u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E301Cu; }
        if (ctx->pc != 0x1E301Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6408_0x1e6408(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E301Cu; }
        if (ctx->pc != 0x1E301Cu) { return; }
    }
    ctx->pc = 0x1E301Cu;
...
label_1e3054:
    ...
    if (runtime->hasFunction(0x1E6BE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E306Cu; }
        if (ctx->pc != 0x1E306Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6BE8_0x1e6be8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E306Cu; }
...
label_1e3078:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3084u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E1E08u;
    if (runtime->hasFunction(0x1E1E08u)) {
        auto targetFn = runtime->lookupFunction(0x1E1E08u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E308Cu; }
        if (ctx->pc != 0x1E308Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E1E08_0x1e1e08(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E308Cu; }
        if (ctx->pc != 0x1E308Cu) { return; }
    }
    ctx->pc = 0x1E308Cu;
label_1e308c:
    ...
    ctx->pc = 0x1E3094u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3090u;
            // 0x1e3094: 0x40882d  daddu       $s1, $v0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6468u;
    if (runtime->hasFunction(0x1E6468u)) {
        auto targetFn = runtime->lookupFunction(0x1E6468u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3098u; }
        if (ctx->pc != 0x1E3098u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6468_0x1e6468(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3098u; }
        if (ctx->pc != 0x1E3098u) { return; }
    }
    ctx->pc = 0x1E3098u;
label_1e3098:
    ...
    ctx->pc = 0x1E30A0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E309Cu;
    ...
    if (runtime->hasFunction(0x1E6468u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E30A4u; }
        if (ctx->pc != 0x1E30A4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6468_0x1e6468(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E30A4u; }
...
label_1e30d8:
    ...
    ctx->pc = 0x1E30F8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E30F4u;
    ...
    if (runtime->hasFunction(0x1E2960u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E30FCu; }
        if (ctx->pc != 0x1E30FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E2960_0x1e2960(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E30FCu; }
...
label_1e30fc:
    ...
    ctx->pc = 0x1E3108u;
    {
        ...
        ctx->pc = 0x1E310Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3108u;
...
label_1e3130:
    ...
    ctx->pc = 0x1E3140u;
    ctx->pc = 0x1E3144u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3140u;
            // 0x1e3144: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E1E20u;
    {
        auto targetFn = runtime->lookupFunction(0x1E1E20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1e3148:
    ...
    ctx->pc = 0x1E3160u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E315Cu;
    ...
    if (runtime->hasFunction(0x1E2960u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3164u; }
        if (ctx->pc != 0x1E3164u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E2960_0x1e2960(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3164u; }
...
label_1e3188:
    ...
    ctx->pc = 0x1E318Cu;
    {
        ...
        ctx->pc = 0x1E3190u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E318Cu;
    ...
    ctx->pc = 0x1E1E38u;
    {
        auto targetFn = runtime->lookupFunction(0x1E1E38u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1e3250:
    ...
    ctx->pc = 0x1E3264u;
    ctx->pc = 0x1E3268u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3264u;
            // 0x1e3268: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1FB018u;
    {
        auto targetFn = runtime->lookupFunction(0x1FB018u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1e3280:
    ...
    ctx->pc = 0x1E3284u;
    {
        ...
        ctx->pc = 0x1E3288u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3284u;
    ...
    ctx->pc = 0x1E3294u;
    ctx->pc = 0x1E3298u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3294u;
            // 0x1e3298: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1FB028u;
    {
        auto targetFn = runtime->lookupFunction(0x1FB028u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1e32a0:
    ...
    ctx->pc = 0x1E32A4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E32A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E32A4u;
