...
void sub_00226758_0x226758(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x22678Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x226788u;
    // 0x22678c: 0x8de4f1e0  lw          $a0, -0xE20($t7) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 15), 4294963680)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2276D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2276D0u, 0x226788u, 0x226790u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x226790u;
label_226790:
...
label_226794:
    ...
    ctx->pc = 0x2267A4u;
    {
        ...
        ctx->pc = 0x2267A8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2267A4u;
        // 0x2267a8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2267A4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2267acu;
    // NOP
    if (ctx->pc == 0x2267acu) { ctx->pc = 0x2267b0u; }
}
