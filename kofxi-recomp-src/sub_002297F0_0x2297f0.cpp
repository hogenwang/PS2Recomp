...
void sub_002297F0_0x2297f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x229800u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2297FCu;
            // 0x229800: 0x3c1001c1  lui         $s0, 0x1C1 (Delay Slot)
        SET_GPR_S32(ctx, 16, (int32_t)((uint32_t)449 << 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2616B8u;
    if (runtime->hasFunction(0x2616B8u)) {
        auto targetFn = runtime->lookupFunction(0x2616B8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x229804u; }
        if (ctx->pc != 0x229804u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002616B8_0x2616b8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x229804u; }
        if (ctx->pc != 0x229804u) { return; }
    }
    ctx->pc = 0x229804u;
label_229804:
    ...
    ctx->pc = 0x229808u;
    {
        ...
        ctx->pc = 0x22980Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x229808u;
    ...
    if (runtime->hasFunction(0x10CC70u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x229818u; }
        if (ctx->pc != 0x229818u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_22981c:
    ...
    ctx->pc = 0x229824u;
    {
        ...
        ctx->pc = 0x229828u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x229824u;
