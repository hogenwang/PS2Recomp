...
label_2dc790:
    ...
    ctx->pc = 0x2DC7D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC7D0u;
...
label_fallthrough_0x2dc7d8:
    ...
    ctx->pc = 0x2DC7E8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC7E4u;
            // 0x2dc7e8: 0x87c66abb  lh          $a2, 0x6ABB($fp) (Delay Slot)
        SET_GPR_S32(ctx, 6, (int16_t)READ16(ADD32(GPR_U32(ctx, 30), 27323)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x37E1BC8u;
    {
        auto targetFn = runtime->lookupFunction(0x37E1BC8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC7ECu; }
        if (ctx->pc != 0x2DC7ECu) { return; }
    }
    ctx->pc = 0x2DC7ECu;
label_2dc7ec:
...
label_2dc828:
    ...
    ctx->pc = 0x2DC828u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC824u;
            // 0x2dc828: 0x56352995  bnel        $s1, $s5, . + 4 + (0x2995 << 2) (Delay Slot)
        // Likely branch instruction at 0x2DC828 - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x2DB588u;
    if (runtime->hasFunction(0x2DB588u)) {
        auto targetFn = runtime->lookupFunction(0x2DB588u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC82Cu; }
        if (ctx->pc != 0x2DC82Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002DB588_0x2db588(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC82Cu; }
        if (ctx->pc != 0x2DC82Cu) { return; }
    }
    ctx->pc = 0x2DC82Cu;
label_2dc82c:
    ...
    ctx->pc = 0x2DC82Cu;
    ctx->pc = 0x2DC830u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC82Cu;
            // 0x2dc830: 0xdfd4d63  jal         func_7F5358C (Delay Slot)
        // JAL 0x7F5358C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7D4367Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7D4367Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc838:
    ...
    ctx->pc = 0x2DC838u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC834u;
            // 0x2dc838: 0xa9f8c997  swl         $t8, -0x3669($t7) (Delay Slot)
        { uint32_t addr = ADD32(GPR_U32(ctx, 15), 4294953367); uint32_t aligned_addr = addr & ~3u; uint32_t offset = addr & 3u; uint32_t shift = (3u - offset) << 3; uint32_t mask = 0xFFFFFFFFu >> shift; uint32_t old_data = READ32(aligned_addr); uint32_t val = GPR_U32(ctx, 24); uint32_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE32(aligned_addr, new_data); }
        ctx->in_delay_slot = false;
    ctx->pc = 0x112170u;
    if (runtime->hasFunction(0x112170u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC83Cu; }
        if (ctx->pc != 0x2DC83Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc848:
    ...
    ctx->pc = 0x7F5351Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7F5351Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
...
label_2dc850:
    ...
    ctx->pc = 0x2DC850u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC84Cu;
            // 0x2dc850: 0xc9f8a997  lwc2        $24, -0x5669($t7) (Delay Slot)
        // Unhandled opcode: 0x32
        ctx->in_delay_slot = false;
    ctx->pc = 0x112578u;
    if (runtime->hasFunction(0x112578u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC854u; }
        if (ctx->pc != 0x2DC854u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc854:
    ...
    ctx->pc = 0x2DC854u;
    {
        ...
        ctx->pc = 0x2DC858u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC854u;
...
label_2dc860:
    ...
    ctx->pc = 0x2DC85Cu;
    ctx->pc = 0x2DC860u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC85Cu;
            // 0x2dc860: 0xc09ed08  jal         func_27B420 (Delay Slot)
        // JAL 0x27B420 - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dc868:
    ...
    ctx->pc = 0x2DC868u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC864u;
            // 0x2dc868: 0x1afd4d1f  .word       0x1AFD4D1F                   # blez        $s7, . + 4 + (0x4D1F << 2) # 001D0000 <InstrIdType: CPU_NORMAL> (Delay Slot)
        // Likely branch instruction at 0x2DC868 - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7F5354Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7F5354Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC86Cu; }
        if (ctx->pc != 0x2DC86Cu) { return; }
    }
    ctx->pc = 0x2DC86Cu;
label_2dc86c:
    ...
    ctx->pc = 0x2DC86Cu;
    ctx->pc = 0x2DC870u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC86Cu;
            // 0x2dc870: 0xdfd4d47  jal         func_7F5351C (Delay Slot)
        // JAL 0x7F5351C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7CC3D6Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7CC3D6Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc878:
    ...
    ctx->pc = 0x2DC878u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC874u;
            // 0x2dc878: 0xc04495e  jal         func_112578 (Delay Slot)
        // JAL 0x112578 - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x3F5345Cu;
    {
        auto targetFn = runtime->lookupFunction(0x3F5345Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC87Cu; }
        if (ctx->pc != 0x2DC87Cu) { return; }
    }
    ctx->pc = 0x2DC87Cu;
label_2dc87c:
...
label_2dc880:
    ...
    ctx->pc = 0x2DC880u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC87Cu;
            // 0x2dc880: 0x9f3ad9f  j           func_7CEB67C (Delay Slot)
        // J 0x7CEB67C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0xFF5345Cu;
    {
        auto targetFn = runtime->lookupFunction(0xFF5345Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC884u; }
        if (ctx->pc != 0x2DC884u) { return; }
    }
    ctx->pc = 0x2DC884u;
label_2dc884:
...
label_2dc888:
    ...
    ctx->pc = 0x2DC888u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC884u;
            // 0x2dc888: 0xcfd4d5b  jal         func_3F5356C (Delay Slot)
        // JAL 0x3F5356C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7F5351Cu;
    {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC88Cu; }
        if (ctx->pc != 0x2DC88Cu) { return; }
    }
    ctx->pc = 0x2DC88Cu;
label_2dc88c:
...
label_2dc890:
    ...
    ctx->pc = 0x2DC890u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC88Cu;
            // 0x2dc890: 0xffd4d53  jal         func_FF5354C (Delay Slot)
        // JAL 0xFF5354C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x1127B8u;
    if (runtime->hasFunction(0x1127B8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC894u; }
        if (ctx->pc != 0x2DC894u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc898:
    ...
    ctx->pc = 0x7C9367Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7C9367Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc8a0:
    ...
    ctx->pc = 0x2DC8A0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC89Cu;
            // 0x2dc8a0: 0xdfd4d47  jal         func_7F5351C (Delay Slot)
        // JAL 0x7F5351C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x112400u;
    if (runtime->hasFunction(0x112400u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC8A4u; }
        if (ctx->pc != 0x2DC8A4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc8a8:
    if (ctx->pc == 0x2DC8A8u) {
        ...
        // Unhandled COP2 format: 0xF
        ctx->pc = 0x2DC8ACu;
        goto label_2dc8ac;
    }
    ctx->pc = 0x2DC8A4u;
    ctx->pc = 0x2DC8A8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8A4u;
            // 0x2dc8a8: 0x49f9a997  .word       0x49F9A997                   # INVALID     $t7, $t9, -0x5669 # 00000000 <InstrIdType: R5900_COP2_NOHIGHBIT> (Delay Slot)
        // Unhandled COP2 format: 0xF
        ctx->in_delay_slot = false;
    ctx->pc = 0x7CB367Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7CB367Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc8ac:
    ...
    ctx->pc = 0x2DC8B4u;
    {
        ...
        ctx->pc = 0x2DC8B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8B4u;
    ...
    ctx->pc = 0x7F5345Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7F5345Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
...
label_2dc8c8:
    ...
    ctx->pc = 0x2DC8C4u;
    ctx->pc = 0x2DC8C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8C4u;
            // 0x2dc8c8: 0xa9f9a997  swl         $t9, -0x5669($t7) (Delay Slot)
        { uint32_t addr = ADD32(GPR_U32(ctx, 15), 4294945175); uint32_t aligned_addr = addr & ~3u; uint32_t offset = addr & 3u; uint32_t shift = (3u - offset) << 3; uint32_t mask = 0xFFFFFFFFu >> shift; uint32_t old_data = READ32(aligned_addr); uint32_t val = GPR_U32(ctx, 25); uint32_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE32(aligned_addr, new_data); }
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dc8cc:
    ...
    ctx->pc = 0x2DC8CCu;
    ctx->pc = 0x2DC8D0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8CCu;
    ...
    ctx->pc = 0x7E32754u;
    {
        auto targetFn = runtime->lookupFunction(0x7E32754u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc8d4:
    ...
    ctx->pc = 0x2DC8E0u;
    ctx->pc = 0x2DC8E4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8E0u;
...
label_2dc8ec:
    ...
    ctx->pc = 0x2DC8E8u;
    ctx->pc = 0x2DC8ECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8E8u;
            // 0x2dc8ec: 0x1607e79b  bne         $s0, $a3, . + 4 + (-0x1865 << 2) (Delay Slot)
        // Likely branch instruction at 0x2DC8EC - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dc8f0:
    ...
    ctx->pc = 0x2DC8F0u;
    ctx->pc = 0x2DC8F4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8F0u;
...
label_2dc8f8:
    ...
    ctx->pc = 0x2DC8F8u;
    {
        ...
        if (branch_taken_0x2dc8f8) {
            ctx->pc = 0x2DC8FCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC8F8u;
...
label_2dc904:
    if (ctx->pc == 0x2DC904u) {
        ...
        ctx->pc = 0x2DC908u;
        goto label_fallthrough_0x2dc900;
    }
    ctx->pc = 0x2DC900u;
    {
        const bool branch_taken_0x2dc900 = (GPR_S32(ctx, 15) <= 0);
        ctx->pc = 0x2DC904u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC900u;
            // 0x2dc904: 0x69ffa997  ldl         $ra, -0x5669($t7) (Delay Slot)
        { uint32_t addr = ADD32(GPR_U32(ctx, 15), 4294945175); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint64_t mem = READ64(aligned_addr); uint32_t shift = (7u - offset) << 3; uint64_t keepMask = (shift == 0) ? 0ull : ((1ull << shift) - 1ull); SET_GPR_U64(ctx, 31, (GPR_U64(ctx, 31) & keepMask) | (mem << shift)); }
        ctx->in_delay_slot = false;
...
label_2dc91c:
    ...
    ctx->pc = 0x2DC918u;
    ctx->pc = 0x2DC91Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC918u;
            // 0x2dc91c: 0xa9ffa997  swl         $ra, -0x5669($t7) (Delay Slot)
        { uint32_t addr = ADD32(GPR_U32(ctx, 15), 4294945175); uint32_t aligned_addr = addr & ~3u; uint32_t offset = addr & 3u; uint32_t shift = (3u - offset) << 3; uint32_t mask = 0xFFFFFFFFu >> shift; uint32_t old_data = READ32(aligned_addr); uint32_t val = GPR_U32(ctx, 31); uint32_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE32(aligned_addr, new_data); }
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dc920:
    ...
    ctx->pc = 0x2DC920u;
    ctx->pc = 0x2DC924u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC920u;
...
label_2dc92c:
    ...
    ctx->pc = 0x2DC938u;
    ctx->pc = 0x2DC93Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC938u;
...
label_2dc944:
    ...
    ctx->pc = 0x2DC940u;
    ctx->pc = 0x2DC944u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC940u;
            // 0x2dc944: 0x1607e79b  bne         $s0, $a3, . + 4 + (-0x1865 << 2) (Delay Slot)
        // Likely branch instruction at 0x2DC944 - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dc948:
    ...
    ctx->pc = 0x2DC948u;
    ctx->pc = 0x2DC94Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC948u;
...
label_2dc950:
    ...
    ctx->pc = 0x2DC950u;
    {
        ...
        if (branch_taken_0x2dc950) {
            ctx->pc = 0x2DC954u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC950u;
...
label_2dc95c:
    ...
    ctx->pc = 0x2DC95Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC958u;
            // 0x2dc95c: 0xdfd4d57  jal         func_7F5355C (Delay Slot)
        // JAL 0x7F5355C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x2DCCC8u;
    if (runtime->hasFunction(0x2DCCC8u)) {
        auto targetFn = runtime->lookupFunction(0x2DCCC8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC960u; }
        if (ctx->pc != 0x2DC960u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002DCCC8_0x2dccc8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC960u; }
        if (ctx->pc != 0x2DC960u) { return; }
    }
    ctx->pc = 0x2DC960u;
...
label_2dc964:
    ...
    ctx->pc = 0x7F33E7Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7F33E7Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc970:
    ...
    ctx->pc = 0x2DC96Cu;
    ctx->pc = 0x2DC970u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC96Cu;
            // 0x2dc970: 0xabfccd57  swl         $gp, -0x32A9($ra) (Delay Slot)
        { uint32_t addr = ADD32(GPR_U32(ctx, 31), 4294954327); uint32_t aligned_addr = addr & ~3u; uint32_t offset = addr & 3u; uint32_t shift = (3u - offset) << 3; uint32_t mask = 0xFFFFFFFFu >> shift; uint32_t old_data = READ32(aligned_addr); uint32_t val = GPR_U32(ctx, 28); uint32_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE32(aligned_addr, new_data); }
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dc974:
    ...
    ctx->pc = 0x2DC998u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC994u;
    ...
    ctx->pc = 0x3F5345Cu;
    {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC99Cu; }
        if (ctx->pc != 0x2DC99Cu) { return; }
    }
    ctx->pc = 0x2DC99Cu;
label_2dc99c:
    ...
    ctx->pc = 0x2DC9C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC9BCu;
    ...
    ctx->pc = 0x3F5345Cu;
    {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC9C4u; }
        if (ctx->pc != 0x2DC9C4u) { return; }
    }
    ctx->pc = 0x2DC9C4u;
label_2dc9c4:
    ...
    ctx->pc = 0x2DC9D4u;
    {
        ...
        ctx->pc = 0x2DC9D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC9D4u;
    ...
    ctx->pc = 0x7F5356Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7F5356Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC9E4u; }
        if (ctx->pc != 0x2DC9E4u) { return; }
    }
    ctx->pc = 0x2DC9E4u;
label_2dc9e4:
...
label_2dc9e8:
    ...
    ctx->pc = 0x2DC9E4u;
    {
        ...
        ctx->pc = 0x2DC9E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC9E4u;
            // 0x2dc9e8: 0x49f9c995  .word       0x49F9C995                   # INVALID     $t7, $t9, -0x366B # 00000000 <InstrIdType: R5900_COP2_NOHIGHBIT> (Delay Slot)
        // Unhandled COP2 format: 0xF
        ctx->in_delay_slot = false;
...
label_fallthrough_0x2dc9e4:
    ...
    ctx->pc = 0x2DC9ECu;
    ctx->pc = 0x2DC9F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC9ECu;
            // 0x2dc9f0: 0x9f8ed17  j           func_7E3B45C (Delay Slot)
        // J 0x7E3B45C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E23D6Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7E23D6Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc9f8:
    ...
    if (runtime->hasFunction(0x27B758u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC9FCu; }
        if (ctx->pc != 0x2DC9FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dca00:
    ...
    ctx->pc = 0x7E1B71Cu;
    {
        auto targetFn = runtime->lookupFunction(0x7E1B71Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dca08:
    ...
    ctx->pc = 0x2DCA08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCA04u;
            // 0x2dca08: 0xdfd4d47  jal         func_7F5351C (Delay Slot)
        // JAL 0x7F5351C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x112400u;
    if (runtime->hasFunction(0x112400u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCA0Cu; }
        if (ctx->pc != 0x2DCA0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00112400_0x112400(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCA0Cu; }
...
label_2dca10:
    ...
    ctx->pc = 0x2DCA10u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCA0Cu;
            // 0x2dca10: 0xdfd4d17  jal         func_7F5345C (Delay Slot)
        // JAL 0x7F5345C - Handled by branch logic
        ctx->in_delay_slot = false;
    ctx->pc = 0x3F5358Cu;
    {
        auto targetFn = runtime->lookupFunction(0x3F5358Cu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
...
label_2dca18:
    ...
    ctx->pc = 0x2DCA14u;
    ctx->pc = 0x2DCA18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCA14u;
            // 0x2dca18: 0x8afccd03  lwl         $gp, -0x32FD($s7) (Delay Slot)
        { uint32_t addr = ADD32(GPR_U32(ctx, 23), 4294954243); uint32_t aligned_addr = addr & ~3u; uint32_t offset = addr & 3u; uint32_t mem = READ32(aligned_addr); uint32_t shift = (3u - offset) << 3; uint32_t keepMask = (shift == 0) ? 0u : ((1u << shift) - 1u); uint32_t merged = (GPR_U32(ctx, 28) & keepMask) | (mem << shift); SET_GPR_S32(ctx, 28, (int32_t)merged); }
        ctx->in_delay_slot = false;
    ctx->pc = 0x7E3B45Cu;
...
label_2dca30:
    if (ctx->pc == 0x2DCA30u) {
        ...
        ctx->pc = 0x2DCA34u;
        goto label_fallthrough_0x2dca2c;
    }
    ctx->pc = 0x2DCA2Cu;
    {
        const bool branch_taken_0x2dca2c = (GPR_U64(ctx, 16) != GPR_U64(ctx, 7));
        ctx->pc = 0x2DCA30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCA2Cu;
            // 0x2dca30: 0x9f8f91b  j           func_7E3E46C (Delay Slot)
        // J 0x7E3E46C - Handled by branch logic
        ctx->in_delay_slot = false;
...
label_2dca7c:
    ...
    ctx->pc = 0x2DCA80u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCA7Cu;
    ...
    if (runtime->hasFunction(0x2D8FC0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCA84u; }
        if (ctx->pc != 0x2DCA84u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002D8FC0_0x2d8fc0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DCA84u; }
...
label_2dcaa8:
    ...
    ctx->pc = 0x2DCAA4u;
    {
        ...
        ctx->pc = 0x2DCAA8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DCAA4u;
            // 0x2dcaa8: 0x27bd0060  addiu       $sp, $sp, 0x60 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 96));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
