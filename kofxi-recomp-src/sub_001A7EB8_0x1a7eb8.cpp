...
void sub_001A7EB8_0x1a7eb8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A7ECCu;
    {
        ...
        ctx->pc = 0x1A7ED0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A7ECCu;
    ...
    ctx->pc = 0x1A7ED4u;
    {
        ...
        ctx->pc = 0x1A7ED8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A7ED4u;
...
label_1a7f0c:
    ...
    ctx->pc = 0x1A7F1Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A7F18u;
...
label_1a7f20:
    ...
    ctx->pc = 0x1A7F20u;
    {
        ...
        ctx->pc = 0x1A7F24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A7F20u;
...
label_1a7f28:
    ...
    ctx->pc = 0x1A7F2Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A7F28u;
