...
label_187cd4:
    ...
    ctx->pc = 0x187CD4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x187CD4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x187cdcu;
    // NOP
    if (ctx->pc == 0x187cdcu) { ctx->pc = 0x187ce0u; }
}
