...
void sub_00221A58_0x221a58(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x221A60u;
    {
        ...
        if (branch_taken_0x221a60) {
            ctx->pc = 0x221A64u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x221A60u;
    ...
    ctx->pc = 0x221A88u;
    ctx->pc = 0x221A8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x221A88u;
...
label_221a90:
    ...
    ctx->pc = 0x221A94u;
    {
        ...
        ctx->pc = 0x221A98u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x221A94u;
...
label_221aa0:
    ...
    ctx->pc = 0x221AD0u;
    ctx->pc = 0x221AD4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x221AD0u;
...
label_221ae4:
    ...
    ctx->pc = 0x221AE8u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x221AECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x221AE8u;
