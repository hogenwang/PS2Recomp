...
label_262920:
    ...
    ctx->pc = 0x10CC70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CC70u, 0x262930u, 0x262938u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x262938u;
label_262938:
...
label_26293c:
    ...
    ctx->pc = 0x262940u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x26293Cu;
    // 0x262940: 0xae021a10  sw          $v0, 0x1A10($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 6672), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x116EA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116EA0u, 0x26293Cu, 0x262944u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x262944u;
label_262944:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x10FFA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10FFA8u, 0x26294Cu, 0x262954u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x262954u;
label_262954:
    ...
    ctx->pc = 0x116EF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116EF0u, 0x26295Cu, 0x262964u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x262964u;
label_262964:
...
label_262968:
    ...
    ctx->pc = 0x262970u;
    {
        ...
        ctx->pc = 0x262974u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x262970u;
        // 0x262974: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x262970u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
