...
void sub_001FB008_0x1fb008(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FB010u;
    {
        ...
        ctx->pc = 0x1FB014u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FB010u;
...
label_1fb018:
    ...
    ctx->pc = 0x1FB01Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1FB020u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FB01Cu;
...
label_1fb028:
    ...
    ctx->pc = 0x1FB02Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1FB030u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FB02Cu;
...
label_1fb038:
    ...
    ctx->pc = 0x1FB03Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1FB040u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FB03Cu;
...
label_1fb068:
    ...
    ctx->pc = 0x1FB06Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1FB070u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FB06Cu;
