...
void sub_00211950_0x211950(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x211954u;
    {
        ...
        ctx->pc = 0x211958u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211954u;
...
label_211998:
    ...
    ctx->pc = 0x2119B8u;
    {
        ...
        ctx->pc = 0x2119BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2119B8u;
...
label_2119d4:
    ...
    ctx->pc = 0x2119F0u;
    {
        ...
        ctx->pc = 0x2119F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2119F0u;
...
label_211a00:
    ...
    ctx->pc = 0x211A0Cu;
    {
        ...
        ctx->pc = 0x211A10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211A0Cu;
...
label_211a1c:
    ...
    ctx->pc = 0x211A30u;
    {
        ...
        ctx->pc = 0x211A34u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211A30u;
...
label_211a50:
    ...
    ctx->pc = 0x211A50u;
    {
        ...
        ctx->pc = 0x211A54u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211A50u;
...
label_211a58:
    ...
    ctx->pc = 0x211A58u;
    {
        ...
        ctx->pc = 0x211A5Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x211A58u;
