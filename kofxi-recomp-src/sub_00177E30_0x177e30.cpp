...
void sub_00177E30_0x177e30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x177E58u;
    {
        ...
        ctx->pc = 0x177E5Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x177E58u;
    ...
    ctx->pc = 0x177E60u;
    {
        ...
        ctx->pc = 0x177E64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x177E60u;
...
label_177e68:
    ...
    ctx->pc = 0x177E84u;
    {
        ...
        if (branch_taken_0x177e84) {
            ctx->pc = 0x177E88u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x177E84u;
...
label_177ec8:
    ...
    ctx->pc = 0x177EE0u;
    {
        ...
        ctx->pc = 0x177EE4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x177EE0u;
