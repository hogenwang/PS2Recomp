...
label_103d84:
    ...
    ctx->pc = 0x103D84u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x103D84u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x103d8cu;
    // NOP
    if (ctx->pc == 0x103d8cu) { ctx->pc = 0x103d90u; }
}
