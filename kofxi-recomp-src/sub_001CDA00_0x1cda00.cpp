...
label_1cda2c:
    ...
    ctx->pc = 0x1CDA2Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CDA28u;
            // 0x1cda2c: 0xafa20000  sw          $v0, 0x0($sp) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 29), 0), GPR_U32(ctx, 2));
    ...
    if (runtime->hasFunction(0x1C25B8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CDA30u; }
        if (ctx->pc != 0x1CDA30u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cda40:
    ...
    ctx->pc = 0x1CDA3Cu;
    {
        ...
        ctx->pc = 0x1CDA40u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CDA3Cu;
            // 0x1cda40: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_1cda74:
    ...
    ctx->pc = 0x1CDA70u;
    {
        ...
        ctx->pc = 0x1CDA74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CDA70u;
            // 0x1cda74: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_1cda7c:
    ...
    ctx->pc = 0x1CDA78u;
    {
        ...
        ctx->pc = 0x1CDA7Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CDA78u;
            // 0x1cda7c: 0x8c440004  lw          $a0, 0x4($v0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4)));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1CDA80u; }
            if (ctx->pc != 0x1CDA80u) { return; }
        }
        }
    }
    ctx->pc = 0x1CDA80u;
...
label_1cdb18:
    ...
    ctx->pc = 0x1CDB18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CDB14u;
            // 0x1cdb18: 0x2484be10  addiu       $a0, $a0, -0x41F0 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294950416));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1CDC78u;
    if (runtime->hasFunction(0x1CDC78u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CDB1Cu; }
        if (ctx->pc != 0x1CDB1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001CDC78_0x1cdc78(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CDB1Cu; }
        if (ctx->pc != 0x1CDB1Cu) { return; }
    }
    ctx->pc = 0x1CDB1Cu;
