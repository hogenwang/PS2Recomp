...
void sub_001AFFE0_0x1affe0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B1AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AB0u, 0x1AFFF4u, 0x1AFFFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFFFCu;
label_1afffc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B0028u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B0028u, 0x1B0000u, 0x1B0008u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0008u;
label_1b0008:
    ...
    ctx->pc = 0x1B000Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B0008u;
    // 0x1b000c: 0x40802d  daddu       $s0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AC8u, 0x1B0008u, 0x1B0010u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0010u;
label_1b0010:
    ...
    ctx->pc = 0x1B0020u;
    {
        ...
        ctx->pc = 0x1B0024u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B0020u;
        // 0x1b0024: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B0020u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
