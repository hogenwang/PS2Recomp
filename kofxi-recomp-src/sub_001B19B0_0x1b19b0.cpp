...
void sub_001B19B0_0x1b19b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B19B4u;
    {
        ...
        ctx->pc = 0x1B19B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B19B4u;
    ...
    if (runtime->hasFunction(0x1AE828u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B19C8u; }
        if (ctx->pc != 0x1B19C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b19c8:
    ...
    ctx->pc = 0x1B19D0u;
    {
        ...
        ctx->pc = 0x1B19D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B19D0u;
...
label_1b19d8:
    ...
    ctx->pc = 0x1B19DCu;
    ctx->pc = 0x1B19E0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B19DCu;
            // 0x1b19e0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B7B00u;
    {
        auto targetFn = runtime->lookupFunction(0x1B7B00u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b19fc:
    ...
    ctx->pc = 0x1B1A00u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B19FCu;
            // 0x1b1a00: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B1A20u;
    if (runtime->hasFunction(0x1B1A20u)) {
        auto targetFn = runtime->lookupFunction(0x1B1A20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1A04u; }
        if (ctx->pc != 0x1B1A04u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B1A20_0x1b1a20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1A04u; }
        if (ctx->pc != 0x1B1A04u) { return; }
    }
    ctx->pc = 0x1B1A04u;
label_1b1a04:
    ...
    ctx->pc = 0x1B1A08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1A04u;
    ...
    if (runtime->hasFunction(0x1B1AC8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1A0Cu; }
        if (ctx->pc != 0x1B1A0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
