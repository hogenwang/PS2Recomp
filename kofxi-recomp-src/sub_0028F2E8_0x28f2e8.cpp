...
label_28f310:
    ...
    ctx->pc = 0x28F310u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28F30Cu;
            // 0x28f310: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x295920u;
    if (runtime->hasFunction(0x295920u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x28F314u; }
        if (ctx->pc != 0x28F314u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_28f32c:
    ...
    ctx->pc = 0x28F328u;
    {
        ...
        ctx->pc = 0x28F32Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28F328u;
            // 0x28f32c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
