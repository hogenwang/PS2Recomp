...
label_18f2ec:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F2F0u, 0x18F2F8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F2F8u;
label_18f2f8:
    ...
    ctx->pc = 0x18F300u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F2FCu;
    // 0x18f300: 0x2484bc34  addiu       $a0, $a0, -0x43CC (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949940));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F2FCu, 0x18F304u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F304u;
label_18f304:
    ...
    ctx->pc = 0x18F30Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F308u;
    // 0x18f30c: 0x2484bc38  addiu       $a0, $a0, -0x43C8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949944));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F308u, 0x18F310u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F310u;
label_18f310:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F314u, 0x18F31Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F31Cu;
label_18f31c:
...
label_18f324:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F328u, 0x18F330u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F330u;
label_18f330:
    ...
    ctx->pc = 0x18F338u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F334u;
    // 0x18f338: 0x2484bc24  addiu       $a0, $a0, -0x43DC (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949924));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F334u, 0x18F33Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F33Cu;
label_18f33c:
    ...
    ctx->pc = 0x18F344u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F340u;
    // 0x18f344: 0x2484bc28  addiu       $a0, $a0, -0x43D8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949928));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F340u, 0x18F348u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F348u;
label_18f348:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F34Cu, 0x18F354u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F354u;
label_18f354:
...
label_18f35c:
    ...
    ctx->pc = 0x18F364u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F360u;
    // 0x18f364: 0x2484bc10  addiu       $a0, $a0, -0x43F0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949904));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F360u, 0x18F368u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F368u;
label_18f368:
    ...
    ctx->pc = 0x18F370u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F36Cu;
    // 0x18f370: 0x2484bc14  addiu       $a0, $a0, -0x43EC (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949908));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F36Cu, 0x18F374u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F374u;
label_18f374:
    ...
    ctx->pc = 0x18F37Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F378u;
    // 0x18f37c: 0x2484bc18  addiu       $a0, $a0, -0x43E8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949912));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F378u, 0x18F380u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F380u;
label_18f380:
    ...
    ctx->pc = 0x18F388u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F384u;
    // 0x18f388: 0x2484bc1c  addiu       $a0, $a0, -0x43E4 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949916));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F384u, 0x18F38Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F38Cu;
label_18f38c:
...
label_18f394:
    ...
    ctx->pc = 0x18F39Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F398u;
    // 0x18f39c: 0x2484bc10  addiu       $a0, $a0, -0x43F0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949904));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F398u, 0x18F3A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F3A0u;
label_18f3a0:
    ...
    ctx->pc = 0x18F3A8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F3A4u;
    // 0x18f3a8: 0x2484bc14  addiu       $a0, $a0, -0x43EC (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949908));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F3A4u, 0x18F3ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F3ACu;
label_18f3ac:
    ...
    ctx->pc = 0x18F3B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F3B0u;
    // 0x18f3b4: 0x2484bc18  addiu       $a0, $a0, -0x43E8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949912));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F3B0u, 0x18F3B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F3B8u;
label_18f3b8:
    ...
    ctx->pc = 0x18F3C0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x18F3BCu;
    // 0x18f3c0: 0x2484bc1c  addiu       $a0, $a0, -0x43E4 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294949916));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x18F3BCu, 0x18F3C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F3C4u;
label_18f3c4:
    ...
    ctx->pc = 0x197F80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x197F80u, 0x18F3C4u, 0x18F3CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x18F3CCu;
label_18f3cc:
    ...
    ctx->pc = 0x18F3D0u;
    {
        ...
        ctx->pc = 0x18F3D4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x18F3D0u;
        // 0x18f3d4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x18F3D0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x18f3dcu;
    // NOP
    if (ctx->pc == 0x18f3dcu) { ctx->pc = 0x18f3e0u; }
}
