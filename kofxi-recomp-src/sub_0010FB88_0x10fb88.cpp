...
void sub_0010FB88_0x10fb88(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x10FB9Cu;
    // 0x10fba0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x116EA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116EA0u, 0x10FB9Cu, 0x10FBA4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FBA4u;
label_10fba4:
    ...
    ctx->pc = 0x116EF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116EF0u, 0x10FBC0u, 0x10FBC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FBC8u;
label_10fbc8:
...
label_10fbcc:
    ...
    ctx->pc = 0x10FBD4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10FBD0u;
    // 0x10fbd4: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10FAC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10FAC0u, 0x10FBD0u, 0x10FBD8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FBD8u;
label_10fbd8:
...
label_10fbe0:
    ...
    ctx->pc = 0x116EF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x116EF0u, 0x10FBE8u, 0x10FBF0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FBF0u;
label_10fbf0:
...
label_10fbf4:
    ...
    ctx->pc = 0x10FBF8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10FBF4u;
    // 0x10fbf8: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10D020u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10D020u, 0x10FBF4u, 0x10FBFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FBFCu;
label_10fbfc:
...
label_10fc00:
    ...
    ctx->pc = 0x10FC08u;
    {
        ...
        ctx->pc = 0x10FC0Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x10FC08u;
        // 0x10fc0c: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10FC08u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10FC28u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x10FC24u;
    // 0x10fc28: 0x24060001  addiu       $a2, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10FAC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10FAC0u, 0x10FC24u, 0x10FC2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FC2Cu;
label_10fc2c:
...
label_10fc34:
    ...
    ctx->pc = 0x10D030u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10D030u, 0x10FC34u, 0x10FC3Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x10FC3Cu;
label_10fc3c:
...
label_10fc40:
    ...
    ctx->pc = 0x10FC40u;
    {
        ...
        ctx->pc = 0x10FC44u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x10FC40u;
        // 0x10fc44: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10FC40u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
