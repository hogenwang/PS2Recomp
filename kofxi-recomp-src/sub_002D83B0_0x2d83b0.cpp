...
void sub_002D83B0_0x2d83b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2D83BCu;
    // 0x2d83c0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D83E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D83E0u, 0x2D83BCu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2D83C4u;
    // 0x2d83c4: 0x0  nop
    ctx->pc = 0x2d83c4u;
    // NOP
    if (ctx->pc == 0x2d83c4u) { ctx->pc = 0x2d83c8u; }
}
