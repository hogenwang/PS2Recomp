...
void sub_002CE178_0x2ce178(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2CE198u;
    // 0x2ce19c: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8238u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8238u, 0x2CE198u, 0x2CE1A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2CE1A0u;
label_2ce1a0:
    ...
    ctx->pc = 0x2CE1A4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2CE1A0u;
    // 0x2ce1a4: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D7230u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D7230u, 0x2CE1A0u, 0x2CE1A8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2CE1A8u;
label_2ce1a8:
...
label_2ce1b0:
    ...
    ctx->pc = 0x2CE1BCu;
    {
        ...
        ctx->pc = 0x2CE1C0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2CE1BCu;
        // 0x2ce1c0: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2CE1BCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2ce1c4u;
    // NOP
    if (ctx->pc == 0x2ce1c4u) { ctx->pc = 0x2ce1c8u; }
}
