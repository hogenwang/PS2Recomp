...
void sub_00118190_0x118190(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1181A8u;
    {
        ...
        ctx->pc = 0x1181ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1181A8u;
    ...
    ctx->pc = 0x1181B8u;
    {
        ...
        ctx->pc = 0x1181BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1181B8u;
...
label_1181c0:
    ...
    ctx->pc = 0x1181C4u;
    {
        ...
        ctx->pc = 0x1181C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1181C4u;
...
label_1181cc:
    ...
    ctx->pc = 0x1181E0u;
    {
        ...
        ctx->pc = 0x1181E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1181E0u;
...
label_1181fc:
    ...
    ctx->pc = 0x118204u;
    {
        ...
        if (branch_taken_0x118204) {
            ctx->pc = 0x118208u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x118204u;
