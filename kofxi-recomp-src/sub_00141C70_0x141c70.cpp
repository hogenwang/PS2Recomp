...
void sub_00141C70_0x141c70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x141C90u;
    {
        ...
        ctx->branch_pc = 0x141C90u;
        // 0x141c94: 0xa4800404  sh          $zero, 0x404($a0) (Delay Slot)
        WRITE16(ADD32(GPR_U32(ctx, 4), 1028), (uint16_t)GPR_U32(ctx, 0));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x141C90u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x141c9cu;
    // NOP
    if (ctx->pc == 0x141c9cu) { ctx->pc = 0x141ca0u; }
}
