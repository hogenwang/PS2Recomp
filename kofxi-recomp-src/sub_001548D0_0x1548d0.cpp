...
void sub_001548D0_0x1548d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x154988u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x154984u;
    ...
    if (runtime->hasFunction(0x1307E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x15498Cu; }
        if (ctx->pc != 0x15498Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_15498c:
    ...
    ctx->pc = 0x19FDD0u;
    if (runtime->hasFunction(0x19FDD0u)) {
        auto targetFn = runtime->lookupFunction(0x19FDD0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x154994u; }
        if (ctx->pc != 0x154994u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0019FDD0_0x19fdd0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x154994u; }
        if (ctx->pc != 0x154994u) { return; }
    }
    ctx->pc = 0x154994u;
label_154994:
    ...
    if (runtime->hasFunction(0x1A0430u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x15499Cu; }
        if (ctx->pc != 0x15499Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_15499c:
    ...
    ctx->pc = 0x1549A0u;
    {
        ...
        ctx->pc = 0x1549A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1549A0u;
