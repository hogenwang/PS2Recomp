...
void sub_001559F0_0x1559f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1559E0u;
    if (runtime->hasFunction(0x1559E0u)) {
        auto targetFn = runtime->lookupFunction(0x1559E0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x155A00u; }
        if (ctx->pc != 0x155A00u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001559E0_0x1559e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x155A00u; }
        if (ctx->pc != 0x155A00u) { return; }
    }
    ctx->pc = 0x155A00u;
