...
void sub_001DEDE8_0x1dede8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1DEE38u;
    if (runtime->hasFunction(0x1DEE38u)) {
        auto targetFn = runtime->lookupFunction(0x1DEE38u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1DEE0Cu; }
        if (ctx->pc != 0x1DEE0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001DEE38_0x1dee38(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1DEE0Cu; }
        if (ctx->pc != 0x1DEE0Cu) { return; }
    }
    ctx->pc = 0x1DEE0Cu;
label_1dee0c:
    ...
    ctx->pc = 0x1DEE0Cu;
    {
        ...
        ctx->pc = 0x1DEE10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DEE0Cu;
...
label_1dee18:
    ...
    ctx->pc = 0x1DEE1Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1DEE18u;
            // 0x1dee1c: 0x60202d  daddu       $a0, $v1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 3) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1DEE40u;
    if (runtime->hasFunction(0x1DEE40u)) {
        auto targetFn = runtime->lookupFunction(0x1DEE40u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001DEE40_0x1dee40(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1DEE20u; }
        if (ctx->pc != 0x1DEE20u) { return; }
    }
    ctx->pc = 0x1DEE20u;
...
label_1dee24:
    ...
    ctx->pc = 0x1DEEE8u;
    {
        auto targetFn = runtime->lookupFunction(0x1DEEE8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
