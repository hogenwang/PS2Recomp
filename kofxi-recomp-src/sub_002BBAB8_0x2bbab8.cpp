...
void sub_002BBAB8_0x2bbab8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2BBAD0u;
    {
        ...
        ctx->pc = 0x2BBAD4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BBAD0u;
    ...
    ctx->pc = 0x2BBAD8u;
    {
        ...
        if (branch_taken_0x2bbad8) {
            ctx->pc = 0x2BBADCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2BBAD8u;
    ...
    ctx->pc = 0x2BBAE4u;
    {
        ...
        ctx->pc = 0x2BBAE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BBAE4u;
...
label_2bbaec:
    ...
    ctx->pc = 0x2BBAF0u;
    {
        ...
        ctx->pc = 0x2BBAF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BBAF0u;
...
label_2bbaf8:
    ...
    ctx->pc = 0x2BBAF8u;
    {
        ...
        if (branch_taken_0x2bbaf8) {
            ctx->pc = 0x2BBAFCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2BBAF8u;
    ...
    ctx->pc = 0x2BBB08u;
    {
        ...
        ctx->pc = 0x2BBB0Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BBB08u;
