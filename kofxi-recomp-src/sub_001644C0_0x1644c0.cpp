...
label_164534:
    ...
    ctx->pc = 0x164540u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x164540u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x16454cu;
    // NOP
    if (ctx->pc == 0x16454cu) { ctx->pc = 0x164550u; }
}
