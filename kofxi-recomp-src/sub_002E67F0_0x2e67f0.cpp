...
void sub_002E67F0_0x2e67f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2E680Cu;
    {
        ...
        ctx->pc = 0x2E6810u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E680Cu;
    ...
    ctx->pc = 0x2E6814u;
    {
        ...
        ctx->pc = 0x2E6818u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6814u;
...
label_2e681c:
    ...
    ctx->pc = 0x2E681Cu;
    {
        ...
        ctx->pc = 0x2E6820u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E681Cu;
    ...
    ctx->pc = 0x2E683Cu;
    {
        ...
        ctx->pc = 0x2E6840u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E683Cu;
    ...
    ctx->pc = 0x2E6860u;
    {
        ...
        ctx->pc = 0x2E6864u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E6860u;
...
label_2e686c:
    ...
    ctx->pc = 0x2E686Cu;
    {
        ...
        ctx->pc = 0x2E6870u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E686Cu;
...
label_2e6878:
    ...
    ctx->pc = 0x2E688Cu;
    {
        ...
        ctx->pc = 0x2E6890u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E688Cu;
...
label_2e68b8:
    ...
    ctx->pc = 0x2E68B8u;
    {
        ...
        ctx->pc = 0x2E68BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E68B8u;
...
label_2e68c0:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E68D0u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x2E6628u;
    if (runtime->hasFunction(0x2E6628u)) {
        auto targetFn = runtime->lookupFunction(0x2E6628u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_002E6628_0x2e6628(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E68D8u; }
        if (ctx->pc != 0x2E68D8u) { return; }
    }
    ctx->pc = 0x2E68D8u;
...
label_2e68e8:
    ...
    ctx->pc = 0x2E68F4u;
    {
        ...
        ctx->pc = 0x2E68F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E68F4u;
