...
// Function: kofxiVblankSchedulerDispatch
// Address: 0x1b3e40 - 0x1b3f90
void kofxiVblankSchedulerDispatch_0x1b3e40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiVblankSchedulerDispatch_0x1b3e40");
#endif
...
label_1b3e60:
    ...
    ctx->pc = 0x1B3E5Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B3E5Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1b3ed8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B30E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B30E0u, 0x1B3ED4u, 0x1B3EDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3EDCu;
label_1b3edc:
...
label_1b3ef8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B30E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B30E0u, 0x1B3EF4u, 0x1B3EFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3EFCu;
label_1b3efc:
...
label_1b3f00:
    ...
    ctx->pc = 0x1B3638u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3638u, 0x1B3EFCu, 0x1B3F04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3F04u;
label_1b3f04:
...
label_1b3f2c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B30E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B30E0u, 0x1B3F28u, 0x1B3F30u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3F30u;
label_1b3f30:
...
label_1b3f48:
    ...
    ctx->pc = 0x1B27B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B27B8u, 0x1B3F44u, 0x1B3F4Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3F4Cu;
label_1b3f4c:
...
label_1b3f68:
    ...
    ctx->pc = 0x1B3F64u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B3F64u, 0x1B3F6Cu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B3F6Cu;
...
label_1b3f8c:
    ...
    ctx->pc = 0x1B3F88u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B3F88u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
