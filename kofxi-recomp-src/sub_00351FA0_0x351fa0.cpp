...
label_351fa0:
    ...
    ctx->pc = 0x351FC0u;
    {
        ...
        ctx->pc = 0x351FC4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x351FC0u;
...
label_351fd0:
    ...
    ctx->pc = 0x351F90u;
    if (runtime->hasFunction(0x351F90u)) {
        auto targetFn = runtime->lookupFunction(0x351F90u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x351FE0u; }
        if (ctx->pc != 0x351FE0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00351F90_0x351f90(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x351FE0u; }
        if (ctx->pc != 0x351FE0u) { return; }
    }
    ctx->pc = 0x351FE0u;
label_351fe0:
    ...
    ctx->pc = 0x351FE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x351FE4u;
    ...
    if (runtime->hasFunction(0x2099D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x351FECu; }
        if (ctx->pc != 0x351FECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_351fec:
    ...
    ctx->pc = 0x351FF0u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x351FF4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x351FF0u;
...
label_352010:
    ...
    ctx->pc = 0x352010u;
    {
        ...
        if (branch_taken_0x352010) {
            ctx->pc = 0x352014u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x352010u;
    ...
    ctx->pc = 0x352020u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x35201Cu;
    ...
    if (runtime->hasFunction(0x2099D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352024u; }
        if (ctx->pc != 0x352024u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002099D0_0x2099d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352024u; }
...
label_352028:
    ...
    ctx->pc = 0x352028u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x35202Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x352028u;
...
label_35203c:
    ...
    ctx->pc = 0x14AC80u;
    if (runtime->hasFunction(0x14AC80u)) {
        auto targetFn = runtime->lookupFunction(0x14AC80u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352060u; }
        if (ctx->pc != 0x352060u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0014AC80_0x14ac80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352060u; }
        if (ctx->pc != 0x352060u) { return; }
    }
    ctx->pc = 0x352060u;
label_352060:
    ...
    ctx->pc = 0x11CD60u;
    if (runtime->hasFunction(0x11CD60u)) {
        auto targetFn = runtime->lookupFunction(0x11CD60u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352068u; }
        if (ctx->pc != 0x352068u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0011CD60_0x11cd60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352068u; }
        if (ctx->pc != 0x352068u) { return; }
    }
    ctx->pc = 0x352068u;
label_352068:
    ...
    if (runtime->hasFunction(0x114A18u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352088u; }
        if (ctx->pc != 0x352088u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_352088:
    ...
    ctx->pc = 0x10FEC8u;
    if (runtime->hasFunction(0x10FEC8u)) {
        auto targetFn = runtime->lookupFunction(0x10FEC8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352098u; }
        if (ctx->pc != 0x352098u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010FEC8_0x10fec8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352098u; }
        if (ctx->pc != 0x352098u) { return; }
    }
    ctx->pc = 0x352098u;
label_352098:
    ...
    ctx->pc = 0x3520BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3520B8u;
            // 0x3520bc: 0x24c69688  addiu       $a2, $a2, -0x6978 (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 4294940296));
        ctx->in_delay_slot = false;
    ctx->pc = 0x117510u;
    if (runtime->hasFunction(0x117510u)) {
        auto targetFn = runtime->lookupFunction(0x117510u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3520C0u; }
        if (ctx->pc != 0x3520C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00117510_0x117510(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3520C0u; }
        if (ctx->pc != 0x3520C0u) { return; }
    }
    ctx->pc = 0x3520C0u;
...
label_3520c8:
    ...
    ctx->pc = 0x3520DCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3520D8u;
    ...
    if (runtime->hasFunction(0x117510u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3520E0u; }
        if (ctx->pc != 0x3520E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00117510_0x117510(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3520E0u; }
...
label_3520e4:
    ...
    ctx->pc = 0x3520E4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x3520E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3520E4u;
...
label_352100:
    ...
    ctx->pc = 0x352108u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x352104u;
    ...
    if (runtime->hasFunction(0x2099D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x35210Cu; }
        if (ctx->pc != 0x35210Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002099D0_0x2099d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x35210Cu; }
...
label_352130:
    ...
    ctx->pc = 0x352130u;
    {
        ...
        if (branch_taken_0x352130) {
            ctx->pc = 0x352134u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x352130u;
    ...
    ctx->pc = 0x352140u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x35213Cu;
    ...
    if (runtime->hasFunction(0x2099D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352144u; }
        if (ctx->pc != 0x352144u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002099D0_0x2099d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352144u; }
...
label_352148:
    ...
    ctx->pc = 0x352148u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x35214Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x352148u;
...
label_35215c:
    ...
    if (runtime->hasFunction(0x14AC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352180u; }
        if (ctx->pc != 0x352180u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0014AC80_0x14ac80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352180u; }
...
label_352180:
    ...
    if (runtime->hasFunction(0x11CD60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352188u; }
        if (ctx->pc != 0x352188u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0011CD60_0x11cd60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352188u; }
...
label_352188:
    ...
    ctx->pc = 0x3521A4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3521A0u;
    ...
    if (runtime->hasFunction(0x114A18u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3521A8u; }
        if (ctx->pc != 0x3521A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00114A18_0x114a18(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3521A8u; }
...
label_3521a8:
    ...
    if (runtime->hasFunction(0x10FEC8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3521B8u; }
        if (ctx->pc != 0x3521B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010FEC8_0x10fec8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3521B8u; }
...
label_3521b8:
    ...
    ctx->pc = 0x3521DCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3521D8u;
    ...
    if (runtime->hasFunction(0x117510u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3521E0u; }
        if (ctx->pc != 0x3521E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00117510_0x117510(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x3521E0u; }
...
label_3521e0:
    ...
    ctx->pc = 0x3521E0u;
    {
        ...
        ctx->pc = 0x3521E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3521E0u;
...
label_3521e8:
    ...
    ctx->pc = 0x3521FCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3521F8u;
    ...
    if (runtime->hasFunction(0x117510u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352200u; }
        if (ctx->pc != 0x352200u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00117510_0x117510(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x352200u; }
...
label_352204:
    ...
    ctx->pc = 0x352204u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x352208u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x352204u;
