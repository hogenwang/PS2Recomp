...
void sub_002AC600_0x2ac600(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2AC5C0u;
    if (runtime->hasFunction(0x2AC5C0u)) {
        auto targetFn = runtime->lookupFunction(0x2AC5C0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2AC610u; }
        if (ctx->pc != 0x2AC610u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002AC5C0_0x2ac5c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2AC610u; }
        if (ctx->pc != 0x2AC610u) { return; }
    }
    ctx->pc = 0x2AC610u;
label_2ac610:
    ...
    ctx->pc = 0x2AC61Cu;
    {
        ...
        ctx->pc = 0x2AC620u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2AC61Cu;
