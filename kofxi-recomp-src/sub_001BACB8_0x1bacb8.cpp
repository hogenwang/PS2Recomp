...
void sub_001BACB8_0x1bacb8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1BACD0u;
    ctx->pc = 0x1BACD4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BACD0u;
...
label_1bacd8:
    ...
    ctx->pc = 0x1BACECu;
    {
        ...
        ctx->pc = 0x1BACF0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BACECu;
...
label_1bacf8:
    ...
    ctx->pc = 0x1BAD08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAD04u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAD0Cu; }
        if (ctx->pc != 0x1BAD0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bad0c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAD0Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BAD30u;
    if (runtime->hasFunction(0x1BAD30u)) {
        auto targetFn = runtime->lookupFunction(0x1BAD30u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAD14u; }
        if (ctx->pc != 0x1BAD14u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BAD30_0x1bad30(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAD14u; }
        if (ctx->pc != 0x1BAD14u) { return; }
    }
    ctx->pc = 0x1BAD14u;
label_1bad14:
    ...
    ctx->pc = 0x1BAD18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAD14u;
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAD1Cu; }
        if (ctx->pc != 0x1BAD1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
