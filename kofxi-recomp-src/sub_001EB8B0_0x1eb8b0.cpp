...
void sub_001EB8B0_0x1eb8b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1EB8BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EB8B8u;
    ...
    if (runtime->hasFunction(0x1FB008u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EB8C0u; }
        if (ctx->pc != 0x1EB8C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1eb8c0:
    ...
    ctx->pc = 0x1EB8C8u;
    {
        ...
        ctx->pc = 0x1EB8CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1EB8C8u;
