...
void sub_0020E910_0x20e910(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20E93Cu;
    {
        ...
        ctx->pc = 0x20E940u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E93Cu;
...
label_20e944:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20E950u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x20E820u;
    if (runtime->hasFunction(0x20E820u)) {
        auto targetFn = runtime->lookupFunction(0x20E820u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E958u; }
        if (ctx->pc != 0x20E958u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0020E820_0x20e820(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20E958u; }
        if (ctx->pc != 0x20E958u) { return; }
    }
    ctx->pc = 0x20E958u;
label_20e958:
    ...
    ctx->pc = 0x20E964u;
    {
        ...
        ctx->pc = 0x20E968u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E964u;
...
label_20e970:
    ...
    ctx->pc = 0x20E984u;
    {
        ...
        ctx->pc = 0x20E988u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20E984u;
