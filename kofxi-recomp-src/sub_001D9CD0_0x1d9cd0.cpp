...
void sub_001D9CD0_0x1d9cd0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1D9CE0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9CDCu;
    ...
    if (runtime->hasFunction(0x1DC3B8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1D9CE4u; }
        if (ctx->pc != 0x1D9CE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1d9ce4:
    ...
    ctx->pc = 0x1D9D00u;
    ctx->pc = 0x1D9D04u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9D00u;
...
label_1d9d08:
    ...
    ctx->pc = 0x1D9D10u;
    {
        ...
        ctx->pc = 0x1D9D14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9D10u;
    ...
    ctx->pc = 0x1D9D1Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9D18u;
            // 0x1d9d1c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1DC6B8u;
    if (runtime->hasFunction(0x1DC6B8u)) {
        auto targetFn = runtime->lookupFunction(0x1DC6B8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1D9D20u; }
        if (ctx->pc != 0x1D9D20u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001DC6B8_0x1dc6b8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1D9D20u; }
        if (ctx->pc != 0x1D9D20u) { return; }
    }
    ctx->pc = 0x1D9D20u;
label_1d9d20:
    ...
    ctx->pc = 0x1D9D28u;
    {
        ...
        ctx->pc = 0x1D9D2Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9D28u;
