...
void sub_00103CC0_0x103cc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x103CD0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x103CCCu;
    ...
    if (runtime->hasFunction(0x116EA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x103CD4u; }
        if (ctx->pc != 0x103CD4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_103cd4:
    ...
    ctx->pc = 0x103CF8u;
    {
        ...
        ctx->pc = 0x103CFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x103CF8u;
    ...
    ctx->pc = 0x103D04u;
    ctx->pc = 0x103D08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x103D04u;
...
label_103d0c:
    ...
    ctx->pc = 0x103D10u;
    {
        ...
        ctx->pc = 0x103D14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x103D10u;
