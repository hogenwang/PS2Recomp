...
void sub_0011E800_0x11e800(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11E80Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11E808u;
    ...
    if (runtime->hasFunction(0x11E6D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x11E810u; }
        if (ctx->pc != 0x11E810u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_11e828:
    ...
    ctx->pc = 0x11E82Cu;
    {
        ...
        ctx->pc = 0x11E830u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11E82Cu;
