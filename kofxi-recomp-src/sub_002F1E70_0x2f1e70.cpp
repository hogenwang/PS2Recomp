...
void sub_002F1E70_0x2f1e70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F1E70u;
    {
        ...
        if (branch_taken_0x2f1e70) {
            ctx->pc = 0x2F1E74u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E70u;
    ...
    ctx->pc = 0x2F1E78u;
    {
        ...
        ctx->pc = 0x2F1E7Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E78u;
...
label_2f1e80:
    ...
    ctx->pc = 0x2F1E80u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2F1E84u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E80u;
...
label_2f1e88:
    ...
    ctx->pc = 0x2F1E88u;
    {
        ...
        ctx->pc = 0x2F1E8Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1E88u;
...
label_2f1e98:
    ...
    ctx->pc = 0x2F1EB4u;
    {
        ...
        ctx->pc = 0x2F1EB8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1EB4u;
...
label_2f1ebc:
    ...
    ctx->pc = 0x2F1EBCu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2F1EC0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1EBCu;
