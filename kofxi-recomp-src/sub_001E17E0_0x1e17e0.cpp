...
label_1e17f8:
    ...
    ctx->pc = 0x1E1808u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1804u;
    // 0x1e1808: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2960u, 0x1E1804u, 0x1E180Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E180Cu;
label_1e180c:
...
label_1e1830:
    ...
    ctx->pc = 0x1E16E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E16E8u, 0x1E1830u, 0x1E1838u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1838u;
label_1e1838:
    ...
    ctx->pc = 0x1E1840u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E183Cu;
    // 0x1e1840: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5A80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5A80u, 0x1E183Cu, 0x1E1844u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1844u;
label_1e1844:
    ...
    ctx->pc = 0x1e185cu;
    // NOP
    if (ctx->pc == 0x1e185cu) { ctx->pc = 0x1e1860u; }
}
