...
label_1a4d20:
    ...
    ctx->pc = 0x1A49D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A49D0u, 0x1A4D2Cu, 0x1A4D34u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A4D34u;
label_1a4d34:
...
label_1a4d84:
    ...
    ctx->pc = 0x1A4D90u;
    {
        ...
        ctx->pc = 0x1A4D94u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1A4D90u;
        // 0x1a4d94: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A4D90u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a4d9cu;
    // NOP
    if (ctx->pc == 0x1a4d9cu) { ctx->pc = 0x1a4da0u; }
}
