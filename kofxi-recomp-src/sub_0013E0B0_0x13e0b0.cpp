...
label_13e0e0:
    ...
    ctx->pc = 0x13E0E0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x13E0E0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x13e0ecu;
    // NOP
    if (ctx->pc == 0x13e0ecu) { ctx->pc = 0x13e0f0u; }
}
