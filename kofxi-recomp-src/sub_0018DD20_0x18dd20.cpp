...
void sub_0018DD20_0x18dd20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x18DC60u;
    if (runtime->hasFunction(0x18DC60u)) {
        auto targetFn = runtime->lookupFunction(0x18DC60u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0018DC60_0x18dc60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x18DD34u; }
        if (ctx->pc != 0x18DD34u) { return; }
    }
    ctx->pc = 0x18DD34u;
label_18dd34:
    ...
    ctx->pc = 0x18DD34u;
    {
        ...
        if (branch_taken_0x18dd34) {
            ctx->pc = 0x18DD38u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x18DD34u;
