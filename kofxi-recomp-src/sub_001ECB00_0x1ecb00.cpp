...
void sub_001ECB00_0x1ecb00(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1ECB28u;
    if (runtime->hasFunction(0x1ECB28u)) {
        auto targetFn = runtime->lookupFunction(0x1ECB28u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001ECB28_0x1ecb28(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1ECB10u; }
        if (ctx->pc != 0x1ECB10u) { return; }
    }
    ctx->pc = 0x1ECB10u;
label_1ecb10:
    ...
    ctx->pc = 0x1ECB1Cu;
    {
        ...
        ctx->pc = 0x1ECB20u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1ECB1Cu;
