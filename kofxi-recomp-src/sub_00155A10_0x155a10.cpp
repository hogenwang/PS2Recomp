...
label_155aac:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F5B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F5B0u, 0x155B10u, 0x155B18u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x155B18u;
label_155b18:
    ...
    ctx->pc = 0x155B40u;
    {
        ...
        ctx->pc = 0x155B44u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x155B40u;
        // 0x155b44: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x155B40u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x155b4cu;
    // NOP
    if (ctx->pc == 0x155b4cu) { ctx->pc = 0x155b50u; }
}
