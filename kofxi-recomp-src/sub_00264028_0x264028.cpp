...
void sub_00264028_0x264028(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x264038u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x264034u;
    ...
    if (runtime->hasFunction(0x22D7F8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x26403Cu; }
        if (ctx->pc != 0x26403Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_26406c:
    ...
    ctx->pc = 0x264070u;
    {
        ...
        ctx->pc = 0x264074u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x264070u;
