...
void sub_002B1538_0x2b1538(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2B1540u;
    {
        ...
        if (branch_taken_0x2b1540) {
            ctx->pc = 0x2B1544u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2B1540u;
    ...
    ctx->pc = 0x2B154Cu;
    {
        ...
        ctx->pc = 0x2B1550u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B154Cu;
...
label_2b1554:
    ...
    ctx->pc = 0x2B1554u;
    {
        ...
        if (branch_taken_0x2b1554) {
            ctx->pc = 0x2B1558u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2B1554u;
    ...
    ctx->pc = 0x2B1560u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2B1564u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B1560u;
...
label_2b1568:
    ...
    ctx->pc = 0x2B1574u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2B1578u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B1574u;
...
label_2b157c:
    ...
    ctx->pc = 0x2B157Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2B1580u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B157Cu;
