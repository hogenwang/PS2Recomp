...
void sub_002CF600_0x2cf600(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2CF628u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF624u;
    ...
    if (runtime->hasFunction(0x2CF7E8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CF62Cu; }
        if (ctx->pc != 0x2CF62Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2cf62c:
    ...
    ctx->pc = 0x2CF650u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF64Cu;
    ...
    if (runtime->hasFunction(0x2CF420u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CF654u; }
        if (ctx->pc != 0x2CF654u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2cf690:
    ...
    ctx->pc = 0x2CF694u;
    {
        ...
        ctx->pc = 0x2CF698u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF694u;
...
label_2cf6b4:
    ...
    ctx->pc = 0x2CF6B4u;
    {
        ...
        ctx->pc = 0x2CF6B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CF6B4u;
