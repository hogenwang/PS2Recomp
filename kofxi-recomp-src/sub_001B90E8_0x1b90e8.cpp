...
void sub_001B90E8_0x1b90e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B9100u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B90FCu;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9104u; }
        if (ctx->pc != 0x1B9104u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b9104:
    ...
    ctx->pc = 0x1B910Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9108u;
            // 0x1b910c: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B9128u;
    if (runtime->hasFunction(0x1B9128u)) {
        auto targetFn = runtime->lookupFunction(0x1B9128u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9110u; }
        if (ctx->pc != 0x1B9110u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B9128_0x1b9128(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9110u; }
        if (ctx->pc != 0x1B9110u) { return; }
    }
    ctx->pc = 0x1B9110u;
