...
void sub_00303610_0x303610(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x303620u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x30361Cu;
    ...
    if (runtime->hasFunction(0x32C8B0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x303624u; }
        if (ctx->pc != 0x303624u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_303624:
    ...
    ctx->pc = 0x303630u;
    {
        ...
        ctx->pc = 0x303634u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x303630u;
