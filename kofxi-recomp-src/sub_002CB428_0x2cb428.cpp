...
void sub_002CB428_0x2cb428(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2CB45Cu;
    {
        ...
        ctx->pc = 0x2CB460u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB45Cu;
...
label_2cb478:
    ...
    ctx->pc = 0x2CB494u;
    {
        ...
        if (branch_taken_0x2cb494) {
            ctx->pc = 0x2CB498u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB494u;
...
label_2cb49c:
    ...
    ctx->pc = 0x2CB49Cu;
    {
        ...
        ctx->pc = 0x2CB4A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB49Cu;
    ...
    ctx->pc = 0x2CB4ACu;
    {
        ...
        ctx->pc = 0x2CB4B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB4ACu;
...
label_2cb4b4:
    ...
    ctx->pc = 0x2CB4CCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB4C8u;
    ...
    if (runtime->hasFunction(0x2C99B8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CB4D0u; }
        if (ctx->pc != 0x2CB4D0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2cb4d0:
    ...
    ctx->pc = 0x2CB4D0u;
    {
        ...
        if (branch_taken_0x2cb4d0) {
            ctx->pc = 0x2CB4D4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB4D0u;
...
label_2cb4e4:
    ...
    ctx->pc = 0x2CB4ECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB4E8u;
    ...
    if (runtime->hasFunction(0x2C99B8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CB4F0u; }
        if (ctx->pc != 0x2CB4F0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002C99B8_0x2c99b8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2CB4F0u; }
...
label_2cb4f4:
    ...
    ctx->pc = 0x2CB500u;
    {
        ...
        ctx->pc = 0x2CB504u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2CB500u;
