...
label_1f5b58:
    ...
    ctx->pc = 0x1F5B7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F5B78u;
    // 0x1f5b7c: 0x26520001  addiu       $s2, $s2, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 18, (int32_t)ADD32(GPR_U32(ctx, 18), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F5A30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F5A30u, 0x1F5B78u, 0x1F5B80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F5B80u;
label_1f5b80:
...
label_1f5b90:
    ...
    ctx->pc = 0x1F5BB0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F5BACu;
    // 0x1f5bb0: 0x24060002  addiu       $a2, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F5A30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F5A30u, 0x1F5BACu, 0x1F5BB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F5BB4u;
label_1f5bb4:
    ...
    ctx->pc = 0x1F5BECu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F5BE8u;
    // 0x1f5bec: 0xaca60000  sw          $a2, 0x0($a1) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 5), 0), GPR_U32(ctx, 6));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F59C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F59C8u, 0x1F5BE8u, 0x1F5BF0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F5BF0u;
label_1f5bf0:
    ...
    ctx->pc = 0x1F5C04u;
    {
        ...
        ctx->pc = 0x1F5C08u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F5C04u;
        // 0x1f5c08: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F5C04u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f5c0cu;
    // NOP
    if (ctx->pc == 0x1f5c0cu) { ctx->pc = 0x1f5c10u; }
}
