...
void sub_002D3E20_0x2d3e20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2D3E44u;
    // 0x2d3e48: 0xe0982d  daddu       $s3, $a3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 19, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2CFC68u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2CFC68u, 0x2D3E44u, 0x2D3E4Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2D3E4Cu;
label_2d3e4c:
...
label_2d3e80:
    ...
    ctx->pc = 0x2d3eacu;
    // NOP
    if (ctx->pc == 0x2d3eacu) { ctx->pc = 0x2d3eb0u; }
}
