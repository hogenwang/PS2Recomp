...
label_20d974:
    ...
    ctx->pc = 0x20D998u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20D994u;
    ...
    if (runtime->hasFunction(0x20D650u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x20D99Cu; }
        if (ctx->pc != 0x20D99Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0020D650_0x20d650(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20D99Cu; }
        if (ctx->pc != 0x20D99Cu) { return; }
    }
    ctx->pc = 0x20D99Cu;
...
label_20d9b0:
    ...
    ctx->pc = 0x20D600u;
    if (runtime->hasFunction(0x20D600u)) {
        auto targetFn = runtime->lookupFunction(0x20D600u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20D9B8u; }
        if (ctx->pc != 0x20D9B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0020D600_0x20d600(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20D9B8u; }
        if (ctx->pc != 0x20D9B8u) { return; }
    }
    ctx->pc = 0x20D9B8u;
...
label_20d9c8:
    ...
    ctx->pc = 0x20D9CCu;
    {
        ...
        if (branch_taken_0x20d9cc) {
            ctx->pc = 0x20D9D0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x20D9CCu;
