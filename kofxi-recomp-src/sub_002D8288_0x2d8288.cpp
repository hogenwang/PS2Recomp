...
void sub_002D8288_0x2d8288(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D828Cu;
    {
        ...
        ctx->pc = 0x2D8290u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D828Cu;
    ...
    ctx->pc = 0x2D8298u;
    ctx->pc = 0x2D829Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D8298u;
            // 0x2d829c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2D8540u;
    {
        auto targetFn = runtime->lookupFunction(0x2D8540u);
...
label_2d82a0:
    ...
    ctx->pc = 0x2D82A4u;
    {
        ...
        ctx->pc = 0x2D82A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D82A4u;
