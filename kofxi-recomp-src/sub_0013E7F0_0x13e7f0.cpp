...
void sub_0013E7F0_0x13e7f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13E808u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13E804u;
    ...
    if (runtime->hasFunction(0x18A9F0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E80Cu; }
        if (ctx->pc != 0x13E80Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13e80c:
    ...
    ctx->pc = 0x13E814u;
    {
        ...
        if (branch_taken_0x13e814) {
            ctx->pc = 0x13E818u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13E814u;
    ...
    ctx->pc = 0x13E81Cu;
    {
        ...
        ctx->pc = 0x13E820u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13E81Cu;
