...
label_153630:
    ...
    ctx->pc = 0x153630u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x153630u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x15363cu;
    // NOP
    if (ctx->pc == 0x15363cu) { ctx->pc = 0x153640u; }
}
