...
void sub_001726F0_0x1726f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x172A10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x172A10u, 0x172724u, 0x17272Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17272Cu;
label_17272c:
...
label_172730:
    ...
    ctx->pc = 0x172730u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x172730u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x17273cu;
    // NOP
    if (ctx->pc == 0x17273cu) { ctx->pc = 0x172740u; }
}
