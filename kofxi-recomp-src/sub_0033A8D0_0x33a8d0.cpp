...
label_33a940:
    ...
    ctx->pc = 0x33A940u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x33A940u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x33a94cu;
    // NOP
    if (ctx->pc == 0x33a94cu) { ctx->pc = 0x33a950u; }
}
