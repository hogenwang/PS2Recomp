...
label_34bb44:
    ...
    ctx->pc = 0x34BB44u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x34BB44u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x34bb4cu;
    // NOP
    if (ctx->pc == 0x34bb4cu) { ctx->pc = 0x34bb50u; }
}
