...
void sub_0015E550_0x15e550(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x15E55Cu;
    // 0x15e560: 0x24840d70  addiu       $a0, $a0, 0xD70 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 3440));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F300u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F300u, 0x15E55Cu, 0x15E564u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E564u;
label_15e564:
    ...
    ctx->pc = 0x322A70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x322A70u, 0x15E564u, 0x15E56Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E56Cu;
label_15e56c:
    ...
    ctx->pc = 0x19ACB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19ACB0u, 0x15E56Cu, 0x15E574u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E574u;
label_15e574:
    ...
    ctx->pc = 0x19ADB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19ADB0u, 0x15E574u, 0x15E57Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E57Cu;
label_15e57c:
    ...
    ctx->pc = 0x15E584u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15E580u;
    // 0x15e584: 0x24844108  addiu       $a0, $a0, 0x4108 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 16648));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x15E580u, 0x15E588u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E588u;
label_15e588:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x15E58Cu, 0x15E594u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E594u;
label_15e594:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x15E598u, 0x15E5A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E5A0u;
label_15e5a0:
    ...
    ctx->pc = 0x15E5A8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15E5A4u;
    // 0x15e5a8: 0x24844118  addiu       $a0, $a0, 0x4118 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 16664));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x15E5A4u, 0x15E5ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E5ACu;
label_15e5ac:
    ...
    ctx->pc = 0x15E5B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15E5B0u;
    // 0x15e5b4: 0x2484411c  addiu       $a0, $a0, 0x411C (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 16668));
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x15E5B0u, 0x15E5B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E5B8u;
label_15e5b8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x18F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18F420u, 0x15E5BCu, 0x15E5C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15E5C4u;
label_15e5c4:
    ...
    ctx->pc = 0x15E5C8u;
    {
        ...
        ctx->pc = 0x15E5CCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x15E5C8u;
        // 0x15e5cc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x15E5C8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
