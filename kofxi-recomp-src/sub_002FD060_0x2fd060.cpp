...
void sub_002FD060_0x2fd060(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11E200u;
    if (runtime->hasFunction(0x11E200u)) {
        auto targetFn = runtime->lookupFunction(0x11E200u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FD070u; }
        if (ctx->pc != 0x2FD070u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0011E200_0x11e200(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FD070u; }
        if (ctx->pc != 0x2FD070u) { return; }
    }
    ctx->pc = 0x2FD070u;
label_2fd070:
    ...
    ctx->pc = 0x2FD080u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2FD07Cu;
    ...
    if (runtime->hasFunction(0x1284A8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FD084u; }
        if (ctx->pc != 0x2FD084u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2fd090:
    ...
    ctx->pc = 0x2FD0A4u;
    {
        ...
        ctx->pc = 0x2FD0A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FD0A4u;
