...
void sub_0033A290_0x33a290(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x33BA10u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2A0u; }
        if (ctx->pc != 0x33A2A0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2a0:
    ...
    if (runtime->hasFunction(0x155A10u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2A8u; }
        if (ctx->pc != 0x33A2A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2a8:
    ...
    if (runtime->hasFunction(0x1A4B00u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2B0u; }
        if (ctx->pc != 0x33A2B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2b0:
    ...
    if (runtime->hasFunction(0x32C7D0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2B8u; }
        if (ctx->pc != 0x33A2B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2b8:
    ...
    if (runtime->hasFunction(0x14D1F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2C0u; }
        if (ctx->pc != 0x33A2C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2c0:
    ...
    if (runtime->hasFunction(0x14CC60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2C8u; }
        if (ctx->pc != 0x33A2C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2c8:
    ...
    if (runtime->hasFunction(0x1A0430u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2D0u; }
        if (ctx->pc != 0x33A2D0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2d0:
    ...
    if (runtime->hasFunction(0x33A5F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2D8u; }
        if (ctx->pc != 0x33A2D8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2d8:
    ...
    ctx->pc = 0x33A2F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x33A2ECu;
    ...
    if (runtime->hasFunction(0x1A0B80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2F4u; }
        if (ctx->pc != 0x33A2F4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a2f4:
    ...
    ctx->pc = 0x33A2F8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x33A2F4u;
    ...
    if (runtime->hasFunction(0x1A0B80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2FCu; }
        if (ctx->pc != 0x33A2FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001A0B80_0x1a0b80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A2FCu; }
...
label_33a2fc:
    ...
    if (runtime->hasFunction(0x305940u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A304u; }
        if (ctx->pc != 0x33A304u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a304:
    ...
    ctx->pc = 0x33A32Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x33A328u;
    ...
    if (runtime->hasFunction(0x306FE0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A330u; }
        if (ctx->pc != 0x33A330u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a330:
    ...
    if (runtime->hasFunction(0x1A1C70u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A338u; }
        if (ctx->pc != 0x33A338u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a338:
    ...
    ctx->pc = 0x33A390u;
    if (runtime->hasFunction(0x33A390u)) {
        auto targetFn = runtime->lookupFunction(0x33A390u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A350u; }
        if (ctx->pc != 0x33A350u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0033A390_0x33a390(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A350u; }
        if (ctx->pc != 0x33A350u) { return; }
    }
    ctx->pc = 0x33A350u;
label_33a350:
    ...
    ctx->pc = 0x33A368u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x33A364u;
    ...
    if (runtime->hasFunction(0x156350u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A36Cu; }
        if (ctx->pc != 0x33A36Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a374:
    ...
    if (runtime->hasFunction(0x32FC40u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x33A37Cu; }
        if (ctx->pc != 0x33A37Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33a380:
    ...
    ctx->pc = 0x33A380u;
    {
        ...
        ctx->pc = 0x33A384u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33A380u;
