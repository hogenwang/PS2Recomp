...
label_275544:
    ...
    ctx->pc = 0x275554u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x275550u;
            // 0x275554: 0xddc31c97  ld          $v1, 0x1C97($t6) (Delay Slot)
        SET_GPR_U64(ctx, 3, READ64(ADD32(GPR_U32(ctx, 14), 7319)));
        ctx->in_delay_slot = false;
    ctx->pc = 0xA196A0u;
    {
        auto targetFn = runtime->lookupFunction(0xA196A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x275558u; }
        if (ctx->pc != 0x275558u) { return; }
    }
    ctx->pc = 0x275558u;
label_275558:
...
label_275578:
    ...
    ctx->pc = 0x275584u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x275580u;
    ...
    if (runtime->hasFunction(0x279588u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x275588u; }
        if (ctx->pc != 0x275588u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_275588:
    ...
    ctx->pc = 0x275588u;
    {
        ...
        if (branch_taken_0x275588) {
            ctx->pc = 0x27558Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x275588u;
