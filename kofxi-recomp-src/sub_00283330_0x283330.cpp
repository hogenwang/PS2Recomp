...
void sub_00283330_0x283330(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x2A36C8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x283388u; }
        if (ctx->pc != 0x283388u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_28339c:
    ...
    ctx->pc = 0x2833A0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x28339Cu;
    ...
    if (runtime->hasFunction(0x12A0F8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2833A4u; }
        if (ctx->pc != 0x2833A4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2833a4:
    ...
    ctx->pc = 0x2833B0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2833ACu;
    ...
    if (runtime->hasFunction(0x2852C0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2833B4u; }
        if (ctx->pc != 0x2833B4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2833b4:
    ...
    ctx->pc = 0x2833BCu;
    {
        ...
        ctx->pc = 0x2833C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2833BCu;
