...
void sub_002CF3F0_0x2cf3f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2CF3FCu;
    // 0x2cf400: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2CF708u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2CF708u, 0x2CF3FCu, 0x2CF404u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2CF404u;
label_2cf404:
