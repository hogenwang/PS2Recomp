...
label_1d0c00:
    ...
    ctx->pc = 0x1D0BFCu;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D0BFCu, 0x1D0C04u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1D0C04u;
...
label_1d0c78:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D0F38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D0F38u, 0x1D0C74u, 0x1D0C7Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0C7Cu;
label_1d0c7c:
...
label_1d0c8c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D1710u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D1710u, 0x1D0C88u, 0x1D0C90u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0C90u;
label_1d0c90:
...
label_1d0c9c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D1830u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D1830u, 0x1D0C98u, 0x1D0CA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0CA0u;
label_1d0ca0:
...
label_1d0cb0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D1C00u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D1C00u, 0x1D0CACu, 0x1D0CB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0CB4u;
label_1d0cb4:
...
label_1d0cc4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D4BE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D4BE0u, 0x1D0CC0u, 0x1D0CC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0CC8u;
label_1d0cc8:
...
label_1d0cd8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D5148u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D5148u, 0x1D0CD4u, 0x1D0CDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0CDCu;
label_1d0cdc:
...
label_1d0cfc:
    ...
    ctx->pc = 0x1D0CF8u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D0CF8u, 0x1D0D00u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1D0D00u;
...
label_1d0d18:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CCDF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CCDF8u, 0x1D0D14u, 0x1D0D1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0D1Cu;
label_1d0d1c:
...
label_1d0d30:
    ...
    ctx->pc = 0x1D0D2Cu;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D0D2Cu, 0x1D0D34u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1D0D34u;
...
label_1d0d48:
    ...
    ctx->pc = 0x1D0D44u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D0D44u, 0x1D0D4Cu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1D0D4Cu;
...
label_1d0d5c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1DB878u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DB878u, 0x1D0D58u, 0x1D0D60u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1D0D60u;
label_1d0d60:
...
label_1d0db0:
    ...
    ctx->pc = 0x1D0DACu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1D0DACu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1d0db4:
    ...
    ctx->pc = 0x1d0db4u;
    // NOP
    if (ctx->pc == 0x1d0db4u) { ctx->pc = 0x1d0db8u; }
}
