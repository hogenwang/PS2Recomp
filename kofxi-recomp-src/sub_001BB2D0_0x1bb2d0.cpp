...
void sub_001BB2D0_0x1bb2d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1BB2ECu;
    // 0x1bb2f0: 0xc0902d  daddu       $s2, $a2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BB2ECu, 0x1BB2F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BB2F4u;
label_1bb2f4:
    ...
    ctx->pc = 0x1BB300u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BB2FCu;
    // 0x1bb300: 0x240302d  daddu       $a2, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BB328u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BB328u, 0x1BB2FCu, 0x1BB304u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BB304u;
label_1bb304:
    ...
    ctx->pc = 0x1bb31cu;
    // NOP
    if (ctx->pc == 0x1bb31cu) { ctx->pc = 0x1bb320u; }
}
