...
void sub_001A8F78_0x1a8f78(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A8EC0u;
    if (runtime->hasFunction(0x1A8EC0u)) {
        auto targetFn = runtime->lookupFunction(0x1A8EC0u);
...
label_1a8fa0:
    ...
    ctx->pc = 0x1A8FA4u;
    {
        ...
        ctx->pc = 0x1A8FA8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A8FA4u;
    ...
    ctx->pc = 0x1A8FB8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A8FB4u;
    ...
    if (runtime->hasFunction(0x10F948u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A8FBCu; }
        if (ctx->pc != 0x1A8FBCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a8fc4:
    ...
    ctx->pc = 0x1A8FE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1A8FE4u;
    ...
    if (runtime->hasFunction(0x110D30u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A8FECu; }
        if (ctx->pc != 0x1A8FECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1a8fec:
    ...
    ctx->pc = 0x1A9000u;
    {
        ...
        ctx->pc = 0x1A9004u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A9000u;
