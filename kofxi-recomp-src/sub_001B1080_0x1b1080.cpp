...
void sub_001B1080_0x1b1080(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B109Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B1098u;
    // 0x1b109c: 0x24847970  addiu       $a0, $a0, 0x7970 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 31088));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1B1098u, 0x1B10A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B10A0u;
label_1b10a0:
...
label_1b10a8:
    ...
    ctx->pc = 0x1B10C4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B10C0u;
    // 0x1b10c4: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8050u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8050u, 0x1B10C0u, 0x1B10C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B10C8u;
label_1b10c8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6C60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6C60u, 0x1B10C8u, 0x1B10D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B10D0u;
label_1b10d0:
...
label_1b10dc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B7AC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B7AC0u, 0x1B10DCu, 0x1B10E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B10E4u;
label_1b10e4:
...
label_1b10e8:
    ...
    ctx->pc = 0x1B10F0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B10F0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1B1108u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B1104u;
    // 0x1b1108: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AB0u, 0x1B1104u, 0x1B110Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B110Cu;
label_1b110c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1130u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1130u, 0x1B110Cu, 0x1B1114u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B1114u;
label_1b1114:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AC8u, 0x1B1114u, 0x1B111Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B111Cu;
label_1b111c:
    ...
    ctx->pc = 0x1B1128u;
    {
        ...
        ctx->pc = 0x1B112Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B1128u;
        // 0x1b112c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B1128u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
