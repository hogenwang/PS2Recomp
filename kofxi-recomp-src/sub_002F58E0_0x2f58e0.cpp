...
label_2f5920:
    ...
    ctx->pc = 0x2F5920u;
    {
        ...
        ctx->pc = 0x2F5924u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F5920u;
        // 0x2f5924: 0x100102d  daddu       $v0, $t0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 8) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F5920u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2F5938u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F5934u;
    // 0x2f5938: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F58A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F58A0u, 0x2F5934u, 0x2F593Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F593Cu;
label_2f593c:
    ...
    ctx->pc = 0x2F5940u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F593Cu;
    // 0x2f5940: 0x24440001  addiu       $a0, $v0, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F9140u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F9140u, 0x2F593Cu, 0x2F5944u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F5944u;
label_2f5944:
...
label_2f59e0:
    ...
    ctx->pc = 0x2F59E8u;
    {
        ...
        ctx->pc = 0x2F59ECu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F59E8u;
        // 0x2f59ec: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F59E8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
