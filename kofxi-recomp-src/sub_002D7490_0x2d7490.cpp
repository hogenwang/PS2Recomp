...
void sub_002D7490_0x2d7490(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D74B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D74B0u;
    ...
    if (runtime->hasFunction(0x2D73C8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D74B8u; }
        if (ctx->pc != 0x2D74B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002D73C8_0x2d73c8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D74B8u; }
        if (ctx->pc != 0x2D74B8u) { return; }
    }
    ctx->pc = 0x2D74B8u;
label_2d74b8:
    ...
    ctx->pc = 0x2D74BCu;
    {
        ...
        ctx->pc = 0x2D74C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D74BCu;
    ...
    ctx->pc = 0x2D74C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D74C4u;
    ...
    if (runtime->hasFunction(0x2D8260u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D74CCu; }
        if (ctx->pc != 0x2D74CCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d74d0:
    ...
    ctx->pc = 0x2D74E0u;
    {
        ...
        ctx->pc = 0x2D74E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D74E0u;
