...
void sub_001F9BA0_0x1f9ba0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F9BE4u;
    {
        ...
        ctx->pc = 0x1F9BE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9BE4u;
    ...
    ctx->pc = 0x1F9BF0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9BECu;
            // 0x1f9bf0: 0xe0302d  daddu       $a2, $a3, $zero (Delay Slot)
        SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F9C30u;
    if (runtime->hasFunction(0x1F9C30u)) {
        auto targetFn = runtime->lookupFunction(0x1F9C30u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F9BF4u; }
        if (ctx->pc != 0x1F9BF4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F9C30_0x1f9c30(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F9BF4u; }
        if (ctx->pc != 0x1F9BF4u) { return; }
    }
    ctx->pc = 0x1F9BF4u;
...
label_1f9c1c:
    ...
    ctx->pc = 0x1F9C24u;
    {
        ...
        ctx->pc = 0x1F9C28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9C24u;
