...
void sub_0025F2E0_0x25f2e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x25F2F4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F2F0u;
    ...
    if (runtime->hasFunction(0x25CA38u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F2F8u; }
        if (ctx->pc != 0x25F2F8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f2f8:
    ...
    ctx->pc = 0x25F2FCu;
    {
        ...
        ctx->pc = 0x25F300u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25F2FCu;
    ...
    ctx->pc = 0x25F308u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F304u;
    ...
    if (runtime->hasFunction(0x230328u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F30Cu; }
        if (ctx->pc != 0x25F30Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f30c:
    ...
    ctx->pc = 0x25F31Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F318u;
    ...
    if (runtime->hasFunction(0x22E2E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F320u; }
        if (ctx->pc != 0x25F320u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f320:
    ...
    ctx->pc = 0x25F324u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F320u;
            // 0x25f324: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x22E130u;
    if (runtime->hasFunction(0x22E130u)) {
        auto targetFn = runtime->lookupFunction(0x22E130u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0022E130_0x22e130(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F328u; }
        if (ctx->pc != 0x25F328u) { return; }
    }
    ctx->pc = 0x25F328u;
label_25f328:
    ...
    ctx->pc = 0x25F330u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25F32Cu;
    ...
    if (runtime->hasFunction(0x25CB68u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25F334u; }
        if (ctx->pc != 0x25F334u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25f334:
    ...
    ctx->pc = 0x25F340u;
    {
        ...
        ctx->pc = 0x25F344u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25F340u;
