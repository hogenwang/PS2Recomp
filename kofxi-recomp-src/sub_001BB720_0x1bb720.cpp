...
void sub_001BB720_0x1bb720(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1BB730u;
    // 0x1bb734: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B61F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B61F0u, 0x1BB730u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1BB738u;
    ...
    ctx->pc = 0x1BB748u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BB744u;
    // 0x1bb748: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BB744u, 0x1BB74Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BB74Cu;
label_1bb74c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BB770u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BB770u, 0x1BB74Cu, 0x1BB754u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BB754u;
label_1bb754:
    ...
    ctx->pc = 0x1BB758u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BB754u;
    // 0x1bb758: 0x40802d  daddu       $s0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD270u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD270u, 0x1BB754u, 0x1BB75Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BB75Cu;
label_1bb75c:
    ...
    ctx->pc = 0x1BB768u;
    {
        ...
        ctx->pc = 0x1BB76Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1BB768u;
        // 0x1bb76c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BB768u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
