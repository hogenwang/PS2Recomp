...
void sub_00127120_0x127120(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x127128u;
    {
        ...
        ctx->pc = 0x12712Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127128u;
    ...
    ctx->pc = 0x127138u;
    {
        ...
        if (branch_taken_0x127138) {
            ctx->pc = 0x12713Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x127138u;
...
label_127144:
    ...
    ctx->pc = 0x127174u;
    {
        ...
        ctx->pc = 0x127178u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127174u;
...
label_1271a0:
    ...
    ctx->pc = 0x1271A4u;
    {
        ...
        ctx->pc = 0x1271A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1271A4u;
