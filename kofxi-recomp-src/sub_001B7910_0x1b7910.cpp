...
label_1b7928:
    ...
    ctx->pc = 0x1B7938u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7934u;
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B793Cu; }
        if (ctx->pc != 0x1B793Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b793c:
    ...
    ctx->pc = 0x1B7940u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B793Cu;
            // 0x1b7940: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B7960u;
    if (runtime->hasFunction(0x1B7960u)) {
        auto targetFn = runtime->lookupFunction(0x1B7960u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7944u; }
        if (ctx->pc != 0x1B7944u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B7960_0x1b7960(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7944u; }
        if (ctx->pc != 0x1B7944u) { return; }
    }
    ctx->pc = 0x1B7944u;
label_1b7944:
    ...
    ctx->pc = 0x1B7948u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7944u;
    ...
    if (runtime->hasFunction(0x1B8168u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B794Cu; }
        if (ctx->pc != 0x1B794Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b794c:
    ...
    ctx->pc = 0x1B7958u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1B795Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7958u;
