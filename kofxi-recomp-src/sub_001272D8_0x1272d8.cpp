...
void sub_001272D8_0x1272d8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1272DCu;
    {
        ...
        ctx->pc = 0x1272E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1272DCu;
    ...
    ctx->pc = 0x1272E8u;
    {
        ...
        ctx->pc = 0x1272ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1272E8u;
   ...
   SET_GPR_VEC(ctx, 3, _mm_set_epi16(h,h,h,h, l,l,l,l)); }
    ...
    ctx->pc = 0x127308u;
    {
        ...
        ctx->pc = 0x12730Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127308u;
...
label_127314:
    ...
    ctx->pc = 0x127328u;
    {
        ...
        ctx->pc = 0x12732Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127328u;
