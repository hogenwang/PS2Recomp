...
void sub_003235F0_0x3235f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x32361Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x323618u;
    ...
    if (runtime->hasFunction(0x321F90u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x323620u; }
        if (ctx->pc != 0x323620u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_3236ac:
    ...
    ctx->pc = 0x3236C0u;
    {
        ...
        ctx->pc = 0x3236C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3236C0u;
