...
label_1bbc88:
    ...
    ctx->pc = 0x1BBC94u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BBC90u;
    // 0x1bbc94: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6100u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6100u, 0x1BBC90u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1BBC98u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BBCA4u, 0x1BBCACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BBCACu;
label_1bbcac:
    ...
    ctx->pc = 0x1BBCB0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BBCACu;
    // 0x1bbcb0: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BBCC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BBCC8u, 0x1BBCACu, 0x1BBCB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BBCB4u;
label_1bbcb4:
    ...
    ctx->pc = 0x1bbcc4u;
    // NOP
    if (ctx->pc == 0x1bbcc4u) { ctx->pc = 0x1bbcc8u; }
}
