...
void sub_001E6A98_0x1e6a98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E6AA4u;
    // 0x1e6aa8: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE888u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE888u, 0x1E6AA4u, 0x1E6AACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E6AACu;
label_1e6aac:
    ...
    ctx->pc = 0x1E6ABCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E6AB8u;
    // 0x1e6abc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE8A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE8A0u, 0x1E6AB8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E6AC0u;
    ...
    ctx->pc = 0x1CDB78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDB78u, 0x1E6AF8u, 0x1E6B00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E6B00u;
label_1e6b00:
    ...
    ctx->pc = 0x1E6B08u;
    {
        ...
        ctx->pc = 0x1E6B0Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E6B08u;
        // 0x1e6b0c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E6B08u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1CDB90u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDB90u, 0x1E6B30u, 0x1E6B38u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E6B38u;
label_1e6b38:
    ...
    ctx->pc = 0x1E6B40u;
    {
        ...
        ctx->pc = 0x1E6B44u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E6B40u;
        // 0x1e6b44: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E6B40u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1E6B58u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E6B54u;
    // 0x1e6b58: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDC08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDC08u, 0x1E6B54u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E6B5Cu;
    // 0x1e6b5c: 0x0  nop
    ...
    ctx->pc = 0x1CDBA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDBA8u, 0x1E6B68u, 0x1E6B70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E6B70u;
label_1e6b70:
    ...
    ctx->pc = 0x1E6B78u;
    {
        ...
        ctx->pc = 0x1E6B7Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E6B78u;
        // 0x1e6b7c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E6B78u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1CDBC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDBC0u, 0x1E6BA0u, 0x1E6BA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E6BA8u;
label_1e6ba8:
    ...
    ctx->pc = 0x1E6BB0u;
    {
        ...
        ctx->pc = 0x1E6BB4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E6BB0u;
        // 0x1e6bb4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E6BB0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1E6BC8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E6BC4u;
    // 0x1e6bc8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDC38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDC38u, 0x1E6BC4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E6BCCu;
    // 0x1e6bcc: 0x0  nop
    ctx->pc = 0x1e6bccu;
    // NOP
    if (ctx->pc == 0x1e6bccu) { ctx->pc = 0x1e6bd0u; }
}
