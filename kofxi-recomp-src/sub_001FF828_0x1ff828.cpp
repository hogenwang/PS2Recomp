...
void sub_001FF828_0x1ff828(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FEFA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FEFA8u, 0x1FF844u, 0x1FF84Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FF84Cu;
label_1ff84c:
...
label_1ff864:
    ...
    ctx->pc = 0x1FF86Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1FF86Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1ff874u;
    // NOP
    if (ctx->pc == 0x1ff874u) { ctx->pc = 0x1ff878u; }
}
