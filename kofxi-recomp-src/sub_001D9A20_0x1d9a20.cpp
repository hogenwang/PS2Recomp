...
void sub_001D9A20_0x1d9a20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1D9A34u;
    {
        ...
        ctx->pc = 0x1D9A38u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9A34u;
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9A40u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1D9A70u;
    if (runtime->hasFunction(0x1D9A70u)) {
        auto targetFn = runtime->lookupFunction(0x1D9A70u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001D9A70_0x1d9a70(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1D9A48u; }
        if (ctx->pc != 0x1D9A48u) { return; }
    }
    ctx->pc = 0x1D9A48u;
...
label_1d9a50:
    ...
    if (runtime->hasFunction(0x1D9A70u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1D9A58u; }
        if (ctx->pc != 0x1D9A58u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001D9A70_0x1d9a70(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1D9A58u; }
...
label_1d9a5c:
    ...
    ctx->pc = 0x1D9A64u;
    {
        ...
        ctx->pc = 0x1D9A68u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1D9A64u;
