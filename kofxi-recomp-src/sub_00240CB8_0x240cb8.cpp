...
void sub_00240CB8_0x240cb8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x240CCCu;
    {
        ...
        ctx->pc = 0x240CD0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240CCCu;
...
label_240d08:
    ...
    ctx->pc = 0x240D0Cu;
    {
        ...
        ctx->pc = 0x240D10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240D0Cu;
...
label_240d20:
    ...
    ctx->pc = 0x240D24u;
    {
        ...
        ctx->pc = 0x240D28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240D24u;
...
label_240d38:
    ...
    ctx->pc = 0x240D3Cu;
    {
        ...
        ctx->pc = 0x240D40u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240D3Cu;
...
label_240d44:
    ...
    ctx->pc = 0x240D5Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x240D58u;
    ...
    if (runtime->hasFunction(0x10F890u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x240D60u; }
        if (ctx->pc != 0x240D60u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_240d64:
    ...
    ctx->pc = 0x240D6Cu;
    {
        ...
        ctx->pc = 0x240D70u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240D6Cu;
