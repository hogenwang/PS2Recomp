...
label_336ae0:
    ...
    ctx->pc = 0x336AE0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x336AE0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x336aecu;
    // NOP
    if (ctx->pc == 0x336aecu) { ctx->pc = 0x336af0u; }
}
