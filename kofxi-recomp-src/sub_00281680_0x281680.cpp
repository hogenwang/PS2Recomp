...
void sub_00281680_0x281680(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x28168Cu;
    {
        ...
        ctx->pc = 0x281690u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x28168Cu;
    ...
    ctx->pc = 0x28169Cu;
    {
        ...
        if (branch_taken_0x28169c) {
            ctx->pc = 0x2816A0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x28169Cu;
    ...
    ctx->pc = 0x2816ACu;
    {
        ...
        ctx->pc = 0x2816B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2816ACu;
...
label_2816b4:
    ...
    ctx->pc = 0x2816C0u;
    {
        ...
        ctx->pc = 0x2816C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2816C0u;
    ...
    ctx->pc = 0x2816CCu;
    {
        ...
        ctx->pc = 0x2816D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2816CCu;
    ...
    ctx->pc = 0x2816D8u;
    {
        ...
        ctx->pc = 0x2816DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2816D8u;
...
label_2816f0:
    ...
    ctx->pc = 0x281700u;
    {
        ...
        ctx->pc = 0x281704u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x281700u;
...
label_281730:
    ...
    ctx->pc = 0x281734u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x281738u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x281734u;
