...
void sub_00203DA0_0x203da0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x203CB0u;
    if (runtime->hasFunction(0x203CB0u)) {
        auto targetFn = runtime->lookupFunction(0x203CB0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x203DB0u; }
        if (ctx->pc != 0x203DB0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00203CB0_0x203cb0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x203DB0u; }
        if (ctx->pc != 0x203DB0u) { return; }
    }
    ctx->pc = 0x203DB0u;
label_203db0:
    ...
    ctx->pc = 0x203D20u;
    if (runtime->hasFunction(0x203D20u)) {
        auto targetFn = runtime->lookupFunction(0x203D20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x203DB8u; }
        if (ctx->pc != 0x203DB8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00203D20_0x203d20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x203DB8u; }
        if (ctx->pc != 0x203DB8u) { return; }
    }
    ctx->pc = 0x203DB8u;
