...
void sub_001FBBB8_0x1fbbb8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FBBCCu;
    {
        ...
        ctx->pc = 0x1FBBD0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBBCCu;
    ...
    if (runtime->hasFunction(0x120208u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FBBDCu; }
        if (ctx->pc != 0x1FBBDCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1fbbdc:
    ...
    if (runtime->hasFunction(0x120630u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FBBECu; }
        if (ctx->pc != 0x1FBBECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1fbc08:
    ...
    ctx->pc = 0x1FBC10u;
    {
        ...
        ctx->pc = 0x1FBC14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBC10u;
