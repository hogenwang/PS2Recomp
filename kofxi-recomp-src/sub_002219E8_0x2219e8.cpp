...
void sub_002219E8_0x2219e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2219FCu;
    {
        ...
        ctx->pc = 0x221A00u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2219FCu;
    ...
    ctx->pc = 0x221A1Cu;
    ctx->pc = 0x221A20u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x221A1Cu;
...
label_221a28:
    ...
    ctx->pc = 0x221A2Cu;
    {
        ...
        ctx->pc = 0x221A30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x221A2Cu;
...
label_221a4c:
    ...
    ctx->pc = 0x221A4Cu;
    {
        ...
        ctx->pc = 0x221A50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x221A4Cu;
