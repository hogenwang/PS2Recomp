...
void sub_002B9748_0x2b9748(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2B974Cu;
    {
        ...
        ctx->pc = 0x2B9750u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B974Cu;
    ...
    ctx->pc = 0x2B9754u;
    {
        ...
        ctx->pc = 0x2B9758u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B9754u;
    ...
    ctx->pc = 0x2B9764u;
    {
        ...
        ctx->pc = 0x2B9768u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B9764u;
...
label_2b9774:
    ...
    ctx->pc = 0x2B9780u;
    {
        ...
        ctx->pc = 0x2B9784u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2B9780u;
