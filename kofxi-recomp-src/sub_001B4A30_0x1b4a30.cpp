...
void sub_001B4A30_0x1b4a30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B4A40u;
    ctx->pc = 0x1B4A44u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4A40u;
            // 0x1b4a44: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C9358u;
    {
        auto targetFn = runtime->lookupFunction(0x1C9358u);
...
label_1b4a48:
    ...
    ctx->pc = 0x1B4A58u;
    ctx->pc = 0x1B4A5Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4A58u;
            // 0x1b4a5c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C93A0u;
    {
        auto targetFn = runtime->lookupFunction(0x1C93A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4a60:
    ...
    ctx->pc = 0x1C93A8u;
    {
        auto targetFn = runtime->lookupFunction(0x1C93A8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4a78:
    ...
    ctx->pc = 0x1B4A84u;
    ctx->pc = 0x1B4A88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4A84u;
            // 0x1b4a88: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C94E8u;
    {
        auto targetFn = runtime->lookupFunction(0x1C94E8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4a90:
    ...
    ctx->pc = 0x1B4A9Cu;
    ctx->pc = 0x1B4AA0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4A9Cu;
            // 0x1b4aa0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C9578u;
    {
        auto targetFn = runtime->lookupFunction(0x1C9578u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4aa8:
    ...
    ctx->pc = 0x1B4AB4u;
    ctx->pc = 0x1B4AB8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4AB4u;
            // 0x1b4ab8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C9600u;
    {
        auto targetFn = runtime->lookupFunction(0x1C9600u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b4ac0:
    ...
    ctx->pc = 0x1B4AD4u;
    ctx->pc = 0x1B4AD8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B4AD4u;
            // 0x1b4ad8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C9628u;
    {
        auto targetFn = runtime->lookupFunction(0x1C9628u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
