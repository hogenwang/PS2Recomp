...
void sub_001B7010_0x1b7010(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B7024u;
    // 0x1b7028: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8150u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8150u, 0x1B7024u, 0x1B702Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B702Cu;
label_1b702c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B7050u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B7050u, 0x1B7030u, 0x1B7038u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B7038u;
label_1b7038:
    ...
    ctx->pc = 0x1b704cu;
    // NOP
    if (ctx->pc == 0x1b704cu) { ctx->pc = 0x1b7050u; }
}
