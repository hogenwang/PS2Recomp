...
void sub_001CD890_0x1cd890(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CD8C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CD8BCu;
    ...
    if (runtime->hasFunction(0x1C2258u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CD8C4u; }
        if (ctx->pc != 0x1CD8C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cd8c4:
    ...
    ctx->pc = 0x1CD8D4u;
    {
        ...
        ctx->pc = 0x1CD8D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CD8D4u;
    ...
    if (runtime->hasFunction(0x115288u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CD8E4u; }
        if (ctx->pc != 0x1CD8E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cd8f8:
    ...
    ctx->pc = 0x1CD900u;
    {
        ...
        ctx->pc = 0x1CD904u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CD900u;
