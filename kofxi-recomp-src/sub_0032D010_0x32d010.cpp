...
void sub_0032D010_0x32d010(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x32D03Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x32D038u;
    // 0x32d03c: 0x24a545e8  addiu       $a1, $a1, 0x45E8 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 17896));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1297C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1297C8u, 0x32D038u, 0x32D040u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x32D040u;
label_32d040:
...
label_32d048:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1297C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1297C8u, 0x32D04Cu, 0x32D054u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x32D054u;
label_32d054:
...
label_32d05c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1297C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1297C8u, 0x32D06Cu, 0x32D074u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x32D074u;
label_32d074:
...
label_32d07c:
    ...
    ctx->pc = 0x32D084u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x32D080u;
    // 0x32d084: 0x24a54618  addiu       $a1, $a1, 0x4618 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 17944));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1297C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1297C8u, 0x32D080u, 0x32D088u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x32D088u;
label_32d088:
...
label_32d08c:
    ...
    ctx->pc = 0x32D08Cu;
    {
        ...
        ctx->pc = 0x32D090u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x32D08Cu;
        // 0x32d090: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x32D08Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x32d09cu;
    // NOP
    if (ctx->pc == 0x32d09cu) { ctx->pc = 0x32d0a0u; }
}
