...
label_2bf8a4:
    ...
    ctx->pc = 0x2BF8A0u;
    {
        ...
        ctx->pc = 0x2BF8A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8A0u;
            // 0x2bf8a4: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bf8b0:
    ...
    ctx->pc = 0x2BF8ACu;
    {
        ...
        ctx->pc = 0x2BF8B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8ACu;
            // 0x2bf8b0: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bf8b8:
    ...
    ctx->pc = 0x2BF8B4u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x2BF8BCu; }
            if (ctx->pc != 0x2BF8BCu) { return; }
        }
        }
    }
    ctx->pc = 0x2BF8BCu;
...
label_2bf8c4:
    ...
    ctx->pc = 0x2BF8C0u;
    {
        ...
        ctx->pc = 0x2BF8C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8C0u;
            // 0x2bf8c4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_2bf8dc:
    ...
    ctx->pc = 0x2BF8D8u;
    {
        ...
        ctx->pc = 0x2BF8DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8D8u;
            // 0x2bf8dc: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bf8e4:
    ...
    ctx->pc = 0x2BF8E4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8E0u;
            // 0x2bf8e4: 0x8c840004  lw          $a0, 0x4($a0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 4)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2BF130u;
    if (runtime->hasFunction(0x2BF130u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF8E8u; }
        if (ctx->pc != 0x2BF8E8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf8ec:
    ...
    ctx->pc = 0x2BF8ECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8E8u;
            // 0x2bf8ec: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2BF290u;
    if (runtime->hasFunction(0x2BF290u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF8F0u; }
        if (ctx->pc != 0x2BF8F0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf8f4:
    ...
    ctx->pc = 0x2BF8F0u;
    {
        ...
        ctx->pc = 0x2BF8F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8F0u;
            // 0x2bf8f4: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
...
label_2bf900:
    ...
    ctx->pc = 0x2BF8FCu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2BF900u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF8FCu;
            // 0x2bf900: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_2bf920:
    ...
    ctx->pc = 0x2BF91Cu;
    {
        ...
        ctx->pc = 0x2BF920u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF91Cu;
            // 0x2bf920: 0x60102d  daddu       $v0, $v1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 3) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bf92c:
    ...
    ctx->pc = 0x2BF928u;
    {
        ...
        ctx->pc = 0x2BF92Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF928u;
            // 0x2bf92c: 0x60102d  daddu       $v0, $v1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 3) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bf938:
    ...
    ctx->pc = 0x2BF938u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF934u;
            // 0x2bf938: 0x8ca50004  lw          $a1, 0x4($a1) (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 5), 4)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2BF0F8u;
    if (runtime->hasFunction(0x2BF0F8u)) {
        auto targetFn = runtime->lookupFunction(0x2BF0F8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF93Cu; }
        if (ctx->pc != 0x2BF93Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002BF0F8_0x2bf0f8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF93Cu; }
        if (ctx->pc != 0x2BF93Cu) { return; }
    }
    ctx->pc = 0x2BF93Cu;
...
label_2bf94c:
    ...
    ctx->pc = 0x2BF948u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2BF94Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF948u;
            // 0x2bf94c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_2bf968:
    ...
    ctx->pc = 0x2BF968u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF964u;
            // 0x2bf968: 0xffb00000  sd          $s0, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2A2FD8u;
    if (runtime->hasFunction(0x2A2FD8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF96Cu; }
        if (ctx->pc != 0x2BF96Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf974:
    ...
    ctx->pc = 0x2BF970u;
    {
        ...
        ctx->pc = 0x2BF974u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF970u;
            // 0x2bf974: 0x3c04002c  lui         $a0, 0x2C (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)((uint32_t)44 << 16));
        ctx->in_delay_slot = false;
...
label_2bf97c:
    ...
    ctx->pc = 0x2BF978u;
    {
        ...
        ctx->pc = 0x2BF97Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF978u;
            // 0x2bf97c: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bf9a4:
    ...
    ctx->pc = 0x2BF9A4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF9A0u;
            // 0x2bf9a4: 0x26500014  addiu       $s0, $s2, 0x14 (Delay Slot)
        SET_GPR_S32(ctx, 16, (int32_t)ADD32(GPR_U32(ctx, 18), 20));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2BC010u;
    if (runtime->hasFunction(0x2BC010u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF9A8u; }
        if (ctx->pc != 0x2BF9A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf9c0:
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF9C4u; }
        if (ctx->pc != 0x2BF9C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf9d8:
    ...
    if (runtime->hasFunction(0x297638u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF9DCu; }
        if (ctx->pc != 0x2BF9DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf9f4:
    ...
    ctx->pc = 0x2BF9F0u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2BF9F4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF9F0u;
            // 0x2bf9f4: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
...
label_2bfa14:
    ...
    ctx->pc = 0x2BFA10u;
    {
        ...
        ctx->pc = 0x2BFA14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFA10u;
            // 0x2bfa14: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_2bfa30:
    ...
    ctx->pc = 0x2BFA2Cu;
    ctx->pc = 0x2BFA30u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFA2Cu;
            // 0x2bfa30: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2A3028u;
...
label_2bfa94:
    ...
    ctx->pc = 0x2BFA94u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFA90u;
            // 0x2bfa94: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2BF808u;
    if (runtime->hasFunction(0x2BF808u)) {
        auto targetFn = runtime->lookupFunction(0x2BF808u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_002BF808_0x2bf808(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BFA98u; }
        if (ctx->pc != 0x2BFA98u) { return; }
    }
    ctx->pc = 0x2BFA98u;
...
label_2bfa9c:
    ...
    ctx->pc = 0x2BFA9Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFA98u;
            // 0x2bfa9c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2BF7B0u;
    if (runtime->hasFunction(0x2BF7B0u)) {
        auto targetFn = runtime->lookupFunction(0x2BF7B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BFAA0u; }
        if (ctx->pc != 0x2BFAA0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002BF7B0_0x2bf7b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BFAA0u; }
        if (ctx->pc != 0x2BFAA0u) { return; }
    }
    ctx->pc = 0x2BFAA0u;
...
label_2bfaac:
    ...
    ctx->pc = 0x2BFAA8u;
    {
        ...
        if (branch_taken_0x2bfaa8) {
            ctx->pc = 0x2BFAACu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFAA8u;
            // 0x2bfaac: 0x8e630004  lw          $v1, 0x4($s3) (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 19), 4)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x2BFA80u;
...
label_2bfae4:
    ...
    ctx->pc = 0x2BFAE4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFAE0u;
            // 0x2bfae4: 0x26c5f9f8  addiu       $a1, $s6, -0x608 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 22), 4294965752));
        ctx->in_delay_slot = false;
    ctx->pc = 0x298970u;
    if (runtime->hasFunction(0x298970u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BFAE8u; }
        if (ctx->pc != 0x2BFAE8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bfaec:
    ...
    ctx->pc = 0x2BFAECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFAE8u;
            // 0x2bfaec: 0x8e440004  lw          $a0, 0x4($s2) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 18), 4)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2986E8u;
...
label_2bfb18:
    ...
    ctx->pc = 0x2BFB14u;
    ctx->pc = 0x2BFB18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BFB14u;
            // 0x2bfb18: 0x27bd0080  addiu       $sp, $sp, 0x80 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 128));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2A3028u;
