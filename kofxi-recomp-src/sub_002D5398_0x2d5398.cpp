...
void sub_002D5398_0x2d5398(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x2d53e8u: goto label_2d53e8;
    ...
    ctx->pc = 0x2D53B0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D53ACu;
    ...
    if (runtime->hasFunction(0x2D5050u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D53B4u; }
        if (ctx->pc != 0x2D53B4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d53b4:
    ...
    ctx->pc = 0x2D53C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D53BCu;
    ...
    if (runtime->hasFunction(0x2D5050u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D53C4u; }
        if (ctx->pc != 0x2D53C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002D5050_0x2d5050(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D53C4u; }
...
label_2d53c4:
    ...
    ctx->pc = 0x2D53DCu;
    ctx->pc = 0x2D53E0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D53DCu;
...
label_2d5410:
    ...
    ctx->pc = 0x2D541Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D5418u;
            // 0x2d541c: 0x24060008  addiu       $a2, $zero, 0x8 (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 8));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2D82B0u;
    if (runtime->hasFunction(0x2D82B0u)) {
        auto targetFn = runtime->lookupFunction(0x2D82B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D5420u; }
        if (ctx->pc != 0x2D5420u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002D82B0_0x2d82b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D5420u; }
        if (ctx->pc != 0x2D5420u) { return; }
    }
    ctx->pc = 0x2D5420u;
label_2d5420:
    ...
    ctx->pc = 0x2D5420u;
    {
        ...
        ctx->pc = 0x2D5424u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D5420u;
...
label_2d5430:
    ...
    ctx->pc = 0x2D5434u;
    {
        ...
        ctx->pc = 0x2D5438u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D5434u;
...
label_2d5440:
    ...
    ctx->pc = 0x2D5450u;
    {
        ...
        ctx->pc = 0x2D5454u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D5450u;
