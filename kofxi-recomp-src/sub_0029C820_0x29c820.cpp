...
void sub_0029C820_0x29c820(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29C830u;
    {
        ...
        if (branch_taken_0x29c830) {
            ctx->pc = 0x29C834u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x29C830u;
    ...
    ctx->pc = 0x29C83Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29C838u;
    ...
    if (runtime->hasFunction(0x2A8E70u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x29C840u; }
        if (ctx->pc != 0x29C840u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29c848:
    ...
    ctx->pc = 0x29C848u;
    {
        ...
        ctx->pc = 0x29C84Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C848u;
    ...
    ctx->pc = 0x29C858u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29C854u;
    ...
    if (runtime->hasFunction(0x286808u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29C85Cu; }
        if (ctx->pc != 0x29C85Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29c85c:
    ...
    ctx->pc = 0x29C85Cu;
    {
        ...
        ctx->pc = 0x29C860u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C85Cu;
...
label_29c868:
    ...
    ctx->pc = 0x29C868u;
    {
        ...
        ctx->pc = 0x29C86Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C868u;
