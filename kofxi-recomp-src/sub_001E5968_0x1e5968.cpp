...
void sub_001E5968_0x1e5968(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E5978u;
    // 0x1e597c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C6548u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C6548u, 0x1E5978u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E5980u;
label_1e5980:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C6620u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C6620u, 0x1E5990u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E5998u;
    ...
    ctx->pc = 0x1E59ACu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E59A8u;
    // 0x1e59ac: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C6700u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C6700u, 0x1E59A8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E59B0u;
    ...
    ctx->pc = 0x1E59C4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E59C0u;
    // 0x1e59c4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C67E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C67E0u, 0x1E59C0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E59C8u;
}
