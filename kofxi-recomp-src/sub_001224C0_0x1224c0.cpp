...
void sub_001224C0_0x1224c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1224D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1224D0u;
    ...
    if (runtime->hasFunction(0x122438u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1224D8u; }
        if (ctx->pc != 0x1224D8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1224d8:
    ...
    ctx->pc = 0x1224ECu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1224E8u;
            // 0x1224ec: 0x8fa60008  lw          $a2, 0x8($sp) (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 29), 8)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x123018u;
    if (runtime->hasFunction(0x123018u)) {
        auto targetFn = runtime->lookupFunction(0x123018u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1224F0u; }
        if (ctx->pc != 0x1224F0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00123018_0x123018(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1224F0u; }
        if (ctx->pc != 0x1224F0u) { return; }
    }
    ctx->pc = 0x1224F0u;
label_1224f0:
    ...
    ctx->pc = 0x1224F4u;
    {
        ...
        ctx->pc = 0x1224F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1224F4u;
