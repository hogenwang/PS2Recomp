...
label_1f9f00:
    ...
    ctx->pc = 0x1F9F0Cu;
    {
        ...
        ctx->pc = 0x1F9F10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9F0Cu;
...
label_1f9f20:
    ...
    ctx->pc = 0x1F9F28u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9F24u;
            // 0x1f9f28: 0x2610ffff  addiu       $s0, $s0, -0x1 (Delay Slot)
        SET_GPR_S32(ctx, 16, (int32_t)ADD32(GPR_U32(ctx, 16), 4294967295));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F9F48u;
    if (runtime->hasFunction(0x1F9F48u)) {
        auto targetFn = runtime->lookupFunction(0x1F9F48u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F9F2Cu; }
        if (ctx->pc != 0x1F9F2Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F9F48_0x1f9f48(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F9F2Cu; }
        if (ctx->pc != 0x1F9F2Cu) { return; }
    }
    ctx->pc = 0x1F9F2Cu;
...
label_1f9f34:
    ...
    ctx->pc = 0x1F9F40u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1F9F44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F9F40u;
