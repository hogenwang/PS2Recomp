...
void sub_001CDBC0_0x1cdbc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1CDBD0u;
    // 0x1cdbd4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDA58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDA58u, 0x1CDBD0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1CDBD8u;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDA58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDA58u, 0x1CDBE8u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1CDBF0u;
}
