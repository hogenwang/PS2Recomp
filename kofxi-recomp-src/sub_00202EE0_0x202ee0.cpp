...
void sub_00202EE0_0x202ee0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x202EE8u;
    {
        ...
        ctx->pc = 0x202EECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x202EE8u;
...
label_202f00:
    ...
    ctx->pc = 0x202F14u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x202F10u;
    ...
    if (runtime->hasFunction(0x123150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x202F18u; }
        if (ctx->pc != 0x202F18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_202f18:
    ...
    ctx->pc = 0x202F1Cu;
    {
        ...
        ctx->pc = 0x202F20u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x202F1Cu;
