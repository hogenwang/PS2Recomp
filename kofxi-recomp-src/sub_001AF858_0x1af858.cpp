...
label_1af874:
    ...
    ctx->pc = 0x1AF890u;
    {
        ...
        ctx->pc = 0x1AF894u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF890u;
...
label_1af8a8:
    ...
    ctx->pc = 0x1AF8C0u;
    if (runtime->hasFunction(0x1AF8C0u)) {
        auto targetFn = runtime->lookupFunction(0x1AF8C0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AF8B0u; }
        if (ctx->pc != 0x1AF8B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001AF8C0_0x1af8c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AF8B0u; }
        if (ctx->pc != 0x1AF8B0u) { return; }
    }
    ctx->pc = 0x1AF8B0u;
label_1af8b0:
    ...
    ctx->pc = 0x1AF8B4u;
    ctx->pc = 0x1AF8B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF8B4u;
