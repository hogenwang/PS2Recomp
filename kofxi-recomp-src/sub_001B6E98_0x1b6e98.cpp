...
label_1b6eac:
    ...
    ctx->pc = 0x1B6EB0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6EACu;
            // 0x1b6eb0: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B6EC8u;
    if (runtime->hasFunction(0x1B6EC8u)) {
        auto targetFn = runtime->lookupFunction(0x1B6EC8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6EB4u; }
        if (ctx->pc != 0x1B6EB4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B6EC8_0x1b6ec8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6EB4u; }
        if (ctx->pc != 0x1B6EB4u) { return; }
    }
    ctx->pc = 0x1B6EB4u;
label_1b6eb4:
    ...
    ctx->pc = 0x1B6EBCu;
    ctx->pc = 0x1B6EC0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6EBCu;
