...
void sub_0033CFC0_0x33cfc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x33D038u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x33D034u;
    ...
    if (runtime->hasFunction(0x1271D0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x33D03Cu; }
        if (ctx->pc != 0x33D03Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_33d03c:
    ...
    ctx->pc = 0x33D044u;
    {
        ...
        if (branch_taken_0x33d044) {
            ctx->pc = 0x33D048u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x33D044u;
...
label_33d05c:
    ...
    ctx->pc = 0x33D05Cu;
    {
        ...
        ctx->pc = 0x33D060u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33D05Cu;
