...
void sub_002E9410_0x2e9410(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2E941Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E9418u;
            // 0x2e941c: 0x302d  daddu       $a2, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2E9430u;
    if (runtime->hasFunction(0x2E9430u)) {
        auto targetFn = runtime->lookupFunction(0x2E9430u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E9420u; }
        if (ctx->pc != 0x2E9420u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002E9430_0x2e9430(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E9420u; }
        if (ctx->pc != 0x2E9420u) { return; }
    }
    ctx->pc = 0x2E9420u;
label_2e9420:
    ...
    ctx->pc = 0x2E9424u;
    {
        ...
        ctx->pc = 0x2E9428u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E9424u;
