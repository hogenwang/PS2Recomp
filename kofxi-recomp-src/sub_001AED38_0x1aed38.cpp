...
label_1aed40:
    ...
    ctx->pc = 0x1AED5Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AED5Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1aed64u;
    // NOP
    if (ctx->pc == 0x1aed64u) { ctx->pc = 0x1aed68u; }
}
