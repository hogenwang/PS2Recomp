...
void sub_002017F8_0x2017f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x201820u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20181Cu;
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x201824u; }
        if (ctx->pc != 0x201824u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_201824:
    ...
    ctx->pc = 0x201890u;
    {
        ...
        ctx->pc = 0x201894u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201890u;
