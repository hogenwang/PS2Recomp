...
void sub_001F9A98_0x1f9a98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1ED920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ED920u, 0x1F9AC4u, 0x1F9ACCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F9ACCu;
label_1f9acc:
...
label_1f9af8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F9B20u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F9B20u, 0x1F9AFCu, 0x1F9B04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F9B04u;
label_1f9b04:
...
label_1f9b08:
    ...
    ctx->pc = 0x1F9B18u;
    {
        ...
        ctx->pc = 0x1F9B1Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F9B18u;
        // 0x1f9b1c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F9B18u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
