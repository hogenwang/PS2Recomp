...
void sub_0017E790_0x17e790(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x17E7A4u;
    // 0x17e7a8: 0xa0802d  daddu       $s0, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15F0A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15F0A0u, 0x17E7A4u, 0x17E7ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17E7ACu;
label_17e7ac:
    ...
    ctx->pc = 0x17E7B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x17E7B0u;
    // 0x17e7b4: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15EF80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15EF80u, 0x17E7B0u, 0x17E7B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17E7B8u;
label_17e7b8:
    ...
    ctx->pc = 0x17E7C4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x17E7C0u;
    // 0x17e7c4: 0x26250268  addiu       $a1, $s1, 0x268 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 17), 616));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1614A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1614A0u, 0x17E7C0u, 0x17E7C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17E7C8u;
label_17e7c8:
    ...
    ctx->pc = 0x17E7CCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x17E7C8u;
    // 0x17e7cc: 0x262405f8  addiu       $a0, $s1, 0x5F8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 17), 1528));
    ctx->in_delay_slot = false;
    ctx->pc = 0x161A40u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x161A40u, 0x17E7C8u, 0x17E7D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17E7D0u;
label_17e7d0:
    ...
    ctx->pc = 0x17E7D4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x17E7D0u;
    // 0x17e7d4: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15EE10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15EE10u, 0x17E7D0u, 0x17E7D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17E7D8u;
label_17e7d8:
    ...
    ctx->pc = 0x17E7DCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x17E7D8u;
    // 0x17e7dc: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15EEF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15EEF0u, 0x17E7D8u, 0x17E7E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17E7E0u;
label_17e7e0:
    ...
    ctx->pc = 0x17E7ECu;
    {
        ...
        ctx->pc = 0x17E7F0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x17E7ECu;
        // 0x17e7f0: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x17E7ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
