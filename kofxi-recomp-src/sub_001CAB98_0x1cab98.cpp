...
void sub_001CAB98_0x1cab98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CAB9Cu;
    {
        ...
        ctx->pc = 0x1CABA0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1CAB9Cu;
...
label_1cabb8:
    ...
    ctx->pc = 0x1CABBCu;
    {
        ...
        if (branch_taken_0x1cabbc) {
            ctx->pc = 0x1CABC0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1CABBCu;
...
label_1cabd4:
    ...
    if (runtime->hasFunction(0x1CA850u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CABDCu; }
        if (ctx->pc != 0x1CABDCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cabf0:
    ...
    ctx->pc = 0x1CAC10u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CAC0Cu;
    ...
    if (runtime->hasFunction(0x1CA7E8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CAC14u; }
        if (ctx->pc != 0x1CAC14u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cac14:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CAC1Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1CAC40u;
    if (runtime->hasFunction(0x1CAC40u)) {
        auto targetFn = runtime->lookupFunction(0x1CAC40u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CAC24u; }
        if (ctx->pc != 0x1CAC24u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001CAC40_0x1cac40(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CAC24u; }
        if (ctx->pc != 0x1CAC24u) { return; }
    }
    ctx->pc = 0x1CAC24u;
label_1cac24:
    ...
    ctx->pc = 0x1CAC34u;
    ctx->pc = 0x1CAC38u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1CAC34u;
