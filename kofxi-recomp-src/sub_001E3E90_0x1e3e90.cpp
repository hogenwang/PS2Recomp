...
void sub_001E3E90_0x1e3e90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E3EA8u;
    {
        ...
        ctx->pc = 0x1E3EACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3EA8u;
    ...
    ctx->pc = 0x1E3EB0u;
    {
        ...
        ctx->pc = 0x1E3EB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3EB0u;
    ...
    ctx->pc = 0x1E3EC0u;
    {
        ...
        ctx->pc = 0x1E3EC4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3EC0u;
...
label_1e3ee0:
    ...
    ctx->pc = 0x1E3EE4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3EE0u;
    ...
    if (runtime->hasFunction(0x1E6BE8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E3EE8u; }
        if (ctx->pc != 0x1E3EE8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e3eec:
    ...
    ctx->pc = 0x1E3EF4u;
    {
        ...
        ctx->pc = 0x1E3EF8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3EF4u;
