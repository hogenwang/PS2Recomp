...
// Function: kofxiPollAsyncResourceStatusCore
// Address: 0x1af9c8 - 0x1afe28
void kofxiPollAsyncResourceStatusCore_0x1af9c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiPollAsyncResourceStatusCore_0x1af9c8");
#endif
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1AFA18u, 0x1AFA20u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFA20u;
label_1afa20:
...
label_1afa50:
    ...
    ctx->pc = 0x1AFA58u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFA54u;
    // 0x1afa58: 0x8ca401c8  lw          $a0, 0x1C8($a1) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 5), 456)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1360u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1360u, 0x1AFA54u, 0x1AFA5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFA5Cu;
label_1afa5c:
...
label_1afaa0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x127088u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x127088u, 0x1AFAC4u, 0x1AFACCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFACCu;
label_1afacc:
...
label_1afae0:
    ...
    ctx->pc = 0x1AFB34u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFB30u;
    // 0x1afb34: 0x248475b0  addiu       $a0, $a0, 0x75B0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 30128));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1AFB30u, 0x1AFB38u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFB38u;
label_1afb38:
...
label_1afc20:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AF858u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AF858u, 0x1AFC20u, 0x1AFC28u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFC28u;
label_1afc28:
...
label_1afcb8:
    ...
    ctx->pc = 0x1AFCE8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFCE4u;
    // 0x1afce8: 0x642025  or          $a0, $v1, $a0 (Delay Slot)
    SET_GPR_U64(ctx, 4, GPR_U64(ctx, 3) | GPR_U64(ctx, 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1A88u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1A88u, 0x1AFCE4u, 0x1AFCECu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFCECu;
label_1afcec:
...
label_1afd50:
    ...
    ctx->pc = 0x1AFD60u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFD5Cu;
    // 0x1afd60: 0x8e240000  lw          $a0, 0x0($s1) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 17), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B0AB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B0AB8u, 0x1AFD5Cu, 0x1AFD64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFD64u;
label_1afd64:
    ...
    ctx->pc = 0x1AFD74u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFD70u;
    // 0x1afd74: 0xaec201d0  sw          $v0, 0x1D0($s6) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 22), 464), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AF858u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AF858u, 0x1AFD70u, 0x1AFD78u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFD78u;
label_1afd78:
...
label_1afd8c:
    ...
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1AFD8Cu, 0x1AFD94u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFD94u;
label_1afd94:
...
label_1afd9c:
    ...
    ctx->pc = 0x1AF858u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AF858u, 0x1AFD9Cu, 0x1AFDA4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFDA4u;
label_1afda4:
...
label_1afdbc:
    ...
    ctx->pc = 0x1AFDE4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AFDE4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1AFE00u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFDFCu;
    // 0x1afe00: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AB0u, 0x1AFDFCu, 0x1AFE04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFE04u;
label_1afe04:
    ...
    ctx->pc = 0x1AFE08u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFE04u;
    // 0x1afe08: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AFE28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AFE28u, 0x1AFE04u, 0x1AFE0Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFE0Cu;
label_1afe0c:
    ...
    ctx->pc = 0x1AFE10u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AFE0Cu;
    // 0x1afe10: 0x40802d  daddu       $s0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B1AC8u, 0x1AFE0Cu, 0x1AFE14u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AFE14u;
label_1afe14:
    ...
    ctx->pc = 0x1AFE20u;
    {
        ...
        ctx->pc = 0x1AFE24u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1AFE20u;
        // 0x1afe24: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AFE20u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
