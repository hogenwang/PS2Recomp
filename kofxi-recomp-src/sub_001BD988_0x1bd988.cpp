...
void sub_001BD988_0x1bd988(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1BD9C8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BD9C4u;
    // 0x1bd9c8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8010u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8010u, 0x1BD9C4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1BD9CCu;
    // 0x1bd9cc: 0x0  nop
...
label_1bd9d8:
    ...
    ctx->pc = 0x1BD9E0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BD9DCu;
    // 0x1bd9e0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8010u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8010u, 0x1BD9DCu, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1BD9E4u;
    // 0x1bd9e4: 0x0  nop
...
label_1bd9e8:
    ...
    ctx->pc = 0x1BD9ECu;
    {
        ...
        ctx->pc = 0x1BD9F0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1BD9ECu;
        // 0x1bd9f0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BD9ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1bd9f4u;
    // NOP
    if (ctx->pc == 0x1bd9f4u) { ctx->pc = 0x1bd9f8u; }
}
