...
void sub_0010C590_0x10c590(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10C5A0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x10C59Cu;
    ...
    if (runtime->hasFunction(0x116EA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x10C5A4u; }
        if (ctx->pc != 0x10C5A4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_10c5a4:
    ...
    ctx->pc = 0x10C5E4u;
    {
        ...
        ctx->pc = 0x10C5E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10C5E4u;
...
label_10c5f8:
    ...
    ctx->pc = 0x10C5FCu;
    {
        ...
        ctx->pc = 0x10C600u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10C5FCu;
