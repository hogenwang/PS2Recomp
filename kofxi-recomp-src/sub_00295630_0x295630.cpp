...
void sub_00295630_0x295630(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29564Cu;
    {
        ...
        ctx->pc = 0x295650u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29564Cu;
...
label_295668:
    ...
    ctx->pc = 0x29566Cu;
    {
        ...
        ctx->pc = 0x295670u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29566Cu;
...
label_295680:
    ...
    ctx->pc = 0x295680u;
    {
        ...
        ctx->pc = 0x295684u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295680u;
...
label_2956a0:
    ...
    ctx->pc = 0x2956A4u;
    {
        ...
        ctx->pc = 0x2956A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2956A4u;
...
label_2956dc:
    ...
    ctx->pc = 0x2956DCu;
    {
        ...
        ctx->pc = 0x2956E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2956DCu;
    ...
    ctx->pc = 0x2956ECu;
    {
        ...
        ctx->pc = 0x2956F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2956ECu;
...
label_2956fc:
    ...
    ctx->pc = 0x295750u;
    {
        ...
        ctx->pc = 0x295754u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x295750u;
    ...
    ctx->pc = 0x2957A8u;
    {
        ...
        ctx->pc = 0x2957ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2957A8u;
