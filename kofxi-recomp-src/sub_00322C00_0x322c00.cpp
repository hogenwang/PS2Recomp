...
void sub_00322C00_0x322c00(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x322C0Cu;
    {
        ...
        ctx->pc = 0x322C10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322C0Cu;
    ...
    ctx->pc = 0x322C3Cu;
    {
        ...
        ctx->pc = 0x322C40u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322C3Cu;
...
label_322c94:
    ...
    ctx->pc = 0x322CACu;
    {
        ...
        ctx->pc = 0x322CB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322CACu;
...
label_322cd0:
    ...
    ctx->pc = 0x322CE0u;
    {
        ...
        ctx->pc = 0x322CE4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322CE0u;
...
label_322d28:
    ...
    ctx->pc = 0x322E00u;
    {
        ...
        ctx->pc = 0x322E04u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322E00u;
...
label_322e34:
    ...
    ctx->pc = 0x322E50u;
    {
        ...
        ctx->pc = 0x322E54u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x322E50u;
