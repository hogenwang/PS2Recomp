...
label_29450c:
    ...
    ctx->pc = 0x294508u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x294508u, 0x294510u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x294510u;
...
label_294518:
    ...
    ctx->pc = 0x294514u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x294514u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_29451c:
    ...
    ctx->pc = 0x29451cu;
    // NOP
    if (ctx->pc == 0x29451cu) { ctx->pc = 0x294520u; }
}
