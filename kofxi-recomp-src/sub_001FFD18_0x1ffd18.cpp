...
void sub_001FFD18_0x1ffd18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FFD3Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1FFD38u;
    ...
    if (runtime->hasFunction(0x1FFBD0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FFD40u; }
        if (ctx->pc != 0x1FFD40u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ffd40:
    ...
    ctx->pc = 0x1FFD44u;
    {
        ...
        ctx->pc = 0x1FFD48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FFD44u;
    ...
    if (runtime->hasFunction(0x2004C8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FFD54u; }
        if (ctx->pc != 0x1FFD54u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ffd54:
    ...
    ctx->pc = 0x1FFD58u;
    {
        ...
        ctx->pc = 0x1FFD5Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FFD58u;
...
label_1ffd6c:
    ...
    ctx->pc = 0x1FFD7Cu;
    {
        ...
        ctx->pc = 0x1FFD80u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FFD7Cu;
