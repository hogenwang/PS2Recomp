...
void sub_00200570_0x200570(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2005C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2005C8u, 0x20057Cu, 0x200584u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x200584u;
label_200584:
    ...
    ctx->pc = 0x200618u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x200618u, 0x200590u, 0x200598u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x200598u;
label_200598:
...
label_2005b8:
    ...
    ctx->pc = 0x2005C0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2005C0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
