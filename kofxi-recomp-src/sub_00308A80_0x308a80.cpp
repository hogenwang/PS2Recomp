...
label_308aa0:
    ...
    ctx->branch_pc = 0x308AA4u;
    // 0x308aa8: 0x248447a0  addiu       $a0, $a0, 0x47A0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 18336));
    ctx->in_delay_slot = false;
    ctx->pc = 0x3087C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x3087C0u, 0x308AA4u, 0x308AACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x308AACu;
label_308aac:
...
label_308ac0:
    ...
    ctx->pc = 0x308AC8u;
    {
        ...
        ctx->pc = 0x308ACCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x308AC8u;
        // 0x308acc: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x308AC8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
