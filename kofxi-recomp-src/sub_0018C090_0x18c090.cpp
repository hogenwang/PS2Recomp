...
void sub_0018C090_0x18c090(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x18C0A4u;
    {
        ...
        if (branch_taken_0x18c0a4) {
            ctx->pc = 0x18C0A8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x18C0A4u;
...
label_18c0c8:
    ...
    if (runtime->hasFunction(0x18E020u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x18C0D0u; }
        if (ctx->pc != 0x18C0D0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_18c0d0:
    ...
    ctx->pc = 0x18C0D4u;
    {
        ...
        ctx->pc = 0x18C0D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C0D4u;
...
label_18c0dc:
    ...
    if (runtime->hasFunction(0x18E020u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x18C0E4u; }
        if (ctx->pc != 0x18C0E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0018E020_0x18e020(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x18C0E4u; }
...
label_18c0e4:
    ...
    ctx->pc = 0x18C0E8u;
    {
        ...
        ctx->pc = 0x18C0ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C0E8u;
...
label_18c10c:
    ...
    ctx->pc = 0x18C110u;
    {
        ...
        ctx->pc = 0x18C114u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18C110u;
