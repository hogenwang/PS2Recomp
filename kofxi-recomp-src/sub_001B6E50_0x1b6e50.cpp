...
void sub_001B6E50_0x1b6e50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1B6E64u;
    // 0x1b6e68: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8108u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8108u, 0x1B6E64u, 0x1B6E6Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6E6Cu;
label_1b6e6c:
    ...
    ctx->pc = 0x1B6E70u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B6E6Cu;
    // 0x1b6e70: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6D58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6D58u, 0x1B6E6Cu, 0x1B6E74u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6E74u;
label_1b6e74:
    ...
    ctx->pc = 0x1B6E78u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B6E74u;
    // 0x1b6e78: 0xae11005c  sw          $s1, 0x5C($s0) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 16), 92), GPR_U32(ctx, 17));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8120u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8120u, 0x1B6E74u, 0x1B6E7Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6E7Cu;
label_1b6e7c:
    ...
    ctx->pc = 0x1B6E8Cu;
    {
        ...
        ctx->pc = 0x1B6E90u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B6E8Cu;
        // 0x1b6e90: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B6E8Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1b6e94u;
    // NOP
    if (ctx->pc == 0x1b6e94u) { ctx->pc = 0x1b6e98u; }
}
