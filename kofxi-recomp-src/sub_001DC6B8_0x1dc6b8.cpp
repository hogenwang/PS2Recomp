...
void sub_001DC6B8_0x1dc6b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1DC6C8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC6C4u;
    ...
    if (runtime->hasFunction(0x1D0000u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1DC6CCu; }
        if (ctx->pc != 0x1DC6CCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1dc6cc:
    ...
    ctx->pc = 0x1DC6CCu;
    {
        ...
        if (branch_taken_0x1dc6cc) {
            ctx->pc = 0x1DC6D0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC6CCu;
    ...
    ctx->pc = 0x1DC6D8u;
    {
        ...
        ctx->pc = 0x1DC6DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC6D8u;
    ...
    ctx->pc = 0x1D0350u;
    {
        auto targetFn = runtime->lookupFunction(0x1D0350u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1dc6f4:
    ...
    ctx->pc = 0x1DC6F8u;
    {
        ...
        ctx->pc = 0x1DC6FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DC6F8u;
