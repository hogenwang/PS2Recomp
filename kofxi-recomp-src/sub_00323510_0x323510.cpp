...
void sub_00323510_0x323510(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x323524u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x323520u;
    ...
    if (runtime->hasFunction(0x321F90u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x323528u; }
        if (ctx->pc != 0x323528u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_323528:
    ...
    ctx->pc = 0x323534u;
    {
        ...
        ctx->pc = 0x323538u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x323534u;
