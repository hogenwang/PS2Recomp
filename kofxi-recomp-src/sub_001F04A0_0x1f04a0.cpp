...
void sub_001F04A0_0x1f04a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1DA2C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DA2C8u, 0x1F04E0u, 0x1F04E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F04E8u;
label_1f04e8:
...
label_1f0504:
    ...
    ctx->pc = 0x1F0508u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F0508u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
