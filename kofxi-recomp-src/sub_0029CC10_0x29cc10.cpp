...
void sub_0029CC10_0x29cc10(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29CC1Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29CC18u;
    ...
    if (runtime->hasFunction(0x29CC80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x29CC20u; }
        if (ctx->pc != 0x29CC20u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29cc20:
    ...
    ctx->pc = 0x29CC24u;
    {
        ...
        ctx->pc = 0x29CC28u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29CC24u;
...
label_29cc30:
    ...
    if (runtime->hasFunction(0x29CC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29CC48u; }
        if (ctx->pc != 0x29CC48u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0029CC80_0x29cc80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29CC48u; }
...
label_29cc48:
    ...
    ctx->pc = 0x29CC4Cu;
    {
        ...
        ctx->pc = 0x29CC50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29CC4Cu;
    ...
    ctx->pc = 0x29CC64u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29CC60u;
    ...
    if (runtime->hasFunction(0x2A8DA8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29CC68u; }
        if (ctx->pc != 0x29CC68u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29cc6c:
    ...
    ctx->pc = 0x29CC74u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x29CC78u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29CC74u;
