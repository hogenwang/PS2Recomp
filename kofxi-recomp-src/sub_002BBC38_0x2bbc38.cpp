...
void sub_002BBC38_0x2bbc38(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B1898u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B1898u, 0x2BBC5Cu, 0x2BBC64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBC64u;
label_2bbc64:
...
label_2bbc6c:
    ...
    ctx->pc = 0x2BBC70u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2BBC6Cu;
    // 0x2bbc70: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x29C870u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29C870u, 0x2BBC6Cu, 0x2BBC74u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBC74u;
label_2bbc74:
...
label_2bbc84:
    ...
    ctx->pc = 0x2BBC88u;
    {
        ...
        ctx->pc = 0x2BBC8Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2BBC88u;
        // 0x2bbc8c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BBC88u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2BBCACu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2BBCA8u;
    // 0x2bbcac: 0x24040002  addiu       $a0, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2B1898u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2B1898u, 0x2BBCA8u, 0x2BBCB0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBCB0u;
label_2bbcb0:
    ...
    ctx->pc = 0x2BBCBCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2BBCB8u;
    // 0x2bbcbc: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x29C8C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29C8C8u, 0x2BBCB8u, 0x2BBCC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2BBCC0u;
label_2bbcc0:
...
label_2bbcd0:
    ...
    ctx->pc = 0x2BBCD8u;
    {
        ...
        ctx->pc = 0x2BBCDCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2BBCD8u;
        // 0x2bbcdc: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2BBCD8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
