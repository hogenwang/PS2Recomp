...
void sub_001F9568_0x1f9568(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1ED920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ED920u, 0x1F957Cu, 0x1F9584u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F9584u;
label_1f9584:
...
label_1f95b0:
    ...
    ctx->pc = 0x1F95BCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F95B8u;
    // 0x1f95bc: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EB5D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EB5D8u, 0x1F95B8u, 0x1F95C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F95C0u;
label_1f95c0:
    ...
    ctx->pc = 0x1EB5A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EB5A8u, 0x1F95D0u, 0x1F95D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F95D8u;
label_1f95d8:
...
label_1f95dc:
    ...
    ctx->pc = 0x1F95F0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F95F0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1F9604u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F9600u;
    // 0x1f9604: 0x8c851f9c  lw          $a1, 0x1F9C($a0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 8092)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EB5D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EB5D8u, 0x1F9600u, 0x1F9608u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F9608u;
label_1f9608:
    ...
    ctx->pc = 0x1F9610u;
    {
        ...
        ctx->pc = 0x1F9614u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F9610u;
        // 0x1f9614: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F9610u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
