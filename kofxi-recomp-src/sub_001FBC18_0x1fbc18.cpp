...
void sub_001FBC18_0x1fbc18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FBC30u;
    {
        ...
        ctx->pc = 0x1FBC34u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBC30u;
    ...
    ctx->pc = 0x1FBC3Cu;
    {
        ...
        ctx->pc = 0x1FBC40u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBC3Cu;
...
label_1fbc48:
    ...
    ctx->pc = 0x1FBC4Cu;
    {
        ...
        ctx->pc = 0x1FBC50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBC4Cu;
    ...
    ctx->pc = 0x1FBC54u;
    {
        ...
        ctx->pc = 0x1FBC58u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBC54u;
...
label_1fbc60:
    ...
    ctx->pc = 0x1FBC60u;
    {
        ...
        ctx->pc = 0x1FBC64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FBC60u;
