...
void sub_0018E2E0_0x18e2e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x18E2F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x18E2ECu;
    ...
    if (runtime->hasFunction(0x18DE30u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x18E2F4u; }
        if (ctx->pc != 0x18E2F4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_18e2f4:
    ...
    ctx->pc = 0x18E2F4u;
    {
        ...
        if (branch_taken_0x18e2f4) {
            ctx->pc = 0x18E2F8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x18E2F4u;
...
label_18e300:
    ...
    ctx->pc = 0x18E304u;
    {
        ...
        ctx->pc = 0x18E308u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x18E304u;
