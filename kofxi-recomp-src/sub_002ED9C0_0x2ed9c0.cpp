...
label_2ed9e4:
    ...
    ctx->pc = 0x2ED9F0u;
    {
        ...
        ctx->pc = 0x2ED9F4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2ED9F0u;
        // 0x2ed9f4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2ED9F0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2ed9f8:
    ...
    ctx->pc = 0x2ED9FCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2ED9F8u;
    // 0x2ed9fc: 0x202d  daddu       $a0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2ED908u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2ED908u, 0x2ED9F8u, 0x2EDA00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EDA00u;
label_2eda00:
...
label_2eda0c:
    ...
    ctx->pc = 0x2EDA1Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2EDA18u;
    // 0x2eda1c: 0x1cf800a  movz        $s0, $t6, $t7 (Delay Slot)
    if (GPR_U64(ctx, 15) == 0) SET_GPR_VEC(ctx, 16, GPR_VEC(ctx, 14));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2ED908u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2ED908u, 0x2EDA18u, 0x2EDA20u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2EDA20u;
label_2eda20:
    ...
    ctx->pc = 0x2EDA34u;
    {
        ...
        ctx->pc = 0x2EDA38u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2EDA34u;
        // 0x2eda38: 0x95e2ecc4  lhu         $v0, -0x133C($t7) (Delay Slot)
        SET_GPR_U32(ctx, 2, (uint16_t)READ16(ADD32(GPR_U32(ctx, 15), 4294962372)));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2EDA34u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2eda3cu;
    // NOP
    if (ctx->pc == 0x2eda3cu) { ctx->pc = 0x2eda40u; }
}
