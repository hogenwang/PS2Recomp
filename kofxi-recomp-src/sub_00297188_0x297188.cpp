...
void sub_00297188_0x297188(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29A7C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x29A7C0u, 0x297190u, 0x297198u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x297198u;
label_297198:
    ...
    ctx->branch_pc = 0x297198u;
    // 0x29719c: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x297070u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x297070u, 0x297198u, 0x2971A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2971A0u;
label_2971a0:
    ...
    ctx->pc = 0x2971A4u;
    {
        ...
        ctx->pc = 0x2971A8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2971A4u;
        // 0x2971a8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2971A4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2971acu;
    // NOP
    if (ctx->pc == 0x2971acu) { ctx->pc = 0x2971b0u; }
}
