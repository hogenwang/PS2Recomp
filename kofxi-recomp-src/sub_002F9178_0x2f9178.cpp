...
label_2f9188:
    ...
    ctx->pc = 0x2F9184u;
    {
        ...
        ctx->pc = 0x2F9188u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9184u;
            // 0x2f9188: 0xffbf0000  sd          $ra, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
...
label_2f9194:
    ...
    ctx->pc = 0x2F9190u;
    ctx->pc = 0x2F9194u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9190u;
            // 0x2f9194: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x126618u;
...
label_2f919c:
    ...
    ctx->pc = 0x2F9198u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x2F91A0u; }
            if (ctx->pc != 0x2F91A0u) { return; }
        }
        }
    }
    ctx->pc = 0x2F91A0u;
