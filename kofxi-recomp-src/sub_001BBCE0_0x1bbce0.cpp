...
label_1bbcf4:
    ...
    ctx->pc = 0x1BBCF8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BBCF4u;
            // 0x1bbcf8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BBD18u;
    if (runtime->hasFunction(0x1BBD18u)) {
        auto targetFn = runtime->lookupFunction(0x1BBD18u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BBCFCu; }
        if (ctx->pc != 0x1BBCFCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BBD18_0x1bbd18(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BBCFCu; }
        if (ctx->pc != 0x1BBCFCu) { return; }
    }
    ctx->pc = 0x1BBCFCu;
label_1bbcfc:
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BBD04u; }
        if (ctx->pc != 0x1BBD04u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bbd04:
    ...
    ctx->pc = 0x1BBD10u;
    {
        ...
        ctx->pc = 0x1BBD14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BBD10u;
