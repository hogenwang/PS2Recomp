...
void sub_001B6B68_0x1b6b68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B8150u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8150u, 0x1B6B74u, 0x1B6B7Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6B7Cu;
label_1b6b7c:
    ...
    ctx->pc = 0x1B6B80u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B6B7Cu;
    // 0x1b6b80: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6B98u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6B98u, 0x1B6B7Cu, 0x1B6B84u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B6B84u;
label_1b6b84:
    ...
    ctx->pc = 0x1b6b94u;
    // NOP
    if (ctx->pc == 0x1b6b94u) { ctx->pc = 0x1b6b98u; }
}
