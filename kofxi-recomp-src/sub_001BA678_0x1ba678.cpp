...
label_1ba6a0:
    ...
    ctx->pc = 0x1BA6C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA6BCu;
    ...
    if (runtime->hasFunction(0x1B7968u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA6C4u; }
        if (ctx->pc != 0x1BA6C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba6d8:
    ...
    ctx->pc = 0x1BA6E8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA6E4u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA6ECu; }
        if (ctx->pc != 0x1BA6ECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ba6ec:
    ...
    ctx->pc = 0x1BA6F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BA6ECu;
            // 0x1ba6f0: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BA710u;
    if (runtime->hasFunction(0x1BA710u)) {
        auto targetFn = runtime->lookupFunction(0x1BA710u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA6F4u; }
        if (ctx->pc != 0x1BA6F4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BA710_0x1ba710(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BA6F4u; }
        if (ctx->pc != 0x1BA6F4u) { return; }
    }
    ctx->pc = 0x1BA6F4u;
