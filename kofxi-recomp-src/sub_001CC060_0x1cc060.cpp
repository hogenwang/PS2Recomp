...
void sub_001CC060_0x1cc060(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1CA780u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CC070u; }
        if (ctx->pc != 0x1CC070u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cc070:
    ...
    if (runtime->hasFunction(0x1CA7E8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CC078u; }
        if (ctx->pc != 0x1CC078u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1cc078:
    ...
    ctx->pc = 0x1CC090u;
    if (runtime->hasFunction(0x1CC090u)) {
        auto targetFn = runtime->lookupFunction(0x1CC090u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001CC090_0x1cc090(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1CC080u; }
        if (ctx->pc != 0x1CC080u) { return; }
    }
    ctx->pc = 0x1CC080u;
