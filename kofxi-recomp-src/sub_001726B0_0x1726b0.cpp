...
label_1726c0:
    ...
    ctx->pc = 0x1731C0u;
    if (runtime->hasFunction(0x1731C0u)) {
        auto targetFn = runtime->lookupFunction(0x1731C0u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001731C0_0x1731c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1726C8u; }
        if (ctx->pc != 0x1726C8u) { return; }
    }
    ctx->pc = 0x1726C8u;
label_1726c8:
    ...
    ctx->pc = 0x1726E4u;
    {
        ...
        ctx->pc = 0x1726E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1726E4u;
