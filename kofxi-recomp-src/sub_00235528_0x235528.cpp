...
label_235558:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x129E28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x129E28u, 0x235564u, 0x23556Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x23556Cu;
label_23556c:
...
label_23558c:
    ...
    ctx->pc = 0x2355a4u;
    // NOP
    if (ctx->pc == 0x2355a4u) { ctx->pc = 0x2355a8u; }
}
