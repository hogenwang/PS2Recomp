...
label_1e4750:
    ...
    ctx->pc = 0x1E474Cu;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E474Cu, 0x1E4754u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1E4754u;
...
label_1e475c:
    ...
    ctx->pc = 0x1E4758u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E4758u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1e4790:
    ...
    ctx->pc = 0x1E4800u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E4800u, 0x1E478Cu, 0x1E4794u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E4794u;
label_1e4794:
...
label_1e47a4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E49B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E49B0u, 0x1E47A0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1E47A8u;
label_1e47a8:
...
label_1e47b4:
    ...
    ctx->pc = 0x1E47B0u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E47B0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
