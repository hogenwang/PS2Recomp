...
void sub_0025FD68_0x25fd68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x118DB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x118DB0u, 0x25FD78u, 0x25FD80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x25FD80u;
label_25fd80:
    ...
    ctx->pc = 0x25FDB4u;
    {
        ...
        ctx->branch_pc = 0x25FDB4u;
        // 0x25fdb8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x25FDB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x25fdbcu;
    // NOP
    if (ctx->pc == 0x25fdbcu) { ctx->pc = 0x25fdc0u; }
}
