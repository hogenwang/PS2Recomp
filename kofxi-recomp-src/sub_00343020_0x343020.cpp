...
label_343074:
    ...
    ctx->pc = 0x343074u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x343074u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x34307cu;
    // NOP
    if (ctx->pc == 0x34307cu) { ctx->pc = 0x343080u; }
}
