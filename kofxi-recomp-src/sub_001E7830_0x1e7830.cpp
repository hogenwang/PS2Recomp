...
void sub_001E7830_0x1e7830(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E7840u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E783Cu;
    ...
    if (runtime->hasFunction(0x1E0780u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E7844u; }
        if (ctx->pc != 0x1E7844u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e7844:
    ...
    ctx->pc = 0x1E7850u;
    {
        ...
        ctx->pc = 0x1E7854u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E7850u;
