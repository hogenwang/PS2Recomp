...
label_342950:
    ...
    ctx->pc = 0x342954u;
    {
        ...
        if (branch_taken_0x342954) {
            ctx->pc = 0x342958u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x342954u;
    ...
    ctx->pc = 0x34295Cu;
    {
        ...
        ctx->pc = 0x342960u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x34295Cu;
...
label_342964:
    ...
    ctx->pc = 0x342968u;
    {
        ...
        ctx->pc = 0x34296Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x342968u;
...
label_342980:
    ...
    ctx->pc = 0x342984u;
    {
        ...
        if (branch_taken_0x342984) {
            ctx->pc = 0x342988u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x342984u;
    ...
    ctx->pc = 0x34298Cu;
    {
        ...
        ctx->pc = 0x342990u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x34298Cu;
...
label_342994:
    ...
    ctx->pc = 0x342998u;
    {
        ...
        ctx->pc = 0x34299Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x342998u;
