...
void sub_00118938_0x118938(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11895Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x118958u;
    ...
    if (runtime->hasFunction(0x1215E8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x118960u; }
        if (ctx->pc != 0x118960u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_118970:
    ...
    ctx->pc = 0x1189B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1189B4u;
    ...
    if (runtime->hasFunction(0x1215E8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1189BCu; }
        if (ctx->pc != 0x1189BCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001215E8_0x1215e8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1189BCu; }
...
label_1189c8:
    ...
    ctx->pc = 0x1189D8u;
    {
        ...
        ctx->pc = 0x1189DCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1189D8u;
