...
label_1a9e40:
    ...
    ctx->pc = 0x1A9E4Cu;
    {
        ...
        ctx->pc = 0x1A9E50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A9E4Cu;
    ...
    if (runtime->hasFunction(0x127088u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A9E5Cu; }
        if (ctx->pc != 0x1A9E5Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00127088_0x127088(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1A9E5Cu; }
...
label_1a9e5c:
    ...
    ctx->pc = 0x1A9E64u;
    {
        ...
        ctx->pc = 0x1A9E68u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A9E64u;
...
label_1a9e74:
    ...
    ctx->pc = 0x1A9E7Cu;
    {
        ...
        ctx->pc = 0x1A9E80u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1A9E7Cu;
