...
label_22520c:
    ...
    ctx->pc = 0x22520Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x22520Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x225214u;
    // NOP
    if (ctx->pc == 0x225214u) { ctx->pc = 0x225218u; }
}
