...
void sub_0030D380_0x30d380(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x30D3B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x30D3B0u;
    // 0x30d3b4: 0xe0302d  daddu       $a2, $a3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x30D300u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x30D300u, 0x30D3B0u, 0x30D3B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x30D3B8u;
label_30d3b8:
...
label_30d3bc:
    ...
    ctx->pc = 0x30D3BCu;
    {
        ...
        ctx->pc = 0x30D3C0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x30D3BCu;
        // 0x30d3c0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x30D3BCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x30d3ccu;
    // NOP
    if (ctx->pc == 0x30d3ccu) { ctx->pc = 0x30d3d0u; }
}
