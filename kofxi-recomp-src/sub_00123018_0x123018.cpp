...
void sub_00123018_0x123018(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x122598u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x122598u, 0x123030u, 0x123038u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x123038u;
label_123038:
    ...
    ctx->pc = 0x12303Cu;
    {
        ...
        ctx->pc = 0x123040u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x12303Cu;
        // 0x123040: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x12303Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x123044u;
    // NOP
    if (ctx->pc == 0x123044u) { ctx->pc = 0x123048u; }
}
