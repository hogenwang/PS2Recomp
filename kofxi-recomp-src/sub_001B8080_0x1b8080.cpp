...
void sub_001B8080_0x1b8080(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B809Cu;
    {
        ...
        if (branch_taken_0x1b809c) {
            ctx->pc = 0x1B80A0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1B809Cu;
...
label_1b80d0:
    ...
    ctx->pc = 0x1B80D0u;
    {
        ...
        ctx->pc = 0x1B80D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B80D0u;
    ...
    if (runtime->hasFunction(0x1B74A8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B80E0u; }
        if (ctx->pc != 0x1B80E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
