...
void sub_0024FFB0_0x24ffb0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x24FFCCu;
    {
        ...
        ctx->pc = 0x24FFD0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x24FFCCu;
    ...
    ctx->pc = 0x24FFE0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x24FFDCu;
    ...
    if (runtime->hasFunction(0x22D3E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x24FFE4u; }
        if (ctx->pc != 0x24FFE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_250004:
    ...
    ctx->pc = 0x250010u;
    {
        ...
        ctx->pc = 0x250014u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x250010u;
