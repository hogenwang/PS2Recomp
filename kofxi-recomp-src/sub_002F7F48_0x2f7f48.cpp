...
void sub_002F7F48_0x2f7f48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2F7F54u;
    // 0x2f7f58: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F7968u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F7968u, 0x2F7F54u, 0x2F7F5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F7F5Cu;
label_2f7f5c:
...
label_2f7f84:
    ...
    ctx->pc = 0x2F7F88u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2F7F84u;
    // 0x2f7f88: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F7438u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F7438u, 0x2F7F84u, 0x2F7F8Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F7F8Cu;
label_2f7f8c:
...
label_2f7f90:
    ...
    ctx->pc = 0x2F7F98u;
    {
        ...
        ctx->pc = 0x2F7F9Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F7F98u;
        // 0x2f7f9c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F7F98u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
