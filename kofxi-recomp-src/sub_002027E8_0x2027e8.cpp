...
void sub_002027E8_0x2027e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x202CD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x202CD0u, 0x202808u, 0x202810u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x202810u;
label_202810:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2028D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2028D8u, 0x202830u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x202838u;
    ...
    ctx->pc = 0x20285Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x202858u;
    // 0x20285c: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x202CD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x202CD0u, 0x202858u, 0x202860u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x202860u;
label_202860:
    ...
    ctx->pc = 0x202884u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x202880u;
    // 0x202884: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2028D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2028D8u, 0x202880u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x202888u;
}
