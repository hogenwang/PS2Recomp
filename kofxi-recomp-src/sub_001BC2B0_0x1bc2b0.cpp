...
label_1bc310:
    ...
    ctx->pc = 0x1BC314u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BC310u;
    // 0x1bc314: 0x3c1300ff  lui         $s3, 0xFF (Delay Slot)
    SET_GPR_S32(ctx, 19, (int32_t)((uint32_t)255 << 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B9280u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B9280u, 0x1BC310u, 0x1BC318u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC318u;
label_1bc318:
    ...
    ctx->pc = 0x1AD238u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD238u, 0x1BC354u, 0x1BC35Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC35Cu;
label_1bc35c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CA998u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CA998u, 0x1BC390u, 0x1BC398u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC398u;
label_1bc398:
    ...
    ctx->pc = 0x1AD250u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD250u, 0x1BC3A4u, 0x1BC3ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC3ACu;
label_1bc3ac:
...
label_1bc3d0:
    ...
    ctx->pc = 0x1BC3D8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BC3D4u;
    // 0x1bc3d8: 0xa2420002  sb          $v0, 0x2($s2) (Delay Slot)
    WRITE8(ADD32(GPR_U32(ctx, 18), 2), (uint8_t)GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B8F10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B8F10u, 0x1BC3D4u, 0x1BC3DCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC3DCu;
label_1bc3dc:
    ...
    ctx->pc = 0x1BC3E4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BC3E0u;
    // 0x1bc3e4: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BB618u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BB618u, 0x1BC3E0u, 0x1BC3E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC3E8u;
label_1bc3e8:
...
label_1bc408:
    ...
    ctx->pc = 0x1BC418u;
    {
        ...
        ctx->pc = 0x1BC41Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1BC418u;
        // 0x1bc41c: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BC418u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1BC438u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BC434u;
    // 0x1bc438: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BC434u, 0x1BC43Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC43Cu;
label_1bc43c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1BC460u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BC460u, 0x1BC440u, 0x1BC448u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BC448u;
label_1bc448:
    ...
    ctx->pc = 0x1bc45cu;
    // NOP
    if (ctx->pc == 0x1bc45cu) { ctx->pc = 0x1bc460u; }
}
