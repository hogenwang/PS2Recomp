...
label_294f40:
    ...
    ctx->pc = 0x294F44u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x294F48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x294F44u;
...
label_294f70:
    ...
    ctx->pc = 0x294F8Cu;
    {
        ...
        ctx->pc = 0x294F90u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x294F8Cu;
    ...
    if (runtime->hasFunction(0x296C30u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x294F9Cu; }
        if (ctx->pc != 0x294F9Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_294fb4:
    ...
    ctx->pc = 0x294FD4u;
    ctx->pc = 0x294FD8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x294FD4u;
            // 0x294fd8: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
    ctx->pc = 0x2A8460u;
    {
        auto targetFn = runtime->lookupFunction(0x2A8460u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_294fe0:
    ...
    ctx->pc = 0x2A83A0u;
    {
        auto targetFn = runtime->lookupFunction(0x2A83A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
