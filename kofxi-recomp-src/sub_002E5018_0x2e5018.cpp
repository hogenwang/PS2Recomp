...
void sub_002E5018_0x2e5018(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2E503Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2E5038u;
    ...
    if (runtime->hasFunction(0x2E4F78u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E5040u; }
        if (ctx->pc != 0x2E5040u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2e5040:
    ...
    ctx->pc = 0x2E5044u;
    {
        ...
        ctx->pc = 0x2E5048u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E5044u;
    ...
    if (runtime->hasFunction(0x2E4F68u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2E5064u; }
        if (ctx->pc != 0x2E5064u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2e5068:
    ...
    ctx->pc = 0x2E507Cu;
    {
        ...
        ctx->pc = 0x2E5080u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2E507Cu;
