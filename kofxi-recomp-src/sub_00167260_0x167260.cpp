...
label_167290:
    ...
    ctx->pc = 0x167294u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x167290u;
    // 0x167294: 0x30a500ff  andi        $a1, $a1, 0xFF (Delay Slot)
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) & (uint64_t)(uint16_t)255);
    ctx->in_delay_slot = false;
    ctx->pc = 0x166EB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x166EB0u, 0x167290u, 0x167298u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x167298u;
label_167298:
...
label_1672a8:
    ...
    ctx->pc = 0x1672ACu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1672A8u;
    // 0x1672ac: 0x2445ffdd  addiu       $a1, $v0, -0x23 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 2), 4294967261));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1672C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1672C0u, 0x1672A8u, 0x1672B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1672B0u;
label_1672b0:
...
label_1672b4:
    ...
    ctx->pc = 0x1672B8u;
    {
        ...
        ctx->pc = 0x1672BCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1672B8u;
        // 0x1672bc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1672B8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
