...
void sub_00115FE8_0x115fe8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x115FF4u;
    // 0x115ff8: 0x3a0382d  daddu       $a3, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x115DC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x115DC0u, 0x115FF4u, 0x115FFCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x115FFCu;
label_115ffc:
    ...
    ctx->pc = 0x116000u;
    {
        ...
        ctx->pc = 0x116004u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x116000u;
        // 0x116004: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x116000u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x116014u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x116010u;
    // 0x116014: 0x402d  daddu       $t0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x115DC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x115DC0u, 0x116010u, 0x116018u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x116018u;
label_116018:
    ...
    ctx->pc = 0x11601Cu;
    {
        ...
        ctx->pc = 0x116020u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x11601Cu;
        // 0x116020: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x11601Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x116024u;
    // NOP
    if (ctx->pc == 0x116024u) { ctx->pc = 0x116028u; }
}
