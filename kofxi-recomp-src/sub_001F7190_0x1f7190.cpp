...
void sub_001F7190_0x1f7190(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F71B8u;
    {
        ...
        ctx->pc = 0x1F71BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F71B8u;
...
label_1f71d8:
    ...
    ctx->pc = 0x1F71E0u;
    {
        ...
        ctx->pc = 0x1F71E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F71E0u;
...
label_1f7200:
    ...
    ctx->pc = 0x1F7220u;
    if (runtime->hasFunction(0x1F7220u)) {
        auto targetFn = runtime->lookupFunction(0x1F7220u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7208u; }
        if (ctx->pc != 0x1F7208u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F7220_0x1f7220(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7208u; }
        if (ctx->pc != 0x1F7208u) { return; }
    }
    ctx->pc = 0x1F7208u;
