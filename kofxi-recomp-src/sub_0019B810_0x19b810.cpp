...
void sub_0019B810_0x19b810(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x19B848u;
    {
        ...
        ctx->pc = 0x19B84Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x19B848u;
    ...
    ctx->pc = 0x19B850u;
    {
        ...
        ctx->pc = 0x19B854u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x19B850u;
...
label_19b864:
    ...
    ctx->pc = 0x19B880u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x19B87Cu;
...
label_19b884:
    ...
    ctx->pc = 0x19B898u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x19B894u;
            // 0x19b898: 0x27a60040  addiu       $a2, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
    ctx->pc = 0x31EF60u;
    if (runtime->hasFunction(0x31EF60u)) {
        auto targetFn = runtime->lookupFunction(0x31EF60u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x19B89Cu; }
        if (ctx->pc != 0x19B89Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0031EF60_0x31ef60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x19B89Cu; }
        if (ctx->pc != 0x19B89Cu) { return; }
    }
    ctx->pc = 0x19B89Cu;
label_19b89c:
    ...
    ctx->pc = 0x19B8B0u;
    {
        ...
        ctx->pc = 0x19B8B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x19B8B0u;
