...
void sub_002D7118_0x2d7118(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x2d7198u: goto label_2d7198;
    ...
    ctx->pc = 0x2D7138u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7134u;
    ...
    if (runtime->hasFunction(0x2CF7E8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D713Cu; }
        if (ctx->pc != 0x2D713Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d713c:
    ...
    ctx->pc = 0x2D714Cu;
    {
        ...
        ctx->pc = 0x2D7150u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D714Cu;
    ...
    ctx->pc = 0x2D7164u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7160u;
    ...
    if (runtime->hasFunction(0x2D63F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D7168u; }
        if (ctx->pc != 0x2D7168u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d7168:
    ...
    ctx->pc = 0x2D717Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7178u;
    ...
    if (runtime->hasFunction(0x2CF420u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D7180u; }
        if (ctx->pc != 0x2D7180u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d7198:
    ...
    ctx->pc = 0x2D71C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2D71BCu;
    ...
    if (runtime->hasFunction(0x2CF568u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D71C4u; }
        if (ctx->pc != 0x2D71C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2d71c4:
    ...
    ctx->pc = 0x2D71CCu;
    {
        ...
        ctx->pc = 0x2D71D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D71CCu;
    ...
    if (runtime->hasFunction(0x2CF7E8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D71DCu; }
        if (ctx->pc != 0x2D71DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002CF7E8_0x2cf7e8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2D71DCu; }
...
label_2d721c:
    ...
    ctx->pc = 0x2D7224u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2D7228u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2D7224u;
