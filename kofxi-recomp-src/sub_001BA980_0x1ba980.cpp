...
label_1ba99c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AE828u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AE828u, 0x1BA998u, 0x1BA9A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BA9A0u;
label_1ba9a0:
...
label_1ba9c0:
    ...
    ctx->pc = 0x1BA9BCu;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BA9BCu, 0x1BA9C4u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1BA9C4u;
...
label_1ba9e8:
    ...
    ctx->pc = 0x1BA9E4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BA9E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1ba9ec:
    ...
    ctx->pc = 0x1ba9ecu;
    // NOP
    if (ctx->pc == 0x1ba9ecu) { ctx->pc = 0x1ba9f0u; }
}
