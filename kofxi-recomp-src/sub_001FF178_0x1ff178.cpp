...
void sub_001FF178_0x1ff178(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2004C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2004C8u, 0x1FF1ACu, 0x1FF1B4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FF1B4u;
label_1ff1b4:
...
label_1ff1e0:
    ...
    ctx->pc = 0x1FFBD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FFBD0u, 0x1FF1E0u, 0x1FF1E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FF1E8u;
label_1ff1e8:
    ...
    ctx->pc = 0x200448u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x200448u, 0x1FF1F8u, 0x1FF200u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FF200u;
label_1ff200:
...
label_1ff208:
    ...
    ctx->pc = 0x1FF20Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1FF208u;
    // 0x1ff20c: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FFBD0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FFBD0u, 0x1FF208u, 0x1FF210u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FF210u;
label_1ff210:
    ...
    ctx->pc = 0x200488u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x200488u, 0x1FF220u, 0x1FF228u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FF228u;
label_1ff228:
...
label_1ff234:
    ...
    ctx->pc = 0x1FF240u;
    {
        ...
        ctx->pc = 0x1FF244u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1FF240u;
        // 0x1ff244: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1FF240u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
