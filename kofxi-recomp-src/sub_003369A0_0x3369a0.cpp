...
void sub_003369A0_0x3369a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x3369ACu;
    {
        ...
        if (branch_taken_0x3369ac) {
            ctx->pc = 0x3369B0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x3369ACu;
    ...
    ctx->pc = 0x3369CCu;
    {
        ...
        ctx->pc = 0x3369D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3369CCu;
...
label_3369d8:
    ...
    ctx->pc = 0x3369D8u;
    {
        ...
        if (branch_taken_0x3369d8) {
            ctx->pc = 0x3369DCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x3369D8u;
    ...
    ctx->pc = 0x3369F8u;
    {
        ...
        ctx->pc = 0x3369FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3369F8u;
