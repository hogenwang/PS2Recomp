...
void sub_001F6B30_0x1f6b30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F6440u;
    if (runtime->hasFunction(0x1F6440u)) {
        auto targetFn = runtime->lookupFunction(0x1F6440u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F6B68u; }
        if (ctx->pc != 0x1F6B68u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F6440_0x1f6440(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F6B68u; }
        if (ctx->pc != 0x1F6B68u) { return; }
    }
    ctx->pc = 0x1F6B68u;
