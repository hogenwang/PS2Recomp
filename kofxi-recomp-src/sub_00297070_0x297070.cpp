...
void sub_00297070_0x297070(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29707Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x297078u;
            // 0x29707c: 0x24050002  addiu       $a1, $zero, 0x2 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
        ctx->in_delay_slot = false;
    ctx->pc = 0x299EE8u;
    if (runtime->hasFunction(0x299EE8u)) {
        auto targetFn = runtime->lookupFunction(0x299EE8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297080u; }
        if (ctx->pc != 0x297080u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00299EE8_0x299ee8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x297080u; }
        if (ctx->pc != 0x297080u) { return; }
    }
    ctx->pc = 0x297080u;
label_297080:
    ...
    ctx->pc = 0x297084u;
    {
        ...
        ctx->pc = 0x297088u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x297084u;
