...
void sub_002A8CD0_0x2a8cd0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2A8CFCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2A8CF8u;
    // 0x2a8cfc: 0x240800db  addiu       $t0, $zero, 0xDB (Delay Slot)
    SET_GPR_S32(ctx, 8, (int32_t)ADD32(GPR_U32(ctx, 0), 219));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A2D18u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A2D18u, 0x2A8CF8u, 0x2A8D00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2A8D00u;
label_2a8d00:
    ...
    ctx->pc = 0x2A0308u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A0308u, 0x2A8D14u, 0x2A8D1Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2A8D1Cu;
label_2a8d1c:
...
label_2a8d20:
    ...
    ctx->pc = 0x2A2340u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A2340u, 0x2A8D28u, 0x2A8D30u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2A8D30u;
label_2a8d30:
...
label_2a8d34:
    ...
    ctx->pc = 0x2A3028u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A3028u, 0x2A8D3Cu, 0x2A8D44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2A8D44u;
label_2a8d44:
...
label_2a8d5c:
    ...
    ctx->pc = 0x2A8D60u;
    {
        ...
        ctx->pc = 0x2A8D64u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2A8D60u;
        // 0x2a8d64: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2A8D60u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
