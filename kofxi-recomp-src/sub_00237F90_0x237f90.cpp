...
void sub_00237F90_0x237f90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x22B220u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x22B220u, 0x237FA8u, 0x237FB0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x237FB0u;
label_237fb0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x237978u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x237978u, 0x237FBCu, 0x237FC4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x237FC4u;
label_237fc4:
    ...
    ctx->pc = 0x237fdcu;
    // NOP
    if (ctx->pc == 0x237fdcu) { ctx->pc = 0x237fe0u; }
}
