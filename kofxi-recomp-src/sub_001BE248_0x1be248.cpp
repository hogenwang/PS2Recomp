...
label_1be254:
    ...
    ctx->pc = 0x1BE250u;
    {
        ...
        ctx->pc = 0x1BE254u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE250u;
            // 0x1be254: 0xffbf0000  sd          $ra, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
...
label_1be284:
    ...
    ctx->pc = 0x1BE280u;
    ctx->pc = 0x1BE284u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE280u;
            // 0x1be284: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BE0E0u;
...
label_1be28c:
    ...
    ctx->pc = 0x1BE2D0u;
    if (runtime->hasFunction(0x1BE2D0u)) {
        auto targetFn = runtime->lookupFunction(0x1BE2D0u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001BE2D0_0x1be2d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BE290u; }
        if (ctx->pc != 0x1BE290u) { return; }
    }
    ctx->pc = 0x1BE290u;
...
label_1be2b0:
    ...
    ctx->pc = 0x1BE2ACu;
    {
        ...
        ctx->pc = 0x1BE2B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE2ACu;
            // 0x1be2b0: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_1be2bc:
    ...
    ctx->pc = 0x1BE2B8u;
    {
        ...
        ctx->pc = 0x1BE2BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE2B8u;
            // 0x1be2bc: 0x2484e0b0  addiu       $a0, $a0, -0x1F50 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294959280));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1BE2C0u; }
            if (ctx->pc != 0x1BE2C0u) { return; }
        }
        }
    }
    ctx->pc = 0x1BE2C0u;
...
label_1be2c8:
    ...
    ctx->pc = 0x1BE2C4u;
    {
        ...
        ctx->pc = 0x1BE2C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1BE2C4u;
            // 0x1be2c8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
