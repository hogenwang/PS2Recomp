...
void sub_00264160_0x264160(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x264170u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x26416Cu;
    ...
    if (runtime->hasFunction(0x22D7F8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x264174u; }
        if (ctx->pc != 0x264174u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_264174:
    ...
    ctx->pc = 0x26417Cu;
    {
        ...
        ctx->pc = 0x264180u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26417Cu;
...
label_264198:
    ...
    ctx->pc = 0x26419Cu;
    {
        ...
        ctx->pc = 0x2641A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26419Cu;
