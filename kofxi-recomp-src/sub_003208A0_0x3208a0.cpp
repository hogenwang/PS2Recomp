...
void sub_003208A0_0x3208a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x3208A8u;
    // 0x3208ac: 0x24040003  addiu       $a0, $zero, 0x3 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 3));
    ctx->in_delay_slot = false;
    ctx->pc = 0x32C8E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x32C8E0u, 0x3208A8u, 0x3208B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3208B0u;
label_3208b0:
    ...
    ctx->pc = 0x3208B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x3208B4u;
    // 0x3208b8: 0x24840c60  addiu       $a0, $a0, 0xC60 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 3168));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F300u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F300u, 0x3208B4u, 0x3208BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x3208BCu;
label_3208bc:
    ...
    ctx->pc = 0x3208C0u;
    {
        ...
        ctx->pc = 0x3208C4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x3208C0u;
        // 0x3208c4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x3208C0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x3208ccu;
    // NOP
    if (ctx->pc == 0x3208ccu) { ctx->pc = 0x3208d0u; }
}
