...
void sub_0013E540_0x13e540(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13E570u;
    {
        ...
        if (branch_taken_0x13e570) {
            ctx->pc = 0x13E574u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x13E570u;
    ...
    ctx->pc = 0x13E5E0u;
    if (runtime->hasFunction(0x13E5E0u)) {
        auto targetFn = runtime->lookupFunction(0x13E5E0u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0013E5E0_0x13e5e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E58Cu; }
        if (ctx->pc != 0x13E58Cu) { return; }
    }
    ctx->pc = 0x13E58Cu;
...
label_13e594:
    ...
    if (runtime->hasFunction(0x13E5E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E59Cu; }
        if (ctx->pc != 0x13E59Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0013E5E0_0x13e5e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E59Cu; }
...
label_13e5a4:
    ...
    ctx->pc = 0x13E5B0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13E5ACu;
    ...
    if (runtime->hasFunction(0x1601A0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E5B4u; }
        if (ctx->pc != 0x13E5B4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13e5c4:
    ...
    ctx->pc = 0x13E5D0u;
    {
        ...
        ctx->pc = 0x13E5D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13E5D0u;
