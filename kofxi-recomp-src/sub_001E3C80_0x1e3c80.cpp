...
label_1e3cb4:
    ...
    ctx->pc = 0x1E3CC4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E3CC0u;
    // 0x1e3cc4: 0x2484db08  addiu       $a0, $a0, -0x24F8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294957832));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E6BE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6BE8u, 0x1E3CC0u, 0x1E3CC8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E3CC8u;
label_1e3cc8:
...
label_1e3cd0:
    ...
    ctx->pc = 0x1E3CD4u;
    {
        ...
        ctx->pc = 0x1E3CD8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E3CD4u;
        // 0x1e3cd8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E3CD4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e3cdcu;
    // NOP
    if (ctx->pc == 0x1e3cdcu) { ctx->pc = 0x1e3ce0u; }
}
