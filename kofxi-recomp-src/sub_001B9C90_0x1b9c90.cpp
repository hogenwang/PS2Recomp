...
label_1b9cb0:
    ...
    ctx->pc = 0x1B9CB8u;
    {
        ...
        if (branch_taken_0x1b9cb8) {
            ctx->pc = 0x1B9CBCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9CB8u;
    ...
    ctx->pc = 0x1B64D8u;
    {
        auto targetFn = runtime->lookupFunction(0x1B64D8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1b9cd0:
    ...
    ctx->pc = 0x1B9CD4u;
    {
        ...
        ctx->pc = 0x1B9CD8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9CD4u;
...
label_1b9ce0:
    ...
    ctx->pc = 0x1B9CF0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9CECu;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9CF4u; }
        if (ctx->pc != 0x1B9CF4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b9cf4:
    ...
    ctx->pc = 0x1B9CF8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9CF4u;
            // 0x1b9cf8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B9D18u;
    if (runtime->hasFunction(0x1B9D18u)) {
        auto targetFn = runtime->lookupFunction(0x1B9D18u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9CFCu; }
        if (ctx->pc != 0x1B9CFCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B9D18_0x1b9d18(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9CFCu; }
        if (ctx->pc != 0x1B9CFCu) { return; }
    }
    ctx->pc = 0x1B9CFCu;
label_1b9cfc:
    ...
    ctx->pc = 0x1B9D00u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B9CFCu;
    ...
    if (runtime->hasFunction(0x1AD270u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B9D04u; }
        if (ctx->pc != 0x1B9D04u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
