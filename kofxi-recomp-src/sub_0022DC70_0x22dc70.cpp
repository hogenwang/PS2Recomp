...
void sub_0022DC70_0x22dc70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x22DC8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x22DC88u;
    ...
    if (runtime->hasFunction(0x10CCA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x22DC90u; }
        if (ctx->pc != 0x22DC90u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_22dc90:
    ...
    ctx->pc = 0x22DC9Cu;
    {
        ...
        ctx->pc = 0x22DCA0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x22DC9Cu;
...
label_22dcb0:
    ...
    ctx->pc = 0x22DCC0u;
    ctx->pc = 0x22DCC4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x22DCC0u;
