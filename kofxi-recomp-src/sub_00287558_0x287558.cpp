...
label_28756c:
    ...
    ctx->pc = 0x287568u;
    {
        ...
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x287568u, 0x287570u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x287570u;
...
label_287578:
    ...
    ctx->pc = 0x287574u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x287574u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_28757c:
    ...
    ctx->pc = 0x28757cu;
    // NOP
    if (ctx->pc == 0x28757cu) { ctx->pc = 0x287580u; }
}
