...
void sub_00201B98_0x201b98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x201BA8u;
    ctx->pc = 0x201BACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x201BA8u;
            // 0x201bac: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x200760u;
    {
        auto targetFn = runtime->lookupFunction(0x200760u);
...
label_201bb0:
    ...
    ctx->pc = 0x201BD0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x201BCCu;
            // 0x201bd0: 0x8e040030  lw          $a0, 0x30($s0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 48)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x200780u;
    if (runtime->hasFunction(0x200780u)) {
        auto targetFn = runtime->lookupFunction(0x200780u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00200780_0x200780(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x201BD4u; }
        if (ctx->pc != 0x201BD4u) { return; }
    }
    ctx->pc = 0x201BD4u;
label_201bd4:
    ...
    ctx->pc = 0x201BE4u;
    ctx->pc = 0x201BE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x201BE4u;
...
label_201bf0:
    ...
    ctx->pc = 0x201C00u;
    ctx->pc = 0x201C04u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x201C00u;
            // 0x201c04: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
    ctx->pc = 0x200798u;
    {
        auto targetFn = runtime->lookupFunction(0x200798u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_201c08:
    ...
    ctx->pc = 0x201C08u;
    {
        ...
        ctx->pc = 0x201C0Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201C08u;
...
label_201c10:
    ...
    ctx->pc = 0x201C10u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x201C14u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201C10u;
...
label_201c20:
    ...
    ctx->pc = 0x201C20u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x201C24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201C20u;
