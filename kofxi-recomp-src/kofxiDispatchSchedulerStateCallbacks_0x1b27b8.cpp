...
// Function: kofxiDispatchSchedulerStateCallbacks
// Address: 0x1b27b8 - 0x1b2850
void kofxiDispatchSchedulerStateCallbacks_0x1b27b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiDispatchSchedulerStateCallbacks_0x1b27b8");
#endif
    ...
    ctx->pc = 0x1B2968u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B2968u, 0x1B27C8u, 0x1B27D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B27D0u;
label_1b27d0:
...
label_1b2808:
    ...
    ctx->pc = 0x1CE5B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5B8u, 0x1B2808u, 0x1B2810u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2810u;
label_1b2810:
...
label_1b2818:
    ...
    ctx->pc = 0x1CE5B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5B8u, 0x1B2818u, 0x1B2820u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2820u;
label_1b2820:
    ...
    ctx->pc = 0x1CE5D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5D0u, 0x1B2820u, 0x1B2828u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2828u;
label_1b2828:
    ...
    ctx->pc = 0x1CE5E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5E8u, 0x1B2828u, 0x1B2830u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2830u;
label_1b2830:
    ...
    ctx->pc = 0x1CE600u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE600u, 0x1B2830u, 0x1B2838u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2838u;
label_1b2838:
    ...
    ctx->pc = 0x1CE630u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE630u, 0x1B2838u, 0x1B2840u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2840u;
label_1b2840:
...
label_1b2848:
    ...
    ctx->pc = 0x1B2848u;
    {
        ...
        ctx->pc = 0x1B284Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B2848u;
        // 0x1b284c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B2848u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
