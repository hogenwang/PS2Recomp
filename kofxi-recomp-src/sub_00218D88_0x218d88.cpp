...
label_218d88:
    ...
    ctx->branch_pc = 0x218D9Cu;
    // 0x218da0: 0x24841170  addiu       $a0, $a0, 0x1170 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4464));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218D9Cu, 0x218DA4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218DA4u;
label_218da4:
    ...
    ctx->pc = 0x218DB0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218DACu;
    // 0x218db0: 0x24841190  addiu       $a0, $a0, 0x1190 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4496));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218DACu, 0x218DB4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218DB4u;
label_218db4:
    ...
    ctx->pc = 0x218DC0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218DBCu;
    // 0x218dc0: 0x248411a0  addiu       $a0, $a0, 0x11A0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4512));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218DBCu, 0x218DC4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218DC4u;
label_218dc4:
    ...
    ctx->pc = 0x218DD0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218DCCu;
    // 0x218dd0: 0x248411b0  addiu       $a0, $a0, 0x11B0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4528));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218DCCu, 0x218DD4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218DD4u;
label_218dd4:
    ...
    ctx->pc = 0x218DE0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218DDCu;
    // 0x218de0: 0x248411c0  addiu       $a0, $a0, 0x11C0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4544));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218DDCu, 0x218DE4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218DE4u;
label_218de4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218DECu, 0x218DF4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218DF4u;
label_218df4:
    ...
    ctx->pc = 0x218E00u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218DFCu;
    // 0x218e00: 0x248411e0  addiu       $a0, $a0, 0x11E0 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4576));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x218DFCu, 0x218E04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218E04u;
label_218e04:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2111F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2111F0u, 0x218E64u, 0x218E6Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218E6Cu;
label_218e6c:
    ...
    ctx->pc = 0x218E7Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218E78u;
    // 0x218e7c: 0x24060040  addiu       $a2, $zero, 0x40 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 64));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211268u, 0x218E78u, 0x218E80u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218E80u;
label_218e80:
    ...
    ctx->pc = 0x218E90u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218E8Cu;
    // 0x218e90: 0x24060002  addiu       $a2, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211370u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211370u, 0x218E8Cu, 0x218E94u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218E94u;
label_218e94:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x211268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211268u, 0x218EA0u, 0x218EA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218EA8u;
label_218ea8:
    ...
    ctx->pc = 0x218EB8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218EB4u;
    // 0x218eb8: 0x24060004  addiu       $a2, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211370u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211370u, 0x218EB4u, 0x218EBCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218EBCu;
label_218ebc:
    ...
    ctx->pc = 0x218ECCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218EC8u;
    // 0x218ecc: 0x24060004  addiu       $a2, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211370u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211370u, 0x218EC8u, 0x218ED0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218ED0u;
label_218ed0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x211268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211268u, 0x218EDCu, 0x218EE4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218EE4u;
label_218ee4:
...
label_218ef4:
    ...
    ctx->pc = 0x218F10u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x218F10u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x218F58u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218F54u;
    // 0x218f58: 0x8cb40000  lw          $s4, 0x0($a1) (Delay Slot)
    SET_GPR_S32(ctx, 20, (int32_t)READ32(ADD32(GPR_U32(ctx, 5), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211608u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211608u, 0x218F54u, 0x218F5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218F5Cu;
label_218f5c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x211708u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211708u, 0x218F68u, 0x218F70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218F70u;
label_218f70:
    ...
    ctx->pc = 0x218F80u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218F7Cu;
    // 0x218f80: 0x24060002  addiu       $a2, $zero, 0x2 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211848u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211848u, 0x218F7Cu, 0x218F84u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218F84u;
label_218f84:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x211708u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211708u, 0x218F90u, 0x218F98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218F98u;
label_218f98:
    ...
    ctx->pc = 0x218FA8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218FA4u;
    // 0x218fa8: 0x24060004  addiu       $a2, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211848u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211848u, 0x218FA4u, 0x218FACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218FACu;
label_218fac:
    ...
    ctx->pc = 0x218FBCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218FB8u;
    // 0x218fbc: 0x24060004  addiu       $a2, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211848u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211848u, 0x218FB8u, 0x218FC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218FC0u;
label_218fc0:
    ...
    ctx->pc = 0x218FD0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x218FCCu;
    // 0x218fd0: 0x24060040  addiu       $a2, $zero, 0x40 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 64));
    ctx->in_delay_slot = false;
    ctx->pc = 0x211708u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x211708u, 0x218FCCu, 0x218FD4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x218FD4u;
label_218fd4:
...
label_218fdc:
    ...
    ctx->pc = 0x219004u;
    // NOP
    if (ctx->pc == 0x219004u) { ctx->pc = 0x219008u; }
}
