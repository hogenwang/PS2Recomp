...
void sub_002C4170_0x2c4170(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x281C30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x281C30u, 0x2C4184u, 0x2C418Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C418Cu;
label_2c418c:
    ...
    ctx->pc = 0x2C4190u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C418Cu;
    // 0x2c4190: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2C2820u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2C2820u, 0x2C418Cu, 0x2C4194u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C4194u;
label_2c4194:
    ...
    ctx->pc = 0x2C4198u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C4194u;
    // 0x2c4198: 0x8e040008  lw          $a0, 0x8($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 8)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x282578u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x282578u, 0x2C4194u, 0x2C419Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C419Cu;
label_2c419c:
    ...
    ctx->pc = 0x2C41A0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C419Cu;
    // 0x2c41a0: 0x8e04000c  lw          $a0, 0xC($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 12)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x281C30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x281C30u, 0x2C419Cu, 0x2C41A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C41A4u;
label_2c41a4:
    ...
    ctx->pc = 0x281C30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x281C30u, 0x2C41B0u, 0x2C41B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C41B8u;
label_2c41b8:
...
label_2c41bc:
    ...
    ctx->pc = 0x2C41C4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2C41C0u;
    // 0x2c41c4: 0x24a54118  addiu       $a1, $a1, 0x4118 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 16664));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2BC5B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2BC5B0u, 0x2C41C0u, 0x2C41C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C41C8u;
label_2c41c8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2BC5B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2BC5B0u, 0x2C41D0u, 0x2C41D8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2C41D8u;
label_2c41d8:
...
label_2c41ec:
    ...
    ctx->pc = 0x2C41F4u;
    {
        ...
        ctx->pc = 0x2C41F8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2C41F4u;
        // 0x2c41f8: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2C41F4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2c41fcu;
    // NOP
    if (ctx->pc == 0x2c41fcu) { ctx->pc = 0x2c4200u; }
}
