...
void sub_001E1DB8_0x1e1db8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E1DC4u;
    // 0x1e1dc8: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E7A18u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E7A18u, 0x1E1DC4u, 0x1E1DCCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1DCCu;
label_1e1dcc:
    ...
    ctx->pc = 0x1E7898u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E7898u, 0x1E1DD4u, 0x1E1DDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1DDCu;
label_1e1ddc:
...
label_1e1de0:
    ...
    ctx->pc = 0x1E1DE8u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E1DE8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
