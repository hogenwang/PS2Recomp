...
void sub_001A8B30_0x1a8b30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1A8B3Cu;
    // 0x1a8b40: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1A7F60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A7F60u, 0x1A8B3Cu, 0x1A8B44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A8B44u;
label_1a8b44:
    ...
    ctx->pc = 0x1A8B5Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1A8B58u;
    // 0x1a8b5c: 0x24060065  addiu       $a2, $zero, 0x65 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 101));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1A8F78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A8F78u, 0x1A8B58u, 0x1A8B60u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A8B60u;
label_1a8b60:
    ...
    ctx->pc = 0x1A8B68u;
    {
        ...
        ctx->pc = 0x1A8B6Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1A8B68u;
        // 0x1a8b6c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A8B68u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
