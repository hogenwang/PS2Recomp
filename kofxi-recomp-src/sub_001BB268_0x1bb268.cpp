...
void sub_001BB268_0x1bb268(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1BB274u;
    // 0x1bb278: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B4DC0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B4DC0u, 0x1BB274u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1BB27Cu;
    // 0x1bb27c: 0x0  nop
    ctx->pc = 0x1bb27cu;
    // NOP
    if (ctx->pc == 0x1bb27cu) { ctx->pc = 0x1bb280u; }
}
