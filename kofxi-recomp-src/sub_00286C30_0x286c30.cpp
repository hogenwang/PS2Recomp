...
void sub_00286C30_0x286c30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x286A30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286A30u, 0x286C3Cu, 0x286C44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286C44u;
label_286c44:
...
label_286c54:
    ...
    ctx->pc = 0x286C58u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x286C54u;
    // 0x286c58: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x286C70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286C70u, 0x286C54u, 0x286C5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286C5Cu;
label_286c5c:
    ...
    ctx->pc = 0x286C64u;
    {
        ...
        ctx->pc = 0x286C68u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x286C64u;
        // 0x286c68: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x286C64u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x286c6cu;
    // NOP
    if (ctx->pc == 0x286c6cu) { ctx->pc = 0x286c70u; }
}
