...
label_286458:
    ...
    ctx->pc = 0x286A30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286A30u, 0x28646Cu, 0x286474u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286474u;
label_286474:
...
label_286490:
    ...
    ctx->pc = 0x286494u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x286490u;
    // 0x286494: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x286DA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286DA8u, 0x286490u, 0x286498u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286498u;
label_286498:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x286DA8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286DA8u, 0x28649Cu, 0x2864A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2864A4u;
label_2864a4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x286C70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286C70u, 0x2864A8u, 0x2864B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2864B0u;
label_2864b0:
    ...
    ctx->pc = 0x2864BCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2864B8u;
    // 0x2864bc: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x286C70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286C70u, 0x2864B8u, 0x2864C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2864C0u;
label_2864c0:
...
label_2864e0:
    ...
    ctx->pc = 0x2864F0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2864ECu;
    // 0x2864f0: 0x240402d  daddu       $t0, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 8, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x285D20u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x285D20u, 0x2864ECu, 0x2864F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2864F4u;
label_2864f4:
...
label_28650c:
    ...
    ctx->pc = 0x286514u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x286510u;
    // 0x286514: 0x240382d  daddu       $a3, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x287C88u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x287C88u, 0x286510u, 0x286518u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x286518u;
label_286518:
    ...
    ctx->pc = 0x286528u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x286524u;
    // 0x286528: 0x260302d  daddu       $a2, $s3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 19) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2857E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2857E8u, 0x286524u, 0x28652Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28652Cu;
label_28652c:
...
label_286564:
    ...
    ctx->pc = 0x286578u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x286574u;
    // 0x286578: 0x260302d  daddu       $a2, $s3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 19) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x285BE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x285BE8u, 0x286574u, 0x28657Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28657Cu;
label_28657c:
...
label_286588:
    ...
    ctx->pc = 0x2865B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2865B4u;
    // 0x2865b8: 0x240382d  daddu       $a3, $s2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2863A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2863A8u, 0x2865B4u, 0x2865BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2865BCu;
label_2865bc:
...
label_2865cc:
    ...
    ctx->pc = 0x2865E4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2865E0u;
    // 0x2865e4: 0x8fa40008  lw          $a0, 0x8($sp) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 29), 8)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2868D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2868D8u, 0x2865E0u, 0x2865E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2865E8u;
label_2865e8:
...
label_2865ec:
    ...
    ctx->pc = 0x286620u;
    {
        ...
        ctx->pc = 0x286624u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x286620u;
        // 0x286624: 0x27bd00b0  addiu       $sp, $sp, 0xB0 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 176));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x286620u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
