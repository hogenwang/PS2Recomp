...
void sub_001B7C70_0x1b7c70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B7C70u;
    {
        ...
        ctx->pc = 0x1B7C74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7C70u;
...
label_1b7c78:
    ...
    ctx->pc = 0x1B7C8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7C88u;
    ...
    if (runtime->hasFunction(0x1BEE00u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7C90u; }
        if (ctx->pc != 0x1B7C90u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7cb8:
    ...
    ctx->pc = 0x1B7CD0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7CCCu;
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7CD4u; }
        if (ctx->pc != 0x1B7CD4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7cd4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7CD8u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B7D00u;
    if (runtime->hasFunction(0x1B7D00u)) {
        auto targetFn = runtime->lookupFunction(0x1B7D00u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7CE0u; }
        if (ctx->pc != 0x1B7CE0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B7D00_0x1b7d00(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7CE0u; }
        if (ctx->pc != 0x1B7CE0u) { return; }
    }
    ctx->pc = 0x1B7CE0u;
label_1b7ce0:
    ...
    ctx->pc = 0x1B7CE4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7CE0u;
    ...
    if (runtime->hasFunction(0x1B8168u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7CE8u; }
        if (ctx->pc != 0x1B7CE8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7ce8:
    ...
    ctx->pc = 0x1B7CF8u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1B7CFCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7CF8u;
