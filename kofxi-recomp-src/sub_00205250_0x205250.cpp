...
void sub_00205250_0x205250(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x203A70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x203A70u, 0x205288u, 0x205290u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x205290u;
label_205290:
    ...
    ctx->pc = 0x2052B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2052B4u;
    // 0x2052b8: 0x24450001  addiu       $a1, $v0, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 2), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x205130u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x205130u, 0x2052B4u, 0x2052BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2052BCu;
label_2052bc:
    ...
    ctx->pc = 0x2052D4u;
    {
        ...
        ctx->pc = 0x2052D8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2052D4u;
        // 0x2052d8: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2052D4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2052dcu;
    // NOP
    if (ctx->pc == 0x2052dcu) { ctx->pc = 0x2052e0u; }
}
