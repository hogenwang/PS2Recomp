...
label_29c52c:
    ...
    ctx->pc = 0x29C528u;
    {
        ...
        ctx->pc = 0x29C52Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C528u;
            // 0x29c52c: 0x8e13001c  lw          $s3, 0x1C($s0) (Delay Slot)
        SET_GPR_S32(ctx, 19, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 28)));
...
label_29c540:
    ...
    ctx->pc = 0x29C53Cu;
    {
        ...
        ctx->pc = 0x29C540u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C53Cu;
            // 0x29c540: 0x24140001  addiu       $s4, $zero, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 20, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
        ctx->in_delay_slot = false;
...
label_29c5b8:
    ...
    ctx->pc = 0x29C5B4u;
    {
        ...
        ctx->pc = 0x29C5B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C5B4u;
            // 0x29c5b8: 0x3225000f  andi        $a1, $s1, 0xF (Delay Slot)
        SET_GPR_U64(ctx, 5, GPR_U64(ctx, 17) & (uint64_t)(uint16_t)15);
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x29C5BCu; }
            if (ctx->pc != 0x29C5BCu) { return; }
        }
        }
    }
    ctx->pc = 0x29C5BCu;
...
label_29c5c4:
    ...
    ctx->pc = 0x29C5C0u;
    {
        ...
        ctx->pc = 0x29C5C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C5C0u;
            // 0x29c5c4: 0x80102d  daddu       $v0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_29c5e8:
    ...
    ctx->pc = 0x29C5E4u;
    {
        ...
        ctx->pc = 0x29C5E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29C5E4u;
            // 0x29c5e8: 0x26060048  addiu       $a2, $s0, 0x48 (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 16), 72));
        ctx->in_delay_slot = false;
...
label_29c608:
    ...
    ctx->pc = 0x29C604u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x29C60Cu; }
            if (ctx->pc != 0x29C60Cu) { return; }
        }
        }
    }
    ctx->pc = 0x29C60Cu;
...
label_29c614:
    ...
    ctx->pc = 0x29C610u;
    {
        ...
        if (branch_taken_0x29c610) {
            ctx->pc = 0x29C614u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x29C610u;
            // 0x29c614: 0x8e030020  lw          $v1, 0x20($s0) (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 32)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x29C548u;
