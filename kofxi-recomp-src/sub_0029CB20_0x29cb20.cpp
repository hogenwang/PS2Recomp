...
void sub_0029CB20_0x29cb20(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29CB2Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29CB28u;
    ...
    if (runtime->hasFunction(0x2A2FD8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x29CB30u; }
        if (ctx->pc != 0x29CB30u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29cb30:
    ...
    ctx->pc = 0x29CB34u;
    {
        ...
        ctx->pc = 0x29CB38u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29CB34u;
    ...
    ctx->pc = 0x29CB50u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29CB4Cu;
    ...
    if (runtime->hasFunction(0x295920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29CB54u; }
        if (ctx->pc != 0x29CB54u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29cb74:
    ...
    ctx->pc = 0x29CB78u;
    {
        ...
        ctx->pc = 0x29CB7Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29CB78u;
...
label_29cb80:
    ...
    ctx->pc = 0x29CB94u;
    ctx->pc = 0x29CB98u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29CB94u;
