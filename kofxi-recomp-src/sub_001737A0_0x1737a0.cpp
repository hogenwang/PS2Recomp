...
label_173880:
    ...
    ctx->pc = 0x173880u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x173880u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x17388cu;
    // NOP
    if (ctx->pc == 0x17388cu) { ctx->pc = 0x173890u; }
}
