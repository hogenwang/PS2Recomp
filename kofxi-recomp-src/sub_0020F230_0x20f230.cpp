...
void sub_0020F230_0x20f230(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20F250u;
    {
        ...
        ctx->pc = 0x20F254u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20F250u;
...
label_20f264:
    ...
    ctx->pc = 0x20F28Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20F288u;
    ...
    if (runtime->hasFunction(0x225F58u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x20F290u; }
        if (ctx->pc != 0x20F290u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_20f290:
    ...
    ctx->pc = 0x20F29Cu;
    {
        ...
        ctx->pc = 0x20F2A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20F29Cu;
