...
void sub_001B30E0_0x1b30e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B30F8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B30F4u;
            // 0x1b30f8: 0x3a0282d  daddu       $a1, $sp, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x10CB70u;
    if (runtime->hasFunction(0x10CB70u)) {
        auto targetFn = runtime->lookupFunction(0x10CB70u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B30FCu; }
        if (ctx->pc != 0x1B30FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010CB70_0x10cb70(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B30FCu; }
        if (ctx->pc != 0x1B30FCu) { return; }
    }
    ctx->pc = 0x1B30FCu;
label_1b30fc:
    ...
    ctx->pc = 0x1B3110u;
    {
        ...
        ctx->pc = 0x1B3114u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B3110u;
...
label_1b3118:
    ...
    ctx->pc = 0x10DB28u;
    if (runtime->hasFunction(0x10DB28u)) {
        auto targetFn = runtime->lookupFunction(0x10DB28u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B3120u; }
        if (ctx->pc != 0x1B3120u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        kofxiThreadRequestControlHelpers_0x10db28(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B3120u; }
        if (ctx->pc != 0x1B3120u) { return; }
    }
    ctx->pc = 0x1B3120u;
...
label_1b3124:
    ...
    ctx->pc = 0x1B3128u;
    {
        ...
        ctx->pc = 0x1B312Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B3128u;
