...
void sub_002BFFF8_0x2bfff8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2C0004u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C0000u;
    ...
    if (runtime->hasFunction(0x297358u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C0008u; }
        if (ctx->pc != 0x2C0008u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c0008:
    ...
    ctx->pc = 0x2C000Cu;
    {
        ...
        ctx->pc = 0x2C0010u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C000Cu;
...
label_2c0018:
    ...
    ctx->pc = 0x2C0024u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C0020u;
    ...
    if (runtime->hasFunction(0x297448u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C0028u; }
        if (ctx->pc != 0x2C0028u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c0028:
    ...
    ctx->pc = 0x2C002Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2C0030u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C002Cu;
...
label_2c004c:
    ...
    ctx->pc = 0x2C0050u;
    {
        ...
        ctx->pc = 0x2C0054u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C0050u;
    ...
    ctx->pc = 0x2C006Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C0068u;
    ...
    if (runtime->hasFunction(0x295920u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C0070u; }
        if (ctx->pc != 0x2C0070u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c0074:
    ...
    ctx->pc = 0x2C007Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2C0080u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C007Cu;
