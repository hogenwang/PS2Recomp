...
label_25e088:
    ...
    ctx->pc = 0x25E088u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E084u;
            // 0x25e088: 0xafa00000  sw          $zero, 0x0($sp) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 29), 0), GPR_U32(ctx, 0));
    ...
    if (runtime->hasFunction(0x25CA38u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E08Cu; }
        if (ctx->pc != 0x25E08Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e094:
    ...
    ctx->pc = 0x25E090u;
    {
        ...
        ctx->pc = 0x25E094u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E090u;
            // 0x25e094: 0x2402ffff  addiu       $v0, $zero, -0x1 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 4294967295));
        ctx->in_delay_slot = false;
...
label_25e09c:
    ...
    ctx->pc = 0x25E09Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E098u;
            // 0x25e09c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x230328u;
    if (runtime->hasFunction(0x230328u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E0A0u; }
        if (ctx->pc != 0x25E0A0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e0a8:
    ...
    ctx->pc = 0x25E0A4u;
    {
        ...
        ctx->pc = 0x25E0A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E0A4u;
            // 0x25e0a8: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_25e0d8:
    ...
    ctx->pc = 0x25E0D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E0D4u;
            // 0x25e0d8: 0x3a0382d  daddu       $a3, $sp, $zero (Delay Slot)
        SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x22FE08u;
    if (runtime->hasFunction(0x22FE08u)) {
        auto targetFn = runtime->lookupFunction(0x22FE08u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E0DCu; }
        if (ctx->pc != 0x25E0DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0022FE08_0x22fe08(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E0DCu; }
        if (ctx->pc != 0x25E0DCu) { return; }
    }
    ctx->pc = 0x25E0DCu;
...
label_25e108:
    ...
    ctx->pc = 0x25E104u;
    {
        ...
        ctx->pc = 0x25E108u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E104u;
            // 0x25e108: 0x982d  daddu       $s3, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 19, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_25e12c:
    ...
    ctx->pc = 0x25E12Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E128u;
            // 0x25e12c: 0x2308821  addu        $s1, $s1, $s0 (Delay Slot)
        SET_GPR_S32(ctx, 17, (int32_t)ADD32(GPR_U32(ctx, 17), GPR_U32(ctx, 16)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x22D3E0u;
    if (runtime->hasFunction(0x22D3E0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E130u; }
        if (ctx->pc != 0x25E130u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e138:
    ...
    ctx->pc = 0x25E138u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E134u;
            // 0x25e138: 0x8fb00000  lw          $s0, 0x0($sp) (Delay Slot)
        SET_GPR_S32(ctx, 16, (int32_t)READ32(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x231A08u;
    if (runtime->hasFunction(0x231A08u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E13Cu; }
        if (ctx->pc != 0x25E13Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e14c:
    ...
    ctx->pc = 0x25E148u;
    {
        ...
        ctx->pc = 0x25E14Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E148u;
            // 0x25e14c: 0x30a20001  andi        $v0, $a1, 0x1 (Delay Slot)
        SET_GPR_U64(ctx, 2, GPR_U64(ctx, 5) & (uint64_t)(uint16_t)1);
        ctx->in_delay_slot = false;
...
label_25e160:
    ...
    if (runtime->hasFunction(0x22A758u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E164u; }
        if (ctx->pc != 0x25E164u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e180:
    ...
    ctx->pc = 0x25E17Cu;
    {
        ...
        ctx->pc = 0x25E180u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E17Cu;
            // 0x25e180: 0x30a20008  andi        $v0, $a1, 0x8 (Delay Slot)
        SET_GPR_U64(ctx, 2, GPR_U64(ctx, 5) & (uint64_t)(uint16_t)8);
        ctx->in_delay_slot = false;
...
label_25e198:
    ...
    ctx->pc = 0x25E194u;
    {
        ...
        ctx->pc = 0x25E198u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E194u;
            // 0x25e198: 0xac620034  sw          $v0, 0x34($v1) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 3), 52), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
...
label_25e1a4:
    ...
    ctx->pc = 0x25E1A0u;
    {
        ...
        if (branch_taken_0x25e1a0) {
            ctx->pc = 0x25E1A4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x25E1A0u;
            // 0x25e1a4: 0x8e020024  lw          $v0, 0x24($s0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 36)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x25E1B8u;
...
label_25e1ac:
    ...
    ctx->pc = 0x25E1ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E1A8u;
            // 0x25e1ac: 0x8e040020  lw          $a0, 0x20($s0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 32)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x261580u;
    if (runtime->hasFunction(0x261580u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E1B0u; }
        if (ctx->pc != 0x25E1B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e1b4:
    ...
    ctx->pc = 0x25E1B0u;
    {
        ...
        ctx->pc = 0x25E1B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E1B0u;
            // 0x25e1b4: 0x96020012  lhu         $v0, 0x12($s0) (Delay Slot)
        SET_GPR_U32(ctx, 2, (uint16_t)READ16(ADD32(GPR_U32(ctx, 16), 18)));
        ctx->in_delay_slot = false;
...
label_25e1cc:
    ...
    ctx->pc = 0x25E1C8u;
    {
        ...
        ctx->pc = 0x25E1CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E1C8u;
            // 0x25e1cc: 0x8e060028  lw          $a2, 0x28($s0) (Delay Slot)
        SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 40)));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x25E1D0u; }
            if (ctx->pc != 0x25E1D0u) { return; }
        }
        }
    }
    ctx->pc = 0x25E1D0u;
...
label_25e1d4:
    ...
    ctx->pc = 0x25E1D0u;
    {
        ...
        ctx->pc = 0x25E1D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E1D0u;
            // 0x25e1d4: 0x96020012  lhu         $v0, 0x12($s0) (Delay Slot)
        SET_GPR_U32(ctx, 2, (uint16_t)READ16(ADD32(GPR_U32(ctx, 16), 18)));
        ctx->in_delay_slot = false;
...
label_25e1fc:
    ...
    ctx->pc = 0x25E1FCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E1F8u;
            // 0x25e1fc: 0xafa20000  sw          $v0, 0x0($sp) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 29), 0), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
    ctx->pc = 0x261580u;
    if (runtime->hasFunction(0x261580u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E200u; }
        if (ctx->pc != 0x25E200u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00261580_0x261580(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E200u; }
...
label_25e204:
    ...
    if (runtime->hasFunction(0x231A60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E208u; }
        if (ctx->pc != 0x25E208u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e210:
    ...
    ctx->pc = 0x25E20Cu;
    {
        ...
        ctx->pc = 0x25E210u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25E20Cu;
            // 0x25e210: 0x80282d  daddu       $a1, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_25e224:
    ...
    ctx->pc = 0x25E220u;
    {
        ...
        if (branch_taken_0x25e220) {
            ctx->pc = 0x25E224u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x25E220u;
            // 0x25e224: 0xaef30000  sw          $s3, 0x0($s7) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 23), 0), GPR_U32(ctx, 19));
        ctx->in_delay_slot = false;
            ctx->pc = 0x25E228u;
...
label_25e234:
    ...
    if (runtime->hasFunction(0x22A658u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E238u; }
        if (ctx->pc != 0x25E238u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e23c:
    ...
    ctx->pc = 0x25E23Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E238u;
            // 0x25e23c: 0x2a0202d  daddu       $a0, $s5, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 21) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x25CEB0u;
    if (runtime->hasFunction(0x25CEB0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E240u; }
        if (ctx->pc != 0x25E240u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25e248:
    ...
    ctx->pc = 0x25E248u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x25E244u;
            // 0x25e248: 0x2c0282d  daddu       $a1, $s6, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 22) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x25CB68u;
    if (runtime->hasFunction(0x25CB68u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x25E24Cu; }
        if (ctx->pc != 0x25E24Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
