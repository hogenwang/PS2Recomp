...
void sub_001ED998_0x1ed998(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1ED9A4u;
    // 0x1ed9a8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ECA08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ECA08u, 0x1ED9A4u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1ED9ACu;
    // 0x1ed9ac: 0x0  nop
    ctx->pc = 0x1ed9acu;
    // NOP
    if (ctx->pc == 0x1ed9acu) { ctx->pc = 0x1ed9b0u; }
}
