...
void sub_001E12B0_0x1e12b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E12D0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E12CCu;
    ...
    if (runtime->hasFunction(0x1E0780u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E12D4u; }
        if (ctx->pc != 0x1E12D4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e12d4:
    ...
    ctx->pc = 0x1E12E0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E12DCu;
            // 0x1e12e0: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E5A50u;
    if (runtime->hasFunction(0x1E5A50u)) {
        auto targetFn = runtime->lookupFunction(0x1E5A50u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E12E4u; }
        if (ctx->pc != 0x1E12E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E5A50_0x1e5a50(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E12E4u; }
        if (ctx->pc != 0x1E12E4u) { return; }
    }
    ctx->pc = 0x1E12E4u;
label_1e12e4:
    ...
    ctx->pc = 0x1DE140u;
    if (runtime->hasFunction(0x1DE140u)) {
        auto targetFn = runtime->lookupFunction(0x1DE140u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001DE140_0x1de140(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E12F8u; }
        if (ctx->pc != 0x1E12F8u) { return; }
    }
    ctx->pc = 0x1E12F8u;
...
label_1e1320:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1324u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6678u;
    if (runtime->hasFunction(0x1E6678u)) {
        auto targetFn = runtime->lookupFunction(0x1E6678u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001E6678_0x1e6678(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E132Cu; }
        if (ctx->pc != 0x1E132Cu) { return; }
    }
    ctx->pc = 0x1E132Cu;
label_1e132c:
    ...
    if (runtime->hasFunction(0x1E6678u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1338u; }
        if (ctx->pc != 0x1E1338u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6678_0x1e6678(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1338u; }
...
label_1e1338:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1338u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E4730u;
    if (runtime->hasFunction(0x1E4730u)) {
        auto targetFn = runtime->lookupFunction(0x1E4730u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1340u; }
        if (ctx->pc != 0x1E1340u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E4730_0x1e4730(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1340u; }
        if (ctx->pc != 0x1E1340u) { return; }
    }
    ctx->pc = 0x1E1340u;
label_1e1340:
    ...
    ctx->pc = 0x1E1344u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1340u;
    ...
    if (runtime->hasFunction(0x1E46B0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1348u; }
        if (ctx->pc != 0x1E1348u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e1348:
    ...
    ctx->pc = 0x1E1348u;
    {
        ...
        ctx->pc = 0x1E134Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1348u;
...
label_1e1370:
    ...
    if (runtime->hasFunction(0x1E4710u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1378u; }
        if (ctx->pc != 0x1E1378u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e1378:
    ...
    ctx->pc = 0x1E137Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1378u;
    ...
    if (runtime->hasFunction(0x1E0020u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1380u; }
        if (ctx->pc != 0x1E1380u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e1380:
    ...
    ctx->pc = 0x1E1384u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1380u;
            // 0x1e1384: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E13F0u;
    if (runtime->hasFunction(0x1E13F0u)) {
        auto targetFn = runtime->lookupFunction(0x1E13F0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1388u; }
        if (ctx->pc != 0x1E1388u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E13F0_0x1e13f0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1388u; }
        if (ctx->pc != 0x1E1388u) { return; }
    }
    ctx->pc = 0x1E1388u;
label_1e1388:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1388u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E1130u;
    if (runtime->hasFunction(0x1E1130u)) {
        auto targetFn = runtime->lookupFunction(0x1E1130u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001E1130_0x1e1130(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1390u; }
        if (ctx->pc != 0x1E1390u) { return; }
    }
    ctx->pc = 0x1E1390u;
label_1e1390:
    ...
    ctx->pc = 0x1E1398u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1394u;
            // 0x1e1398: 0x82050072  lb          $a1, 0x72($s0) (Delay Slot)
        SET_GPR_S32(ctx, 5, (int8_t)READ8(ADD32(GPR_U32(ctx, 16), 114)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E1860u;
    if (runtime->hasFunction(0x1E1860u)) {
        auto targetFn = runtime->lookupFunction(0x1E1860u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E139Cu; }
        if (ctx->pc != 0x1E139Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E1860_0x1e1860(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E139Cu; }
        if (ctx->pc != 0x1E139Cu) { return; }
    }
    ctx->pc = 0x1E139Cu;
label_1e139c:
    ...
    ctx->pc = 0x1E13A4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E13A0u;
            // 0x1e13a4: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E63A8u;
    if (runtime->hasFunction(0x1E63A8u)) {
        auto targetFn = runtime->lookupFunction(0x1E63A8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E13A8u; }
        if (ctx->pc != 0x1E13A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E63A8_0x1e63a8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E13A8u; }
        if (ctx->pc != 0x1E13A8u) { return; }
    }
    ctx->pc = 0x1E13A8u;
...
label_1e13b4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E13B4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1E6230u;
    if (runtime->hasFunction(0x1E6230u)) {
        auto targetFn = runtime->lookupFunction(0x1E6230u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001E6230_0x1e6230(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E13BCu; }
        if (ctx->pc != 0x1E13BCu) { return; }
    }
    ctx->pc = 0x1E13BCu;
label_1e13bc:
    ...
    ctx->pc = 0x1E13C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E13BCu;
    ...
    if (runtime->hasFunction(0x1E6230u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E13C4u; }
        if (ctx->pc != 0x1E13C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001E6230_0x1e6230(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E13C4u; }
...
label_1e13c4:
    ...
    ctx->pc = 0x1E13E8u;
    {
        ...
        ctx->pc = 0x1E13ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E13E8u;
