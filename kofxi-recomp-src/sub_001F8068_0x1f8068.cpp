...
label_1f80b0:
    ...
    ctx->pc = 0x1F80ACu;
    {
        ...
        ctx->pc = 0x1F80B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F80ACu;
            // 0x1f80b0: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x1F80B4u; }
            if (ctx->pc != 0x1F80B4u) { return; }
        }
        }
    }
    ctx->pc = 0x1F80B4u;
...
label_1f80d0:
    ...
    ctx->pc = 0x1F80CCu;
    {
        ...
        if (branch_taken_0x1f80cc) {
            ctx->pc = 0x1F80D0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1F80CCu;
            // 0x1f80d0: 0x1cd  break       0, 7 (Delay Slot)
        runtime->handleBreak(rdram, ctx);
        ctx->in_delay_slot = false;
            ctx->pc = 0x1F80D4u;
...
label_1f80f4:
    ...
    if (runtime->hasFunction(0x1FB008u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F80F8u; }
        if (ctx->pc != 0x1F80F8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f8100:
    ...
    ctx->pc = 0x1F80FCu;
    {
        ...
        ctx->pc = 0x1F8100u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F80FCu;
            // 0x1f8100: 0x102d  daddu       $v0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_1f811c:
    ...
    ctx->pc = 0x1F8118u;
    {
        ...
        ctx->pc = 0x1F811Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F8118u;
            // 0x1f811c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
