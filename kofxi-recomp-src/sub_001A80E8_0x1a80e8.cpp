...
void sub_001A80E8_0x1a80e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1A80F0u;
    // 0x1a80f4: 0x24040001  addiu       $a0, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1A9008u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1A9008u, 0x1A80F0u, 0x1A80F8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A80F8u;
label_1a80f8:
    ...
    ctx->pc = 0x1A80FCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A80FCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a8104u;
    // NOP
    if (ctx->pc == 0x1a8104u) { ctx->pc = 0x1a8108u; }
}
