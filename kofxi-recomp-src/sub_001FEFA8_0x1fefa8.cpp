...
void sub_001FEFA8_0x1fefa8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1FEFF0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1FEFBCu; }
        if (ctx->pc != 0x1FEFBCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1fefbc:
    ...
    ctx->pc = 0x1FEFBCu;
    {
        ...
        ctx->pc = 0x1FEFC0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FEFBCu;
    ...
    ctx->pc = 0x1FEFC8u;
    {
        ...
        ctx->pc = 0x1FEFCCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FEFC8u;
...
label_1fefdc:
    ...
    ctx->pc = 0x1FEFE4u;
    {
        ...
        ctx->pc = 0x1FEFE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1FEFE4u;
