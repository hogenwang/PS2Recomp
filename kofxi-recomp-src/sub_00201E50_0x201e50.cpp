...
void sub_00201E50_0x201e50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x201E5Cu;
    ctx->pc = 0x201E60u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x201E5Cu;
...
label_201e68:
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x201E8Cu; }
        if (ctx->pc != 0x201E8Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_201e8c:
    ...
    ctx->pc = 0x2027C8u;
    {
        auto targetFn = runtime->lookupFunction(0x2027C8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
