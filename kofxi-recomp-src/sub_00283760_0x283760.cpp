...
void sub_00283760_0x283760(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x283784u;
    {
        ...
        if (branch_taken_0x283784) {
            ctx->pc = 0x283788u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x283784u;
    ...
    ctx->pc = 0x283794u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x283790u;
            // 0x283794: 0x52840  sll         $a1, $a1, 1 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)SLL32(GPR_U32(ctx, 5), 1));
        ctx->in_delay_slot = false;
    ctx->pc = 0x283850u;
    if (runtime->hasFunction(0x283850u)) {
        auto targetFn = runtime->lookupFunction(0x283850u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x283798u; }
        if (ctx->pc != 0x283798u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00283850_0x283850(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x283798u; }
        if (ctx->pc != 0x283798u) { return; }
    }
    ctx->pc = 0x283798u;
label_283798:
    ...
    ctx->pc = 0x283798u;
    {
        ...
        ctx->pc = 0x28379Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x283798u;
