...
void sub_00201A48_0x201a48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1CD038u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x201A98u; }
        if (ctx->pc != 0x201A98u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_201a98:
    ...
    ctx->pc = 0x201AA0u;
    {
        ...
        ctx->pc = 0x201AA4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201AA0u;
    ...
    ctx->pc = 0x201F98u;
    if (runtime->hasFunction(0x201F98u)) {
        auto targetFn = runtime->lookupFunction(0x201F98u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x201AB0u; }
        if (ctx->pc != 0x201AB0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00201F98_0x201f98(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x201AB0u; }
        if (ctx->pc != 0x201AB0u) { return; }
    }
    ctx->pc = 0x201AB0u;
label_201ab0:
    ...
    ctx->pc = 0x201AB0u;
    {
        ...
        ctx->pc = 0x201AB4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201AB0u;
...
label_201ab8:
    ...
    ctx->pc = 0x201AC0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x201ABCu;
    ...
    if (runtime->hasFunction(0x201F98u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x201AC4u; }
        if (ctx->pc != 0x201AC4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00201F98_0x201f98(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x201AC4u; }
...
label_201ac8:
    ...
    ctx->pc = 0x201AD8u;
    {
        ...
        ctx->pc = 0x201ADCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x201AD8u;
