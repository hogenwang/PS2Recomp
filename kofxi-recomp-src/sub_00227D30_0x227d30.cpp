...
void sub_00227D30_0x227d30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x227D10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x227D10u, 0x227D38u, 0x227D40u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x227D40u;
label_227d40:
...
label_227d64:
    ...
    ctx->pc = 0x227D6Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x227D6Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x227d74u;
    // NOP
    if (ctx->pc == 0x227d74u) { ctx->pc = 0x227d78u; }
}
