...
void sub_00171CB0_0x171cb0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x171CD0u;
    {
        ...
        ctx->pc = 0x171CD4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x171CD0u;
...
label_171cfc:
    ...
    ctx->pc = 0x171CFCu;
    {
        ...
        ctx->pc = 0x171D00u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x171CFCu;
...
label_171d04:
    ...
    ctx->pc = 0x171D04u;
    {
        ...
        ctx->pc = 0x171D08u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x171D04u;
...
label_171d0c:
    ...
    ctx->pc = 0x171D0Cu;
    {
        ...
        ctx->pc = 0x171D10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x171D0Cu;
