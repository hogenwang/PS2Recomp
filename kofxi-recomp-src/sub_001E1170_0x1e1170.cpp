...
void sub_001E1170_0x1e1170(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F8C18u;
    if (runtime->hasFunction(0x1F8C18u)) {
        auto targetFn = runtime->lookupFunction(0x1F8C18u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001F8C18_0x1f8c18(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1180u; }
        if (ctx->pc != 0x1E1180u) { return; }
    }
    ctx->pc = 0x1E1180u;
label_1e1180:
    ...
    if (runtime->hasFunction(0x1E0CA0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1190u; }
        if (ctx->pc != 0x1E1190u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e11b0:
    ...
    ctx->pc = 0x1E11D8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E11D4u;
    ...
    if (runtime->hasFunction(0x1F9478u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E11DCu; }
        if (ctx->pc != 0x1E11DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e11dc:
    ...
    ctx->pc = 0x1E1204u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E1208u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1204u;
...
label_1e1210:
    ...
    ctx->pc = 0x1E1218u;
    {
        ...
        ctx->pc = 0x1E121Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1218u;
    ...
    ctx->pc = 0x1E1224u;
    ctx->pc = 0x1E1228u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1224u;
...
label_1e1230:
    ...
    ctx->pc = 0x1E1234u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E1238u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1234u;
...
label_1e1240:
    ...
    ctx->pc = 0x1F70B0u;
    if (runtime->hasFunction(0x1F70B0u)) {
        auto targetFn = runtime->lookupFunction(0x1F70B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001F70B0_0x1f70b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E1260u; }
        if (ctx->pc != 0x1E1260u) { return; }
    }
    ctx->pc = 0x1E1260u;
label_1e1260:
    ...
    ctx->pc = 0x1E1280u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E127Cu;
...
label_1e128c:
    ...
    ctx->pc = 0x1E1290u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E1294u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E1290u;
...
label_1e1298:
    ...
    ctx->pc = 0x1E12A8u;
    ctx->pc = 0x1E12ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E12A8u;
