...
void sub_00336D00_0x336d00(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x336D18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x336D14u;
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x336D1Cu; }
        if (ctx->pc != 0x336D1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_336d1c:
    ...
    ctx->pc = 0x336D48u;
    {
        ...
        ctx->pc = 0x336D4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x336D48u;
