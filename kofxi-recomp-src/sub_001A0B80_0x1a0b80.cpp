...
void sub_001A0B80_0x1a0b80(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1A0BB4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A0BB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a0bbcu;
    // NOP
    if (ctx->pc == 0x1a0bbcu) { ctx->pc = 0x1a0bc0u; }
}
