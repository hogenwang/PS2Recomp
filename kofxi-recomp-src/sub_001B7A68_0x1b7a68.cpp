...
void sub_001B7A68_0x1b7a68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B7A68u;
    {
        ...
        ctx->pc = 0x1B7A6Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7A68u;
...
label_1b7a70:
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7A84u; }
        if (ctx->pc != 0x1B7A84u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7a84:
    ...
    ctx->pc = 0x1B7A88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7A84u;
    ...
    if (runtime->hasFunction(0x1B7AA8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7A8Cu; }
        if (ctx->pc != 0x1B7A8Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7a8c:
    ...
    ctx->pc = 0x1B7A90u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7A8Cu;
    ...
    if (runtime->hasFunction(0x1B8168u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7A94u; }
        if (ctx->pc != 0x1B7A94u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
