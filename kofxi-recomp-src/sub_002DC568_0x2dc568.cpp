...
void sub_002DC568_0x2dc568(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2DC5BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC5B8u;
    ...
    if (runtime->hasFunction(0x2D8FC0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC5C0u; }
        if (ctx->pc != 0x2DC5C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc5c0:
    ...
    ctx->pc = 0x3560ADCu;
    {
        auto targetFn = runtime->lookupFunction(0x3560ADCu);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
...
label_2dc5f4:
    ...
    ctx->pc = 0x2DC5FCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC5F8u;
    ...
    if (runtime->hasFunction(0x2DD4D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC600u; }
        if (ctx->pc != 0x2DC600u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc600:
    ...
    ctx->pc = 0x2DC614u;
    {
        ...
        ctx->pc = 0x2DC618u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC614u;
    ...
    ctx->pc = 0x2DC61Cu;
    {
        ...
        ctx->pc = 0x2DC620u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC61Cu;
    ...
    ctx->pc = 0x2DC62Cu;
    {
        ...
        ctx->pc = 0x2DC630u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC62Cu;
...
label_2dc660:
    ...
    ctx->pc = 0x2DC664u;
    {
        ...
        ctx->pc = 0x2DC668u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC664u;
    ...
    ctx->pc = 0x2DC678u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC674u;
    ...
    if (runtime->hasFunction(0x2E3988u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC67Cu; }
        if (ctx->pc != 0x2DC67Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc67c:
    ...
    ctx->pc = 0x2DC68Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC688u;
            // 0x2dc68c: 0x8dbb56d7  lw          $k1, 0x56D7($t5) (Delay Slot)
        SET_GPR_S32(ctx, 27, (int32_t)READ32(ADD32(GPR_U32(ctx, 13), 22231)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x91A2FD4u;
    {
        auto targetFn = runtime->lookupFunction(0x91A2FD4u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC690u; }
        if (ctx->pc != 0x2DC690u) { return; }
    }
    ctx->pc = 0x2DC690u;
label_2dc690:
    ...
    ctx->pc = 0x2DC6B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC6B0u;
    ...
    if (runtime->hasFunction(0x2DF1D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC6B8u; }
        if (ctx->pc != 0x2DC6B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2dc6b8:
    ...
    ctx->pc = 0x8181FD0u;
    {
        auto targetFn = runtime->lookupFunction(0x8181FD0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_2dc704:
    ...
    ctx->pc = 0x2DC714u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC710u;
            // 0x2dc714: 0xa2776291  sb          $s7, 0x6291($s3) (Delay Slot)
        WRITE8(ADD32(GPR_U32(ctx, 19), 25233), (uint8_t)GPR_U32(ctx, 23));
        ctx->in_delay_slot = false;
    ctx->pc = 0x3D40A74u;
    {
        auto targetFn = runtime->lookupFunction(0x3D40A74u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DC718u; }
        if (ctx->pc != 0x2DC718u) { return; }
    }
    ctx->pc = 0x2DC718u;
label_2dc718:
...
label_2dc754:
    ...
    ctx->pc = 0x2DC778u;
    {
        ...
        ctx->pc = 0x2DC77Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2DC778u;
