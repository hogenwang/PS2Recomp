...
void sub_0015EFF0_0x15eff0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x15F008u;
    {
        ...
        ctx->pc = 0x15F00Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x15F008u;
    ...
    ctx->pc = 0x15F01Cu;
    {
        ...
        if (branch_taken_0x15f01c) {
            ctx->pc = 0x15F020u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x15F01Cu;
    ...
    ctx->pc = 0x15F050u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x15F04Cu;
            // 0x15f050: 0xac820008  sw          $v0, 0x8($a0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 4), 8), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
    ctx->pc = 0x15ED20u;
    if (runtime->hasFunction(0x15ED20u)) {
        auto targetFn = runtime->lookupFunction(0x15ED20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x15F054u; }
        if (ctx->pc != 0x15F054u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0015ED20_0x15ed20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x15F054u; }
        if (ctx->pc != 0x15F054u) { return; }
    }
    ctx->pc = 0x15F054u;
...
label_15f060:
    ...
    ctx->pc = 0x15F064u;
    {
        ...
        ctx->pc = 0x15F068u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x15F064u;
