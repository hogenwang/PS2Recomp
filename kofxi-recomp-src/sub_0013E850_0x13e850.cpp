...
void sub_0013E850_0x13e850(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x13E864u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13E860u;
    ...
    if (runtime->hasFunction(0x18A8C0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E868u; }
        if (ctx->pc != 0x13E868u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_13e868:
    ...
    ctx->pc = 0x13E878u;
    {
        ...
        ctx->pc = 0x13E87Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13E878u;
...
label_13e880:
    ...
    ctx->pc = 0x13E884u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x13E880u;
    ...
    if (runtime->hasFunction(0x18A8C0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E888u; }
        if (ctx->pc != 0x13E888u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0018A8C0_0x18a8c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x13E888u; }
...
label_13e894:
    ...
    ctx->pc = 0x13E89Cu;
    {
        ...
        ctx->pc = 0x13E8A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x13E89Cu;
