...
label_1b7fc8:
    ...
    ctx->pc = 0x1B7FD8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7FD4u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7FDCu; }
        if (ctx->pc != 0x1B7FDCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b7fdc:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7FDCu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1B8000u;
    if (runtime->hasFunction(0x1B8000u)) {
        auto targetFn = runtime->lookupFunction(0x1B8000u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001B8000_0x1b8000(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B7FE4u; }
        if (ctx->pc != 0x1B7FE4u) { return; }
    }
    ctx->pc = 0x1B7FE4u;
label_1b7fe4:
    ...
    ctx->pc = 0x1B7FE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B7FE4u;
