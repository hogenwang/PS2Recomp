...
label_2bf3f8:
    ...
    ctx->pc = 0x2BF3F8u;
    {
        ...
        ctx->pc = 0x2BF3FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF3F8u;
...
label_2bf400:
    ...
    ctx->pc = 0x2BF404u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF400u;
    ...
    if (runtime->hasFunction(0x2C4CA8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF408u; }
        if (ctx->pc != 0x2BF408u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf408:
    ...
    ctx->pc = 0x2BF40Cu;
    {
        ...
        ctx->pc = 0x2BF410u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF40Cu;
