...
void sub_001CDBF0_0x1cdbf0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1CDC00u;
    // 0x1cdc04: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDAB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDAB8u, 0x1CDC00u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1CDC08u;
label_1cdc08:
    ...
    ctx->pc = 0x1CDC1Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1CDC18u;
    // 0x1cdc1c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDAB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDAB8u, 0x1CDC18u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1CDC20u;
}
