...
label_208c2c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x14E3F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x14E3F0u, 0x208C3Cu, 0x208C44u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x208C44u;
label_208c44:
...
label_208c48:
    ...
    ctx->pc = 0x208c5cu;
    // NOP
    if (ctx->pc == 0x208c5cu) { ctx->pc = 0x208c60u; }
}
