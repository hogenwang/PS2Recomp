...
void sub_001B0028_0x1b0028(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1AEC88u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AEC88u, 0x1B0054u, 0x1B005Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B005Cu;
label_1b005c:
    ...
    ctx->pc = 0x1AFE98u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AFE98u, 0x1B005Cu, 0x1B0064u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0064u;
label_1b0064:
    ...
    ctx->pc = 0x1AFF30u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AFF30u, 0x1B0078u, 0x1B0080u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0080u;
label_1b0080:
    ...
    ctx->pc = 0x1B0090u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B008Cu;
    // 0x1b0090: 0x802d  daddu       $s0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B04D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B04D0u, 0x1B008Cu, 0x1B0094u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B0094u;
label_1b0094:
...
label_1b0098:
    ...
    ctx->pc = 0x1B00A8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B00A4u;
    // 0x1b00a8: 0x2408ffff  addiu       $t0, $zero, -0x1 (Delay Slot)
    SET_GPR_S32(ctx, 8, (int32_t)ADD32(GPR_U32(ctx, 0), 4294967295));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AEC88u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AEC88u, 0x1B00A4u, 0x1B00ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B00ACu;
label_1b00ac:
    ...
    ctx->pc = 0x1B00C0u;
    {
        ...
        ctx->pc = 0x1B00C4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B00C0u;
        // 0x1b00c4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B00C0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
