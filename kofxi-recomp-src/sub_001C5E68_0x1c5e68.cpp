...
void sub_001C5E68_0x1c5e68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1C6AB8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C5E7Cu; }
        if (ctx->pc != 0x1C5E7Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c5e7c:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C5E7Cu;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C5E98u;
    if (runtime->hasFunction(0x1C5E98u)) {
        auto targetFn = runtime->lookupFunction(0x1C5E98u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C5E84u; }
        if (ctx->pc != 0x1C5E84u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C5E98_0x1c5e98(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C5E84u; }
        if (ctx->pc != 0x1C5E84u) { return; }
    }
    ctx->pc = 0x1C5E84u;
label_1c5e84:
    ...
    ctx->pc = 0x1C5E8Cu;
    ctx->pc = 0x1C5E90u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C5E8Cu;
