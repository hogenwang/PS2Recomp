...
void sub_003081C0_0x3081c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x3081C8u;
    {
        ...
        ctx->pc = 0x3081CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3081C8u;
...
label_308210:
    ...
    ctx->pc = 0x308224u;
    {
        ...
        ctx->pc = 0x308228u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x308224u;
...
label_308238:
    ...
    ctx->pc = 0x30824Cu;
    {
        ...
        if (branch_taken_0x30824c) {
            ctx->pc = 0x308250u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x30824Cu;
...
label_308258:
    ...
    ctx->pc = 0x30825Cu;
    {
        ...
        ctx->pc = 0x308260u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x30825Cu;
