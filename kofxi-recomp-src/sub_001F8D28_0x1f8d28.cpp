...
void sub_001F8D28_0x1f8d28(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F8D40u;
    {
        ...
        ctx->pc = 0x1F8D44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F8D40u;
    ...
    if (runtime->hasFunction(0x1F8DB0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D50u; }
        if (ctx->pc != 0x1F8D50u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f8d50:
    ...
    ctx->pc = 0x1F8D60u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F8D5Cu;
            // 0x1f8d60: 0xae000048  sw          $zero, 0x48($s0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 16), 72), GPR_U32(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F8D90u;
    if (runtime->hasFunction(0x1F8D90u)) {
        auto targetFn = runtime->lookupFunction(0x1F8D90u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D64u; }
        if (ctx->pc != 0x1F8D64u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F8D90_0x1f8d90(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D64u; }
        if (ctx->pc != 0x1F8D64u) { return; }
    }
    ctx->pc = 0x1F8D64u;
label_1f8d64:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F8D64u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F8E10u;
    if (runtime->hasFunction(0x1F8E10u)) {
        auto targetFn = runtime->lookupFunction(0x1F8E10u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D6Cu; }
        if (ctx->pc != 0x1F8D6Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F8E10_0x1f8e10(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D6Cu; }
        if (ctx->pc != 0x1F8D6Cu) { return; }
    }
    ctx->pc = 0x1F8D6Cu;
label_1f8d6c:
    ...
    ctx->pc = 0x1F8D74u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F8D70u;
    ...
    if (runtime->hasFunction(0x1F8D90u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D78u; }
        if (ctx->pc != 0x1F8D78u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F8D90_0x1f8d90(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F8D78u; }
