...
void sub_001E7A90_0x1e7a90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E0780u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E0780u, 0x1E7AB0u, 0x1E7AB8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E7AB8u;
label_1e7ab8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E7A70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E7A70u, 0x1E7AB8u, 0x1E7AC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E7AC0u;
label_1e7ac0:
...
label_1e7ad0:
    ...
    ctx->pc = 0x1E7ADCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E7AD8u;
    // 0x1e7adc: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5B98u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5B98u, 0x1E7AD8u, 0x1E7AE0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E7AE0u;
label_1e7ae0:
...
label_1e7aec:
    ...
    ctx->pc = 0x1E7AF8u;
    {
        ...
        ctx->pc = 0x1E7AFCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E7AF8u;
        // 0x1e7afc: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E7AF8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
