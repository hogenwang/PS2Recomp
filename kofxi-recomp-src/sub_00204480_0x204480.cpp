...
void sub_00204480_0x204480(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x204480u;
    // 0x204484: 0x24a50010  addiu       $a1, $a1, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20B8E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20B8E0u, 0x204480u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x204488u;
    // 0x204488: 0x0  nop
    ...
    ctx->pc = 0x20448cu;
    // NOP
    if (ctx->pc == 0x20448cu) { ctx->pc = 0x204490u; }
}
