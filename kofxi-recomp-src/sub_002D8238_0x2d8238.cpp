...
void sub_002D8238_0x2d8238(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2D824Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2D8248u;
    // 0x2d824c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2D8488u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2D8488u, 0x2D8248u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2D8250u;
label_2d8250:
    ...
    ctx->pc = 0x2D8254u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2D8254u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2d825cu;
    // NOP
    if (ctx->pc == 0x2d825cu) { ctx->pc = 0x2d8260u; }
}
