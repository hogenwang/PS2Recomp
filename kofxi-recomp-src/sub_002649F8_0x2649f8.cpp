...
void sub_002649F8_0x2649f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x265500u;
    if (runtime->hasFunction(0x265500u)) {
        auto targetFn = runtime->lookupFunction(0x265500u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x264A0Cu; }
        if (ctx->pc != 0x264A0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00265500_0x265500(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x264A0Cu; }
        if (ctx->pc != 0x264A0Cu) { return; }
    }
    ctx->pc = 0x264A0Cu;
...
label_264a1c:
    ...
    ctx->pc = 0x264A1Cu;
    {
        ...
        if (branch_taken_0x264a1c) {
            ctx->pc = 0x264A20u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x264A1Cu;
...
label_264a24:
    ...
    ctx->pc = 0x264A30u;
    {
        ...
        ctx->pc = 0x264A34u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x264A30u;
