...
label_1e1b60:
    ...
    ctx->pc = 0x1E1B80u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1B7Cu;
    // 0x1e1b80: 0xe0902d  daddu       $s2, $a3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E1AC8u, 0x1E1B7Cu, 0x1E1B84u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1B84u;
label_1e1b84:
    ...
    ctx->pc = 0x1E1BA8u;
    {
        ...
        ctx->pc = 0x1E1BACu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E1BA8u;
        // 0x1e1bac: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E1BA8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1e1bb0:
    ...
    ctx->pc = 0x1E1BD8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1BD4u;
    // 0x1e1bd8: 0x27a90008  addiu       $t1, $sp, 0x8 (Delay Slot)
    SET_GPR_S32(ctx, 9, (int32_t)ADD32(GPR_U32(ctx, 29), 8));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B14B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B14B0u, 0x1E1BD4u, 0x1E1BDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1BDCu;
label_1e1bdc:
...
label_1e1c10:
    ...
    ctx->pc = 0x1E6BE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6BE8u, 0x1E1C10u, 0x1E1C18u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1C18u;
label_1e1c18:
    ...
    ctx->pc = 0x1E1C20u;
    {
        ...
        ctx->pc = 0x1E1C24u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E1C20u;
        // 0x1e1c24: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E1C20u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1E1C54u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1C50u;
    // 0x1e1c54: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1297C8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1297C8u, 0x1E1C50u, 0x1E1C58u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1C58u;
label_1e1c58:
    ...
    ctx->pc = 0x1E1C60u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1C5Cu;
    // 0x1e1c60: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E1400u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E1400u, 0x1E1C5Cu, 0x1E1C64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1C64u;
label_1e1c64:
    ...
    ctx->pc = 0x1E1C6Cu;
    {
        ...
        ctx->pc = 0x1E1C70u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1E1C6Cu;
        // 0x1e1c70: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E1C6Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1E1CA0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1C9Cu;
    // 0x1e1ca0: 0xe0982d  daddu       $s3, $a3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 19, (uint64_t)GPR_U64(ctx, 7) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2960u, 0x1E1C9Cu, 0x1E1CA4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1CA4u;
label_1e1ca4:
...
label_1e1cf8:
    ...
    ctx->pc = 0x1E1CFCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1CF8u;
    // 0x1e1cfc: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E3388u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E3388u, 0x1E1CF8u, 0x1E1D00u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1D00u;
label_1e1d00:
    ...
    ctx->pc = 0x1E1D08u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1D04u;
    // 0x1e1d08: 0x40282d  daddu       $a1, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E1638u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E1638u, 0x1E1D04u, 0x1E1D0Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1D0Cu;
label_1e1d0c:
    ...
    ctx->pc = 0x1E1D4Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1D48u;
    // 0x1e1d4c: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2960u, 0x1E1D48u, 0x1E1D50u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1D50u;
label_1e1d50:
...
label_1e1d78:
    ...
    ctx->pc = 0x1E1D94u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1D90u;
    // 0x1e1d94: 0x8e04003c  lw          $a0, 0x3C($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 60)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F93D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F93D0u, 0x1E1D90u, 0x1E1D98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1D98u;
label_1e1d98:
    ...
    ctx->pc = 0x1E1D9Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E1D98u;
    // 0x1e1d9c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E79E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E79E0u, 0x1E1D98u, 0x1E1DA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E1DA0u;
label_1e1da0:
...
label_1e1da8:
    ...
    ctx->pc = 0x1E1DB0u;
    {
        ...
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E1DB0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
