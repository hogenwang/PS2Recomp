...
void sub_0032C7D0_0x32c7d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x32C840u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32C83Cu;
    ...
    if (runtime->hasFunction(0x18D430u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C844u; }
        if (ctx->pc != 0x32C844u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_32c844:
    ...
    ctx->pc = 0x32C85Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32C858u;
            // 0x32c85c: 0xa0405d28  sb          $zero, 0x5D28($v0) (Delay Slot)
        WRITE8(ADD32(GPR_U32(ctx, 2), 23848), (uint8_t)GPR_U32(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x32D1E0u;
    if (runtime->hasFunction(0x32D1E0u)) {
        auto targetFn = runtime->lookupFunction(0x32D1E0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C860u; }
        if (ctx->pc != 0x32C860u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0032D1E0_0x32d1e0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C860u; }
        if (ctx->pc != 0x32C860u) { return; }
    }
    ctx->pc = 0x32C860u;
label_32c860:
    ...
    if (runtime->hasFunction(0x18F460u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C868u; }
        if (ctx->pc != 0x32C868u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_32c868:
    ...
    ctx->pc = 0x32C86Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32C868u;
            // 0x32c86c: 0x202d  daddu       $a0, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x18D5A0u;
    if (runtime->hasFunction(0x18D5A0u)) {
        auto targetFn = runtime->lookupFunction(0x18D5A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C870u; }
        if (ctx->pc != 0x32C870u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0018D5A0_0x18d5a0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C870u; }
        if (ctx->pc != 0x32C870u) { return; }
    }
    ctx->pc = 0x32C870u;
label_32c870:
    ...
    ctx->pc = 0x32C874u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x32C870u;
    ...
    if (runtime->hasFunction(0x18D5A0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C878u; }
        if (ctx->pc != 0x32C878u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0018D5A0_0x18d5a0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x32C878u; }
...
label_32c880:
    ...
    ctx->pc = 0x32C884u;
    {
        ...
        ctx->pc = 0x32C888u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x32C884u;
