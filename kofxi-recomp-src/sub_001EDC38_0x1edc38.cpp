...
void sub_001EDC38_0x1edc38(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1EDC38u;
    {
        ...
        ctx->pc = 0x1EDC3Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDC38u;
...
label_1edc40:
    ...
    ctx->pc = 0x1D8678u;
    if (runtime->hasFunction(0x1D8678u)) {
        auto targetFn = runtime->lookupFunction(0x1D8678u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDC50u; }
        if (ctx->pc != 0x1EDC50u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001D8678_0x1d8678(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDC50u; }
        if (ctx->pc != 0x1EDC50u) { return; }
    }
    ctx->pc = 0x1EDC50u;
label_1edc50:
    ...
    ctx->pc = 0x1EDC58u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1EDC5Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDC58u;
...
label_1edc60:
    ...
    ctx->pc = 0x1EDC6Cu;
    ctx->pc = 0x1EDC70u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDC6Cu;
...
label_1edc78:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDC88u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1EEE20u;
    if (runtime->hasFunction(0x1EEE20u)) {
        auto targetFn = runtime->lookupFunction(0x1EEE20u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001EEE20_0x1eee20(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDC90u; }
        if (ctx->pc != 0x1EDC90u) { return; }
    }
    ctx->pc = 0x1EDC90u;
...
label_1edca8:
    ...
    ctx->pc = 0x1EDCF0u;
    if (runtime->hasFunction(0x1EDCF0u)) {
        auto targetFn = runtime->lookupFunction(0x1EDCF0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDCB0u; }
        if (ctx->pc != 0x1EDCB0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001EDCF0_0x1edcf0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDCB0u; }
        if (ctx->pc != 0x1EDCB0u) { return; }
    }
    ctx->pc = 0x1EDCB0u;
label_1edcb0:
    ...
    ctx->pc = 0x1EDCB4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDCB0u;
            // 0x1edcb4: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1EDD18u;
    if (runtime->hasFunction(0x1EDD18u)) {
        auto targetFn = runtime->lookupFunction(0x1EDD18u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDCB8u; }
        if (ctx->pc != 0x1EDCB8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001EDD18_0x1edd18(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDCB8u; }
        if (ctx->pc != 0x1EDCB8u) { return; }
    }
    ctx->pc = 0x1EDCB8u;
label_1edcb8:
    ...
    ctx->pc = 0x1EDCC4u;
    {
        ...
        ctx->pc = 0x1EDCC8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDCC4u;
    ...
    ctx->pc = 0x1EF0C8u;
    if (runtime->hasFunction(0x1EF0C8u)) {
        auto targetFn = runtime->lookupFunction(0x1EF0C8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDCD4u; }
        if (ctx->pc != 0x1EDCD4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001EF0C8_0x1ef0c8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1EDCD4u; }
        if (ctx->pc != 0x1EDCD4u) { return; }
    }
    ctx->pc = 0x1EDCD4u;
...
label_1edcd8:
    ...
    ctx->pc = 0x1EDCE4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1EDCE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1EDCE4u;
