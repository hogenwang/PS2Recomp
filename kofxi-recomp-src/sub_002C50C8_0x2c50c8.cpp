...
void sub_002C50C8_0x2c50c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2C50D4u;
    {
        ...
        ctx->pc = 0x2C50D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C50D4u;
    ...
    ctx->pc = 0x2C50E0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C50DCu;
    ...
    if (runtime->hasFunction(0x2C2820u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C50E4u; }
        if (ctx->pc != 0x2C50E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c50ec:
    ...
    ctx->pc = 0x2C50F8u;
    ctx->pc = 0x2C50FCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C50F8u;
