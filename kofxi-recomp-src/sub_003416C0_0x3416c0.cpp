...
void sub_003416C0_0x3416c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x3416C8u;
    {
        ...
        if (branch_taken_0x3416c8) {
            ctx->pc = 0x3416CCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x3416C8u;
    ...
    ctx->pc = 0x3416DCu;
    {
        ...
        ctx->pc = 0x3416E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3416DCu;
...
label_3416e4:
    ...
    ctx->pc = 0x3416E4u;
    {
        ...
        if (branch_taken_0x3416e4) {
            ctx->pc = 0x3416E8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x3416E4u;
    ...
    ctx->pc = 0x3416ECu;
    {
        ...
        ctx->pc = 0x3416F0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x3416ECu;
