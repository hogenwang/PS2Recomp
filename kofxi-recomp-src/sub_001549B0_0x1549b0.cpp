...
void sub_001549B0_0x1549b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x336D50u;
    if (runtime->hasFunction(0x336D50u)) {
        auto targetFn = runtime->lookupFunction(0x336D50u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00336D50_0x336d50(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1549C0u; }
        if (ctx->pc != 0x1549C0u) { return; }
    }
    ctx->pc = 0x1549C0u;
label_1549c0:
    ...
    ctx->pc = 0x154AA8u;
    {
        ...
        ctx->pc = 0x154AACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x154AA8u;
