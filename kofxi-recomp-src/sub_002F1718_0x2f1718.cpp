...
void sub_002F1718_0x2f1718(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F17ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2F17A8u;
    ...
    if (runtime->hasFunction(0x225F58u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F17B0u; }
        if (ctx->pc != 0x2F17B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2f17b0:
    ...
    ctx->pc = 0x2F17B8u;
    {
        ...
        ctx->pc = 0x2F17BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F17B8u;
...
label_2f17c0:
    ...
    ctx->pc = 0x2F1844u;
    {
        ...
        ctx->pc = 0x2F1848u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F1844u;
