...
void sub_001A3180_0x1a3180(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1A31A4u;
    // 0x1a31a8: 0x24060006  addiu       $a2, $zero, 0x6 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 6));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1272D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1272D8u, 0x1A31A4u, 0x1A31ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A31ACu;
label_1a31ac:
    ...
    ctx->pc = 0x1A31BCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1A31B8u;
    // 0x1a31bc: 0x24c6e8cb  addiu       $a2, $a2, -0x1735 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 4294961355));
    ctx->in_delay_slot = false;
    ctx->pc = 0x11DA08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11DA08u, 0x1A31B8u, 0x1A31C0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A31C0u;
label_1a31c0:
    ...
    ctx->pc = 0x1A31E0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1A31DCu;
    // 0x1a31e0: 0x24060006  addiu       $a2, $zero, 0x6 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 6));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1272D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1272D8u, 0x1A31DCu, 0x1A31E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A31E4u;
label_1a31e4:
    ...
    ctx->pc = 0x1A31F4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1A31F0u;
    // 0x1a31f4: 0x24c6e96b  addiu       $a2, $a2, -0x1695 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 4294961515));
    ctx->in_delay_slot = false;
    ctx->pc = 0x11DA08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x11DA08u, 0x1A31F0u, 0x1A31F8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1A31F8u;
label_1a31f8:
    ...
    ctx->pc = 0x1A31FCu;
    {
        ...
        ctx->pc = 0x1A3200u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1A31FCu;
        // 0x1a3200: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1A31FCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1a320cu;
    // NOP
    if (ctx->pc == 0x1a320cu) { ctx->pc = 0x1a3210u; }
}
