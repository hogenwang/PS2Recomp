...
void sub_001F81A0_0x1f81a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F81B0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F81ACu;
            // 0x1f81b0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F8220u;
    if (runtime->hasFunction(0x1F8220u)) {
        auto targetFn = runtime->lookupFunction(0x1F8220u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81B4u; }
        if (ctx->pc != 0x1F81B4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F8220_0x1f8220(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81B4u; }
        if (ctx->pc != 0x1F81B4u) { return; }
    }
    ctx->pc = 0x1F81B4u;
label_1f81b4:
    ...
    ctx->pc = 0x1F81B4u;
    {
        ...
        ctx->pc = 0x1F81B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F81B4u;
    ...
    ctx->pc = 0x1F8290u;
    if (runtime->hasFunction(0x1F8290u)) {
        auto targetFn = runtime->lookupFunction(0x1F8290u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81C4u; }
        if (ctx->pc != 0x1F81C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F8290_0x1f8290(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81C4u; }
        if (ctx->pc != 0x1F81C4u) { return; }
    }
    ctx->pc = 0x1F81C4u;
label_1f81c4:
    ...
    ctx->pc = 0x1F81C4u;
    {
        ...
        ctx->pc = 0x1F81C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F81C4u;
    ...
    ctx->pc = 0x1F8348u;
    if (runtime->hasFunction(0x1F8348u)) {
        auto targetFn = runtime->lookupFunction(0x1F8348u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81D4u; }
        if (ctx->pc != 0x1F81D4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F8348_0x1f8348(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81D4u; }
        if (ctx->pc != 0x1F81D4u) { return; }
    }
    ctx->pc = 0x1F81D4u;
label_1f81d4:
    ...
    ctx->pc = 0x1F81D4u;
    {
        ...
        ctx->pc = 0x1F81D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F81D4u;
    ...
    ctx->pc = 0x1F83A0u;
    if (runtime->hasFunction(0x1F83A0u)) {
        auto targetFn = runtime->lookupFunction(0x1F83A0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81E4u; }
        if (ctx->pc != 0x1F81E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001F83A0_0x1f83a0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F81E4u; }
        if (ctx->pc != 0x1F81E4u) { return; }
    }
    ctx->pc = 0x1F81E4u;
label_1f81e4:
    ...
    ctx->pc = 0x1F81E4u;
    {
        ...
        ctx->pc = 0x1F81E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F81E4u;
    ...
    ctx->pc = 0x1F81F0u;
    {
        ...
        if (branch_taken_0x1f81f0) {
            ctx->pc = 0x1F81F4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1F81F0u;
...
label_1f81fc:
    ...
    ctx->pc = 0x1F84C0u;
    {
        auto targetFn = runtime->lookupFunction(0x1F84C0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
