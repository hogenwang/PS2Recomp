...
void sub_00297090_0x297090(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29709Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x297098u;
    ...
    if (runtime->hasFunction(0x299EE8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2970A0u; }
        if (ctx->pc != 0x2970A0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2970a0:
    ...
    ctx->pc = 0x2970A4u;
    {
        ...
        ctx->pc = 0x2970A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2970A4u;
