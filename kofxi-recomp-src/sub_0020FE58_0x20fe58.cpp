...
void sub_0020FE58_0x20fe58(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x20FE68u;
    // 0x20fe6c: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x20F658u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20F658u, 0x20FE68u, 0x20FE70u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x20FE70u;
label_20fe70:
    ...
    ctx->pc = 0x20FCB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x20FCB0u, 0x20FE7Cu, 0x20FE84u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x20FE84u;
label_20fe84:
...
label_20fe88:
    ...
    ctx->pc = 0x20FE94u;
    {
        ...
        ctx->pc = 0x20FE98u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x20FE94u;
        // 0x20fe98: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x20FE94u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x20fe9cu;
    // NOP
    if (ctx->pc == 0x20fe9cu) { ctx->pc = 0x20fea0u; }
}
