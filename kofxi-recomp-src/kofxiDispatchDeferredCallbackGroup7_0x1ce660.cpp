...
// Function: kofxiDispatchDeferredCallbackGroup7
// Address: 0x1ce660 - 0x1ce6a0
void kofxiDispatchDeferredCallbackGroup7_0x1ce660(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiDispatchDeferredCallbackGroup7_0x1ce660");
#endif
...
label_1ce698:
    ...
    ctx->pc = 0x1CE698u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1CE698u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
