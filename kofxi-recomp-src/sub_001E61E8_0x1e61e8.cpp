...
label_1e61f8:
    ...
    ctx->pc = 0x1E61F8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E61F4u;
            // 0x1e61f8: 0xa0802d  daddu       $s0, $a1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ...
    if (runtime->hasFunction(0x1E67F0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E61FCu; }
        if (ctx->pc != 0x1E61FCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e6200:
    ...
    ctx->pc = 0x1E61FCu;
    {
        ...
        if (branch_taken_0x1e61fc) {
            ctx->pc = 0x1E6200u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1E61FCu;
            // 0x1e6200: 0xdfb00000  ld          $s0, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1E6224u;
...
label_1e621c:
    ...
    ctx->pc = 0x1E6218u;
    {
        ...
        ctx->pc = 0x1E621Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E6218u;
            // 0x1e621c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x1E6220u; }
            if (ctx->pc != 0x1E6220u) { return; }
        }
        }
    }
    ctx->pc = 0x1E6220u;
...
label_1e622c:
    ...
    ctx->pc = 0x1E6228u;
    {
        ...
        ctx->pc = 0x1E622Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E6228u;
            // 0x1e622c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
