...
void sub_001C34A0_0x1c34a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1C34BCu;
    // 0x1c34c0: 0x42603  sra         $a0, $a0, 24 (Delay Slot)
    SET_GPR_S32(ctx, 4, SRA32(GPR_S32(ctx, 4), 24));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C3468u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C3468u, 0x1C34BCu, 0x1C34C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C34C4u;
label_1c34c4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C3468u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C3468u, 0x1C34C8u, 0x1C34D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C34D0u;
label_1c34d0:
    ...
    ctx->pc = 0x1C34ECu;
    {
        ...
        ctx->pc = 0x1C34F0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C34ECu;
        // 0x1c34f0: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C34ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1c34f4u;
    // NOP
    if (ctx->pc == 0x1c34f4u) { ctx->pc = 0x1c34f8u; }
}
