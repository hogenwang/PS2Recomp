...
void sub_00200CF8_0x200cf8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x200D14u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x200D10u;
    ...
    if (runtime->hasFunction(0x202798u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x200D18u; }
        if (ctx->pc != 0x200D18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_200d18:
    ...
    ctx->pc = 0x200D28u;
    {
        ...
        ctx->pc = 0x200D2Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x200D28u;
...
label_200d50:
    ...
    ctx->pc = 0x200D64u;
    ctx->pc = 0x200D68u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x200D64u;
