...
void sub_002A1EC0_0x2a1ec0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2A97A0u;
    if (runtime->hasFunction(0x2A97A0u)) {
        auto targetFn = runtime->lookupFunction(0x2A97A0u);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_002A97A0_0x2a97a0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2A1EECu; }
        if (ctx->pc != 0x2A1EECu) { return; }
    }
    ctx->pc = 0x2A1EECu;
label_2a1eec:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2A1F00u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x29C730u;
    if (runtime->hasFunction(0x29C730u)) {
        auto targetFn = runtime->lookupFunction(0x29C730u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0029C730_0x29c730(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2A1F08u; }
        if (ctx->pc != 0x2A1F08u) { return; }
    }
    ctx->pc = 0x2A1F08u;
