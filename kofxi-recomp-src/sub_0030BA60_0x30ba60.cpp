...
label_30ba8c:
    ...
    ctx->pc = 0x30BA90u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x30BA8Cu;
            // 0x30ba90: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x30B980u;
    if (runtime->hasFunction(0x30B980u)) {
        auto targetFn = runtime->lookupFunction(0x30B980u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x30BA94u; }
        if (ctx->pc != 0x30BA94u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0030B980_0x30b980(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x30BA94u; }
        if (ctx->pc != 0x30BA94u) { return; }
    }
    ctx->pc = 0x30BA94u;
...
label_30baf8:
    ...
    ctx->pc = 0x30BB00u;
    {
        ...
        if (branch_taken_0x30bb00) {
            ctx->pc = 0x30BB04u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x30BB00u;
...
label_30bb08:
    ...
    ctx->pc = 0x30BB14u;
    {
        ...
        ctx->pc = 0x30BB18u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x30BB14u;
