...
void sub_0012E718_0x12e718(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x12E72Cu;
    {
        ...
        if (branch_taken_0x12e72c) {
            ctx->pc = 0x12E730u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12E72Cu;
...
label_12e748:
    ...
    ctx->pc = 0x12E748u;
    {
        ...
        if (branch_taken_0x12e748) {
            ctx->pc = 0x12E74Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12E748u;
    ...
    if (runtime->hasFunction(0x124D80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x12E758u; }
        if (ctx->pc != 0x12E758u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_12e75c:
    ...
    ctx->pc = 0x12E760u;
    {
        ...
        if (branch_taken_0x12e760) {
            ctx->pc = 0x12E764u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12E760u;
    ...
    ctx->pc = 0x12E76Cu;
    {
        ...
        ctx->pc = 0x12E770u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12E76Cu;
    ...
    ctx->pc = 0x12E784u;
    {
        ...
        ctx->pc = 0x12E788u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12E784u;
    ...
    ctx->pc = 0x12E798u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x12E794u;
    ...
    if (runtime->hasFunction(0x1250F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x12E79Cu; }
        if (ctx->pc != 0x12E79Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_12e820:
    ...
    ctx->pc = 0x12E820u;
    {
        ...
        ctx->pc = 0x12E824u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12E820u;
