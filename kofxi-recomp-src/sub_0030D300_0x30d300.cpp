...
label_30d360:
    ...
    ctx->pc = 0x30D36Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x30D36Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x30d37cu;
    // NOP
    if (ctx->pc == 0x30d37cu) { ctx->pc = 0x30d380u; }
}
