...
void sub_001F4608_0x1f4608(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F461Cu;
    {
        ...
        if (branch_taken_0x1f461c) {
            ctx->pc = 0x1F4620u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1F461Cu;
...
label_1f4658:
    ...
    ctx->pc = 0x1F4658u;
    {
        ...
        ctx->pc = 0x1F465Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F4658u;
...
label_1f46a0:
    ...
    ctx->pc = 0x1F46A0u;
    {
        ...
        ctx->pc = 0x1F46A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F46A0u;
...
label_1f46c4:
    ...
    ctx->pc = 0x1F46C4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1F46C8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F46C4u;
