...
void sub_0020D600_0x20d600(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20D60Cu;
    {
        ...
        ctx->pc = 0x20D610u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20D60Cu;
    ...
    ctx->pc = 0x20D614u;
    {
        ...
        ctx->pc = 0x20D618u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20D614u;
...
label_20d620:
    ...
    ctx->pc = 0x20D624u;
    {
        ...
        if (branch_taken_0x20d624) {
            ctx->pc = 0x20D628u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x20D624u;
...
label_20d634:
    ...
    ctx->pc = 0x20D63Cu;
    {
        ...
        ctx->pc = 0x20D640u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20D63Cu;
