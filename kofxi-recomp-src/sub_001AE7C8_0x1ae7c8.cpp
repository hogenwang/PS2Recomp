...
void sub_001AE7C8_0x1ae7c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1AE7E4u; }
        if (ctx->pc != 0x1AE7E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1ae7e4:
    ...
    ctx->pc = 0x1AE7F8u;
    {
        ...
        ctx->pc = 0x1AE7FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AE7F8u;
...
label_1ae800:
    ...
    ctx->pc = 0x1AE81Cu;
    ctx->pc = 0x1AE820u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AE81Cu;
