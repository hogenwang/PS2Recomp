...
label_2bf380:
    ...
    ctx->pc = 0x2BF390u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF38Cu;
    ...
    if (runtime->hasFunction(0x2BF130u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF394u; }
        if (ctx->pc != 0x2BF394u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf394:
    ...
    ctx->pc = 0x2BF39Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF398u;
    ...
    if (runtime->hasFunction(0x2BF150u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BF3A0u; }
        if (ctx->pc != 0x2BF3A0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bf3a0:
    ...
    ctx->pc = 0x2BF3A0u;
    {
        ...
        if (branch_taken_0x2bf3a0) {
            ctx->pc = 0x2BF3A4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF3A0u;
...
label_2bf3b0:
    ...
    ctx->pc = 0x2BF3B8u;
    {
        ...
        if (branch_taken_0x2bf3b8) {
            ctx->pc = 0x2BF3BCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2BF3B8u;
