...
void sub_0014E0E0_0x14e0e0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x14E10Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x14E108u;
    ...
    if (runtime->hasFunction(0x14DFB0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x14E110u; }
        if (ctx->pc != 0x14E110u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_14e110:
    ...
    ctx->pc = 0x14E128u;
    {
        ...
        ctx->pc = 0x14E12Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x14E128u;
