...
label_15ce44:
    ...
    ctx->pc = 0x15CE48u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15CE44u;
    // 0x15ce48: 0x200302d  daddu       $a2, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 6, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15CA80u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15CA80u, 0x15CE44u, 0x15CE4Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15CE4Cu;
label_15ce4c:
...
label_15cf38:
    ...
    ctx->pc = 0x15CF5Cu;
    {
        ...
        ctx->pc = 0x15CF60u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x15CF5Cu;
        // 0x15cf60: 0x27bd0050  addiu       $sp, $sp, 0x50 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 80));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x15CF5Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_15cfe8:
    ...
    ctx->pc = 0x15D014u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D010u;
    // 0x15d014: 0x3c072000  lui         $a3, 0x2000 (Delay Slot)
    SET_GPR_S32(ctx, 7, (int32_t)((uint32_t)8192 << 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15CBE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15CBE0u, 0x15D010u, 0x15D018u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D018u;
label_15d018:
...
label_15d020:
    ...
    ctx->pc = 0x15D02Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D028u;
    // 0x15d02c: 0x3c072000  lui         $a3, 0x2000 (Delay Slot)
    SET_GPR_S32(ctx, 7, (int32_t)((uint32_t)8192 << 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x15CBE0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15CBE0u, 0x15D028u, 0x15D030u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D030u;
label_15d030:
...
label_15d04c:
    ...
    ctx->pc = 0x19F2D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F2D0u, 0x15D04Cu, 0x15D054u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D054u;
label_15d054:
...
label_15d078:
    ...
    ctx->pc = 0x15D084u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D080u;
    // 0x15d084: 0x382d  daddu       $a3, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F2F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F2F0u, 0x15D080u, 0x15D088u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D088u;
label_15d088:
    ...
    ctx->pc = 0x15D08Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D088u;
    // 0x15d08c: 0x24040001  addiu       $a0, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F430u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F430u, 0x15D088u, 0x15D090u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D090u;
label_15d090:
    ...
    ctx->pc = 0x15D098u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D094u;
    // 0x15d098: 0x24050004  addiu       $a1, $zero, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x19F400u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F400u, 0x15D094u, 0x15D09Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D09Cu;
label_15d09c:
    ...
    ctx->pc = 0x19F420u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F420u, 0x15D09Cu, 0x15D0A4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D0A4u;
label_15d0a4:
    ...
    ctx->pc = 0x19F2E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x19F2E0u, 0x15D0A4u, 0x15D0ACu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D0ACu;
label_15d0ac:
    ...
    ctx->pc = 0x15D0C0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D0BCu;
    // 0x15d0c0: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x155CA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x155CA0u, 0x15D0BCu, 0x15D0C4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D0C4u;
label_15d0c4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x15D110u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x15D110u, 0x15D0D8u, 0x15D0E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D0E0u;
label_15d0e0:
...
label_15d0e8:
    ...
    ctx->pc = 0x15D0F0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x15D0ECu;
    // 0x15d0f0: 0xa0404074  sb          $zero, 0x4074($v0) (Delay Slot)
    WRITE8(ADD32(GPR_U32(ctx, 2), 16500), (uint8_t)GPR_U32(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x155CA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x155CA0u, 0x15D0ECu, 0x15D0F4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x15D0F4u;
label_15d0f4:
...
label_15d0f8:
    ...
    ctx->pc = 0x15D100u;
    {
        ...
        ctx->pc = 0x15D104u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x15D100u;
        // 0x15d104: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x15D100u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
