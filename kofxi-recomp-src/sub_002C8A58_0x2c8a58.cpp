...
label_2c8a68:
    ...
    ctx->pc = 0x2C8A6Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C8A68u;
    ...
    if (runtime->hasFunction(0x2D7CA0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2C8A70u; }
        if (ctx->pc != 0x2C8A70u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2c8a70:
    ...
    ctx->pc = 0x2C8A7Cu;
    {
        ...
        ctx->pc = 0x2C8A80u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C8A7Cu;
