...
label_202cac:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x2018F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2018F8u, 0x202CB4u, 0x202CBCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x202CBCu;
label_202cbc:
...
label_202cc0:
    ...
    ctx->pc = 0x202CC8u;
    {
        ...
        ctx->pc = 0x202CCCu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x202CC8u;
        // 0x202ccc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x202CC8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
