...
void sub_001CB268_0x1cb268(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x129F70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x129F70u, 0x1CB280u, 0x1CB288u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1CB288u;
label_1cb288:
    ...
    ctx->pc = 0x1CB290u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1CB28Cu;
    // 0x1cb290: 0x200282d  daddu       $a1, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x129B68u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x129B68u, 0x1CB28Cu, 0x1CB294u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1CB294u;
label_1cb294:
    ...
    ctx->pc = 0x1CB298u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1CB294u;
    // 0x1cb298: 0x3a0202d  daddu       $a0, $sp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CA818u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CA818u, 0x1CB294u, 0x1CB29Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1CB29Cu;
label_1cb29c:
    ...
    ctx->pc = 0x1CB2A4u;
    {
        ...
        ctx->pc = 0x1CB2A8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1CB2A4u;
        // 0x1cb2a8: 0x27bd0050  addiu       $sp, $sp, 0x50 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 80));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1CB2A4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1cb2acu;
    // NOP
    if (ctx->pc == 0x1cb2acu) { ctx->pc = 0x1cb2b0u; }
}
