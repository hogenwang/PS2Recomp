...
void sub_0020C040_0x20c040(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x10CEE0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x20C0A8u; }
        if (ctx->pc != 0x20C0A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_20c0a8:
    ...
    ctx->pc = 0x20C0B8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20C0B4u;
    ...
    if (runtime->hasFunction(0x102810u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20C0BCu; }
        if (ctx->pc != 0x20C0BCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_20c0c0:
    ...
    if (runtime->hasFunction(0x20C0F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20C0E4u; }
        if (ctx->pc != 0x20C0E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
