...
void sub_001E5400_0x1e5400(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1E5418u;
    // 0x1e541c: 0xa0902d  daddu       $s2, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E2960u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E2960u, 0x1E5418u, 0x1E5420u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5420u;
label_1e5420:
...
label_1e5478:
    ...
    ctx->pc = 0x1E547Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5478u;
    // 0x1e547c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E1AC8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E1AC8u, 0x1E5478u, 0x1E5480u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5480u;
label_1e5480:
    ...
    ctx->pc = 0x1E5484u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5480u;
    // 0x1e5484: 0x8e040048  lw          $a0, 0x48($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 72)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C62B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C62B8u, 0x1E5480u, 0x1E5488u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5488u;
label_1e5488:
    ...
    ctx->pc = 0x1E5490u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E548Cu;
    // 0x1e5490: 0x8e0503a8  lw          $a1, 0x3A8($s0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 936)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5240u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5240u, 0x1E548Cu, 0x1E5494u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E5494u;
label_1e5494:
    ...
    ctx->pc = 0x1E549Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1E5498u;
    // 0x1e549c: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E53A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E53A0u, 0x1E5498u, 0x1E54A0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E54A0u;
label_1e54a0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E5300u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E5300u, 0x1E54A0u, 0x1E54A8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1E54A8u;
label_1e54a8:
...
label_1e54bc:
    ...
    ctx->pc = 0x1E54CCu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1E54CCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1e54d4u;
    // NOP
    if (ctx->pc == 0x1e54d4u) { ctx->pc = 0x1e54d8u; }
}
