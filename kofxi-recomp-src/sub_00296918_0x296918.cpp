...
void sub_00296918_0x296918(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x296918u;
    {
        ...
        ctx->pc = 0x29691Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x296918u;
...
label_296920:
    ...
    ctx->pc = 0x296924u;
    {
        ...
        ctx->pc = 0x296928u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x296924u;
    ...
    ctx->pc = 0x296934u;
    ctx->pc = 0x296938u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x296934u;
...
label_29693c:
    ...
    ctx->pc = 0x29693Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x296940u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29693Cu;
