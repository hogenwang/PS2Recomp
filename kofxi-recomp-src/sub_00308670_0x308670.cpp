...
label_308690:
    ...
    ctx->pc = 0x308694u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x308690u;
    // 0x308694: 0x2625015c  addiu       $a1, $s1, 0x15C (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 17), 348));
    ctx->in_delay_slot = false;
    ctx->pc = 0x129E28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x129E28u, 0x308690u, 0x308698u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x308698u;
label_308698:
...
label_3086b4:
    ...
    ctx->pc = 0x3086C0u;
    {
        ...
        ctx->pc = 0x3086C4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x3086C0u;
        // 0x3086c4: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x3086C0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
