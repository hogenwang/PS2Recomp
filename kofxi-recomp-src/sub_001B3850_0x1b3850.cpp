...
void sub_001B3850_0x1b3850(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B3800u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3800u, 0x1B3870u, 0x1B3878u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3878u;
label_1b3878:
    ...
    ctx->pc = 0x1B39B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B39B8u, 0x1B3878u, 0x1B3880u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3880u;
label_1b3880:
    ...
    ctx->pc = 0x1B3B58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3B58u, 0x1B3880u, 0x1B3888u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3888u;
label_1b3888:
    ...
    ctx->pc = 0x1B3A88u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3A88u, 0x1B3888u, 0x1B3890u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3890u;
label_1b3890:
    ...
    ctx->pc = 0x1B3D58u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B3D58u, 0x1B3890u, 0x1B3898u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B3898u;
label_1b3898:
    ...
    ctx->branch_pc = 0x1B38A8u;
    // 0x1b38ac: 0x8c440000  lw          $a0, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10CAF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10CAF0u, 0x1B38A8u, 0x1B38B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B38B0u;
label_1b38b0:
    ...
    ctx->pc = 0x1B38B8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B38B4u;
    // 0x1b38b8: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE428u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE428u, 0x1B38B4u, 0x1B38BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B38BCu;
label_1b38bc:
    ...
    ctx->pc = 0x1B38C4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B38C0u;
    // 0x1b38c4: 0x282d  daddu       $a1, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE440u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE440u, 0x1B38C0u, 0x1B38C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B38C8u;
label_1b38c8:
...
label_1b38d8:
    ...
    ctx->pc = 0x1B38DCu;
    {
        ...
        ctx->pc = 0x1B38E0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1B38DCu;
        // 0x1b38e0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B38DCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1b38e4u;
    // NOP
    if (ctx->pc == 0x1b38e4u) { ctx->pc = 0x1b38e8u; }
}
