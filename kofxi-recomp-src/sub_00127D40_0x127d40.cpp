...
label_127d9c:
    ...
    ctx->pc = 0x127D9Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x127D9Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x127da4u;
    // NOP
    if (ctx->pc == 0x127da4u) { ctx->pc = 0x127da8u; }
}
