...
// Function: kofxiDispatchAllSchedulerStateCallbacks
// Address: 0x1b2850 - 0x1b2968
void kofxiDispatchAllSchedulerStateCallbacks_0x1b2850(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiDispatchAllSchedulerStateCallbacks_0x1b2850");
#endif
    ...
    ctx->pc = 0x1CE5B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5B8u, 0x1B2858u, 0x1B2860u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2860u;
label_1b2860:
    ...
    ctx->pc = 0x1CE5D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5D0u, 0x1B2860u, 0x1B2868u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2868u;
label_1b2868:
    ...
    ctx->pc = 0x1CE5E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE5E8u, 0x1B2868u, 0x1B2870u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2870u;
label_1b2870:
    ...
    ctx->pc = 0x1CE600u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE600u, 0x1B2870u, 0x1B2878u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2878u;
label_1b2878:
    ...
    ctx->pc = 0x1CE618u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE618u, 0x1B2878u, 0x1B2880u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2880u;
label_1b2880:
    ...
    ctx->pc = 0x1CE630u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE630u, 0x1B2880u, 0x1B2888u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2888u;
label_1b2888:
    ...
    ctx->pc = 0x1CE648u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE648u, 0x1B2888u, 0x1B2890u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2890u;
label_1b2890:
    ...
    ctx->pc = 0x1CE660u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CE660u, 0x1B2890u, 0x1B2898u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B2898u;
label_1b2898:
    ...
    ctx->pc = 0x1B28A0u;
    {
        ...
        ctx->branch_pc = 0x1B28A0u;
        // 0x1b28a4: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B28A0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1B28D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B28CCu;
    // 0x1b28d0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE5D0u;
    kofxiDispatchDeferredCallbackGroup1_0x1ce5d0(rdram, ctx, runtime); return;
    ctx->pc = 0x1B28D4u;
    // 0x1b28d4: 0x0  nop
    ctx->pc = 0x1b28d4u;
    // NOP
    ...
    ctx->pc = 0x1B2960u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1B295Cu;
    // 0x1b2960: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CE660u;
    kofxiDispatchDeferredCallbackGroup7_0x1ce660(rdram, ctx, runtime); return;
    ctx->pc = 0x1B2964u;
    // 0x1b2964: 0x0  nop
    ctx->pc = 0x1b2964u;
    // NOP
    if (ctx->pc == 0x1b2964u) { ctx->pc = 0x1b2968u; }
}
