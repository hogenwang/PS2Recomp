...
void sub_0012A598_0x12a598(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x12A5ACu;
    {
        ...
        ctx->pc = 0x12A5B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A5ACu;
    ...
    ctx->pc = 0x12A5B8u;
    {
        ...
        ctx->pc = 0x12A5BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A5B8u;
...
label_12a66c:
    ...
    ctx->pc = 0x12A6B8u;
    {
        ...
        ctx->pc = 0x12A6BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A6B8u;
...
label_12a6c8:
    ...
    ctx->pc = 0x12A6F4u;
    {
        ...
        if (branch_taken_0x12a6f4) {
            ctx->pc = 0x12A6F8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12A6F4u;
...
label_12a700:
    ...
    ctx->pc = 0x12A700u;
    {
        ...
        ctx->pc = 0x12A704u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A700u;
