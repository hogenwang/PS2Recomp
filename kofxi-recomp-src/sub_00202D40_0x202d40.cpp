...
void sub_00202D40_0x202d40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x202D44u;
    {
        ...
        ctx->pc = 0x202D48u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x202D44u;
...
label_202d50:
    ...
    ctx->pc = 0x202D5Cu;
    {
        ...
        ctx->pc = 0x202D60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x202D5Cu;
...
label_202d70:
    ...
    ctx->pc = 0x202D94u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x202D90u;
    ...
    if (runtime->hasFunction(0x12A598u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x202D98u; }
        if (ctx->pc != 0x202D98u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_202d98:
    ...
    ctx->pc = 0x202DA8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x202DA4u;
    ...
    if (runtime->hasFunction(0x1297C8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x202DACu; }
        if (ctx->pc != 0x202DACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_202dac:
    ...
    ctx->pc = 0x202DB8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x202DB4u;
    ...
    if (runtime->hasFunction(0x129B68u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x202DBCu; }
        if (ctx->pc != 0x202DBCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_202dd0:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x202DD4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x202E00u;
    if (runtime->hasFunction(0x202E00u)) {
        auto targetFn = runtime->lookupFunction(0x202E00u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00202E00_0x202e00(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x202DDCu; }
        if (ctx->pc != 0x202DDCu) { return; }
    }
    ctx->pc = 0x202DDCu;
label_202ddc:
    ...
    ctx->pc = 0x202DE8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x202DE4u;
    ...
    if (runtime->hasFunction(0x129B68u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x202DECu; }
        if (ctx->pc != 0x202DECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00129B68_0x129b68(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x202DECu; }
