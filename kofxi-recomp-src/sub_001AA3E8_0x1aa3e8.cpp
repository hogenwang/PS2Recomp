...
void sub_001AA3E8_0x1aa3e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AA268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AA268u, 0x1AA400u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1AA408u;
label_1aa408:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AA0B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AA0B0u, 0x1AA408u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1AA410u;
}
