...
void sub_00276F98_0x276f98(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2755F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2755F0u, 0x276FA0u, 0x276FA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x276FA8u;
label_276fa8:
    ...
    ctx->pc = 0x276FACu;
    {
        ...
        ctx->branch_pc = 0x276FACu;
        // 0x276fb0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x276FACu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x276fb4u;
    // NOP
    if (ctx->pc == 0x276fb4u) { ctx->pc = 0x276fb8u; }
}
