...
void sub_001C6A48_0x1c6a48(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1C6AB8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C6A64u; }
        if (ctx->pc != 0x1C6A64u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c6a64:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C6A68u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C6A88u;
    if (runtime->hasFunction(0x1C6A88u)) {
        auto targetFn = runtime->lookupFunction(0x1C6A88u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C6A70u; }
        if (ctx->pc != 0x1C6A70u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C6A88_0x1c6a88(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C6A70u; }
        if (ctx->pc != 0x1C6A70u) { return; }
    }
    ctx->pc = 0x1C6A70u;
label_1c6a70:
    ...
    ctx->pc = 0x1C6A7Cu;
    ctx->pc = 0x1C6A80u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C6A7Cu;
