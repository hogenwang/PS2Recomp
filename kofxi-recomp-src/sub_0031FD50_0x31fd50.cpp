...
void sub_0031FD50_0x31fd50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x18A040u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x31FD68u; }
        if (ctx->pc != 0x31FD68u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_31fd68:
    ...
    ctx->pc = 0x31FD70u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x31FD6Cu;
    ...
    if (runtime->hasFunction(0x18A040u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x31FD74u; }
        if (ctx->pc != 0x31FD74u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0018A040_0x18a040(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x31FD74u; }
...
label_31fd74:
    ...
    ctx->pc = 0x31FD8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x31FD88u;
    ...
    if (runtime->hasFunction(0x12EFB0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x31FD90u; }
        if (ctx->pc != 0x31FD90u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_31fdd4:
    ...
    ctx->pc = 0x31FDDCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x31FDD8u;
    ...
    if (runtime->hasFunction(0x31FB80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x31FDE0u; }
        if (ctx->pc != 0x31FDE0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_31fde0:
    ...
    ctx->pc = 0x31FDECu;
    {
        ...
        ctx->pc = 0x31FDF0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x31FDECu;
