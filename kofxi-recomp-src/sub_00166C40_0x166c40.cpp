...
void sub_00166C40_0x166c40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x166C54u;
    // 0x166c58: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x171AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171AB0u, 0x166C54u, 0x166C5Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166C5Cu;
label_166c5c:
...
label_166cb8:
    ...
    ctx->pc = 0x166CBCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166CB8u;
    // 0x166cbc: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x171FF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171FF0u, 0x166CB8u, 0x166CC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166CC0u;
label_166cc0:
...
label_166cd0:
    ...
    ctx->pc = 0x166CD8u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166CD4u;
    // 0x166cd8: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x171FF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171FF0u, 0x166CD4u, 0x166CDCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166CDCu;
label_166cdc:
...
label_166cec:
    ...
    ctx->pc = 0x166CF4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166CF0u;
    // 0x166cf4: 0x24050001  addiu       $a1, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x171FF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171FF0u, 0x166CF0u, 0x166CF8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166CF8u;
label_166cf8:
...
label_166d08:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x171FF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171FF0u, 0x166D0Cu, 0x166D14u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166D14u;
label_166d14:
...
label_166d28:
    ...
    ctx->pc = 0x166D3Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166D38u;
    // 0x166d3c: 0x3047ffff  andi        $a3, $v0, 0xFFFF (Delay Slot)
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 2) & (uint64_t)(uint16_t)65535);
    ctx->in_delay_slot = false;
    ctx->pc = 0x1735D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1735D0u, 0x166D38u, 0x166D40u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166D40u;
label_166d40:
    ...
    ctx->pc = 0x166D4Cu;
    {
        ...
        ctx->pc = 0x166D50u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x166D4Cu;
        // 0x166d50: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x166D4Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x171AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171AB0u, 0x166D70u, 0x166D78u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166D78u;
label_166d78:
    ...
    ctx->pc = 0x166DA4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166DA0u;
    // 0x166da4: 0x24070001  addiu       $a3, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 7, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1682E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1682E0u, 0x166DA0u, 0x166DA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166DA8u;
label_166da8:
...
label_166db0:
    ...
    ctx->pc = 0x166DBCu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166DB8u;
    // 0x166dbc: 0x382d  daddu       $a3, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1682E0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1682E0u, 0x166DB8u, 0x166DC0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166DC0u;
label_166dc0:
...
label_166dc8:
    ...
    ctx->pc = 0x166DECu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166DE8u;
    // 0x166dec: 0x24070001  addiu       $a3, $zero, 0x1 (Delay Slot)
    SET_GPR_S32(ctx, 7, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    ctx->in_delay_slot = false;
    ctx->pc = 0x173650u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x173650u, 0x166DE8u, 0x166DF0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166DF0u;
label_166df0:
...
label_166df8:
    ...
    ctx->pc = 0x166E00u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166DFCu;
    // 0x166e00: 0x382d  daddu       $a3, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x173650u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x173650u, 0x166DFCu, 0x166E04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166E04u;
label_166e04:
...
label_166e08:
    ...
    ctx->pc = 0x166E0Cu;
    {
        ...
        ctx->pc = 0x166E10u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x166E0Cu;
        // 0x166e10: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x166E0Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x166E3Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166E38u;
    // 0x166e3c: 0x802d  daddu       $s0, $zero, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x171AB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x171AB0u, 0x166E38u, 0x166E40u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166E40u;
label_166e40:
...
label_166e68:
    ...
    ctx->pc = 0x166E70u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166E6Cu;
    // 0x166e70: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x166EB0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x166EB0u, 0x166E6Cu, 0x166E74u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166E74u;
label_166e74:
...
label_166e84:
    ...
    ctx->pc = 0x166E90u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x166E8Cu;
    // 0x166e90: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x167020u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x167020u, 0x166E8Cu, 0x166E94u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x166E94u;
label_166e94:
    ...
    ctx->pc = 0x166EA0u;
    {
        ...
        ctx->pc = 0x166EA4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x166EA0u;
        // 0x166ea4: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x166EA0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x166eacu;
    // NOP
    if (ctx->pc == 0x166eacu) { ctx->pc = 0x166eb0u; }
}
