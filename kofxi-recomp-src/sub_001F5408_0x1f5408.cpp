...
label_1f542c:
    ...
    ctx->pc = 0x1F542Cu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F542Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f5434u;
    // NOP
    if (ctx->pc == 0x1f5434u) { ctx->pc = 0x1f5438u; }
}
