...
void sub_00230848_0x230848(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x230864u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x230860u;
    ...
    if (runtime->hasFunction(0x22D970u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x230868u; }
        if (ctx->pc != 0x230868u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_230868:
    ...
    ctx->pc = 0x23086Cu;
    {
        ...
        ctx->pc = 0x230870u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x23086Cu;
