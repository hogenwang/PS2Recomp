...
void sub_001BAAC8_0x1baac8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1AD268u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD268u, 0x1BAAD0u, 0x1BAAD8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BAAD8u;
label_1baad8:
    ...
    ctx->pc = 0x1BAAF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1BAAF0u, 0x1BAAD8u, 0x1BAAE0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BAAE0u;
label_1baae0:
    ...
    ctx->pc = 0x1baaecu;
    // NOP
    if (ctx->pc == 0x1baaecu) { ctx->pc = 0x1baaf0u; }
}
