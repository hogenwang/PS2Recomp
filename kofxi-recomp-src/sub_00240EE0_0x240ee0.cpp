...
void sub_00240EE0_0x240ee0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x240EE4u;
    {
        ...
        ctx->pc = 0x240EE8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240EE4u;
...
label_240f10:
    ...
    ctx->pc = 0x240F14u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x240F18u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240F14u;
...
label_240f1c:
    ...
    ctx->pc = 0x240F20u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x240F24u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240F20u;
...
label_240f28:
    ...
    ctx->pc = 0x240F2Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x240F30u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240F2Cu;
...
label_240f34:
    ...
    ctx->pc = 0x240F38u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x240F3Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x240F38u;
