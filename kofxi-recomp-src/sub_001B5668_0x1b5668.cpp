...
label_1b56b8:
    ...
    ctx->pc = 0x1B56B4u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B56B4u, 0x1B56BCu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B56BCu;
...
label_1b56dc:
    ...
    ctx->pc = 0x1B56D8u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B56D8u, 0x1B56E0u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B56E0u;
...
label_1b5714:
    ...
    ctx->pc = 0x1B5710u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5710u, 0x1B5718u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5718u;
...
label_1b571c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AB930u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AB930u, 0x1B5718u, 0x1B5720u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5720u;
label_1b5720:
...
label_1b5764:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ADD78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ADD78u, 0x1B5760u, 0x1B5768u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5768u;
label_1b5768:
...
label_1b5790:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CCDF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CCDF8u, 0x1B578Cu, 0x1B5794u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5794u;
label_1b5794:
...
label_1b57a8:
    ...
    ctx->pc = 0x1B57A4u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B57A4u, 0x1B57ACu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B57ACu;
...
label_1b57c0:
    ...
    ctx->pc = 0x1B57BCu;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B57BCu, 0x1B57C4u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B57C4u;
...
label_1b5834:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CCDF8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CCDF8u, 0x1B5830u, 0x1B5838u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5838u;
label_1b5838:
...
label_1b584c:
    ...
    ctx->pc = 0x1B5848u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5848u, 0x1B5850u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5850u;
...
label_1b5864:
    ...
    ctx->pc = 0x1B5860u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5860u, 0x1B5868u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5868u;
...
label_1b588c:
    ...
    ctx->pc = 0x1B5888u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5888u, 0x1B5890u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5890u;
...
label_1b58ac:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B62D0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B62D0u, 0x1B58A8u, 0x1B58B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B58B0u;
label_1b58b0:
...
label_1b58c4:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AB930u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AB930u, 0x1B58C0u, 0x1B58C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B58C8u;
label_1b58c8:
...
label_1b58dc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6538u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6538u, 0x1B58D8u, 0x1B58E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B58E0u;
label_1b58e0:
...
label_1b5900:
    ...
    ctx->pc = 0x1B58FCu;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B58FCu, 0x1B5904u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5904u;
...
label_1b5914:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B62A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B62A0u, 0x1B5910u, 0x1B5918u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5918u;
label_1b5918:
...
label_1b592c:
    ...
    ctx->pc = 0x1B5928u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5928u, 0x1B5930u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5930u;
...
label_1b595c:
    ...
    ctx->pc = 0x1B5958u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5958u, 0x1B5960u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5960u;
...
label_1b596c:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AB930u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AB930u, 0x1B5968u, 0x1B5970u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5970u;
label_1b5970:
...
label_1b598c:
    ...
    ctx->pc = 0x1B5988u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B5988u, 0x1B5990u, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B5990u;
...
label_1b5994:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AB930u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AB930u, 0x1B5990u, 0x1B5998u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B5998u;
label_1b5998:
...
label_1b59b8:
    ...
    ctx->pc = 0x1B59B4u;
    {
        ...
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B59B4u, 0x1B59BCu, PS2Runtime::GuestBranchKind::IndirectCall, "JALR")) {
            return;
        }
    }
    ctx->pc = 0x1B59BCu;
...
label_1b59c8:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ABCE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ABCE8u, 0x1B59C4u, 0x1B59CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B59CCu;
label_1b59cc:
...
label_1b59d0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ABD68u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ABD68u, 0x1B59CCu, 0x1B59D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1B59D4u;
label_1b59d4:
...
label_1b59f0:
    ...
    ctx->pc = 0x1B59ECu;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1B59ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1b59f4:
    ...
    ctx->pc = 0x1b59f4u;
    // NOP
    if (ctx->pc == 0x1b59f4u) { ctx->pc = 0x1b59f8u; }
}
