...
void sub_00264078_0x264078(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x264080u;
    {
        ...
        ctx->pc = 0x264084u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x264080u;
    ...
    ctx->pc = 0x26409Cu;
    {
        ...
        ctx->pc = 0x2640A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26409Cu;
...
label_2640a4:
    ...
    ctx->pc = 0x2640ACu;
    {
        ...
        if (branch_taken_0x2640ac) {
            ctx->pc = 0x2640B0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2640ACu;
    ...
    ctx->pc = 0x2640BCu;
    {
        ...
        ctx->pc = 0x2640C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2640BCu;
...
label_2640c4:
    ...
    ctx->pc = 0x2640CCu;
    {
        ...
        if (branch_taken_0x2640cc) {
            ctx->pc = 0x2640D0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2640CCu;
...
label_2640e4:
    ...
    ctx->pc = 0x2640E8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2640E4u;
    ...
    if (runtime->hasFunction(0x228950u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2640ECu; }
        if (ctx->pc != 0x2640ECu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2640ec:
    ...
    ctx->pc = 0x264158u;
    {
        ...
        ctx->pc = 0x26415Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x264158u;
