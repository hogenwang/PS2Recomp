...
label_1c89fc:
    ...
    ctx->pc = 0x1C89F8u;
    {
        ...
        ctx->pc = 0x1C89FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C89F8u;
            // 0x1c89fc: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_1c8a04:
    ...
    ctx->pc = 0x1CD208u;
    if (runtime->hasFunction(0x1CD208u)) {
        auto targetFn = runtime->lookupFunction(0x1CD208u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C8A08u; }
        if (ctx->pc != 0x1C8A08u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001CD208_0x1cd208(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C8A08u; }
        if (ctx->pc != 0x1C8A08u) { return; }
    }
    ctx->pc = 0x1C8A08u;
...
label_1c8a10:
    ...
    ctx->pc = 0x1C8A0Cu;
    {
        ...
        ctx->pc = 0x1C8A10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C8A0Cu;
            // 0x1c8a10: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_1c8a34:
    ...
    ctx->pc = 0x1CDA00u;
    if (runtime->hasFunction(0x1CDA00u)) {
        auto targetFn = runtime->lookupFunction(0x1CDA00u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C8A38u; }
        if (ctx->pc != 0x1C8A38u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001CDA00_0x1cda00(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C8A38u; }
        if (ctx->pc != 0x1C8A38u) { return; }
    }
    ctx->pc = 0x1C8A38u;
...
label_1c8a5c:
    ...
    ctx->pc = 0x1C8A58u;
    {
        ...
        if (branch_taken_0x1c8a58) {
            ctx->pc = 0x1C8A5Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1C8A58u;
            // 0x1c8a5c: 0x8e020004  lw          $v0, 0x4($s0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x1C89F8u;
...
label_1c8a74:
    ...
    ctx->pc = 0x1C8A70u;
    {
        ...
        ctx->pc = 0x1C8A74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C8A70u;
            // 0x1c8a74: 0xdfb00000  ld          $s0, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
...
label_1c8a84:
    ...
    ctx->pc = 0x1C8A84u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C8A80u;
            // 0x1c8a84: 0x8e040000  lw          $a0, 0x0($s0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 0)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x115288u;
    if (runtime->hasFunction(0x115288u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C8A88u; }
        if (ctx->pc != 0x1C8A88u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
