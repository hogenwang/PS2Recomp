...
void sub_001B1AE0_0x1b1ae0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1AF0u; }
        if (ctx->pc != 0x1B1AF0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b1af0:
    ...
    ctx->pc = 0x1B1B08u;
    if (runtime->hasFunction(0x1B1B08u)) {
        auto targetFn = runtime->lookupFunction(0x1B1B08u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1AF8u; }
        if (ctx->pc != 0x1B1AF8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001B1B08_0x1b1b08(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B1AF8u; }
        if (ctx->pc != 0x1B1AF8u) { return; }
    }
    ctx->pc = 0x1B1AF8u;
label_1b1af8:
    ...
    ctx->pc = 0x1B1AFCu;
    ctx->pc = 0x1B1B00u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B1AFCu;
