...
void sub_00339930_0x339930(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x339934u;
    {
        ...
        ctx->pc = 0x339938u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x339934u;
    ...
    ctx->pc = 0x33994Cu;
    {
        ...
        ctx->pc = 0x339950u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x33994Cu;
...
label_339a14:
    ...
    if (runtime->hasFunction(0x33BA10u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x339A1Cu; }
        if (ctx->pc != 0x339A1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_339a1c:
    ...
    ctx->pc = 0x339A38u;
    {
        ...
        ctx->pc = 0x339A3Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x339A38u;
