...
label_10e1d4:
    ...
    ctx->pc = 0x10E1D4u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x10E1D4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10e1dcu;
    // NOP
    if (ctx->pc == 0x10e1dcu) { ctx->pc = 0x10e1e0u; }
}
