...
void sub_001F7BE0_0x1f7be0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F7BECu;
    // 0x1f7bf0: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F81A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F81A0u, 0x1F7BECu, 0x1F7BF4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F7BF4u;
label_1f7bf4:
    ...
    ctx->pc = 0x1F7CB8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F7CB8u, 0x1F7BFCu, 0x1F7C04u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F7C04u;
label_1f7c04:
...
label_1f7c40:
    ...
    ctx->pc = 0x1F7C48u;
    {
        ...
        ctx->pc = 0x1F7C4Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F7C48u;
        // 0x1f7c4c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F7C48u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
