...
void sub_001AD6F8_0x1ad6f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1AD724u;
    // 0x1ad728: 0xa0882d  daddu       $s1, $a1, $zero (Delay Slot)
    SET_GPR_U64(ctx, 17, (uint64_t)GPR_U64(ctx, 5) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD680u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD680u, 0x1AD724u, 0x1AD72Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AD72Cu;
label_1ad72c:
...
label_1ad810:
    ...
    ctx->pc = 0x1AD824u;
    {
        ...
        ctx->pc = 0x1AD828u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1AD824u;
        // 0x1ad828: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1AD824u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1AD870u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1AD86Cu;
    // 0x1ad870: 0xafa20000  sw          $v0, 0x0($sp) (Delay Slot)
    WRITE32(ADD32(GPR_U32(ctx, 29), 0), GPR_U32(ctx, 2));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1AD8F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1AD8F8u, 0x1AD86Cu, 0x1AD874u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1AD874u;
label_1ad874:
