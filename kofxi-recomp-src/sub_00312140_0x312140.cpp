...
label_312170:
    ...
    ctx->pc = 0x312184u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x312180u;
    // 0x312184: 0x306500ff  andi        $a1, $v1, 0xFF (Delay Slot)
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 3) & (uint64_t)(uint16_t)255);
    ctx->in_delay_slot = false;
    ctx->pc = 0x312100u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x312100u, 0x312180u, 0x312188u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x312188u;
label_312188:
...
label_31219c:
    ...
    ctx->pc = 0x31219Cu;
    {
        ...
        ctx->pc = 0x3121A0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x31219Cu;
        // 0x3121a0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x31219Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x3121acu;
    // NOP
    if (ctx->pc == 0x3121acu) { ctx->pc = 0x3121b0u; }
}
