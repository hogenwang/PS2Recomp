...
label_215490:
    ...
    ctx->pc = 0x215498u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x215498u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_2154c8:
    ...
    ctx->pc = 0x2154DCu;
    {
        ...
        ctx->pc = 0x2154E0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2154DCu;
        // 0x2154e0: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2154DCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x2154e4u;
    // NOP
    if (ctx->pc == 0x2154e4u) { ctx->pc = 0x2154e8u; }
}
