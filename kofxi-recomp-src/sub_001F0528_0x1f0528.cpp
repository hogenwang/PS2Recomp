...
void sub_001F0528_0x1f0528(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F0558u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F0554u;
    ...
    if (runtime->hasFunction(0x1EB570u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F055Cu; }
        if (ctx->pc != 0x1F055Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f055c:
    ...
    ctx->pc = 0x1F0560u;
    {
        ...
        ctx->pc = 0x1F0564u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F0560u;
    ...
    if (runtime->hasFunction(0x1EB570u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F0570u; }
        if (ctx->pc != 0x1F0570u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001EB570_0x1eb570(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F0570u; }
...
label_1f0570:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F0578u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F05D8u;
    if (runtime->hasFunction(0x1F05D8u)) {
        auto targetFn = runtime->lookupFunction(0x1F05D8u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_001F05D8_0x1f05d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F0580u; }
        if (ctx->pc != 0x1F0580u) { return; }
    }
    ctx->pc = 0x1F0580u;
label_1f0580:
    ...
    ctx->pc = 0x1F0580u;
    {
        ...
        ctx->pc = 0x1F0584u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F0580u;
    ...
    ctx->pc = 0x1F0590u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F058Cu;
    ...
    if (runtime->hasFunction(0x1EB540u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F0594u; }
        if (ctx->pc != 0x1F0594u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f0594:
    ...
    ctx->pc = 0x1F05ACu;
    ctx->pc = 0x1F05B0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F05ACu;
            // 0x1f05b0: 0x27bd0030  addiu       $sp, $sp, 0x30 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 48));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1F0788u;
    {
        auto targetFn = runtime->lookupFunction(0x1F0788u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        return;
    }
...
label_1f05bc:
    ...
    ctx->pc = 0x1F05CCu;
    {
        ...
        ctx->pc = 0x1F05D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F05CCu;
