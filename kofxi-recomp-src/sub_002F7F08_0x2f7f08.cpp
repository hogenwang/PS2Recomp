...
void sub_002F7F08_0x2f7f08(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2FC4B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2FC4B0u, 0x2F7F20u, 0x2F7F28u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2F7F28u;
label_2f7f28:
...
label_2f7f2c:
    ...
    ctx->pc = 0x2F7F30u;
    {
        ...
        ctx->pc = 0x2F7F34u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2F7F30u;
        // 0x2f7f34: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2F7F30u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
