...
void sub_001C1450_0x1c1450(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C146Cu;
    ctx->pc = 0x1C1470u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C146Cu;
...
label_1c1488:
    ...
    ctx->pc = 0x1C14ACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C14A8u;
    ...
    if (runtime->hasFunction(0x1CE7E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C14B0u; }
        if (ctx->pc != 0x1C14B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c14c4:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C14C4u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x11C588u;
    if (runtime->hasFunction(0x11C588u)) {
        auto targetFn = runtime->lookupFunction(0x11C588u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0011C588_0x11c588(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C14CCu; }
        if (ctx->pc != 0x1C14CCu) { return; }
    }
    ctx->pc = 0x1C14CCu;
...
label_1c14d8:
    ...
    ctx->pc = 0x1C14D8u;
    {
        ...
        if (branch_taken_0x1c14d8) {
            ctx->pc = 0x1C14DCu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1C14D8u;
...
label_1c14f4:
    ...
    ctx->pc = 0x1C1504u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1C1508u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C1504u;
