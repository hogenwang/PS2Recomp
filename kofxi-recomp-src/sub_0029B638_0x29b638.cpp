...
void sub_0029B638_0x29b638(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x29B64Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29B648u;
    ...
    if (runtime->hasFunction(0x283A50u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x29B650u; }
        if (ctx->pc != 0x29B650u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29b650:
    ...
    if (runtime->hasFunction(0x2A3028u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x29B664u; }
        if (ctx->pc != 0x29B664u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_29b668:
    ...
    ctx->pc = 0x29B668u;
    {
        ...
        if (branch_taken_0x29b668) {
            ctx->pc = 0x29B66Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x29B668u;
...
label_29b690:
    ...
    ctx->pc = 0x29B69Cu;
    {
        ...
        ctx->pc = 0x29B6A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29B69Cu;
    ...
    ctx->pc = 0x29B6ACu;
    ctx->pc = 0x29B6B0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x29B6ACu;
...
label_29b6b4:
    ...
    ctx->pc = 0x29B6B8u;
    {
        ...
        ctx->pc = 0x29B6BCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x29B6B8u;
