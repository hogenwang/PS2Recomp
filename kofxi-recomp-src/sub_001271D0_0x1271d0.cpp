...
void sub_001271D0_0x1271d0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x127228u: goto label_127228;
...
label_127204:
    ...
    ctx->pc = 0x127220u;
    {
        ...
        ctx->pc = 0x127224u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127220u;
...
label_127228:
    ...
    ctx->pc = 0x12722Cu;
    {
        ...
        if (branch_taken_0x12722c) {
            ctx->pc = 0x127230u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12722Cu;
...
label_127248:
    ...
    ctx->pc = 0x12726Cu;
    {
        ...
        ctx->pc = 0x127270u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12726Cu;
    ...
    ctx->pc = 0x127278u;
    {
        ...
        ctx->pc = 0x12727Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x127278u;
...
label_1272a4:
    ...
    ctx->pc = 0x1272A8u;
    {
        ...
        ctx->pc = 0x1272ACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1272A8u;
...
label_1272cc:
    ...
    ctx->pc = 0x1272CCu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1272D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1272CCu;
