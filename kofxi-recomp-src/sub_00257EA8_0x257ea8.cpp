...
void sub_00257EA8_0x257ea8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x257EB4u;
    // 0x257eb8: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x231A08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x231A08u, 0x257EB4u, 0x257EBCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x257EBCu;
label_257ebc:
    ...
    ctx->pc = 0x257edcu;
    // NOP
    if (ctx->pc == 0x257edcu) { ctx->pc = 0x257ee0u; }
}
