...
void sub_001C7B30_0x1c7b30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C7B40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C7B3Cu;
    ...
    if (runtime->hasFunction(0x1C7A08u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C7B44u; }
        if (ctx->pc != 0x1C7B44u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1c7b44:
    ...
    ctx->pc = 0x1C7B48u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C7B44u;
            // 0x1c7b48: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C7B60u;
    if (runtime->hasFunction(0x1C7B60u)) {
        auto targetFn = runtime->lookupFunction(0x1C7B60u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C7B4Cu; }
        if (ctx->pc != 0x1C7B4Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C7B60_0x1c7b60(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C7B4Cu; }
        if (ctx->pc != 0x1C7B4Cu) { return; }
    }
    ctx->pc = 0x1C7B4Cu;
