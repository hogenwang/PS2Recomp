...
label_20b378:
    ...
    ctx->pc = 0x20B3E0u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x20B3E0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x20b3ecu;
    // NOP
    if (ctx->pc == 0x20b3ecu) { ctx->pc = 0x20b3f0u; }
}
