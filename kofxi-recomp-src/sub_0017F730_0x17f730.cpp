...
label_17f854:
    ...
    ctx->pc = 0x17F854u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x17F854u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x17f85cu;
    // NOP
    if (ctx->pc == 0x17f85cu) { ctx->pc = 0x17f860u; }
}
