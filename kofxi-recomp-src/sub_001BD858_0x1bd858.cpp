...
void sub_001BD858_0x1bd858(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1BD868u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BD864u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BD86Cu; }
        if (ctx->pc != 0x1BD86Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1bd86c:
    ...
    ctx->pc = 0x1BD870u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BD86Cu;
            // 0x1bd870: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1BD888u;
    if (runtime->hasFunction(0x1BD888u)) {
        auto targetFn = runtime->lookupFunction(0x1BD888u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BD874u; }
        if (ctx->pc != 0x1BD874u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BD888_0x1bd888(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BD874u; }
        if (ctx->pc != 0x1BD874u) { return; }
    }
    ctx->pc = 0x1BD874u;
label_1bd874:
    ...
    ctx->pc = 0x1BD87Cu;
    ctx->pc = 0x1BD880u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BD87Cu;
