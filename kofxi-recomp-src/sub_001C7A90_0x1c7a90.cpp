...
label_1c7ab0:
    ...
    ctx->pc = 0x1C7AACu;
    {
        ...
        ctx->pc = 0x1C7AB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C7AACu;
            // 0x1c7ab0: 0x8c444370  lw          $a0, 0x4370($v0) (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 17264)));
        ctx->in_delay_slot = false;
        if (jumpTarget == 0u) {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x1C7AB4u; }
            if (ctx->pc != 0x1C7AB4u) { return; }
        }
        }
    }
    ctx->pc = 0x1C7AB4u;
...
label_1c7abc:
    ...
    ctx->pc = 0x1C7AB8u;
    {
        ...
        ctx->pc = 0x1C7ABCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1C7AB8u;
            // 0x1c7abc: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
