...
label_33a500:
    ...
    ctx->pc = 0x33A500u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x33A500u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x33a50cu;
    // NOP
    if (ctx->pc == 0x33a50cu) { ctx->pc = 0x33a510u; }
}
