...
void sub_001FC948_0x1fc948(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1FC974u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1FC970u;
    // 0x1fc974: 0x27a60004  addiu       $a2, $sp, 0x4 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 29), 4));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FCA60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FCA60u, 0x1FC970u, 0x1FC978u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FC978u;
label_1fc978:
    ...
    ctx->pc = 0x1FC984u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1FC980u;
    // 0x1fc984: 0x8fa60004  lw          $a2, 0x4($sp) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 29), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FC9A8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FC9A8u, 0x1FC980u, 0x1FC988u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FC988u;
label_1fc988:
    ...
    ctx->pc = 0x1FC994u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1FC990u;
    // 0x1fc994: 0x8fa60004  lw          $a2, 0x4($sp) (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 29), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1FCA10u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1FCA10u, 0x1FC990u, 0x1FC998u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1FC998u;
label_1fc998:
...
label_1fc99c:
    ...
    ctx->pc = 0x1FC9A0u;
    {
        ...
        ctx->pc = 0x1FC9A4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1FC9A0u;
        // 0x1fc9a4: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1FC9A0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
