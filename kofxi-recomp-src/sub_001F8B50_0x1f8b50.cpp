...
void sub_001F8B50_0x1f8b50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1F8B5Cu;
    // 0x1f8b60: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ED920u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ED920u, 0x1F8B5Cu, 0x1F8B64u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8B64u;
label_1f8b64:
...
label_1f8b88:
    ...
    ctx->pc = 0x1F8B8Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F8B88u;
    // 0x1f8b8c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F8D28u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F8D28u, 0x1F8B88u, 0x1F8B90u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8B90u;
label_1f8b90:
    ...
    ctx->pc = 0x1F8B94u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F8B90u;
    // 0x1f8b94: 0x26040078  addiu       $a0, $s0, 0x78 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 16), 120));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1ECA38u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1ECA38u, 0x1F8B90u, 0x1F8B98u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8B98u;
label_1f8b98:
    ...
    ctx->pc = 0x1F8B9Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1F8B98u;
    // 0x1f8b9c: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1EA2A0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1EA2A0u, 0x1F8B98u, 0x1F8BA0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8BA0u;
label_1f8ba0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1F8BF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1F8BF0u, 0x1F8BA0u, 0x1F8BA8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F8BA8u;
label_1f8ba8:
...
label_1f8bc4:
    ...
    ctx->pc = 0x1F8BE8u;
    {
        ...
        ctx->pc = 0x1F8BECu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F8BE8u;
        // 0x1f8bec: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F8BE8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
