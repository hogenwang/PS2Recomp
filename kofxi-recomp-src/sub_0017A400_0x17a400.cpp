...
void sub_0017A400_0x17a400(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x17A404u;
    {
        ...
        if (branch_taken_0x17a404) {
            ctx->pc = 0x17A408u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x17A404u;
...
label_17a430:
    ...
    ctx->pc = 0x17A458u;
    {
        ...
        if (branch_taken_0x17a458) {
            ctx->pc = 0x17A45Cu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x17A458u;
...
label_17a468:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x17A468u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x14D080u;
    if (runtime->hasFunction(0x14D080u)) {
        auto targetFn = runtime->lookupFunction(0x14D080u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_0014D080_0x14d080(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x17A470u; }
        if (ctx->pc != 0x17A470u) { return; }
    }
    ctx->pc = 0x17A470u;
...
label_17a4a0:
    ...
    ctx->pc = 0x17A4BCu;
    {
        ...
        if (branch_taken_0x17a4bc) {
            ctx->pc = 0x17A4C0u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x17A4BCu;
...
label_17a500:
    ...
    ctx->pc = 0x17A524u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x17A528u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x17A524u;
