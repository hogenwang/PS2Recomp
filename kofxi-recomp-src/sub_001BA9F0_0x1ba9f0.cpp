...
void sub_001BA9F0_0x1ba9f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1BAA08u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAA04u;
    ...
    if (runtime->hasFunction(0x1AD268u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAA0Cu; }
        if (ctx->pc != 0x1BAA0Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1baa0c:
    ...
    if (runtime->hasFunction(0x1BAA30u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAA18u; }
        if (ctx->pc != 0x1BAA18u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001BAA30_0x1baa30(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1BAA18u; }
        if (ctx->pc != 0x1BAA18u) { return; }
    }
    ctx->pc = 0x1BAA18u;
label_1baa18:
    ...
    ctx->pc = 0x1BAA24u;
    ctx->pc = 0x1BAA28u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1BAA24u;
