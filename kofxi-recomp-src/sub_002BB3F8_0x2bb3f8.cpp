...
void sub_002BB3F8_0x2bb3f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2BB410u;
    {
        ...
        ctx->pc = 0x2BB414u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BB410u;
    ...
    ctx->pc = 0x2BB41Cu;
    {
        ...
        ctx->pc = 0x2BB420u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BB41Cu;
    ...
    ctx->pc = 0x2BB438u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BB434u;
    ...
    if (runtime->hasFunction(0x2A2CE8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BB43Cu; }
        if (ctx->pc != 0x2BB43Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bb43c:
    ...
    ctx->pc = 0x2BB444u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BB440u;
    ...
    if (runtime->hasFunction(0x2BB488u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BB448u; }
        if (ctx->pc != 0x2BB448u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2bb448:
    ...
    ctx->pc = 0x2BB45Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2BB458u;
    ...
    if (runtime->hasFunction(0x2A2CE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BB460u; }
        if (ctx->pc != 0x2BB460u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002A2CE8_0x2a2ce8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2BB460u; }
...
label_2bb460:
    ...
    ctx->pc = 0x2BB460u;
    {
        ...
        ctx->pc = 0x2BB464u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2BB460u;
