...
void sub_001F1E80_0x1f1e80(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x120630u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x120630u, 0x1F1EA8u, 0x1F1EB0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F1EB0u;
label_1f1eb0:
    ...
    ctx->pc = 0x1F1EB4u;
    {
        ...
        ctx->pc = 0x1F1EB8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F1EB4u;
        // 0x1f1eb8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F1EB4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f1ebcu;
    // NOP
    if (ctx->pc == 0x1f1ebcu) { ctx->pc = 0x1f1ec0u; }
}
