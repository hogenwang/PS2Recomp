...
void sub_00116860_0x116860(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x1168b0u: goto label_1168b0;
        case 0x1168c0u: goto label_1168c0;
        case 0x1168d0u: goto label_1168d0;
        case 0x1168e0u: goto label_1168e0;
        case 0x1168f0u: goto label_1168f0;
...
label_116870:
    ...
    ctx->pc = 0x11687Cu;
    {
        ...
        ctx->pc = 0x116880u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11687Cu;
    ...
    ctx->pc = 0x116884u;
    {
        ...
        ctx->pc = 0x116888u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x116884u;
...
label_116894:
    ...
    ctx->pc = 0x116898u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x11689Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x116898u;
...
label_116900:
    ...
    ctx->pc = 0x10D0C0u;
    if (runtime->hasFunction(0x10D0C0u)) {
        auto targetFn = runtime->lookupFunction(0x10D0C0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x116910u; }
        if (ctx->pc != 0x116910u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010D0C0_0x10d0c0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x116910u; }
        if (ctx->pc != 0x116910u) { return; }
    }
    ctx->pc = 0x116910u;
label_116910:
    ...
    ctx->pc = 0x116940u;
    if (runtime->hasFunction(0x116940u)) {
        auto targetFn = runtime->lookupFunction(0x116940u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x116924u; }
        if (ctx->pc != 0x116924u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00116940_0x116940(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x116924u; }
        if (ctx->pc != 0x116924u) { return; }
    }
    ctx->pc = 0x116924u;
...
label_11692c:
    ...
    ctx->pc = 0x10D0D0u;
    if (runtime->hasFunction(0x10D0D0u)) {
        auto targetFn = runtime->lookupFunction(0x10D0D0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x116934u; }
        if (ctx->pc != 0x116934u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010D0D0_0x10d0d0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x116934u; }
        if (ctx->pc != 0x116934u) { return; }
    }
    ctx->pc = 0x116934u;
...
label_116938:
    ...
    ctx->pc = 0x116938u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x11693Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x116938u;
