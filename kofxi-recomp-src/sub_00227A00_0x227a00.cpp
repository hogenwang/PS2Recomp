...
label_227a30:
    ...
    ctx->pc = 0x227A30u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x227A2Cu;
            // 0x227a30: 0x200482d  daddu       $t1, $s0, $zero (Delay Slot)
        SET_GPR_U64(ctx, 9, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ...
    if (runtime->hasFunction(0x225F58u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x227A34u; }
        if (ctx->pc != 0x227A34u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_227a48:
    ...
    ctx->pc = 0x227A44u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            const uint32_t __entryPc = ctx->pc;
            targetFn(rdram, ctx, runtime);
            if (ctx->pc == __entryPc) { ctx->pc = 0x227A4Cu; }
            if (ctx->pc != 0x227A4Cu) { return; }
        }
        }
    }
    ctx->pc = 0x227A4Cu;
...
label_227a9c:
    ...
    ctx->pc = 0x227A9Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x227A98u;
            // 0x227a9c: 0x2484f538  addiu       $a0, $a0, -0xAC8 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294964536));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1272D8u;
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x227AA0u; }
        if (ctx->pc != 0x227AA0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001272D8_0x1272d8(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x227AA0u; }
...
label_227ab0:
    ...
    ctx->pc = 0x227AACu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x227AB0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x227AACu;
            // 0x227ab0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
