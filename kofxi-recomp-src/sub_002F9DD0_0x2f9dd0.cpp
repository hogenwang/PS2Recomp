...
label_2f9e18:
    ...
    ctx->pc = 0x2F9E1Cu;
    {
        ...
        ctx->pc = 0x2F9E20u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9E1Cu;
...
label_2f9e30:
    ...
    ctx->pc = 0x2F9E48u;
    {
        ...
        ctx->pc = 0x2F9E4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9E48u;
    ...
    if (runtime->hasFunction(0x10CC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F9E58u; }
        if (ctx->pc != 0x2F9E58u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2f9e60:
    ...
    ctx->pc = 0x2F9E70u;
    {
        ...
        ctx->pc = 0x2F9E74u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9E70u;
...
label_2f9e78:
    ...
    ctx->pc = 0x2F9E7Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2F9E80u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9E7Cu;
