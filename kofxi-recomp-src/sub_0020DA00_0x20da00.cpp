...
void sub_0020DA00_0x20da00(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x20DA5Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x20DA58u;
            // 0x20da5c: 0xa22821  addu        $a1, $a1, $v0 (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 2)));
        ctx->in_delay_slot = false;
    ctx->pc = 0x20B3F0u;
    if (runtime->hasFunction(0x20B3F0u)) {
        auto targetFn = runtime->lookupFunction(0x20B3F0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20DA60u; }
        if (ctx->pc != 0x20DA60u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0020B3F0_0x20b3f0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x20DA60u; }
        if (ctx->pc != 0x20DA60u) { return; }
    }
    ctx->pc = 0x20DA60u;
label_20da60:
    ...
    ctx->pc = 0x20DA64u;
    {
        ...
        ctx->pc = 0x20DA68u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x20DA64u;
