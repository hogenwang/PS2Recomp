...
label_1df750:
    ...
    ctx->pc = 0x1DF760u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1DF75Cu;
    // 0x1df760: 0x2484cac8  addiu       $a0, $a0, -0x3538 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294953672));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1E6BE8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1E6BE8u, 0x1DF75Cu, 0x1DF764u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1DF764u;
label_1df764:
...
label_1df76c:
    ...
    ctx->pc = 0x1DF770u;
    {
        ...
        ctx->pc = 0x1DF774u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1DF770u;
        // 0x1df774: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1DF770u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
