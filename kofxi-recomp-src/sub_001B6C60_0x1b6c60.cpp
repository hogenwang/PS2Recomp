...
void sub_001B6C60_0x1b6c60(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B6C70u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6C6Cu;
    ...
    if (runtime->hasFunction(0x1B8150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6C74u; }
        if (ctx->pc != 0x1B6C74u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b6c74:
    ...
    ctx->pc = 0x1B6C78u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B6C74u;
    ...
    if (runtime->hasFunction(0x1B6C98u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B6C7Cu; }
        if (ctx->pc != 0x1B6C7Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
