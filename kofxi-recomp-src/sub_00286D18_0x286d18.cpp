...
void sub_00286D18_0x286d18(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x286D2Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x286D28u;
    ...
    if (runtime->hasFunction(0x286808u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x286D30u; }
        if (ctx->pc != 0x286D30u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_286d30:
    ...
    ctx->pc = 0x286D4Cu;
    {
        ...
        ctx->pc = 0x286D50u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286D4Cu;
...
label_286d54:
    ...
    ctx->pc = 0x286D54u;
    {
        ...
        ctx->pc = 0x286D58u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286D54u;
...
label_286d5c:
    ...
    ctx->pc = 0x286D64u;
    {
        ...
        ctx->pc = 0x286D68u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286D64u;
...
label_286d90:
    ...
    ctx->pc = 0x286D9Cu;
    {
        ...
        ctx->pc = 0x286DA0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x286D9Cu;
