...
void sub_0012A230_0x12a230(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x12A244u;
    {
        ...
        if (branch_taken_0x12a244) {
            ctx->pc = 0x12A248u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12A244u;
...
label_12a2b0:
    ...
    ctx->pc = 0x12A2D4u;
    {
        ...
        ctx->pc = 0x12A2D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A2D4u;
...
label_12a2dc:
    ...
    ctx->pc = 0x12A31Cu;
    {
        ...
        ctx->pc = 0x12A320u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12A31Cu;
...
label_12a328:
    ...
    ctx->pc = 0x12A33Cu;
    {
        ...
        if (branch_taken_0x12a33c) {
            ctx->pc = 0x12A340u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12A33Cu;
