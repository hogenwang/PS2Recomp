...
void sub_00117C90_0x117c90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x117d0cu: goto label_117d0c;
        default: break;
    }
...
label_117cc4:
    ...
    ctx->pc = 0x117CC4u;
    {
        ...
        if (branch_taken_0x117cc4) {
            ctx->pc = 0x117CC8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x117CC4u;
...
label_117cfc:
    ...
    ctx->pc = 0x117CFCu;
    {
        ...
        ctx->pc = 0x117D00u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x117CFCu;
    ...
    ctx->pc = 0x117D04u;
    {
        ...
        ctx->pc = 0x117D08u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x117D04u;
...
label_117d0c:
    ...
    ctx->pc = 0x117D0Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x117D10u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x117D0Cu;
