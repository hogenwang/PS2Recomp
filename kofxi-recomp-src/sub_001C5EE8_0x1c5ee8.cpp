...
void sub_001C5EE8_0x1c5ee8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1C5F00u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C5EFCu;
...
label_1c5f04:
    ...
    ctx->pc = 0x1C5F0Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C5F08u;
            // 0x1c5f0c: 0x220282d  daddu       $a1, $s1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1C5F28u;
    if (runtime->hasFunction(0x1C5F28u)) {
        auto targetFn = runtime->lookupFunction(0x1C5F28u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C5F10u; }
        if (ctx->pc != 0x1C5F10u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001C5F28_0x1c5f28(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C5F10u; }
        if (ctx->pc != 0x1C5F10u) { return; }
    }
    ctx->pc = 0x1C5F10u;
label_1c5f10:
    ...
    ctx->pc = 0x1C5F1Cu;
    ctx->pc = 0x1C5F20u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1C5F1Cu;
