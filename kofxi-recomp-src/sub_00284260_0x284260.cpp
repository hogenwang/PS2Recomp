...
label_2842d8:
    ...
    ctx->pc = 0x2842E4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x2842E0u;
    // 0x2842e4: 0x24040008  addiu       $a0, $zero, 0x8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 8));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2A2FD8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2A2FD8u, 0x2842E0u, 0x2842E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x2842E8u;
label_2842e8:
...
label_2842fc:
    ...
    ctx->pc = 0x284308u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x284304u;
    // 0x284308: 0x24060008  addiu       $a2, $zero, 0x8 (Delay Slot)
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 0), 8));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1272D8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1272D8u, 0x284304u, 0x28430Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28430Cu;
label_28430c:
...
label_284390:
    ...
    ctx->pc = 0x283B70u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x283B70u, 0x284390u, 0x284398u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x284398u;
label_284398:
...
label_28439c:
    ...
    ctx->pc = 0x2843B4u;
    {
        ...
        ctx->pc = 0x2843B8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2843B4u;
        // 0x2843b8: 0x27bd0060  addiu       $sp, $sp, 0x60 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 96));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2843B4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
