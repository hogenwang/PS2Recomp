...
label_1c11f0:
    ...
    ctx->pc = 0x1C1110u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C1110u, 0x1C1208u, 0x1C1210u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C1210u;
label_1c1210:
...
label_1c1218:
    ...
    ctx->pc = 0x1C122Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C1228u;
    // 0x1c122c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C1150u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C1150u, 0x1C1228u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1C1230u;
label_1c1230:
    ...
    ctx->pc = 0x1C1234u;
    {
        ...
        ctx->pc = 0x1C1238u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C1234u;
        // 0x1c1238: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C1234u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1C1254u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C1250u;
    // 0x1c1254: 0x248498a8  addiu       $a0, $a0, -0x6758 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294940840));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C1250u, 0x1C1258u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C1258u;
label_1c1258:
    ...
    ctx->pc = 0x1C1268u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C1264u;
    // 0x1c1268: 0x248498b8  addiu       $a0, $a0, -0x6748 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294940856));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C1264u, 0x1C126Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C126Cu;
label_1c126c:
    ...
    ctx->pc = 0x1C1280u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C127Cu;
    // 0x1c1280: 0x8c450000  lw          $a1, 0x0($v0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C127Cu, 0x1C1284u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C1284u;
label_1c1284:
    ...
    ctx->pc = 0x1C1298u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C1294u;
    // 0x1c1298: 0x82050002  lb          $a1, 0x2($s0) (Delay Slot)
    SET_GPR_S32(ctx, 5, (int8_t)READ8(ADD32(GPR_U32(ctx, 16), 2)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C1294u, 0x1C129Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C129Cu;
label_1c129c:
    ...
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C12B4u, 0x1C12BCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C12BCu;
label_1c12bc:
...
label_1c12c0:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C12D8u, 0x1C12E0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C12E0u;
label_1c12e0:
...
label_1c12e8:
    ...
    ctx->pc = 0x1C12F4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C12F0u;
    // 0x1c12f4: 0x24849958  addiu       $a0, $a0, -0x66A8 (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 4294941016));
    ctx->in_delay_slot = false;
    ctx->pc = 0x10F948u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10F948u, 0x1C12F0u, 0x1C12F8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C12F8u;
label_1c12f8:
    ...
    ctx->pc = 0x1C1304u;
    {
        ...
        ctx->pc = 0x1C1308u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C1304u;
        // 0x1c1308: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C1304u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1C1318u;
    {
        ...
        ctx->pc = 0x1C131Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C1318u;
        // 0x1c131c: 0x8c620000  lw          $v0, 0x0($v1) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 0)));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C1318u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1C1328u;
    {
        ...
        ctx->pc = 0x1C132Cu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C1328u;
        // 0x1c132c: 0x8c620000  lw          $v0, 0x0($v1) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 0)));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C1328u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
