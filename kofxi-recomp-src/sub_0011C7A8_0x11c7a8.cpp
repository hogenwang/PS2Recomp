...
void sub_0011C7A8_0x11c7a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11C7BCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11C7B8u;
    ...
    if (runtime->hasFunction(0x11BA80u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x11C7C0u; }
        if (ctx->pc != 0x11C7C0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_11c7c0:
    ...
    ctx->pc = 0x11C7C0u;
    {
        ...
        ctx->pc = 0x11C7C4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11C7C0u;
...
label_11c7d0:
    ...
    ctx->pc = 0x11C808u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11C804u;
    ...
    if (runtime->hasFunction(0x110D30u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x11C80Cu; }
        if (ctx->pc != 0x11C80Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_11c80c:
    ...
    if (runtime->hasFunction(0x10CC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x11C820u; }
        if (ctx->pc != 0x11C820u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_11c820:
    ...
    ctx->pc = 0x11C824u;
    {
        ...
        ctx->pc = 0x11C828u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11C824u;
...
label_11c82c:
    ...
    ctx->pc = 0x11C844u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11C840u;
    ...
    if (runtime->hasFunction(0x10CC80u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x11C848u; }
        if (ctx->pc != 0x11C848u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010CC80_0x10cc80(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x11C848u; }
...
label_11c84c:
    ...
    ctx->pc = 0x11C858u;
    {
        ...
        ctx->pc = 0x11C85Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11C858u;
