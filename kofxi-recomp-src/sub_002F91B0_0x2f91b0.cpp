...
label_2f91c0:
    ...
    ctx->pc = 0x2F91BCu;
    {
        ...
        ctx->pc = 0x2F91C0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F91BCu;
            // 0x2f91c0: 0xffbf0000  sd          $ra, 0x0($sp) (Delay Slot)
        WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
...
label_2f91c8:
    ...
    ctx->pc = 0x2F91C4u;
    {
        ...
        ctx->pc = jumpTarget;
        {
            ...
            if (ctx->pc == __entryPc) { ctx->pc = 0x2F91CCu; }
            if (ctx->pc != 0x2F91CCu) { return; }
        }
        }
    }
    ctx->pc = 0x2F91CCu;
...
label_2f91d0:
    ...
    ctx->pc = 0x2F91CCu;
    {
        ...
        ctx->pc = 0x2F91D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F91CCu;
            // 0x2f91d0: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
...
label_2f91d8:
    ...
    ctx->pc = 0x128FB0u;
    if (runtime->hasFunction(0x128FB0u)) {
        auto targetFn = runtime->lookupFunction(0x128FB0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F91DCu; }
        if (ctx->pc != 0x2F91DCu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00128FB0_0x128fb0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F91DCu; }
        if (ctx->pc != 0x2F91DCu) { return; }
    }
    ctx->pc = 0x2F91DCu;
