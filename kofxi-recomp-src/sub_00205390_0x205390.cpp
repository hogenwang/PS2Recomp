...
void sub_00205390_0x205390(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2053B4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2053B0u;
    ...
    if (runtime->hasFunction(0x203A70u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2053B8u; }
        if (ctx->pc != 0x2053B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2053b8:
    ...
    if (runtime->hasFunction(0x205130u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2053E4u; }
        if (ctx->pc != 0x2053E4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2053e4:
    ...
    ctx->pc = 0x205400u;
    {
        ...
        ctx->pc = 0x205404u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x205400u;
