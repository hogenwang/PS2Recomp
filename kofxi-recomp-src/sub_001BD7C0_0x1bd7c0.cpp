...
void sub_001BD7C0_0x1bd7c0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1B9370u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B9370u, 0x1BD7DCu, 0x1BD7E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BD7E4u;
label_1bd7e4:
    ...
    ctx->pc = 0x1BD80Cu;
    {
        ...
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BD80Cu, 0x0u, PS2Runtime::GuestBranchKind::IndirectJump, "JR")) {
            return;
        }
    }
    ctx->pc = 0x1BD814u;
...
label_1bd818:
    ...
    ctx->pc = 0x1BD81Cu;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BD818u;
    // 0x1bd81c: 0x8e040008  lw          $a0, 0x8($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 8)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B6C60u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B6C60u, 0x1BD818u, 0x1BD820u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BD820u;
label_1bd820:
    ...
    ctx->pc = 0x1BD830u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BD82Cu;
    // 0x1bd830: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B51B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B51B0u, 0x1BD82Cu, 0x1BD834u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BD834u;
label_1bd834:
...
label_1bd840:
    ...
    ctx->pc = 0x1BD844u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1BD840u;
    // 0x1bd844: 0x8e040004  lw          $a0, 0x4($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1B51B0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1B51B0u, 0x1BD840u, 0x1BD848u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1BD848u;
label_1bd848:
...
label_1bd84c:
    ...
    ctx->pc = 0x1BD850u;
    {
        ...
        ctx->pc = 0x1BD854u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1BD850u;
        // 0x1bd854: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1BD850u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
