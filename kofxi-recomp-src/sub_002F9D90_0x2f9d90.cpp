...
void sub_002F9D90_0x2f9d90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F9DA4u;
    {
        ...
        ctx->pc = 0x2F9DA8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9DA4u;
    ...
    ctx->pc = 0x2F9318u;
    if (runtime->hasFunction(0x2F9318u)) {
        auto targetFn = runtime->lookupFunction(0x2F9318u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F9DB4u; }
        if (ctx->pc != 0x2F9DB4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_002F9318_0x2f9318(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F9DB4u; }
        if (ctx->pc != 0x2F9DB4u) { return; }
    }
    ctx->pc = 0x2F9DB4u;
...
label_2f9dc4:
    ...
    ctx->pc = 0x2F9DC4u;
    {
        ...
        ctx->pc = 0x2F9DC8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F9DC4u;
