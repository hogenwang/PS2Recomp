...
void sub_00308270_0x308270(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x3082A4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x3082A0u;
    ...
    if (runtime->hasFunction(0x1272D8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x3082A8u; }
        if (ctx->pc != 0x3082A8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_3082d0:
    ...
    ctx->pc = 0x3082D4u;
    {
        ...
        if (branch_taken_0x3082d4) {
            ctx->pc = 0x3082D8u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x3082D4u;
...
label_308334:
    ...
    ctx->pc = 0x308348u;
    {
        ...
        ctx->pc = 0x30834Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x308348u;
...
label_308358:
    ...
    ctx->pc = 0x308370u;
    {
        ...
        if (branch_taken_0x308370) {
            ctx->pc = 0x308374u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x308370u;
...
label_308378:
    ...
    ctx->pc = 0x308394u;
    {
        ...
        ctx->pc = 0x308398u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x308394u;
