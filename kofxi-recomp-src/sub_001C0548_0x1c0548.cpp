...
void sub_001C0548_0x1c0548(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x1C057Cu;
    // 0x1c0580: 0xc0a82d  daddu       $s5, $a2, $zero (Delay Slot)
    SET_GPR_U64(ctx, 21, (uint64_t)GPR_U64(ctx, 6) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1CDB78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDB78u, 0x1C057Cu, 0x1C0584u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C0584u;
label_1c0584:
...
label_1c05c8:
    ...
    ctx->pc = 0x1CDBF0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDBF0u, 0x1C05C8u, 0x1C05D0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C05D0u;
label_1c05d0:
    ...
    ctx->pc = 0x1C05F0u;
    {
        ...
        ctx->pc = 0x1C05F4u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C05F0u;
        // 0x1c05f4: 0x27bd0040  addiu       $sp, $sp, 0x40 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 64));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C05F0u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
