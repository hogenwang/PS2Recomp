...
void sub_001E32B0_0x1e32b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1E32C0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E32BCu;
    ...
    if (runtime->hasFunction(0x1E2960u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E32C4u; }
        if (ctx->pc != 0x1E32C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e32c4:
    ...
    ctx->pc = 0x1E32DCu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E32D8u;
    ...
    if (runtime->hasFunction(0x1E6BE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E32E0u; }
        if (ctx->pc != 0x1E32E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e32e8:
    ...
    if (runtime->hasFunction(0x1E27F0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1E32F0u; }
        if (ctx->pc != 0x1E32F0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1e3360:
    ...
    ctx->pc = 0x1E3380u;
    ctx->pc = 0x1E3384u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E3380u;
