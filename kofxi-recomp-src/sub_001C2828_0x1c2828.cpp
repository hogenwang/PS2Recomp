...
void sub_001C2828_0x1c2828(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1CDB78u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1CDB78u, 0x1C2844u, 0x1C284Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C284Cu;
label_1c284c:
    ...
    ctx->pc = 0x1C2850u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C284Cu;
    // 0x1c2850: 0x8e04001c  lw          $a0, 0x1C($s0) (Delay Slot)
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 28)));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C05F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C05F8u, 0x1C284Cu, 0x1C2854u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C2854u;
label_1c2854:
    ...
    ctx->pc = 0x1C2874u;
    {
        ...
        if (!runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C2874u, 0x0u, PS2Runtime::GuestBranchKind::IndirectJump, "JR")) {
            return;
        }
    }
    ctx->pc = 0x1C287Cu;
...
label_1c28c0:
    ...
    ctx->pc = 0x1C03B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C03B8u, 0x1C28C0u, 0x1C28C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C28C8u;
label_1c28c8:
...
label_1c28e0:
    ...
    ctx->pc = 0x1C28E4u;
    {
        ...
        ctx->pc = 0x1C28E8u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1C28E4u;
        // 0x1c28e8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1C28E4u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1c28ecu;
    // NOP
    if (ctx->pc == 0x1c28ecu) { ctx->pc = 0x1c28f0u; }
}
