...
void sub_002F18E8_0x2f18e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->branch_pc = 0x2F1904u;
    // 0x2f1908: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
    ctx->in_delay_slot = false;
    ctx->pc = 0x2F17C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x2F17C0u, 0x2F1904u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x2F190Cu;
    // 0x2f190c: 0x0  nop
    ctx->pc = 0x2f190cu;
    // NOP
    if (ctx->pc == 0x2f190cu) { ctx->pc = 0x2f1910u; }
}
