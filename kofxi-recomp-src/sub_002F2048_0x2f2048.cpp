...
void sub_002F2048_0x2f2048(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2F2064u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2F2060u;
    ...
    if (runtime->hasFunction(0x2F5650u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F2068u; }
        if (ctx->pc != 0x2F2068u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2f2068:
    ...
    if (runtime->hasFunction(0x2F9178u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2F207Cu; }
        if (ctx->pc != 0x2F207Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2f2080:
    ...
    ctx->pc = 0x2F2084u;
    {
        ...
        if (branch_taken_0x2f2084) {
            ctx->pc = 0x2F2088u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x2F2084u;
...
label_2f209c:
    ...
    ctx->pc = 0x2F20B0u;
    {
        ...
        ctx->pc = 0x2F20B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2F20B0u;
