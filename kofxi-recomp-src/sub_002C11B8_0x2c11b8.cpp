...
void sub_002C11B8_0x2c11b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2C11CCu;
    {
        ...
        ctx->pc = 0x2C11D0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C11CCu;
...
label_2c11dc:
    ...
    ctx->pc = 0x2C11DCu;
    {
        ...
        ctx->pc = 0x2C11E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2C11DCu;
...
label_2c11e4:
    ...
    ctx->pc = 0x2C11E8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C11E4u;
...
label_2c11ec:
    ...
    ctx->pc = 0x2C11F0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2C11ECu;
