...
void sub_00102D30_0x102d30(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        case 0x102d48u: goto label_102d48;
    ...
    ctx->pc = 0x102D40u;
    {
        ...
        ctx->pc = 0x102D44u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x102D40u;
...
label_102d48:
    ...
    ctx->pc = 0x102D48u;
    {
        ...
        ctx->pc = 0x102D4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x102D48u;
...
label_102d58:
    ...
    ctx->pc = 0x102D58u;
    {
        ...
        ctx->pc = 0x102D5Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x102D58u;
    ...
    ctx->pc = 0x102D60u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x102D64u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x102D60u;
...
label_102d68:
    ...
    ctx->pc = 0x102D68u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x102D6Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x102D68u;
