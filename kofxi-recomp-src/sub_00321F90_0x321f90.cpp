...
void sub_00321F90_0x321f90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x321FA4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x321FA0u;
    ...
    if (runtime->hasFunction(0x321F70u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x321FA8u; }
        if (ctx->pc != 0x321FA8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_321fa8:
    ...
    ctx->pc = 0x321FD0u;
    {
        ...
        ctx->pc = 0x321FD4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x321FD0u;
