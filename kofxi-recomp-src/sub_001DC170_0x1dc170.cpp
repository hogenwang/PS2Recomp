...
void sub_001DC170_0x1dc170(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1DC180u;
    {
        ...
        ctx->branch_pc = 0x1DC180u;
        // 0x1dc184: 0xacc30000  sw          $v1, 0x0($a2) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 6), 0), GPR_U32(ctx, 3));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1DC180u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1dc188:
    ...
    ctx->pc = 0x1DC198u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1DC194u;
    // 0x1dc198: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1DC3B8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DC3B8u, 0x1DC194u, 0x1DC19Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1DC19Cu;
label_1dc19c:
...
label_1dc1c0:
    ...
    ctx->pc = 0x1DC458u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DC458u, 0x1DC1C0u, 0x1DC1C8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1DC1C8u;
label_1dc1c8:
    ...
    ctx->pc = 0x1DC1D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1DC1CCu;
    // 0x1dc1d0: 0x24050428  addiu       $a1, $zero, 0x428 (Delay Slot)
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 0), 1064));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1DC1F8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1DC1F8u, 0x1DC1CCu, 0x1DC1D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1DC1D4u;
label_1dc1d4:
    ...
    ctx->pc = 0x1DC1E8u;
    {
        ...
        ctx->pc = 0x1DC1ECu;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1DC1E8u;
        // 0x1dc1ec: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1DC1E8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
