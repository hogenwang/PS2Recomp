...
void sub_002FC880_0x2fc880(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    if (runtime->hasFunction(0x25D528u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FC890u; }
        if (ctx->pc != 0x2FC890u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2fc890:
    ...
    ctx->pc = 0x2FC894u;
    {
        ...
        ctx->pc = 0x2FC898u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC894u;
...
label_2fc8a0:
    ...
    if (runtime->hasFunction(0x25D5D8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FC8B0u; }
        if (ctx->pc != 0x2FC8B0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2fc8b0:
    ...
    ctx->pc = 0x2FC8B4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2FC8B8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC8B4u;
...
label_2fc8c0:
    ...
    if (runtime->hasFunction(0x25DF38u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2FC8D0u; }
        if (ctx->pc != 0x2FC8D0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2fc8d0:
    ...
    ctx->pc = 0x2FC8D4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2FC8D8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2FC8D4u;
