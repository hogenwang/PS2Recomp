...
void sub_001F64B0_0x1f64b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10A520u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10A520u, 0x1F64C4u, 0x1F64CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1F64CCu;
label_1f64cc:
    ...
    ctx->in_delay_slot = false;
    ctx->pc = 0x1D6318u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1D6318u, 0x1F64E0u, 0x0u, PS2Runtime::GuestBranchKind::DirectJump, "J")) {
        return;
    }
    ctx->pc = 0x1F64E8u;
label_1f64e8:
    ...
    ctx->pc = 0x1F64ECu;
    {
        ...
        ctx->pc = 0x1F64F0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F64ECu;
        // 0x1f64f0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F64ECu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
...
label_1f6538:
    ...
    ctx->pc = 0x1F6554u;
    {
        ...
        ctx->pc = 0x1F6558u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x1F6554u;
        // 0x1f6558: 0xad020000  sw          $v0, 0x0($t0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 8), 0), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x1F6554u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x1f655cu;
    // NOP
    if (ctx->pc == 0x1f655cu) { ctx->pc = 0x1f6560u; }
}
