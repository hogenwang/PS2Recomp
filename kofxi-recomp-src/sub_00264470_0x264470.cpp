...
void sub_00264470_0x264470(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2644A8u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x2644A4u;
    ...
    if (runtime->hasFunction(0x10F890u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2644ACu; }
        if (ctx->pc != 0x2644ACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2644c0:
    ...
    if (runtime->hasFunction(0x25CBE8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2644C8u; }
        if (ctx->pc != 0x2644C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_2644c8:
    ...
    ctx->pc = 0x2644D0u;
    {
        ...
        ctx->pc = 0x2644D4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2644D0u;
...
label_2644d8:
    ...
    if (runtime->hasFunction(0x129F70u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x2644E0u; }
        if (ctx->pc != 0x2644E0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
