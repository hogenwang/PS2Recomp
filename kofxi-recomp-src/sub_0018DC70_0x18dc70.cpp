...
void sub_0018DC70_0x18dc70(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x18DC74u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x18DC74u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x18dc7cu;
    // NOP
    if (ctx->pc == 0x18dc7cu) { ctx->pc = 0x18dc80u; }
}
