...
void sub_0025FDC0_0x25fdc0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x25FDD4u;
    {
        ...
        ctx->pc = 0x25FDD8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25FDD4u;
    ...
    if (runtime->hasFunction(0x10CC70u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x25FDE4u; }
        if (ctx->pc != 0x25FDE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_25fde8:
    ...
    ctx->pc = 0x25FDF4u;
    {
        ...
        ctx->pc = 0x25FDF8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x25FDF4u;
