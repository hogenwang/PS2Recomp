...
void sub_0019D1A0_0x19d1a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x18A490u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x18A490u, 0x19D1A8u, 0x19D1B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x19D1B0u;
label_19d1b0:
...
label_19d244:
    ...
    ctx->pc = 0x19D244u;
    {
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x19D244u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x19d24cu;
    // NOP
    if (ctx->pc == 0x19d24cu) { ctx->pc = 0x19d250u; }
}
