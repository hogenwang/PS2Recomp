...
void sub_0017A590_0x17a590(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x155CA0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x155CA0u, 0x17A5A8u, 0x17A5B0u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x17A5B0u;
label_17a5b0:
...
label_17a5bc:
    ...
    ctx->pc = 0x17A5BCu;
    {
        ...
        ctx->pc = 0x17A5C0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x17A5BCu;
        // 0x17a5c0: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 16));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x17A5BCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x17a5ccu;
    // NOP
    if (ctx->pc == 0x17a5ccu) { ctx->pc = 0x17a5d0u; }
}
