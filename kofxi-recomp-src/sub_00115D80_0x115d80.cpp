...
void sub_00115D80_0x115d80(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    switch (ctx->pc) {
        ...
        case 0x115da0u: goto label_115da0;
    ...
    ctx->pc = 0x115D8Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x115D88u;
            // 0x115d8c: 0x3a0382d  daddu       $a3, $sp, $zero (Delay Slot)
        SET_GPR_U64(ctx, 7, (uint64_t)GPR_U64(ctx, 29) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x1157B0u;
    if (runtime->hasFunction(0x1157B0u)) {
        auto targetFn = runtime->lookupFunction(0x1157B0u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x115D90u; }
        if (ctx->pc != 0x115D90u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001157B0_0x1157b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x115D90u; }
        if (ctx->pc != 0x115D90u) { return; }
    }
    ctx->pc = 0x115D90u;
label_115d90:
    ...
    ctx->pc = 0x115D94u;
    {
        ...
        ctx->pc = 0x115D98u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x115D94u;
...
label_115da0:
    ...
    if (runtime->hasFunction(0x1157B0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x115DB0u; }
        if (ctx->pc != 0x115DB0u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_001157B0_0x1157b0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x115DB0u; }
...
label_115db0:
    ...
    ctx->pc = 0x115DB4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x115DB8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x115DB4u;
