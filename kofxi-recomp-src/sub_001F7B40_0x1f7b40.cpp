...
void sub_001F7B40_0x1f7b40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1F7B5Cu;
    {
        ...
        ctx->pc = 0x1F7B60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7B5Cu;
    ...
    ctx->pc = 0x1F7B68u;
    {
        ...
        ctx->pc = 0x1F7B6Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7B68u;
...
label_1f7b88:
    ...
    ctx->pc = 0x1F7B88u;
    {
        ...
        ctx->pc = 0x1F7B8Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7B88u;
    ...
    ctx->pc = 0x1F7B90u;
    {
        ...
        ctx->pc = 0x1F7B94u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7B90u;
    ...
    ctx->pc = 0x1F7B98u;
    {
        ...
        ctx->pc = 0x1F7B9Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7B98u;
...
label_1f7ba8:
    ...
    ctx->pc = 0x1F7BA8u;
    {
        ...
        ctx->pc = 0x1F7BACu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7BA8u;
...
label_1f7bb0:
    ...
    ctx->pc = 0x1F7BB4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7BB0u;
    ...
    if (runtime->hasFunction(0x1F7C58u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7BB8u; }
        if (ctx->pc != 0x1F7BB8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f7bb8:
    ...
    if (runtime->hasFunction(0x1F8CA8u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1F7BC8u; }
        if (ctx->pc != 0x1F7BC8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1f7bd0:
    ...
    ctx->pc = 0x1F7BD8u;
    {
        ...
        ctx->pc = 0x1F7BDCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1F7BD8u;
