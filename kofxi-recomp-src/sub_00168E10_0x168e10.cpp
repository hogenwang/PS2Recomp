...
void sub_00168E10_0x168e10(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x168E34u;
    {
        ...
        if (branch_taken_0x168e34) {
            ctx->pc = 0x168E38u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x168E34u;
    ...
    ctx->pc = 0x168E4Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x168E48u;
    ...
    if (runtime->hasFunction(0x1684E0u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x168E50u; }
        if (ctx->pc != 0x168E50u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
