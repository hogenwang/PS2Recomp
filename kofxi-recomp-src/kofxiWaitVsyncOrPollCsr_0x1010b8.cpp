...
// Function: kofxiWaitVsyncOrPollCsr
// Address: 0x1010b8 - 0x101150
void kofxiWaitVsyncOrPollCsr_0x1010b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiWaitVsyncOrPollCsr_0x1010b8");
#endif
    ...
    ctx->pc = 0x1003C0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1003C0u, 0x1010C4u, 0x1010CCu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1010CCu;
label_1010cc:
    ...
    ctx->pc = 0x10D0F0u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10D0F0u, 0x1010DCu, 0x1010E4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1010E4u;
label_1010e4:
...
label_101118:
    ...
    ctx->pc = 0x10D180u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x10D180u, 0x101118u, 0x101120u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x101120u;
label_101120:
...
label_101144:
    ...
    ctx->pc = 0x101144u;
    {
        ...
        ctx->pc = 0x101148u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x101144u;
        // 0x101148: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 32));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x101144u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x10114cu;
    // NOP
    if (ctx->pc == 0x10114cu) { ctx->pc = 0x101150u; }
}
