...
void sub_00128EF8_0x128ef8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x128F18u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x128F14u;
    ...
    if (runtime->hasFunction(0x120208u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x128F1Cu; }
        if (ctx->pc != 0x128F1Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_128f1c:
    ...
    ctx->pc = 0x128F48u;
    {
        ...
        ctx->pc = 0x128F4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x128F48u;
