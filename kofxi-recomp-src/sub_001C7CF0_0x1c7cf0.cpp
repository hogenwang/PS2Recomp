...
label_1c7d10:
    ...
    ctx->pc = 0x1C7D20u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C7D1Cu;
    // 0x1c7d20: 0x80802d  daddu       $s0, $a0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C7A08u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C7A08u, 0x1C7D1Cu, 0x1C7D24u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C7D24u;
label_1c7d24:
    ...
    ctx->pc = 0x1C7D28u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x1C7D24u;
    // 0x1c7d28: 0x200202d  daddu       $a0, $s0, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1C7D40u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1C7D40u, 0x1C7D24u, 0x1C7D2Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x1C7D2Cu;
label_1c7d2c:
    ...
    ctx->pc = 0x1c7d3cu;
    // NOP
    if (ctx->pc == 0x1c7d3cu) { ctx->pc = 0x1c7d40u; }
}
