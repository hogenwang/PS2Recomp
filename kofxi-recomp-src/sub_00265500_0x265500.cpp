...
void sub_00265500_0x265500(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x265538u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x265534u;
...
label_26553c:
    ...
    ctx->pc = 0x265540u;
    {
        ...
        if (branch_taken_0x265540) {
            ctx->pc = 0x265544u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x265540u;
    ...
    ctx->pc = 0x265548u;
    {
        ...
        ctx->pc = 0x26554Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x265548u;
...
label_265550:
    ...
    ctx->in_delay_slot = true; ctx->branch_pc = 0x265560u;
        ...
        ctx->in_delay_slot = false;
    ctx->pc = 0x265130u;
    if (runtime->hasFunction(0x265130u)) {
        auto targetFn = runtime->lookupFunction(0x265130u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        ...
        const uint32_t __entryPc = ctx->pc;
        sub_00265130_0x265130(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x265568u; }
        if (ctx->pc != 0x265568u) { return; }
    }
    ctx->pc = 0x265568u;
label_265568:
    ...
    ctx->pc = 0x26556Cu;
    {
        ...
        ctx->pc = 0x265570u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x26556Cu;
    ...
    ctx->pc = 0x26557Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x265578u;
            // 0x26557c: 0x220202d  daddu       $a0, $s1, $zero (Delay Slot)
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
    ctx->pc = 0x264D08u;
    if (runtime->hasFunction(0x264D08u)) {
        auto targetFn = runtime->lookupFunction(0x264D08u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x265580u; }
        if (ctx->pc != 0x265580u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_00264D08_0x264d08(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x265580u; }
        if (ctx->pc != 0x265580u) { return; }
    }
    ctx->pc = 0x265580u;
...
label_265588:
    ...
    ctx->pc = 0x26558Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x265588u;
    ...
    if (runtime->hasFunction(0x261580u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x265590u; }
        if (ctx->pc != 0x265590u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_265594:
    ...
    ctx->pc = 0x2655B0u;
    {
        ...
        ctx->pc = 0x2655B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x2655B0u;
