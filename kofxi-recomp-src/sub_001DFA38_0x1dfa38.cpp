...
void sub_001DFA38_0x1dfa38(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1DFA48u;
    {
        ...
        ctx->pc = 0x1DFA4Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DFA48u;
    ...
    ctx->pc = 0x1DFA50u;
    {
        ...
        if (branch_taken_0x1dfa50) {
            ctx->pc = 0x1DFA54u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1DFA50u;
    ...
    ctx->pc = 0x1DFA5Cu;
    {
        ...
        ctx->pc = 0x1DFA60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DFA5Cu;
...
label_1dfa78:
    ...
    ctx->pc = 0x1DFA88u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1DFA84u;
    ...
    if (runtime->hasFunction(0x1E6BE8u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1DFA8Cu; }
        if (ctx->pc != 0x1DFA8Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1dfa94:
    ...
    ctx->pc = 0x1DFA98u;
    {
        ...
        ctx->pc = 0x1DFA9Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1DFA98u;
