...
label_217c78:
    ...
    ctx->pc = 0x217C90u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x217C8Cu;
...
label_217c94:
    ...
    ctx->pc = 0x217CA8u;
    ctx->pc = 0x217CACu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x217CA8u;
...
label_217cb0:
    ...
    if (runtime->hasFunction(0x211370u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x217CE4u; }
        if (ctx->pc != 0x217CE4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_217ce4:
    ...
    ctx->pc = 0x217CF0u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x217CECu;
...
label_217cf4:
    ...
    ctx->pc = 0x217D08u;
    {
        ...
        ctx->pc = 0x217D0Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x217D08u;
...
label_217d10:
    ...
    ctx->pc = 0x217D40u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x217D3Cu;
...
label_217d44:
    ...
    ctx->pc = 0x217D48u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x217D44u;
