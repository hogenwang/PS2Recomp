...
void sub_0010E6F8_0x10e6f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x10E718u;
    {
        ...
        ctx->pc = 0x10E71Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E718u;
    ...
    if (runtime->hasFunction(0x10E150u)) {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x10E738u; }
        if (ctx->pc != 0x10E738u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
        sub_0010E150_0x10e150(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x10E738u; }
        if (ctx->pc != 0x10E738u) { return; }
    }
    ctx->pc = 0x10E738u;
label_10e738:
    ...
    ctx->pc = 0x10E738u;
    {
        ...
        ctx->pc = 0x10E73Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E738u;
