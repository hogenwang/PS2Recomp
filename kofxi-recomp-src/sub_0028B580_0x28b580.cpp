...
label_28b5cc:
    ...
    ctx->pc = 0x28B5D0u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x28B5CCu;
    // 0x28b5d0: 0x2c0202d  daddu       $a0, $s6, $zero (Delay Slot)
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 22) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x286728u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x286728u, 0x28B5CCu, 0x28B5D4u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28B5D4u;
label_28b5d4:
...
label_28b674:
    ...
    ctx->pc = 0x28B678u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x28B674u;
    // 0x28b678: 0x2a0282d  daddu       $a1, $s5, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 21) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x1215E8u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x1215E8u, 0x28B674u, 0x28B67Cu, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28B67Cu;
label_28b67c:
...
label_28b688:
    ...
    ctx->pc = 0x28B690u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x28B68Cu;
    // 0x28b690: 0x2a0282d  daddu       $a1, $s5, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 21) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x120208u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x120208u, 0x28B68Cu, 0x28B694u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28B694u;
label_28b694:
    ...
    ctx->pc = 0x28B6B4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x28B6B0u;
    // 0x28b6b4: 0x260282d  daddu       $a1, $s3, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 19) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x120208u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x120208u, 0x28B6B0u, 0x28B6B8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28B6B8u;
label_28b6b8:
...
label_28b6dc:
    ...
    ctx->pc = 0x28B6E4u;
    ctx->in_delay_slot = true;
    ctx->branch_pc = 0x28B6E0u;
    // 0x28b6e4: 0x3c0282d  daddu       $a1, $fp, $zero (Delay Slot)
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 30) + (uint64_t)GPR_U64(ctx, 0));
    ctx->in_delay_slot = false;
    ctx->pc = 0x120208u;
    if (!runtime->dispatchGuestBranch(rdram, ctx, 0x120208u, 0x28B6E0u, 0x28B6E8u, PS2Runtime::GuestBranchKind::DirectCall, "JAL")) {
        return;
    }
    ctx->pc = 0x28B6E8u;
label_28b6e8:
...
label_28b72c:
    ...
    ctx->pc = 0x28B754u;
    {
        ...
        ctx->pc = 0x28B758u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x28B754u;
        // 0x28b758: 0x27bd00b0  addiu       $sp, $sp, 0xB0 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 176));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x28B754u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
    ...
    ctx->pc = 0x28b75cu;
    // NOP
    if (ctx->pc == 0x28b75cu) { ctx->pc = 0x28b760u; }
}
