...
// Function: kofxiThreadManagerInit
// Address: 0x1b3670 - 0x1b3800
void kofxiThreadManagerInit_0x1b3670(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("kofxiThreadManagerInit_0x1b3670");
#endif
    ...
    // 0x1b3670: 0x27bdffb0  addiu       $sp, $sp, -0x50
    ctx->pc = 0x1b3670u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967216));
    // 0x1b3674: 0x3c020037  lui         $v0, 0x37
    ctx->pc = 0x1b3674u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)55 << 16));
    // 0x1b3678: 0xffb20040  sd          $s2, 0x40($sp)
    ctx->pc = 0x1b3678u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 64), GPR_U64(ctx, 18));
    // 0x1b367c: 0x3c120037  lui         $s2, 0x37
    ctx->pc = 0x1b367cu;
    SET_GPR_S32(ctx, 18, (int32_t)((uint32_t)55 << 16));
    // 0x1b3680: 0xffb00030  sd          $s0, 0x30($sp)
    ctx->pc = 0x1b3680u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 48), GPR_U64(ctx, 16));
    // 0x1b3684: 0x80802d  daddu       $s0, $a0, $zero
    ctx->pc = 0x1b3684u;
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    // 0x1b3688: 0xffb10038  sd          $s1, 0x38($sp)
    ctx->pc = 0x1b3688u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 56), GPR_U64(ctx, 17));
    // 0x1b368c: 0x3c030037  lui         $v1, 0x37
    ctx->pc = 0x1b368cu;
    SET_GPR_S32(ctx, 3, (int32_t)((uint32_t)55 << 16));
    // 0x1b3690: 0xffbf0048  sd          $ra, 0x48($sp)
    ctx->pc = 0x1b3690u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 72), GPR_U64(ctx, 31));
    // 0x1b3694: 0x24422ff0  addiu       $v0, $v0, 0x2FF0
    ctx->pc = 0x1b3694u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 2), 12272));
    // 0x1b3698: 0x8e452ff4  lw          $a1, 0x2FF4($s2)
    ctx->pc = 0x1b3698u;
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 18), 12276)));
    // 0x1b369c: 0x2463304c  addiu       $v1, $v1, 0x304C
    ctx->pc = 0x1b369cu;
    SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 3), 12364));
    // 0x1b36a0: 0x8c460000  lw          $a2, 0x0($v0)
    ctx->pc = 0x1b36a0u;
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 0)));
    // 0x1b36a4: 0xac600000  sw          $zero, 0x0($v1)
    ctx->pc = 0x1b36a4u;
    WRITE32(ADD32(GPR_U32(ctx, 3), 0), GPR_U32(ctx, 0));
    // 0x1b36a8: 0x54a0004c  bnel        $a1, $zero, . + 4 + (0x4C << 2)
    ctx->pc = 0x1B36A8u;
    {
        const bool branch_taken_0x1b36a8 = (GPR_U64(ctx, 5) != GPR_U64(ctx, 0));
        if (branch_taken_0x1b36a8) {
            ctx->pc = 0x1B36ACu;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1B36A8u;
            // 0x1b36ac: 0x26432ff4  addiu       $v1, $s2, 0x2FF4 (Delay Slot)
    ...
    ctx->pc = 0x1B36B0u;
    // 0x1b36b0: 0xc0739d2  jal         func_1CE748
    ctx->pc = 0x1B36B0u;
    SET_GPR_U32(ctx, 31, 0x1B36B8u);
    ctx->pc = 0x1CE748u;
    if (runtime->hasFunction(0x1CE748u)) {
        auto targetFn = runtime->lookupFunction(0x1CE748u);
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B36B8u; }
        if (ctx->pc != 0x1B36B8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b36b8:
    ...
    ctx->pc = 0x1B36C4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B36C0u;
    ...
    if (runtime->hasFunction(0x1CE428u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B36C8u; }
        if (ctx->pc != 0x1B36C8u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b36d8:
    ...
    ctx->pc = 0x1B36F4u;
    {
        ...
        ctx->pc = 0x1B36F8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B36F4u;
    ...
    ctx->pc = 0x1B3730u;
    {
        ...
        ctx->pc = 0x1B3734u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B3730u;
...
label_1b3778:
    ...
    ctx->pc = 0x1B3788u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B3784u;
    ...
    if (runtime->hasFunction(0x10CB60u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B378Cu; }
        if (ctx->pc != 0x1B378Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b378c:
    ...
    if (runtime->hasFunction(0x1B3260u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B379Cu; }
        if (ctx->pc != 0x1B379Cu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b37a4:
    ...
    if (runtime->hasFunction(0x1B3448u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B37ACu; }
        if (ctx->pc != 0x1B37ACu) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b37b4:
    ...
    if (runtime->hasFunction(0x10CAF0u)) {
        ...
        const uint32_t __entryPc = ctx->pc;
        targetFn(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1B37C4u; }
        if (ctx->pc != 0x1B37C4u) { return; }
    } else {
        const uint32_t __entryPc = ctx->pc;
...
label_1b37c4:
    ...
    ctx->pc = 0x1B37D4u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1B37D0u;
...
label_1b37dc:
    ...
    ctx->pc = 0x1B37F8u;
    {
        ...
        ctx->pc = 0x1B37FCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1B37F8u;
